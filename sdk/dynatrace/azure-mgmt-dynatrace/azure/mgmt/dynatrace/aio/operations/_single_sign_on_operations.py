...
from ...operations._single_sign_on_operations import build_create_or_update_request_initial, build_get_request, build_list_request
T = TypeVar('T')
...
class SingleSignOnOperations:
    ...
    def list(
        ...
        monitor_name: str,
        **kwargs: Any
    ) -> AsyncIterable[_models.DynatraceSingleSignOnResourceListResult]:
        ...
        :return: An iterator like instance of either DynatraceSingleSignOnResourceListResult or the
         result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dynatrace.models.DynatraceSingleSignOnResourceListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
