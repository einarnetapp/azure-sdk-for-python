...
class ManagedEnvironmentsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ManagedEnvironment"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.app.models.ManagedEnvironment]
    ...
    def list_workload_profile_states(
        ...
        :return: An iterator like instance of either WorkloadProfileStates or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.app.models.WorkloadProfileStates]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
