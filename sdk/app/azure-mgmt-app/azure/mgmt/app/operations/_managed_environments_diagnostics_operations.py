...
def build_get_root_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{name}/detectorproperties/rootApi/")  # pylint: disable=line-too-long
...
class ManagedEnvironmentsDiagnosticsOperations(object):
    ...
    get_root.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{name}/detectorproperties/rootApi/"}  # type: ignore
