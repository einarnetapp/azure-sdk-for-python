...
from ...operations._container_apps_diagnostics_operations import (
    build_get_auth_configs_request,
...
class ContainerAppsDiagnosticsOperations:
    ...
    def list_detectors(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.app.models.Diagnostics]
    ...
    def list_revisions(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.app.models.Revision]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
