...
class ManagedEnvironmentsDiagnosticsOperations:
    ...
    def list_dapr_components(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.app.models.DaprComponent]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_certificates(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.app.models.Certificate]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
