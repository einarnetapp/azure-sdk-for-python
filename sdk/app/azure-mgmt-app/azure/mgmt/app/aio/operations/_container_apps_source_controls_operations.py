...
class ContainerAppsSourceControlsOperations:
    ...
    def list_by_container_app(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.app.models.SourceControl]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type source_control_envelope: ~azure.mgmt.app.models.SourceControl or IO
