...
class ManagedEnvironmentsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.ManagedEnvironment"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.app.models.ManagedEnvironment]
    ...
    ) -> AsyncIterable["_models.ManagedEnvironment"]:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type environment_envelope: ~azure.mgmt.app.models.ManagedEnvironment or IO
    ...
    async def get_auth_token(
        ...
        :rtype: ~azure.mgmt.app.models.EnvironmentAuthToken
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def list_workload_profile_states(
        ...
        :return: An iterator like instance of either WorkloadProfileStates or the result of
         cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.app.models.WorkloadProfileStates]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
