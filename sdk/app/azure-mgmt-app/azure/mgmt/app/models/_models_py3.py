...
class IpSecurityRestrictionRule(msrest.serialization.Model):
    ...
    :vartype description: str
    :ivar ip_address_range: Required. CIDR notation to match incoming IP address.
    :vartype ip_address_range: str
    :ivar action: Required. Allow or Deny rules to determine for incoming IP. Note: Rules can only
     consist of ALL Allow or ALL Deny. Known values are: "Allow", "Deny".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword description: Describe the IP restriction rule that is being sent to the container-app.
         This is an optional field.
        :paramtype description: str
        :keyword ip_address_range: Required. CIDR notation to match incoming IP address.
        :paramtype ip_address_range: str
        :keyword action: Required. Allow or Deny rules to determine for incoming IP. Note: Rules can
         only consist of ALL Allow or ALL Deny. Known values are: "Allow", "Deny".
        :paramtype action: str or ~azure.mgmt.app.models.Action
        """
        super(IpSecurityRestrictionRule, self).__init__(**kwargs)
        self.name = name
        self.description = description
