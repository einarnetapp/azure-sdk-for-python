...
class Ingress(msrest.serialization.Model):
    ...
    :ivar exposed_port: Exposed Port in containers for TCP traffic.
    :vartype exposed_port: int
    :ivar transport: Ingress transport protocol. Known values are: "auto", "http", "http2", "tcp".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword exposed_port: Exposed Port in containers for TCP traffic.
