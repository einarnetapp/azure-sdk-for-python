...
class Ingress(_serialization.Model):
    ...
    :ivar client_certificate_mode: Client certificate mode for mTLS authentication. Ignore
     ...
     client certificate but does not requires a client certificate. Require indicates server
     requires a client certificate. Known values are: "ignore", "accept", and "require".
    :vartype client_certificate_mode: str or ~azure.mgmt.app.models.IngressClientCertificateMode
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword client_certificate_mode: Client certificate mode for mTLS authentication. Ignore
         ...
         client certificate but does not requires a client certificate. Require indicates server
         requires a client certificate. Known values are: "ignore", "accept", and "require".
        :paramtype client_certificate_mode: str or ~azure.mgmt.app.models.IngressClientCertificateMode
        """
        super().__init__(**kwargs)
        self.fqdn = None
