...
class AvailableWorkloadProfile(ProxyResource):
    ...
    :vartype properties: ~azure.mgmt.app.models.AvailableWorkloadProfileProperties
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype properties: ~azure.mgmt.app.models.AvailableWorkloadProfileProperties
        """
        super().__init__(**kwargs)
...
class AvailableWorkloadProfileProperties(_serialization.Model):
    ...
    :vartype billing_meter_category: str or ~azure.mgmt.app.models.Category
    :ivar applicability: indicates whether the profile is default for the location. Known values
     are: "LocationDefault" and "Custom".
    :vartype applicability: str or ~azure.mgmt.app.models.Applicability
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype billing_meter_category: str or ~azure.mgmt.app.models.Category
        :keyword applicability: indicates whether the profile is default for the location. Known values
         are: "LocationDefault" and "Custom".
        :paramtype applicability: str or ~azure.mgmt.app.models.Applicability
...
class AvailableWorkloadProfilesCollection(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.app.models.AvailableWorkloadProfile]
    :ivar next_link: Link to next page of resources.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.AvailableWorkloadProfile"], **kwargs):
        ...
        :paramtype value: list[~azure.mgmt.app.models.AvailableWorkloadProfile]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class BillingMeter(ProxyResource):
    ...
    :vartype location: str
    :ivar properties: Revision resource specific properties.
    :vartype properties: ~azure.mgmt.app.models.BillingMeterProperties
    """
    ...
    def __init__(
        ...
        :paramtype location: str
        :keyword properties: Revision resource specific properties.
        :paramtype properties: ~azure.mgmt.app.models.BillingMeterProperties
        """
        super().__init__(**kwargs)
        self.location = location
        self.properties = properties
...
class BillingMeterCollection(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.app.models.BillingMeter]
    """
    ...
    def __init__(self, *, value: List["_models.BillingMeter"], **kwargs):
        ...
        :paramtype value: list[~azure.mgmt.app.models.BillingMeter]
        """
        super().__init__(**kwargs)
        self.value = value
...
class BillingMeterProperties(_serialization.Model):
    ...
    :vartype category: str or ~azure.mgmt.app.models.Category
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword category: Used to map workload profile types to billing meter. Known values are:
         "PremiumSkuGeneralPurpose", "PremiumSkuMemoryOptimized", and "PremiumSkuComputeOptimized".
        :paramtype category: str or ~azure.mgmt.app.models.Category
...
class EnvironmentSkuProperties(_serialization.Model):
    ...
    :vartype name: str or ~azure.mgmt.app.models.SkuName
    """
    ...
    def __init__(self, *, name: Union[str, "_models.SkuName"], **kwargs):
        ...
        :paramtype name: str or ~azure.mgmt.app.models.SkuName
        """
        super().__init__(**kwargs)
        self.name = name
...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.app.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.app.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.app.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs):
        ...
        :paramtype error: ~azure.mgmt.app.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class Ingress(_serialization.Model):
    ...
    :vartype ip_security_restrictions: list[~azure.mgmt.app.models.IpSecurityRestrictionRule]
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype ip_security_restrictions: list[~azure.mgmt.app.models.IpSecurityRestrictionRule]
        """
        super().__init__(**kwargs)
        self.fqdn = None
...
class IpSecurityRestrictionRule(_serialization.Model):
    ...
    :vartype action: str or ~azure.mgmt.app.models.Action
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype action: str or ~azure.mgmt.app.models.Action
        """
        super().__init__(**kwargs)
        self.name = name
        self.description = description
...
class ManagedEnvironment(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype sku: ~azure.mgmt.app.models.EnvironmentSkuProperties
    ...
    :vartype workload_profiles: list[~azure.mgmt.app.models.WorkloadProfile]
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype sku: ~azure.mgmt.app.models.EnvironmentSkuProperties
        ...
        :paramtype workload_profiles: list[~azure.mgmt.app.models.WorkloadProfile]
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.sku = sku
        self.provisioning_state = None
...
class ManagedEnvironmentOutboundSettings(_serialization.Model):
    ...
    :ivar out_bound_type: Outbound type for the cluster. Known values are: "LoadBalancer" and
     "UserDefinedRouting".
    :vartype out_bound_type: str or ~azure.mgmt.app.models.ManagedEnvironmentOutBoundType
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword out_bound_type: Outbound type for the cluster. Known values are: "LoadBalancer" and
         "UserDefinedRouting".
        :paramtype out_bound_type: str or ~azure.mgmt.app.models.ManagedEnvironmentOutBoundType
...
class ScaleRule(_serialization.Model):
    ...
    :vartype tcp: ~azure.mgmt.app.models.TcpScaleRule
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype tcp: ~azure.mgmt.app.models.TcpScaleRule
        """
        super().__init__(**kwargs)
        self.name = name
...
class Template(_serialization.Model):
    ...
    Any changes to this section Will result in a new revision being created.
        ...
        :vartype init_containers: list[~azure.mgmt.app.models.InitContainer]
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype init_containers: list[~azure.mgmt.app.models.InitContainer]
...
class VnetConfiguration(_serialization.Model):
    ...
    :vartype outbound_settings: ~azure.mgmt.app.models.ManagedEnvironmentOutboundSettings
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword outbound_settings: Configuration used to control the Environment Egress outbound
         traffic.
        :paramtype outbound_settings: ~azure.mgmt.app.models.ManagedEnvironmentOutboundSettings
        """
        super().__init__(**kwargs)
