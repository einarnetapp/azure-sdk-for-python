...
class ContainerApp(TrackedResource):
    ...
    :ivar workload_profile_type: Workload profile type to pin for container app execution. Known
     values are: "General Purpose", "Memory Optimized", "Compute Optimized".
    :vartype workload_profile_type: str or ~azure.mgmt.app.models.WorkloadProfileType
    ...
    def __init__(
        ...
        *,
        ...
        workload_profile_type: Optional[Union[str, "_models.WorkloadProfileType"]] = None,
        ...
        **kwargs
        ...
        :keyword workload_profile_type: Workload profile type to pin for container app execution. Known
         values are: "General Purpose", "Memory Optimized", "Compute Optimized".
        :paramtype workload_profile_type: str or ~azure.mgmt.app.models.WorkloadProfileType
...
class EnvironmentSkuProperties(msrest.serialization.Model):
    """Managed Environment resource SKU properties.

    All required parameters must be populated in order to send to Azure.

    :ivar name: Required. Name of the Sku. Known values are: "Consumption", "Premium".
    :vartype name: str or ~azure.mgmt.app.models.SkuType
    :ivar capacity: Required. Capacity of the SKU (number of deployed nodes of the SKU). For
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword name: Required. Name of the Sku. Known values are: "Consumption", "Premium".
        :paramtype name: str or ~azure.mgmt.app.models.SkuType
        :keyword capacity: Required. Capacity of the SKU (number of deployed nodes of the SKU). For
         Consumption SKU capacity must be specified as 0.
        :paramtype capacity: int
        """
        super(EnvironmentSkuProperties, self).__init__(**kwargs)
        self.name = name
...
class ManagedEnvironment(TrackedResource):
    ...
    :ivar workload_profiles: Workload profiles available for Managed Environment.
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword workload_profiles: Workload profiles available for Managed Environment.
...
class WorkloadProfile(msrest.serialization.Model):
    ...
    :ivar workload_profile_type: Required. Workload profile type for the workloads to run on. Known
     values are: "General Purpose", "Memory Optimized", "Compute Optimized".
    :vartype workload_profile_type: str or ~azure.mgmt.app.models.WorkloadProfileType
    :ivar provisioning_state: Provisioning state of the workload profile.
    ...
    def __init__(
        self,
        *,
        workload_profile_type: Union[str, "_models.WorkloadProfileType"],
        minimum: Optional[int] = None,
        maximum: Optional[int] = None,
        **kwargs
    ):
        """
        :keyword workload_profile_type: Required. Workload profile type for the workloads to run on.
         Known values are: "General Purpose", "Memory Optimized", "Compute Optimized".
        :paramtype workload_profile_type: str or ~azure.mgmt.app.models.WorkloadProfileType
        ...
        """
        super(WorkloadProfile, self).__init__(**kwargs)
        self.workload_profile_type = workload_profile_type
        self.provisioning_state = None
