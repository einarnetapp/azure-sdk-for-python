...
class Ingress(msrest.serialization.Model):
    ...
    :ivar ip_security_restriction_rules: Rules to restrict incoming IP address.
    :vartype ip_security_restriction_rules: list[~azure.mgmt.app.models.IpSecurityRestrictionRules]
    ...
    _attribute_map = {
        ...
        'ip_security_restriction_rules': {'key': 'ipSecurityRestrictionRules', 'type': '[IpSecurityRestrictionRules]'},
    ...
    def __init__(
        ...
        *,
        ...
        ip_security_restriction_rules: Optional[List["_models.IpSecurityRestrictionRules"]] = None,
        ...
        **kwargs
        ...
        :keyword ip_security_restriction_rules: Rules to restrict incoming IP address.
        :paramtype ip_security_restriction_rules:
         list[~azure.mgmt.app.models.IpSecurityRestrictionRules]
        ...
        self.ip_security_restriction_rules = ip_security_restriction_rules
        self.allow_insecure = allow_insecure


class IpSecurityRestrictionRules(msrest.serialization.Model):
    """Rules to restrict incoming IP address.

    All required parameters must be populated in order to send to Azure.

    :ivar name: Required. Name for the ip restriction rule.
    :vartype name: str
    :ivar description: Describe the IP restriction rules that are being sent to the container-app.
     This is an optional field.
    :vartype description: str
    :ivar ip_address: Required. CIDR notation to match incoming ip address.
    :vartype ip_address: str
    :ivar action: Required. Allow or Deny rules to determine for incoming ip. Known values are:
     "Allow", "Deny".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword name: Required. Name for the ip restriction rule.
        :paramtype name: str
        :keyword description: Describe the IP restriction rules that are being sent to the
         container-app. This is an optional field.
        :paramtype description: str
        :keyword ip_address: Required. CIDR notation to match incoming ip address.
        :paramtype ip_address: str
        :keyword action: Required. Allow or Deny rules to determine for incoming ip. Known values are:
         "Allow", "Deny".
        :paramtype action: str or ~azure.mgmt.app.models.Action
        """
        super(IpSecurityRestrictionRules, self).__init__(**kwargs)
        self.name = name
        self.description = description
