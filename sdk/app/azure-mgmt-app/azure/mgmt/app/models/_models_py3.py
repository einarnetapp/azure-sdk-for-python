...
class CustomHostnameAnalysisResult(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar has_conflict_on_environment: :code:`<code>true</code>` if there is a conflict on the
     Container App's environment; otherwise, :code:`<code>false</code>`.
    :vartype has_conflict_on_environment: bool
    ...
    _validation = {
        ...
        "has_conflict_on_environment": {"readonly": True},
    ...
    _attribute_map = {
        ...
        "has_conflict_on_environment": {"key": "hasConflictOnEnvironment", "type": "bool"},
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.has_conflict_on_environment = None
...
class TrafficLabel(_serialization.Model):
