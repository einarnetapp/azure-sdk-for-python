...
class ApplicationClient(ApplicationClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype applications:
     azure.mgmt.managedapplication.v2018_06_01.operations.ApplicationsOperations
    :ivar application_definitions: ApplicationDefinitionsOperations operations
    :vartype application_definitions:
     azure.mgmt.managedapplication.v2018_06_01.operations.ApplicationDefinitionsOperations
    :ivar jit_requests: JitRequestsOperations operations
    :vartype jit_requests:
     azure.mgmt.managedapplication.v2018_06_01.operations.JitRequestsOperations
