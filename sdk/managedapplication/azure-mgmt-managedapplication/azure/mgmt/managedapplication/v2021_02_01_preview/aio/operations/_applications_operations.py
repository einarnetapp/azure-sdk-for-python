...
from ...operations._applications_operations import build_create_or_update_by_id_request_initial, build_create_or_update_request_initial, build_delete_by_id_request_initial, build_delete_request_initial, build_get_by_id_request, build_get_request, build_list_allowed_upgrade_plans_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_list_tokens_request, build_refresh_permissions_request_initial, build_update_access_request_initial, build_update_by_id_request_initial, build_update_request_initial
...
class ApplicationsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ApplicationPatchable or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managedapplication.v2021_02_01_preview.models.ApplicationPatchable]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ApplicationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.managedapplication.v2021_02_01_preview.models.ApplicationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace_async
    async def begin_refresh_permissions(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        application_name: str,
        **kwargs: Any
    ...
    async def begin_update_access(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._update_access_initial(  # type: ignore
                resource_group_name=resource_group_name,
                application_name=application_name,
                parameters=parameters,
                api_version=api_version,
