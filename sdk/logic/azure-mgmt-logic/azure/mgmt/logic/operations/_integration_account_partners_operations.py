...
def build_get_request(
    resource_group_name: str, integration_account_name: str, partner_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "integrationAccountName": _SERIALIZER.url("integration_account_name", integration_account_name, "str"),
        "partnerName": _SERIALIZER.url("partner_name", partner_name, "str"),
    }
...
class IntegrationAccountPartnersOperations:
    ...
    def list(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.IntegrationAccountPartner"]:
        ...
        :return: An iterator like instance of either IntegrationAccountPartner or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.logic.models.IntegrationAccountPartner]
    ...
    def get(
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))  # type: str
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.IntegrationAccountPartner]
    ...
    def create_or_update(
        ...
        integration_account_name: str,
        partner_name: str,
        partner: Union[_models.IntegrationAccountPartner, IO],
        **kwargs: Any
    ) -> _models.IntegrationAccountPartner:
        """Creates or updates an integration account partner.
        ...
        :param partner_name: The integration account partner name. Required.
        :type partner_name: str
        :param partner: The integration account partner. Is either a model type or a IO type. Required.
        :type partner: ~azure.mgmt.logic.models.IntegrationAccountPartner or IO
        ...
        _json = None
        _content = None
        if isinstance(partner, (IO, bytes)):
            _content = partner
        else:
