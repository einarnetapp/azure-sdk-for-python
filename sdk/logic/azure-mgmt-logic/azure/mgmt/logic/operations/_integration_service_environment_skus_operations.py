...
class IntegrationServiceEnvironmentSkusOperations:
    ...
    def list(
    ...
    ) -> Iterable["_models.IntegrationServiceEnvironmentSkuDefinition"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.logic.models.IntegrationServiceEnvironmentSkuDefinition]
