...
def build_list_by_subscription_request(
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Logic/integrationServiceEnvironments"
...
def build_list_by_resource_group_request(
    resource_group: str, subscription_id: str, *, top: Optional[int] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class IntegrationServiceEnvironmentsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`integration_service_environments` attribute.
    """
    ...
    ) -> Iterable["_models.IntegrationServiceEnvironment"]:
        """Gets a list of integration service environments by subscription.

        :param top: The number of items to be included in the result. Default value is None.
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either IntegrationServiceEnvironment or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.logic.models.IntegrationServiceEnvironment]
    ...
    def list_by_resource_group(
        self, resource_group: str, top: Optional[int] = None, **kwargs: Any
    ) -> Iterable["_models.IntegrationServiceEnvironment"]:
    ...
    def _create_or_update_initial(
        ...
        integration_service_environment: Union[_models.IntegrationServiceEnvironment, IO],
        **kwargs: Any
    ) -> _models.IntegrationServiceEnvironment:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(integration_service_environment, (IO, bytes)):
            _content = integration_service_environment
        else:
            _json = self._serialize.body(integration_service_environment, "IntegrationServiceEnvironment")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.IntegrationServiceEnvironment]:
        ...
        :return: An instance of LROPoller that returns either IntegrationServiceEnvironment or the
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type integration_service_environment_name: str
        :param integration_service_environment: The integration service environment. Required.
        :type integration_service_environment: IO
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param integration_service_environment_name: The integration service environment name.
         Required.
        :type integration_service_environment_name: str
        :param integration_service_environment: The integration service environment. Is either a model
