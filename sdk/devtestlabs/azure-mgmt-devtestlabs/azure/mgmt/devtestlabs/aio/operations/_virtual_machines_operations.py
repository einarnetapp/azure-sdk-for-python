...
from ...operations._virtual_machines_operations import (
    ...
    build_get_rdp_file_contents_request,
    build_get_request,
    ...
    build_start_request,
    build_stop_request,
    build_transfer_disks_request,
    build_un_claim_request,
...
class VirtualMachinesOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either LabVirtualMachine or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.devtestlabs.models.LabVirtualMachine]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    clear_artifact_results.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/virtualmachines/{name}/clearArtifactResults"}  # type: ignore
