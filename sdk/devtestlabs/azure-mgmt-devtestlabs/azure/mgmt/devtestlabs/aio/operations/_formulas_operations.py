...
from ...operations._formulas_operations import (
...
class FormulasOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Formula or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.devtestlabs.models.Formula]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
