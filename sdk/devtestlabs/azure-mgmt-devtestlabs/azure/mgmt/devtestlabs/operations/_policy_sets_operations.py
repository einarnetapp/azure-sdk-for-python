...
class PolicySetsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.PolicySetList]
    ...
    list.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/policysets"}  # type: ignore
