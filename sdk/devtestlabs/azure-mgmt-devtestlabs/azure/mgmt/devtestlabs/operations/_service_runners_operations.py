...
class ServiceRunnersOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.ServiceRunner]:
        ...
        :return: An instance of LROPoller that returns either ServiceRunner or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.devtestlabs.models.ServiceRunner]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
