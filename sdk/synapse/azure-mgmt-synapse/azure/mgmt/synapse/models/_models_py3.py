...
class SelfHostedIntegrationRuntimeStatus(IntegrationRuntimeStatus):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar os_type: OS Type, 1- Windows; 2- Linux.
    :vartype os_type: int
    :ivar target_framework: Target framework type, 0 - DotNetFramework ; 1 - DotNetCore.
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        auto_update_eta: Optional[datetime.datetime] = None,
        ...
        **kwargs
        ...
        :keyword auto_update_eta: The estimated time when the self-hosted integration runtime will be
         updated.
        :paramtype auto_update_eta: ~datetime.datetime
        ...
        self.auto_update_eta = auto_update_eta
