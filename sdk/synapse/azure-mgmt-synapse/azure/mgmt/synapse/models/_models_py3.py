...
class ErrorAdditionalInfoAutoGenerated(_serialization.Model):
    """The resource management error additional info.
...
class ErrorDetailAutoGenerated(_serialization.Model):
    ...
    :ivar details: The error details.
    :vartype details: list[~azure.mgmt.synapse.models.ErrorDetailAutoGenerated]
    :ivar innererror: The error additional info.
    :vartype innererror: list[JSON]
    """
...
class ErrorDetailAutoGenerated2(_serialization.Model):
    ...
    :vartype severity: str
    :ivar details: The error details.
    :vartype details: list[~azure.mgmt.synapse.models.ErrorDetailAutoGenerated2]
    :ivar innererror: The error additional info.
    :vartype innererror: list[JSON]
    """
...
class ErrorResponseAutoGenerated(_serialization.Model):
    ...
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.synapse.models.ErrorAdditionalInfoAutoGenerated]
    """
    ...
    _attribute_map = {
        ...
        "additional_info": {"key": "additionalInfo", "type": "[ErrorAdditionalInfoAutoGenerated]"},
    }
...
class ErrorResponseAutoGenerated2(_serialization.Model):
    ...
    :ivar error: The error object.
    :vartype error: ~azure.mgmt.synapse.models.ErrorDetailAutoGenerated
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetailAutoGenerated"] = None, **kwargs: Any) -> None:
        """
        :keyword error: The error object.
        :paramtype error: ~azure.mgmt.synapse.models.ErrorDetailAutoGenerated
        """
        super().__init__(**kwargs)
        self.error = error
...
class ErrorResponseAutoGenerated3(_serialization.Model):
    ...
    :ivar error: The error object.
    :vartype error: ~azure.mgmt.synapse.models.ErrorDetailAutoGenerated2
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetailAutoGenerated2"] = None, **kwargs: Any) -> None:
        """
        :keyword error: The error object.
        :paramtype error: ~azure.mgmt.synapse.models.ErrorDetailAutoGenerated2
        """
        super().__init__(**kwargs)
        self.error = error
...
class KustoPoolPrivateLinkResources(TrackedResource):
...
class LanguageExtension(_serialization.Model):
    ...
    :ivar language_extension_image_name: languageExtensionImageName.
    :vartype language_extension_image_name: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword language_extension_image_name: languageExtensionImageName.
        :paramtype language_extension_image_name: str
        """
        super().__init__(**kwargs)
...
class ManagedIntegrationRuntime(IntegrationRuntime):
    ...
    :ivar provisioning_state: provisioningState.
    :vartype provisioning_state: str
    """
    ...
    _attribute_map = {
        ...
        "provisioning_state": {"key": "typeProperties.provisioningState", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword provisioning_state: provisioningState.
        :paramtype provisioning_state: str
        """
...
class SkuGet(_serialization.Model):
    """SQL pool SKU.
...
class SqlPool(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar current_service_objective_name: currentServiceObjectiveName.
    :vartype current_service_objective_name: str
    :ivar default_secondary_location: defaultSecondaryLocation.
    :vartype default_secondary_location: str
    :ivar catalog_collation: catalogCollation.
    :vartype catalog_collation: str
    """
    ...
    def __init__(
        ...
        *,
        ...
        current_service_objective_name: Optional[str] = None,
        default_secondary_location: Optional[str] = None,
        catalog_collation: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword tags: Resource tags.
        ...
        :keyword current_service_objective_name: currentServiceObjectiveName.
        :paramtype current_service_objective_name: str
        :keyword default_secondary_location: defaultSecondaryLocation.
        :paramtype default_secondary_location: str
        :keyword catalog_collation: catalogCollation.
        :paramtype catalog_collation: str
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.kind = kind
        self.sku = sku
        ...
        self.current_service_objective_name = current_service_objective_name
        self.default_secondary_location = default_secondary_location
...
class SqlPoolGet(TrackedResource):  # pylint: disable=too-many-instance-attributes
    """A SQL Analytics pool.
    ...
    :vartype kind: str
    :ivar sku: SQL pool SKU.
    :vartype sku: ~azure.mgmt.synapse.models.SkuGet
    :ivar max_size_bytes: Maximum size in bytes.
    :vartype max_size_bytes: int
    :ivar collation: Collation mode.
    :vartype collation: str
    ...
    def __init__(
        ...
        *,
        ...
        tags: Optional[Dict[str, str]] = None,
        kind: Optional[str] = None,
        sku: Optional["_models.SkuGet"] = None,
        max_size_bytes: Optional[int] = None,
        collation: str = "",
        source_database_id: Optional[str] = None,
        recoverable_database_id: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        :paramtype kind: str
        :keyword sku: SQL pool SKU.
        :paramtype sku: ~azure.mgmt.synapse.models.SkuGet
        :keyword max_size_bytes: Maximum size in bytes.
        :paramtype max_size_bytes: int
        :keyword collation: Collation mode.
        :paramtype collation: str
