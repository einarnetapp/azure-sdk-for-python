...
class IntegrationRuntime(_serialization.Model):
    ...
    _subtype_map = {"type": {"SelfHosted": "SelfHostedIntegrationRuntime"}}
...
class ManagedIntegrationRuntimeManagedVirtualNetworkReference(_serialization.Model):
    ...
    :vartype reference_name: str
    :ivar type: The type of the managed virtual network.
    :vartype type: str
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype reference_name: str
        :keyword type: The type of the managed virtual network.
        :paramtype type: str
...
class ManagedIntegrationRuntimeTypeProperties(_serialization.Model):
