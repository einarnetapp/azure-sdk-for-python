...
class IntergrationruntimesOperationStatus(ProxyResource):
    ...
    :vartype location: str
    :ivar status: status of stop Integrationruntimes. Known values are: "InProgress", "Succeeded",
     and "Failed".
    :vartype status: str or ~azure.mgmt.synapse.models.WorkspaceStatus
    :ivar name_properties_name: Name of Operation Statuses.
    :vartype name_properties_name: str
    :ivar properties: properties value for 8A2431BC39114B709A447C12F99E3BB4.
    :vartype properties: str
    :ivar error: error value for 8A2431BC39114B709A447C12F99E3BB4.
    :vartype error: str
    """
