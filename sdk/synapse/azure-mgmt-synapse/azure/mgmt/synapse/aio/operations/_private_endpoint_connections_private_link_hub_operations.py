...
from ...operations._private_endpoint_connections_private_link_hub_operations import (
    build_get_request,
    build_list_request,
)
...
class PrivateEndpointConnectionsPrivateLinkHubOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.PrivateEndpointConnectionForPrivateLinkHub"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.synapse.models.PrivateEndpointConnectionForPrivateLinkHub]
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[_models.PrivateEndpointConnectionForPrivateLinkHubResourceCollectionResponse]
