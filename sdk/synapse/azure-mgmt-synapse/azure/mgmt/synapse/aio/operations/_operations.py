...
from ...operations._operations import (
    ...
    build_get_subscription_quota_and_usage_request,
    build_get_workspace_quota_and_usage_request,
    build_list_request,
)
...
class Operations:
    ...
    @distributed_trace_async
    async def get_subscription_quota_and_usage(self, location: str, **kwargs: Any) -> _models.ListUsagesResult:
    ...
    @distributed_trace_async
    async def get_workspace_quota_and_usage(
    ...
    @distributed_trace_async
    async def get_location_header_result(  # pylint: disable=inconsistent-return-statements
