...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.AutonomousDevelopmentPlatform/accounts"
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
    }
...
class AccountsOperations:
    ...
    @distributed_trace
    def check_name_availability(
        self, parameters: Union[_models.AccountCheckNameAvailabilityParameters, IO], **kwargs: Any
    ) -> _models.CheckNameAvailabilityResult:
        """Checks that the account name is valid and is not already in use.

        :param parameters: The checkNameAvailability parameters. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.adp.models.AccountCheckNameAvailabilityParameters or IO
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.Account"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.adp.models.Account]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.adp.models.Account]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param account_name: The name of the ADP account. Required.
        :type account_name: str
        :param parameters: The parameters to provide for the current ADP account. Is either a model
         type or a IO type. Default value is None.
        :type parameters: ~azure.mgmt.adp.models.AccountPatch or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param account_name: The name of the ADP account. Required.
        :type account_name: str
        :param parameters: The parameters to provide for the ADP account. Is either a model type or a
         IO type. Default value is None.
        :type parameters: ~azure.mgmt.adp.models.Account or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
