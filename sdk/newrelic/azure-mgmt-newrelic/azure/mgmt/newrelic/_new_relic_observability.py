...
class NewRelicObservability:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype operations: azure.mgmt.newrelic.operations.Operations
    :ivar accounts: AccountsOperations operations
    :vartype accounts: azure.mgmt.newrelic.operations.AccountsOperations
    :ivar monitors: MonitorsOperations operations
    :vartype monitors: azure.mgmt.newrelic.operations.MonitorsOperations
    :ivar organizations: OrganizationsOperations operations
    :vartype organizations: azure.mgmt.newrelic.operations.OrganizationsOperations
    :ivar plans: PlansOperations operations
    :vartype plans: azure.mgmt.newrelic.operations.PlansOperations
    :ivar tag_rules: TagRulesOperations operations
    :vartype tag_rules: azure.mgmt.newrelic.operations.TagRulesOperations
    ...
    def __enter__(self) -> "NewRelicObservability":
