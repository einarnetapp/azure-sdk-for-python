...
class MonitorsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.newrelic.aio.NewRelicObservability`'s
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.NewRelicMonitorResource"]:
        ...
        :return: An iterator like instance of either NewRelicMonitorResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.newrelic.models.NewRelicMonitorResource]
    ...
    async def get(self, resource_group_name: str, monitor_name: str, **kwargs: Any) -> _models.NewRelicMonitorResource:
        ...
        :rtype: ~azure.mgmt.newrelic.models.NewRelicMonitorResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.newrelic.models.NewRelicMonitorResource
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.newrelic.models.NewRelicMonitorResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a NewRelicMonitorResource type or a IO
         type. Required.
        :type resource: ~azure.mgmt.newrelic.models.NewRelicMonitorResource or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.newrelic.models.NewRelicMonitorResourceUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.newrelic.models.NewRelicMonitorResourceUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def get_metric_rules(
        ...
        **kwargs: Any
        ...
        :type request: ~azure.mgmt.newrelic.models.MetricsRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MetricRules or the result of cls(response)
        :rtype: ~azure.mgmt.newrelic.models.MetricRules
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_metric_rules(
        ...
        :type request: ~azure.mgmt.newrelic.models.MetricsRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def get_metric_status(
        ...
        **kwargs: Any
        ...
        :type monitor_name: str
        :param request: The details of the get metrics status request. Required.
        :type request: ~azure.mgmt.newrelic.models.MetricsStatusRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MetricsStatusResponse or the result of cls(response)
        :rtype: ~azure.mgmt.newrelic.models.MetricsStatusResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_metric_status(
        ...
        **kwargs: Any
        ...
        :type request: ~azure.mgmt.newrelic.models.MetricsStatusRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_app_services(
        ...
        **kwargs: Any
        ...
        :type request: ~azure.mgmt.newrelic.models.AppServicesGetRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either AppServiceInfo or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.newrelic.models.AppServiceInfo]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_app_services(
        ...
        **kwargs: Any
        ...
        :param request: The details of the app services get request. Is either a AppServicesGetRequest
         type or a IO type. Required.
        :type request: ~azure.mgmt.newrelic.models.AppServicesGetRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def switch_billing(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type request: ~azure.mgmt.newrelic.models.SwitchBillingRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def switch_billing(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param request: The details of the switch billing request. Is either a SwitchBillingRequest
         type or a IO type. Required.
        :type request: ~azure.mgmt.newrelic.models.SwitchBillingRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_hosts(
        ...
        **kwargs: Any
        ...
        :type request: ~azure.mgmt.newrelic.models.HostsGetRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either VMInfo or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.newrelic.models.VMInfo]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_hosts(
        ...
        :param request: The details of the Hosts get request. Is either a HostsGetRequest type or a IO
         type. Required.
        :type request: ~azure.mgmt.newrelic.models.HostsGetRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_monitored_resources(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.newrelic.models.MonitoredResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def vm_host_payload(
        ...
        :rtype: ~azure.mgmt.newrelic.models.VMExtensionPayload
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
