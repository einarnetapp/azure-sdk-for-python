...
class TagRulesOperations:
    ...
    def list_by_new_relic_monitor_resource(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.newrelic.models.TagRule]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.newrelic.models.TagRule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.newrelic.models.TagRule
        ...
        :return: An instance of AsyncLROPoller that returns either TagRule or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.newrelic.models.TagRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.newrelic.models.TagRule or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.newrelic.models.TagRuleUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param properties: The resource properties to be updated. Is either a TagRuleUpdate type or a
         IO type. Required.
        :type properties: ~azure.mgmt.newrelic.models.TagRuleUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
