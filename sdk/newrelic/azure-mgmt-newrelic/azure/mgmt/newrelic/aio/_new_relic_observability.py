...
from ._configuration import NewRelicObservabilityConfiguration
...
class NewRelicObservability:  # pylint: disable=client-accepts-api-version-keyword
    """NewRelicObservability.

    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.newrelic.aio.operations.Operations
    :ivar accounts: AccountsOperations operations
    :vartype accounts: azure.mgmt.newrelic.aio.operations.AccountsOperations
    :ivar monitors: MonitorsOperations operations
    :vartype monitors: azure.mgmt.newrelic.aio.operations.MonitorsOperations
    :ivar organizations: OrganizationsOperations operations
    :vartype organizations: azure.mgmt.newrelic.aio.operations.OrganizationsOperations
    :ivar plans: PlansOperations operations
    :vartype plans: azure.mgmt.newrelic.aio.operations.PlansOperations
    :ivar tag_rules: TagRulesOperations operations
    :vartype tag_rules: azure.mgmt.newrelic.aio.operations.TagRulesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = NewRelicObservabilityConfiguration(
    ...
    async def __aenter__(self) -> "NewRelicObservability":
