...
class Resource(_serialization.Model):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.newrelic.models.SystemData
    """
...
class AccountsListResponse(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.newrelic.models.AccountResource]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.newrelic.models.AccountResource]
...
class AppServicesGetParameter(_serialization.Model):
    ...
    :vartype request: ~azure.mgmt.newrelic.models.AppServicesGetRequest
    """
    ...
    def __init__(self, *, request: "_models.AppServicesGetRequest", **kwargs: Any) -> None:
        ...
        :paramtype request: ~azure.mgmt.newrelic.models.AppServicesGetRequest
        """
        super().__init__(**kwargs)
...
class AppServicesListResponse(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.newrelic.models.AppServiceInfo]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.newrelic.models.AppServiceInfo]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.newrelic.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.newrelic.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.newrelic.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.newrelic.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class FilteringTag(_serialization.Model):
    ...
    :vartype action: str or ~azure.mgmt.newrelic.models.TagAction
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype action: str or ~azure.mgmt.newrelic.models.TagAction
        """
        super().__init__(**kwargs)
        self.name = name
        self.value = value
...
class HostsGetParameter(_serialization.Model):
    ...
    :vartype request: ~azure.mgmt.newrelic.models.HostsGetRequest
    """
    ...
    def __init__(self, *, request: "_models.HostsGetRequest", **kwargs: Any) -> None:
        ...
        :paramtype request: ~azure.mgmt.newrelic.models.HostsGetRequest
        """
        super().__init__(**kwargs)
        self.request = request
...
class LogRules(_serialization.Model):
    ...
    :vartype send_aad_logs: str or ~azure.mgmt.newrelic.models.SendAadLogsStatus
    ...
    :vartype send_subscription_logs: str or ~azure.mgmt.newrelic.models.SendSubscriptionLogsStatus
    ...
    :vartype send_activity_logs: str or ~azure.mgmt.newrelic.models.SendActivityLogsStatus
    :ivar filtering_tags: List of filtering tags to be used for capturing logs. This only takes
     ...
     associated tags.
    :vartype filtering_tags: list[~azure.mgmt.newrelic.models.FilteringTag]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype send_aad_logs: str or ~azure.mgmt.newrelic.models.SendAadLogsStatus
        ...
        :paramtype send_subscription_logs: str or
         ~azure.mgmt.newrelic.models.SendSubscriptionLogsStatus
        ...
        :paramtype send_activity_logs: str or ~azure.mgmt.newrelic.models.SendActivityLogsStatus
        :keyword filtering_tags: List of filtering tags to be used for capturing logs. This only takes
         effect if SendActivityLogs flag is enabled. If empty, all resources will be captured.
         If only Exclude action is specified, the rules will apply to the list of all available
         resources. If Include actions are specified, the rules will only include resources with the
         associated tags.
        :paramtype filtering_tags: list[~azure.mgmt.newrelic.models.FilteringTag]
        """
        super().__init__(**kwargs)
...
class ManagedServiceIdentity(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.newrelic.models.ManagedServiceIdentityType
    :ivar user_assigned_identities: The set of user assigned identities associated with the
     resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form:
     '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}.
     The dictionary values can be empty objects ({}) in requests.
    :vartype user_assigned_identities: dict[str, ~azure.mgmt.newrelic.models.UserAssignedIdentity]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: Type of managed service identity (where both SystemAssigned and UserAssigned
         ...
         "SystemAssigned, UserAssigned".
        :paramtype type: str or ~azure.mgmt.newrelic.models.ManagedServiceIdentityType
        :keyword user_assigned_identities: The set of user assigned identities associated with the
         resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form:
         '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}.
         The dictionary values can be empty objects ({}) in requests.
        :paramtype user_assigned_identities: dict[str,
         ~azure.mgmt.newrelic.models.UserAssignedIdentity]
        """
        super().__init__(**kwargs)
...
class MetricRules(_serialization.Model):
    ...
    :ivar send_metrics: Flag specifying if metrics should be sent for the Monitor resource. Known
     values are: "Enabled" and "Disabled".
    :vartype send_metrics: str or ~azure.mgmt.newrelic.models.SendMetricsStatus
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword send_metrics: Flag specifying if metrics should be sent for the Monitor resource.
         Known values are: "Enabled" and "Disabled".
        :paramtype send_metrics: str or ~azure.mgmt.newrelic.models.SendMetricsStatus
...
class MetricsRequestParameter(_serialization.Model):
    ...
    :vartype request: ~azure.mgmt.newrelic.models.MetricsRequest
    """
    ...
    def __init__(self, *, request: "_models.MetricsRequest", **kwargs: Any) -> None:
        ...
        :paramtype request: ~azure.mgmt.newrelic.models.MetricsRequest
        """
        super().__init__(**kwargs)
        self.request = request
...
class MetricsStatusRequestParameter(_serialization.Model):
    ...
    :ivar request: The details of the get metrics status request. Required.
    :vartype request: ~azure.mgmt.newrelic.models.MetricsStatusRequest
    """
    ...
    def __init__(self, *, request: "_models.MetricsStatusRequest", **kwargs: Any) -> None:
        """
        :keyword request: The details of the get metrics status request. Required.
        :paramtype request: ~azure.mgmt.newrelic.models.MetricsStatusRequest
        """
        super().__init__(**kwargs)
        self.request = request
...
class MonitoredResource(_serialization.Model):
    ...
    :vartype sending_metrics: str or ~azure.mgmt.newrelic.models.SendingMetricsStatus
    ...
    :vartype sending_logs: str or ~azure.mgmt.newrelic.models.SendingLogsStatus
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword sending_metrics: Flag indicating if resource is sending metrics to NewRelic. Known
         values are: "Enabled" and "Disabled".
        :paramtype sending_metrics: str or ~azure.mgmt.newrelic.models.SendingMetricsStatus
        ...
        :keyword sending_logs: Flag indicating if resource is sending logs to NewRelic. Known values
         are: "Enabled" and "Disabled".
        :paramtype sending_logs: str or ~azure.mgmt.newrelic.models.SendingLogsStatus
...
class MonitoredResourceListResponse(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.newrelic.models.MonitoredResource]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.newrelic.models.MonitoredResource]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class NewRelicAccountProperties(_serialization.Model):
    ...
    :vartype account_info: ~azure.mgmt.newrelic.models.AccountInfo
    :ivar organization_info: NewRelic Organization Information.
    :vartype organization_info: ~azure.mgmt.newrelic.models.OrganizationInfo
    :ivar single_sign_on_properties: date when plan was applied.
    :vartype single_sign_on_properties: ~azure.mgmt.newrelic.models.NewRelicSingleSignOnProperties
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype account_info: ~azure.mgmt.newrelic.models.AccountInfo
        :keyword organization_info: NewRelic Organization Information.
        :paramtype organization_info: ~azure.mgmt.newrelic.models.OrganizationInfo
        :keyword single_sign_on_properties: date when plan was applied.
        :paramtype single_sign_on_properties:
         ~azure.mgmt.newrelic.models.NewRelicSingleSignOnProperties
        """
        super().__init__(**kwargs)
...
class NewRelicMonitorResource(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype identity: ~azure.mgmt.newrelic.models.ManagedServiceIdentity
    :ivar provisioning_state: Provisioning State of the resource. Known values are: "Accepted",
     ...
     "NotSpecified".
    :vartype provisioning_state: str or ~azure.mgmt.newrelic.models.ProvisioningState
    :ivar monitoring_status: MonitoringStatus of the resource. Known values are: "Enabled" and
     "Disabled".
    :vartype monitoring_status: str or ~azure.mgmt.newrelic.models.MonitoringStatus
    ...
    :vartype marketplace_subscription_status: str or
     ~azure.mgmt.newrelic.models.MarketplaceSubscriptionStatus
    ...
    :vartype new_relic_account_properties: ~azure.mgmt.newrelic.models.NewRelicAccountProperties
    :ivar user_info: User Info.
    :vartype user_info: ~azure.mgmt.newrelic.models.UserInfo
    :ivar plan_data: Plan details.
    :vartype plan_data: ~azure.mgmt.newrelic.models.PlanData
    :ivar liftr_resource_category: Liftr resource category. Known values are: "Unknown" and
     "MonitorLogs".
    :vartype liftr_resource_category: str or ~azure.mgmt.newrelic.models.LiftrResourceCategories
    ...
    :vartype org_creation_source: str or ~azure.mgmt.newrelic.models.OrgCreationSource
    :ivar account_creation_source: Source of account creation. Known values are: "LIFTR" and
     "NEWRELIC".
    :vartype account_creation_source: str or ~azure.mgmt.newrelic.models.AccountCreationSource
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype identity: ~azure.mgmt.newrelic.models.ManagedServiceIdentity
        :keyword new_relic_account_properties: MarketplaceSubscriptionStatus of the resource.
        :paramtype new_relic_account_properties: ~azure.mgmt.newrelic.models.NewRelicAccountProperties
        :keyword user_info: User Info.
        :paramtype user_info: ~azure.mgmt.newrelic.models.UserInfo
        :keyword plan_data: Plan details.
        :paramtype plan_data: ~azure.mgmt.newrelic.models.PlanData
        :keyword org_creation_source: Source of org creation. Known values are: "LIFTR" and "NEWRELIC".
        :paramtype org_creation_source: str or ~azure.mgmt.newrelic.models.OrgCreationSource
        :keyword account_creation_source: Source of account creation. Known values are: "LIFTR" and
         "NEWRELIC".
        :paramtype account_creation_source: str or ~azure.mgmt.newrelic.models.AccountCreationSource
        """
...
class NewRelicMonitorResourceListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.newrelic.models.NewRelicMonitorResource]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.newrelic.models.NewRelicMonitorResource]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class NewRelicSingleSignOnProperties(_serialization.Model):
    ...
    :vartype single_sign_on_state: str or ~azure.mgmt.newrelic.models.SingleSignOnStates
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword single_sign_on_state: Single sign-on state. Known values are: "Initial", "Enable",
         "Disable", and "Existing".
        :paramtype single_sign_on_state: str or ~azure.mgmt.newrelic.models.SingleSignOnStates
        ...
        :keyword provisioning_state: Provisioning state. Known values are: "Accepted", "Creating",
         "Updating", "Deleting", "Succeeded", "Failed", "Canceled", "Deleted", and "NotSpecified".
        :paramtype provisioning_state: str or ~azure.mgmt.newrelic.models.ProvisioningState
        """
        super().__init__(**kwargs)
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.newrelic.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.newrelic.models.Origin
    :ivar action_type: Enum. Indicates the action type. "Internal" refers to actions that are for
     internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.newrelic.models.ActionType
    """
    ...
    def __init__(self, *, display: Optional["_models.OperationDisplay"] = None, **kwargs: Any) -> None:
        ...
        :paramtype display: ~azure.mgmt.newrelic.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name = None
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.newrelic.models.Operation]
...
class OrganizationResource(ProxyResource):
    ...
    :vartype billing_source: str or ~azure.mgmt.newrelic.models.BillingSource
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype billing_source: str or ~azure.mgmt.newrelic.models.BillingSource
        """
        super().__init__(**kwargs)
        self.organization_id = organization_id
...
class OrganizationsListResponse(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.newrelic.models.OrganizationResource]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.newrelic.models.OrganizationResource]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class PlanData(_serialization.Model):
    ...
    :vartype usage_type: str or ~azure.mgmt.newrelic.models.UsageType
    ...
    :vartype billing_cycle: str or ~azure.mgmt.newrelic.models.BillingCycle
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword usage_type: Different usage type like PAYG/COMMITTED. this could be enum. Known values
         are: "PAYG" and "COMMITTED".
        :paramtype usage_type: str or ~azure.mgmt.newrelic.models.UsageType
        :keyword billing_cycle: Different billing cycles like MONTHLY/WEEKLY. this could be enum. Known
         values are: "YEARLY", "MONTHLY", and "WEEKLY".
        :paramtype billing_cycle: str or ~azure.mgmt.newrelic.models.BillingCycle
...
class PlanDataListResponse(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.newrelic.models.PlanDataResource]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.newrelic.models.PlanDataResource]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class SwitchBillingParameter(_serialization.Model):
    ...
    :vartype request: ~azure.mgmt.newrelic.models.SwitchBillingRequest
    """
    ...
    def __init__(self, *, request: "_models.SwitchBillingRequest", **kwargs: Any) -> None:
        ...
        :paramtype request: ~azure.mgmt.newrelic.models.SwitchBillingRequest
        """
        super().__init__(**kwargs)
        self.request = request
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.newrelic.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or ~azure.mgmt.newrelic.models.CreatedByType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~azure.mgmt.newrelic.models.CreatedByType
        ...
        :paramtype last_modified_by_type: str or ~azure.mgmt.newrelic.models.CreatedByType
...
class TagRule(ProxyResource):
    ...
    :vartype log_rules: ~azure.mgmt.newrelic.models.LogRules
    :ivar metric_rules: Set of rules for sending metrics for the Monitor resource.
    :vartype metric_rules: ~azure.mgmt.newrelic.models.MetricRules
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype log_rules: ~azure.mgmt.newrelic.models.LogRules
        :keyword metric_rules: Set of rules for sending metrics for the Monitor resource.
        :paramtype metric_rules: ~azure.mgmt.newrelic.models.MetricRules
        """
        super().__init__(**kwargs)
        self.provisioning_state = None
...
class TagRuleListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.newrelic.models.TagRule]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.TagRule"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.newrelic.models.TagRule]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class VMHostsListResponse(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.newrelic.models.VMInfo]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.VMInfo"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.newrelic.models.VMInfo]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
