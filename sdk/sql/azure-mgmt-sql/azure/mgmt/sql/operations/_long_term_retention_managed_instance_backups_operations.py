...
def build_list_by_database_request(
    ...
    **kwargs: Any
    ...
    if only_latest_per_database is not None:
        _query_parameters['onlyLatestPerDatabase'] = _SERIALIZER.query("only_latest_per_database", only_latest_per_database, 'bool')
    if database_state is not None:
        _query_parameters['databaseState'] = _SERIALIZER.query("database_state", database_state, 'str')
    _query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
