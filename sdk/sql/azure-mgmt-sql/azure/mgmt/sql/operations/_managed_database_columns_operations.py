...
def build_list_by_database_request(
    ...
    **kwargs: Any
    ...
    if schema is not None:
        _query_parameters['schema'] = [_SERIALIZER.query("schema", q, 'str') if q is not None else '' for q in schema]
    if table is not None:
        _query_parameters['table'] = [_SERIALIZER.query("table", q, 'str') if q is not None else '' for q in table]
    if column is not None:
        _query_parameters['column'] = [_SERIALIZER.query("column", q, 'str') if q is not None else '' for q in column]
    if order_by is not None:
        _query_parameters['orderBy'] = [_SERIALIZER.query("order_by", q, 'str') if q is not None else '' for q in order_by]
