...
def build_create_or_update_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ManagedInstanceDtc] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class ManagedInstanceDtcsOperations:
    ...
    def list_by_managed_instance(
        ...
        managed_instance_name: str,
        **kwargs: Any
    ) -> Iterable[_models.ManagedInstanceDtcListResult]:
        ...
        :return: An iterator like instance of either ManagedInstanceDtcListResult or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ManagedInstanceDtcListResult]
