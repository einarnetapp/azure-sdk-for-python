...
class ExtendedDatabaseBlobAuditingPoliciesOperations(object):
    ...
    def list_by_database(
        ...
        database_name: str,
        **kwargs: Any
    ) -> Iterable["_models.ExtendedDatabaseBlobAuditingPolicyListResult"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ExtendedDatabaseBlobAuditingPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-01-preview")  # type: str
