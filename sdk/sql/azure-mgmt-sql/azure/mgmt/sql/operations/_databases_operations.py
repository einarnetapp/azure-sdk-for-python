...
def build_export_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ExportDatabaseDefinition] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_import_method_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ImportExistingDatabaseDefinition] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_rename_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ResourceMoveDefinition] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class DatabasesOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def begin_upgrade_data_warehouse(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        server_name: str,
        database_name: str,
