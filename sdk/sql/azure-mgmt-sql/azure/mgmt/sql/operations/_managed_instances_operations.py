...
def build_list_by_managed_instance_request(
    ...
    **kwargs: Any
    ...
    if number_of_queries is not None:
        _query_parameters['numberOfQueries'] = _SERIALIZER.query("number_of_queries", number_of_queries, 'int')
    if databases is not None:
        _query_parameters['databases'] = _SERIALIZER.query("databases", databases, 'str')
    ...
    if interval is not None:
        _query_parameters['interval'] = _SERIALIZER.query("interval", interval, 'str')
    if aggregation_function is not None:
        _query_parameters['aggregationFunction'] = _SERIALIZER.query("aggregation_function", aggregation_function, 'str')
    if observation_metric is not None:
        _query_parameters['observationMetric'] = _SERIALIZER.query("observation_metric", observation_metric, 'str')
    _query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
...
def build_failover_request_initial(
    ...
    **kwargs: Any
    ...
    if replica_type is not None:
        _query_parameters['replicaType'] = _SERIALIZER.query("replica_type", replica_type, 'str')
    _query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
