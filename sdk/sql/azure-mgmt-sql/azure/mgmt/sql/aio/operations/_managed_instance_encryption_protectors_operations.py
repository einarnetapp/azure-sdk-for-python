...
from ...operations._managed_instance_encryption_protectors_operations import build_create_or_update_request_initial, build_get_request, build_list_by_instance_request, build_revalidate_request_initial
T = TypeVar('T')
...
class ManagedInstanceEncryptionProtectorsOperations:
    ...
    def list_by_instance(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedInstanceEncryptionProtectorListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-01-preview")  # type: str
