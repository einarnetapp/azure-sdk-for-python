...
from ...operations._managed_instance_private_endpoint_connections_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_managed_instance_request
T = TypeVar('T')
...
class ManagedInstancePrivateEndpointConnectionsOperations:
    ...
    def list_by_managed_instance(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedInstancePrivateEndpointConnectionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-01-preview")  # type: str
