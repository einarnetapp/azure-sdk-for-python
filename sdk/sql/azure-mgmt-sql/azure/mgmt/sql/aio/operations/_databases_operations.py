...
class DatabasesOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace_async
    async def begin_upgrade_data_warehouse(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        server_name: str,
        database_name: str,
