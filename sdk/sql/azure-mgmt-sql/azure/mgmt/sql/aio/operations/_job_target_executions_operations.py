...
class JobTargetExecutionsOperations:
    ...
    def list_by_step(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.JobExecutionAutoGenerated2"]:
        ...
        :return: An iterator like instance of either JobExecutionAutoGenerated2 or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.JobExecutionAutoGenerated2]
        ...
        cls: ClsType[_models.JobExecutionListResultAutoGenerated2] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("JobExecutionListResultAutoGenerated2", pipeline_response)
    ...
    async def get(
        ...
        target_id: str,
        **kwargs: Any
    ) -> _models.JobExecutionAutoGenerated2:
        ...
        :type target_id: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: JobExecutionAutoGenerated2 or the result of cls(response)
        :rtype: ~azure.mgmt.sql.models.JobExecutionAutoGenerated2
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.JobExecutionAutoGenerated2] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("JobExecutionAutoGenerated2", pipeline_response)
