...
class ReplicationLinksOperations:
    ...
    async def _failover_allow_data_loss_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        server_name: str,
        database_name: str,
    ...
    @distributed_trace_async
    async def begin_failover_allow_data_loss(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        server_name: str,
        database_name: str,
    ...
    async def _unlink_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        server_name: str,
        database_name: str,
    ...
    @distributed_trace_async
    async def begin_unlink(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        server_name: str,
        database_name: str,
