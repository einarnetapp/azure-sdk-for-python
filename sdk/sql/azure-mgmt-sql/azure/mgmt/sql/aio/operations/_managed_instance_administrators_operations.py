...
from ...operations._managed_instance_administrators_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_instance_request
T = TypeVar('T')
...
class ManagedInstanceAdministratorsOperations:
    ...
    def list_by_instance(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.ManagedInstanceAdministratorListResult"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedInstanceAdministratorListResult]
