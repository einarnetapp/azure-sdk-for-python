...
from ...operations._distributed_availability_groups_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_instance_request, build_update_request_initial
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class DistributedAvailabilityGroupsOperations:
    """DistributedAvailabilityGroupsOperations async operations.
    ...
    def list_by_instance(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.DistributedAvailabilityGroupsListResult"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.DistributedAvailabilityGroupsListResult]
