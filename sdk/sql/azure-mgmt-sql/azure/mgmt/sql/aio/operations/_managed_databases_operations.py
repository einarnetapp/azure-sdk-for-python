...
from ...operations._managed_databases_operations import build_complete_restore_request_initial, build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_instance_request, build_list_inaccessible_by_instance_request, build_update_request_initial
T = TypeVar('T')
...
class ManagedDatabasesOperations:
    ...
    def list_by_instance(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ManagedDatabaseListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedDatabaseListResult]
    ...
    @distributed_trace_async
    async def begin_complete_restore(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        managed_instance_name: str,
        database_name: str,
