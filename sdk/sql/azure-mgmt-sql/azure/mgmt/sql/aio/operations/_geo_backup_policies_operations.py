...
from ...operations._geo_backup_policies_operations import build_create_or_update_request, build_get_request, build_list_request
T = TypeVar('T')
...
class GeoBackupPoliciesOperations:
    ...
    list.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/geoBackupPolicies"}  # type: ignore
