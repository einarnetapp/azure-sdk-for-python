...
class JobStepExecutionsOperations:
    ...
    def list_by_job_execution(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.JobExecutionAutoGenerated"]:
        ...
        :return: An iterator like instance of either JobExecutionAutoGenerated or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.JobExecutionAutoGenerated]
        ...
        cls: ClsType[_models.JobExecutionListResultAutoGenerated] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("JobExecutionListResultAutoGenerated", pipeline_response)
    ...
    async def get(
        ...
        step_name: str,
        **kwargs: Any
    ) -> _models.JobExecutionAutoGenerated:
        ...
        :type step_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: JobExecutionAutoGenerated or the result of cls(response)
        :rtype: ~azure.mgmt.sql.models.JobExecutionAutoGenerated
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.JobExecutionAutoGenerated] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("JobExecutionAutoGenerated", pipeline_response)
