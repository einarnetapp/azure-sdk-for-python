...
from ...operations._managed_instance_dtcs_operations import build_create_or_update_request_initial, build_get_request, build_list_by_managed_instance_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class ManagedInstanceDtcsOperations:
    """ManagedInstanceDtcsOperations async operations.
    ...
    def list_by_managed_instance(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.ManagedInstanceDtcListResult"]:
        ...
        :return: An iterator like instance of either ManagedInstanceDtcListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedInstanceDtcListResult]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :param managed_instance_name: The name of the managed instance.
        :type managed_instance_name: str
        :param dtc_name: The name of the managed instance DTC.
