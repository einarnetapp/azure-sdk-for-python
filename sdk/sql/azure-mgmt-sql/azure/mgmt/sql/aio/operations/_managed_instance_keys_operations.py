...
from ...operations._managed_instance_keys_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_instance_request
T = TypeVar('T')
    ...
    def list_by_instance(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ManagedInstanceKeyListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedInstanceKeyListResult]
