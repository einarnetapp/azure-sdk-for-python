...
class JobExecution(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar provisioning_state: The ARM provisioning state of the job execution. Known values are:
     "Creating", "Deleting", "Updating", "Unknown", "Succeeded", "Failed", "Accepted", "Created",
     "Deleted", "Unrecognized", "Running", "Canceled", "NotSpecified", "Registering", "TimedOut",
     and "InProgress".
...
class ManagedInstance(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype sku: ~azure.mgmt.sql.models.Sku
    :ivar provisioning_state: Provisioning state of managed instance. Known values are: "Creating",
     "Deleting", "Updating", "Unknown", "Succeeded", "Failed", "Accepted", "Created", "Deleted",
     "Unrecognized", "Running", "Canceled", "NotSpecified", "Registering", "TimedOut", and
     "InProgress".
    :vartype provisioning_state: str or ~azure.mgmt.sql.models.ProvisioningState
