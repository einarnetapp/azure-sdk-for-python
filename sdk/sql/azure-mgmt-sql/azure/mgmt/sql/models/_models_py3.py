...
class DatabaseOperation(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar phase_code: The operation phase code.
    :vartype phase_code: int
    :ivar phase_description: The operation phase description.
    :vartype phase_description: str
    ...
    _validation = {
        ...
        "phase_code": {"readonly": True},
        "phase_description": {"readonly": True},
    ...
    _attribute_map = {
        ...
        "phase_code": {"key": "properties.phaseCode", "type": "int"},
        "phase_description": {"key": "properties.phaseDescription", "type": "str"},
        "phase_information": {"key": "properties.phaseInformation", "type": "{str}"},
    }
