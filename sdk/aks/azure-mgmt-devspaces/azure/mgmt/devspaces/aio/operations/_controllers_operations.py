...
from ...operations._controllers_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_resource_group_request, build_list_connection_details_request, build_list_request, build_update_request
T = TypeVar('T')
...
class ControllersOperations:
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.devspaces.models.ControllerList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2019-04-01")  # type: str
