...
class DiskConfiguration(_serialization.Model):
    ...
    :ivar disk_volume_configuration: The disk configuration for the hana db volume.
    :vartype disk_volume_configuration: dict[str,
     ~azure.mgmt.workloads.models.DiskVolumeConfiguration]
    """

    _attribute_map = {
        "disk_volume_configuration": {"key": "diskVolumeConfiguration", "type": "{DiskVolumeConfiguration}"},
    }

    def __init__(
        self, *, disk_volume_configuration: Optional[Dict[str, "_models.DiskVolumeConfiguration"]] = None, **kwargs
    ):
        """
        :keyword disk_volume_configuration: The disk configuration for the hana db volume.
        :paramtype disk_volume_configuration: dict[str,
         ~azure.mgmt.workloads.models.DiskVolumeConfiguration]
        """
        super().__init__(**kwargs)
        self.disk_volume_configuration = disk_volume_configuration
...
class DiskSku(_serialization.Model):
    ...
    :ivar name: The sku name required such as 'StandardSSD_LRS', 'Premium_LRS'. Only one of these
     will be an accepted input.
    :vartype name: str
    """
    ...
    def __init__(self, *, name: Optional[str] = None, **kwargs):
        """
        :keyword name: The sku name required such as 'StandardSSD_LRS', 'Premium_LRS'. Only one of
         these will be an accepted input.
        :paramtype name: str
        """
        super().__init__(**kwargs)
        self.name = name
