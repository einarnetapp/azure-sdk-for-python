...
class SourceControlOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The parameters supplied to the create or update source control operation. Is
         either a SourceControlCreateOrUpdateParameters type or a IO type. Required.
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param parameters: The parameters supplied to the update source control operation. Is either a
         SourceControlUpdateParameters type or a IO type. Required.
    ...
    def list_by_automation_account(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.automation.models.SourceControl]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
