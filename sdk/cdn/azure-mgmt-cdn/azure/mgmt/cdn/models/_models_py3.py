...
class AFDDomain(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar referenced_route_path: The JSON object list that contains the overall picture of how
     routes are used for the shared custom domain across different profiles.
    :vartype referenced_route_path: ~azure.mgmt.cdn.models.AFDDomainReferencedRoutePathList
    """
    ...
    _validation = {
        ...
        "referenced_route_path": {"readonly": True},
    }
    ...
    _attribute_map = {
        ...
        "referenced_route_path": {"key": "properties.referencedRoutePath", "type": "AFDDomainReferencedRoutePathList"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.referenced_route_path = None
...
class AFDDomainProperties(
    ...
    _attribute_map = {
        ...
        "referenced_route_path": {"key": "referencedRoutePath", "type": "AFDDomainReferencedRoutePathList"},
    }
...
class AFDDomainReferencedRoutePath(_serialization.Model):
    ...
    :ivar route: Resource reference to the shared custom domain.
    :vartype route: ~azure.mgmt.cdn.models.ResourceReference
    :ivar paths: List of paths.
    :vartype paths: list[str]
    """

    _attribute_map = {
        "route": {"key": "route", "type": "ResourceReference"},
        "paths": {"key": "paths", "type": "[str]"},
    }

    def __init__(
        self, *, route: Optional["_models.ResourceReference"] = None, paths: Optional[List[str]] = None, **kwargs: Any
    ) -> None:
        """
        :keyword route: Resource reference to the shared custom domain.
        :paramtype route: ~azure.mgmt.cdn.models.ResourceReference
        :keyword paths: List of paths.
...
class AFDDomainReferencedRoutePathList(_serialization.Model):
    """The JSON object list that contains the overall picture of how routes are used for the shared
    custom domain across different profiles.

    :ivar value: List of route configuration of the shared custom domain.
    :vartype value: list[~azure.mgmt.cdn.models.AFDDomainReferencedRoutePath]
    """

    _attribute_map = {
        "value": {"key": "value", "type": "[AFDDomainReferencedRoutePath]"},
    }

    def __init__(self, *, value: Optional[List["_models.AFDDomainReferencedRoutePath"]] = None, **kwargs: Any) -> None:
        """
        :keyword value: List of route configuration of the shared custom domain.
        :paramtype value: list[~azure.mgmt.cdn.models.AFDDomainReferencedRoutePath]
        """
        super().__init__(**kwargs)
        self.value = value
