...
def build_create_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.CustomDomainParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_disable_custom_https_request_initial(
    resource_group_name: str,
    profile_name: str,
    endpoint_name: str,
    custom_domain_name: str,
...
def build_enable_custom_https_request_initial(
    resource_group_name: str,
    profile_name: str,
    endpoint_name: str,
    custom_domain_name: str,
    subscription_id: str,
    *,
    json: Optional[_models.CustomDomainHttpsParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
