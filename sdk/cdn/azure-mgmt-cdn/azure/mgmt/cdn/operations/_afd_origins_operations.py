...
def build_list_by_origin_group_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/originGroups/{originGroupName}/origins")  # pylint: disable=line-too-long
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/originGroups/{originGroupName}/origins/{originName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        "profileName": _SERIALIZER.url("profile_name", profile_name, 'str'),
        "originGroupName": _SERIALIZER.url("origin_group_name", origin_group_name, 'str'),
...
def build_create_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.AFDOrigin] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_update_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.AFDOriginUpdateParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class AFDOriginsOperations:
    ...
    def list_by_origin_group(
        ...
        origin_group_name: str,
        **kwargs: Any
    ) -> Iterable[_models.AFDOriginListResult]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.cdn.models.AFDOriginListResult]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_origin_group_request(
                    ...
                    template_url=self.list_by_origin_group.metadata['url'],
                    headers=_headers,
                    params=_params,
                )
