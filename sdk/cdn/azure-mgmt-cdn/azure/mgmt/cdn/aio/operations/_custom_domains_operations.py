...
from ...operations._custom_domains_operations import build_create_request_initial, build_delete_request_initial, build_disable_custom_https_request_initial, build_enable_custom_https_request_initial, build_get_request, build_list_by_endpoint_request
T = TypeVar('T')
...
class CustomDomainsOperations:
    ...
    async def _disable_custom_https_initial(
        ...
        **kwargs: Any
        ...
        request = build_disable_custom_https_request_initial(
            resource_group_name=resource_group_name,
            profile_name=profile_name,
            endpoint_name=endpoint_name,
            custom_domain_name=custom_domain_name,
    ...
    async def _enable_custom_https_initial(
        ...
        **kwargs: Any
        ...
        request = build_enable_custom_https_request_initial(
            resource_group_name=resource_group_name,
            profile_name=profile_name,
            endpoint_name=endpoint_name,
            custom_domain_name=custom_domain_name,
