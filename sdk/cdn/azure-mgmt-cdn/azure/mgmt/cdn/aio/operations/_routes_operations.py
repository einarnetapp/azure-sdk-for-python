...
from ...operations._routes_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_endpoint_request, build_update_request_initial
...
class RoutesOperations:
    ...
    def list_by_endpoint(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cdn.models.RouteListResult]
