...
from ...operations._origin_groups_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_endpoint_request, build_update_request_initial
    ...
    def list_by_endpoint(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either OriginGroupListResult or the result of
         cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cdn.models.OriginGroupListResult]
