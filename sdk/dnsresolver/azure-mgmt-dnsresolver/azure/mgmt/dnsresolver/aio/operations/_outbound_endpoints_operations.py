...
from ...operations._outbound_endpoints_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_request, build_update_request_initial
T = TypeVar('T')
...
class OutboundEndpointsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.OutboundEndpointListResult"]:
        ...
        :return: An iterator like instance of either OutboundEndpointListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dnsresolver.models.OutboundEndpointListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
