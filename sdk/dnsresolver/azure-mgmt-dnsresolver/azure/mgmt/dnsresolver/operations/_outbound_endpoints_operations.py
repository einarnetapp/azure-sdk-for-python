...
def build_create_or_update_request_initial(
    ...
    *,
    json: Optional[_models.OutboundEndpoint] = None,
    content: Any = None,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/dnsResolvers/{dnsResolverName}/outboundEndpoints/{outboundEndpointName}")  # pylint: disable=line-too-long
...
def build_update_request_initial(
    ...
    outbound_endpoint_name: str,
    *,
    json: Optional[_models.OutboundEndpointPatch] = None,
    content: Any = None,
    if_match: Optional[str] = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/dnsResolvers/{dnsResolverName}/outboundEndpoints")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "dnsResolverName": _SERIALIZER.url("dns_resolver_name", dns_resolver_name, 'str'),
...
class OutboundEndpointsOperations:
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional[_models.OutboundEndpoint]]
    ...
    def list(
        ...
        top: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable[_models.OutboundEndpointListResult]:
