...
class KeyValueListResult(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.KeyValue"]] = None, next_link: Optional[str] = None, **kwargs):
        """
        :keyword value: The collection value.
...
class ReplicaListResult(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.Replica"]] = None, next_link: Optional[str] = None, **kwargs):
        """
        :keyword value: The collection value.
