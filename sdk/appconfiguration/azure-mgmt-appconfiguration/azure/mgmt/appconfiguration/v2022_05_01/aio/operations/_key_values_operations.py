...
class KeyValuesOperations:
    ...
    def list_by_configuration_store(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appconfiguration.v2022_05_01.models.KeyValue]
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param key_value_name: Identifier of key and label combination. Key and label are joined by $
         character. Label is optional. Required.
        :type key_value_name: str
        :param key_value_parameters: The parameters for creating a key-value. Is either a model type or
