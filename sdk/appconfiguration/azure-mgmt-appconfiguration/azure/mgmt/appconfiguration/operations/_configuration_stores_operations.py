...
def build_list_request(
    ...
    **kwargs: Any
    ...
    api_version = kwargs.pop('api_version', "2020-05-05.012")  # type: str
...
def build_list_key_value_request(
    subscription_id: str,
    resource_group_name: str,
    config_store_name: str,
    *,
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}/listKeyValue")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "configStoreName": _SERIALIZER.url("config_store_name", config_store_name, 'str', max_length=50, min_length=5, pattern=r'^[a-zA-Z0-9_-]*$'),
...
class ConfigurationStoresOperations(object):
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ConfigurationStoreListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appconfiguration.models.ConfigurationStoreListResult]
    ...
    def list_key_value(
        ...
        resource_group_name: str,
        config_store_name: str,
        list_key_value_parameters: "_models.ListKeyValueParameters",
        **kwargs: Any
    ) -> "_models.KeyValue":
        ...
        _json = self._serialize.body(list_key_value_parameters, 'ListKeyValueParameters')

        request = build_list_key_value_request(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            config_store_name=config_store_name,
            api_version=api_version,
            content_type=content_type,
            json=_json,
            template_url=self.list_key_value.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
