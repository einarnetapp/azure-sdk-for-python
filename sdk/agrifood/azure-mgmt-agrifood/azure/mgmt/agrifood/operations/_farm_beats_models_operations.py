...
def build_get_request(
    ...
    api_version = kwargs.pop("api_version", _params.pop("api-version", "2022-08-04-preview"))  # type: str
...
def build_create_or_update_request(
    farm_beats_resource_name: str, resource_group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class FarmBeatsModelsOperations:
    ...
    @distributed_trace
    def create_or_update(
        self, farm_beats_resource_name: str, resource_group_name: str, body: Union[_models.FarmBeats, IO], **kwargs: Any
    ) -> _models.FarmBeats:
        """Create or update FarmBeats resource.
