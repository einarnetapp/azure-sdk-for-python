...
class PrivateLinkResourcesOperations:
    ...
    list_by_resource.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AgFoodPlatform/farmBeats/{dataManagerForAgricultureResourceName}/privateLinkResources"
    }
    ...
    async def get(
        ...
        **kwargs: Any
    ) -> Union[_models.PrivateLinkResource, _models.ErrorResponse]:
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PrivateLinkResource or ErrorResponse or the result of cls(response)
        :rtype: ~azure.mgmt.agrifood.models.PrivateLinkResource or
        ...
        cls: ClsType[Union[_models.PrivateLinkResource, _models.ErrorResponse]] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AgFoodPlatform/farmBeats/{dataManagerForAgricultureResourceName}/privateLinkResources/{subResourceName}"
    }
