...
def build_list_by_billing_account_request(
    ...
    **kwargs: Any
    ...
    _query_parameters['periodStartDate'] = _SERIALIZER.query("period_start_date", period_start_date, 'str')
    _query_parameters['periodEndDate'] = _SERIALIZER.query("period_end_date", period_end_date, 'str')
...
def build_download_invoice_request_initial(
    ...
    **kwargs: Any
    ...
    _query_parameters = kwargs.pop("params", {})  # type: Dict[str, Any]
    _query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
    _query_parameters['downloadToken'] = _SERIALIZER.query("download_token", download_token, 'str')
