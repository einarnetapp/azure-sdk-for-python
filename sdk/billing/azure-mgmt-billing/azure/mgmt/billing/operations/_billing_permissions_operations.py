...
def build_list_by_billing_account_request(billing_account_name: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingPermissions"
    )
    path_format_arguments = {
        "billingAccountName": _SERIALIZER.url("billing_account_name", billing_account_name, "str"),
    }
...
class BillingPermissionsOperations:
    ...
    def list_by_customer(
    ...
    ) -> Iterable["_models.BillingPermissionsProperties"]:
        ...
        cls: ClsType[_models.BillingPermissionsListResult] = kwargs.pop("cls", None)
    ...
    list_by_customer.metadata = {
        "url": "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/customers/{customerName}/billingPermissions"
    }
    ...
    list_by_billing_account.metadata = {
        "url": "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingPermissions"
    }
    ...
    list_by_invoice_sections.metadata = {
        "url": "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/invoiceSections/{invoiceSectionName}/billingPermissions"
    }
