...
class AcceptanceMode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AutoRenew(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class BillingProfileSpendingLimit(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class BillingProfileStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class BillingProfileStatusReasonCode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class BillingRelationshipType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class BillingSubscriptionStatusType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class DocumentSource(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class DocumentType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class InvoiceDocumentType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """The type of the document.
    """
...
class InvoiceSectionState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class InvoiceStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class InvoiceType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """Invoice type.
    """
...
class MarketplacePurchasesPolicy(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PaymentMethodFamily(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ProductStatusType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ProductTransferValidationErrorCode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ReservationPurchasesPolicy(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ReservationType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class SpendingLimitForBillingProfile(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """The billing profile spending limit.
    """
...
class StatusReasonCode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """Reason for the specified billing profile status.
    """
...
class StatusReasonCodeForBillingProfile(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """Reason for the specified billing profile status.
    """
...
class SubscriptionTransferValidationErrorCode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """Error code of the transfer validation response.
    """
...
class TargetCloud(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class TransactionTypeKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ViewCharges(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ViewChargesPolicy(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
