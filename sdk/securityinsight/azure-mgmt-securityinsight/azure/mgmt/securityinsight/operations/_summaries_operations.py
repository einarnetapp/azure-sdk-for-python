...
def build_list_request(
    ...
    api_version = kwargs.pop("api_version", _params.pop("api-version", "2023-03-01-preview"))  # type: str
...
class SummariesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either Summary or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.securityinsight.models.Summary]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
