...
def build_recommendation_request(
    ...
    *,
    json: Optional[List[_models.RecommendationPatch]] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
...
class UpdateOperations:
    ...
    def recommendation(
        ...
        **kwargs: Any
        ...
        :param recommendation_patch: Recommendation Fields to Update.
        ...
        request = build_recommendation_request(
            ...
            json=_json,
            template_url=self.recommendation.metadata['url'],
            headers=_headers,
            params=_params,
        )
    ...
    recommendation.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/recommendations/{recommendationId}"}  # type: ignore
