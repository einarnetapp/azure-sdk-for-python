...
def build_create_request(
    ...
    file_import_id: str,
    *,
    json: Optional[_models.FileImport] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class FileImportsOperations:
    ...
    def list(
        ...
        skip_token: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable[_models.FileImportList]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.securityinsight.models.FileImportList]
