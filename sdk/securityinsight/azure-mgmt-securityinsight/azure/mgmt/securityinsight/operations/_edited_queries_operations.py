...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/assistedQueries/{queryId}/editedQueries")  # pylint: disable=line-too-long
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/assistedQueries/{queryId}/editedQueries/{editedQueryId}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str', max_length=90, min_length=1),
...
def build_create_or_update_request(
    ...
    edited_query_id: str,
    *,
    json: Optional[_models.EditedQuery] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class EditedQueriesOperations:
    ...
    def list(
        ...
        query_id: str,
        **kwargs: Any
    ) -> Iterable[_models.EditedQueryList]:
        ...
        :return: An iterator like instance of either EditedQueryList or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.securityinsight.models.EditedQueryList]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :param query_id: Query Id.
        :type query_id: str
        :param edited_query_id: Edited Query Id (GUID).
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param edited_query_id: Edited Query Id (GUID).
        :type edited_query_id: str
        :param edited_query: The edited query.
