...
class Operations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.OperationAutoGenerated"]:
        ...
        :return: An iterator like instance of either OperationAutoGenerated or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.securityinsight.models.OperationAutoGenerated]
