...
def build_create_indicator_request(
    ...
    workspace_name: str,
    *,
    json: Optional[_models.ThreatIntelligenceIndicatorModel] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_query_indicators_request(
    ...
    workspace_name: str,
    *,
    json: Optional[_models.ThreatIntelligenceFilteringCriteria] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_append_tags_request(
    ...
    name: str,
    *,
    json: Optional[_models.ThreatIntelligenceAppendTags] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
