...
class SecurityInsights:    # pylint: disable=too-many-instance-attributes
    ...
    :vartype queries: azure.mgmt.securityinsight.operations.QueriesOperations
    :ivar edited_queries: EditedQueriesOperations operations
    :vartype edited_queries: azure.mgmt.securityinsight.operations.EditedQueriesOperations
