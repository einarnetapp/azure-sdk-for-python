...
class SecurityInsights:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype packages: azure.mgmt.securityinsight.operations.PackagesOperations
    :ivar package: PackageOperations operations
    :vartype package: azure.mgmt.securityinsight.operations.PackageOperations
    :ivar templates: TemplatesOperations operations
    :vartype templates: azure.mgmt.securityinsight.operations.TemplatesOperations
