...
class BulkActionState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The current state of this bulk action in the execution pipeline."""

    #: This bulk action's state is not known.
    UNKNOWN = "Unknown"
    #: This bulk action is waiting to be processed.
    QUEUED = "Queued"
    #: This bulk action is waiting to be initialized.
    WAITING_FOR_INITIALIZATION = "WaitingForInitialization"
    #: This bulk action is currently being initialized.
    INITIALIZING = "Initializing"
    #: This bulk action is waiting to be executed.
    WAITING_FOR_EXECUTION = "WaitingForExecution"
    #: This bulk action is currently executing.
    EXECUTING = "Executing"
    #: This bulk action is being finalized.
    FINALIZING = "Finalizing"
    #: This bulk action has successfully completed.
    DONE = "Done"
    #: An error occured during the execution of this bulk action.
    ERROR = "Error"
    #: This bulk action is currently on hold.
    ON_HOLD = "OnHold"
    #: Cancellation was requested for this bulk action.
    CANCELLATION_REQUESTED = "CancellationRequested"
    #: This bulk action has been cancelled.
    CANCELLED = "Cancelled"
...
class ConditionOperator(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    #: The 'contains' operator for strings.
    STRING_CONTAINS = "StringContains"
    #: The 'not contains' operator for strings.
    STRING_NOT_CONTAINS = "StringNotContains"
    #: The 'is_null' operator.
    IS_NULL = "IsNull"
    #: The 'not is_null' operator.
...
class Connective(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    #: Conditions/clauses should be joined together using logical AND operator.
    AND = "And"
    #: Conditions/clauses should be joined together using logical OR operator.
    OR = "Or"
...
class OperationMutator(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Mutator for this operation step."""

    #: Use this operator when a scalar value should be replaced/overwritten.
    SET_VALUE = "SetValue"
    #: Use this operator when a scalar or array value should be set explicitly to NULL.
    SET_NULL = "SetNull"
    #: Use this operator when an array value should be set to the empty set/list.
    SET_EMPTY = "SetEmpty"
    #: Use this operator to add an element to a set (i.e. an unordered multivalue variable).
    ADD_TO_SET = "AddToSet"
    #: Use this operator to add an element to the end of a list (i.e. an ordered multivalue variable).
    APPEND_TO_LIST = "AppendToList"
    #: Use this operator to remove the specified element from a set (i.e. an unordered multivalue
    #: variable).
    REMOVE_FROM_SET = "RemoveFromSet"
...
class TargetType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    #: This bulk action is targeting stix indicators.
    STIX_INDICATOR = "StixIndicator"
