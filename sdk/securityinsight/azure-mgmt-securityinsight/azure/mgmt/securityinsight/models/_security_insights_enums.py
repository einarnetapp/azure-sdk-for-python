...
class GroupingKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """GroupingKind."""
...
class IncidentCreationRuleConditionType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class IncidentCreationRulePropertyConditionSupportedOperator(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class IncidentCreationRulePropertyConditionSupportedProperty(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The property to evaluate in a incident creation rule property condition."""

    ALERT_DISPLAY_NAME = "AlertDisplayName"
    """The name of the alert."""
    ALERT_ANALYTIC_RULE_ID = "AlertAnalyticRuleId"
    """The analytic rule id of the alert."""
    ALERT_PRODUCT_NAME = "AlertProductName"
    """The name of the product of the alert."""
...
class IncidentCreationRulePropertyGroupingSupportedProperty(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The property to evaluate by which we will group alerts."""

    ENTITIES = "Entities"
    """Group alerts by identical entities."""
    CUSTOM_DETAILS = "CustomDetails"
    """Group alerts by custom details."""
    ALERT_PROPERTIES = "AlertProperties"
    """Group alerts by alert properties."""
