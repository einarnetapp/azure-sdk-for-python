...
class AutomationRuleCondition(_serialization.Model):
    ...
    :ivar condition_type: Required. "Property"
    ...
    _subtype_map = {"condition_type": {"Property": "PropertyConditionProperties"}}
...
class AutomationRuleTriggeringLogic(_serialization.Model):
    ...
    :ivar triggers_when: Required. "Created"
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword triggers_when: Required. "Created"
