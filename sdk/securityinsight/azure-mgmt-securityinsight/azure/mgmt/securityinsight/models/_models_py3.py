...
class DataConnector(ResourceWithEtag):
    ...
    MCASDataConnector, MDATPDataConnector, MTPDataConnector, OfficeDataConnector, TIDataConnector
    ...
    :ivar kind: The data connector kind. Required. Known values are: "AzureActiveDirectory",
     ...
     "MicrosoftDefenderAdvancedThreatProtection", and "MicrosoftThreatProtection".
