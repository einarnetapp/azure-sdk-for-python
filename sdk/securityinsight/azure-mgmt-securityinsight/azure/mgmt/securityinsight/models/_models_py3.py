...
class DataConnector(ResourceWithEtag):
    ...
    MCASDataConnector, MDATPDataConnector, OfficeDataConnector, TIDataConnector
    ...
    :ivar kind: The data connector kind. Required. Known values are: "AzureActiveDirectory",
     ...
     "AmazonWebServicesCloudTrail", "AzureAdvancedThreatProtection", and
...
class AlertsDataTypeOfDataConnector(_serialization.Model):
    ...
    def __init__(self, *, alerts: Optional["_models.DataConnectorDataTypeCommon"] = None, **kwargs):
        """
...
class AwsCloudTrailDataConnectorDataTypes(_serialization.Model):
    ...
    def __init__(self, *, logs: Optional["_models.AwsCloudTrailDataConnectorDataTypesLogs"] = None, **kwargs):
        """
...
class IncidentEntitiesResultsMetadata(_serialization.Model):
    ...
    def __init__(self, *, count: int, entity_kind: Union[str, "_models.EntityKindEnum"], **kwargs):
        """
...
class TIDataConnectorDataTypes(_serialization.Model):
    ...
    def __init__(self, *, indicators: Optional["_models.TIDataConnectorDataTypesIndicators"] = None, **kwargs):
        """
