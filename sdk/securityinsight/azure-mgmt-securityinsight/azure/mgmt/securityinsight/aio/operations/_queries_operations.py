...
from ...operations._queries_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_request
T = TypeVar('T')
...
class QueriesOperations:
    ...
    def list(
        ...
        workspace_name: str,
        **kwargs: Any
    ) -> AsyncIterable[_models.QueryList]:
        """Gets all queries.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.securityinsight.models.QueryList]
