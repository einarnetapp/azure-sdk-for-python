...
class Operations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.OperationAutoGenerated"]:
        ...
        :return: An iterator like instance of either OperationAutoGenerated or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.securityinsight.models.OperationAutoGenerated]
