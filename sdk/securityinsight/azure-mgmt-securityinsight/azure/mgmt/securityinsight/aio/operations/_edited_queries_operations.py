...
from ...operations._edited_queries_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_request
T = TypeVar('T')
...
class EditedQueriesOperations:
    ...
    def list(
        ...
        query_id: str,
        **kwargs: Any
    ) -> AsyncIterable[_models.EditedQueryList]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.securityinsight.models.EditedQueryList]
