...
class UpdateOperations:
    ...
    async def _recommendation_initial(
        ...
        **kwargs: Any
        ...
        )  # type: Literal["2022-12-01-preview"]
    ...
    _recommendation_initial.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/recommendations/{recommendationId}"}  # type: ignore
    ...
    async def begin_recommendation(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._recommendation_initial(  # type: ignore
                resource_group_name=resource_group_name,
                workspace_name=workspace_name,
                recommendation_id=recommendation_id,
    ...
    begin_recommendation.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/recommendations/{recommendationId}"}  # type: ignore
