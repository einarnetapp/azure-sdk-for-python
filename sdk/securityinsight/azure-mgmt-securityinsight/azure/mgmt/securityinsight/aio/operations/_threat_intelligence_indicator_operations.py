...
from ...operations._threat_intelligence_indicator_operations import (
    ...
    build_count_from_condition_request,
    build_create_indicator_request,
    build_create_request,
    build_delete_request,
    build_get_request,
    build_query_from_condition_request,
...
class ThreatIntelligenceIndicatorOperations:
    ...
    @overload
    async def query_from_condition(
        self,
        resource_group_name: str,
        workspace_name: str,
        filter_criteria: _models.ThreatIntelligenceQueryByCondition,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.ThreatIntelligenceInformationList:
        ...
        :param workspace_name: The name of the workspace. Required.
        :type workspace_name: str
        :param filter_criteria: Filtering criteria for querying threat intelligence indicators by
         condition. Required.
        :type filter_criteria: ~azure.mgmt.securityinsight.models.ThreatIntelligenceQueryByCondition
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ThreatIntelligenceInformationList or the result of cls(response)
        :rtype: ~azure.mgmt.securityinsight.models.ThreatIntelligenceInformationList
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def query_from_condition(
        ...
        resource_group_name: str,
        workspace_name: str,
        filter_criteria: Union[_models.ThreatIntelligenceQueryByCondition, IO],
        **kwargs: Any
    ) -> _models.ThreatIntelligenceInformationList:
        """Query Indicators from condition.
        ...
        :type workspace_name: str
        :param filter_criteria: Filtering criteria for querying threat intelligence indicators by
         condition. Is either a model type or a IO type. Required.
        :type filter_criteria: ~azure.mgmt.securityinsight.models.ThreatIntelligenceQueryByCondition or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        ...
        _json = None
        _content = None
        if isinstance(filter_criteria, (IO, bytes)):
            _content = filter_criteria
        else:
            _json = self._serialize.body(filter_criteria, "ThreatIntelligenceQueryByCondition")

        request = build_query_from_condition_request(
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            ...
            json=_json,
            content=_content,
            template_url=self.query_from_condition.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    query_from_condition.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/queryThreatIntelligenceIndicators"}  # type: ignore

    @overload
    async def count_from_condition(
        self,
        resource_group_name: str,
        workspace_name: str,
        filter_criteria: _models.ThreatIntelligenceCountByCondition,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.ThreatIntelligenceInformationCount:
        ...
        :param workspace_name: The name of the workspace. Required.
        :type workspace_name: str
        :param filter_criteria: Filtering criteria for counting threat intelligence indicators by
         condition. Required.
        :type filter_criteria: ~azure.mgmt.securityinsight.models.ThreatIntelligenceCountByCondition
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ThreatIntelligenceInformationCount or the result of cls(response)
        :rtype: ~azure.mgmt.securityinsight.models.ThreatIntelligenceInformationCount
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def count_from_condition(
        ...
        resource_group_name: str,
        workspace_name: str,
        filter_criteria: Union[_models.ThreatIntelligenceCountByCondition, IO],
        **kwargs: Any
    ) -> _models.ThreatIntelligenceInformationCount:
        """Count Indicators from condition.
        ...
        :param filter_criteria: Filtering criteria for counting threat intelligence indicators by
         condition. Is either a model type or a IO type. Required.
        :type filter_criteria: ~azure.mgmt.securityinsight.models.ThreatIntelligenceCountByCondition or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))  # type: str
        content_type = kwargs.pop("content_type", _headers.pop("Content-Type", None))  # type: Optional[str]
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.ThreatIntelligenceInformationCount]
        ...
        if isinstance(filter_criteria, (IO, bytes)):
            ...
            _json = self._serialize.body(filter_criteria, "ThreatIntelligenceCountByCondition")

        request = build_count_from_condition_request(
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            ...
            json=_json,
            content=_content,
            template_url=self.count_from_condition.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
        ...
        deserialized = self._deserialize("ThreatIntelligenceInformationCount", pipeline_response)
    ...
    count_from_condition.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/countThreatIntelligenceIndicators"}  # type: ignore
