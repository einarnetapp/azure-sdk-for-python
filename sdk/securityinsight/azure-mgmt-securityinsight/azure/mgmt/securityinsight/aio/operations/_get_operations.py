...
from ...operations._get_operations import build_recommendations_request, build_single_recommendation_request
T = TypeVar('T')
...
class GetOperations:
    ...
    async def recommendations(
        ...
        **kwargs: Any
        ...
        :return: list of Recommendation, or the result of cls(response)
        :rtype: list[~azure.mgmt.securityinsight.models.Recommendation]
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType[List[_models.Recommendation]]

        
        request = build_recommendations_request(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            api_version=api_version,
            template_url=self.recommendations.metadata['url'],
            headers=_headers,
            params=_params,
        )
    ...
    recommendations.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/recommendations"}  # type: ignore
