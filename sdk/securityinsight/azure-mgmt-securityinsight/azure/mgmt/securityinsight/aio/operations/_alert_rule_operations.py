...
class AlertRuleOperations:
    ...
    async def _trigger_rule_run_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        workspace_name: str,
        rule_id: str,
        analytics_rule_run_trigger_parameter: Union[_models.AnalyticsRuleRunTrigger, IO],
        **kwargs: Any
    ) -> None:
        error_map = {
        ...
        _json = None
        _content = None
        if isinstance(analytics_rule_run_trigger_parameter, (IO, bytes)):
        ...
        request = build_trigger_rule_run_request(
            ...
            json=_json,
            content=_content,
            template_url=self._trigger_rule_run_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
    ...
    _trigger_rule_run_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/alertRules/{ruleId}/triggerRuleRun"
    }
    ...
    async def begin_trigger_rule_run(
        ...
        workspace_name: str,
        rule_id: str,
        analytics_rule_run_trigger_parameter: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[None]:
        ...
        :param analytics_rule_run_trigger_parameter: The Analytics Rule Run Trigger parameter.
         Required.
        :type analytics_rule_run_trigger_parameter: IO
    ...
    async def begin_trigger_rule_run(
        ...
        **kwargs: Any
        ...
        :param analytics_rule_run_trigger_parameter: The Analytics Rule Run Trigger parameter. Is
         either a AnalyticsRuleRunTrigger type or a IO type. Required.
        :type analytics_rule_run_trigger_parameter:
         ~azure.mgmt.securityinsight.models.AnalyticsRuleRunTrigger or IO
        ...
        if cont_token is None:
            raw_result = await self._trigger_rule_run_initial(  # type: ignore
                resource_group_name=resource_group_name,
                workspace_name=workspace_name,
                rule_id=rule_id,
    ...
    begin_trigger_rule_run.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/alertRules/{ruleId}/triggerRuleRun"
    }
