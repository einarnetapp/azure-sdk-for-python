...
from ...operations._confidential_watchlist_items_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class ConfidentialWatchlistItemsOperations:
    """ConfidentialWatchlistItemsOperations async operations.
