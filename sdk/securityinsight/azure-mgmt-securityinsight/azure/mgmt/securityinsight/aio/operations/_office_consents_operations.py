...
class OfficeConsentsOperations:
    """OfficeConsentsOperations async operations.
    ...
    def list(
        ...
        workspace_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.OfficeConsentList"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.securityinsight.models.OfficeConsentList]
