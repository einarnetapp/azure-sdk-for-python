...
class SecurityInsights:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype packages: azure.mgmt.securityinsight.aio.operations.PackagesOperations
    :ivar package: PackageOperations operations
    :vartype package: azure.mgmt.securityinsight.aio.operations.PackageOperations
    :ivar templates: TemplatesOperations operations
    :vartype templates: azure.mgmt.securityinsight.aio.operations.TemplatesOperations
