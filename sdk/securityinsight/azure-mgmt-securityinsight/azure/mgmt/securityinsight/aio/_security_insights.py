...
class SecurityInsights:    # pylint: disable=too-many-instance-attributes
    ...
    :ivar overview: OverviewOperations operations
    :vartype overview: azure.mgmt.securityinsight.aio.operations.OverviewOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.overview = OverviewOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
