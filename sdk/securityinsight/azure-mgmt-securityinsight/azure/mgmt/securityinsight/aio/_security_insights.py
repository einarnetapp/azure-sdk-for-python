...
class SecurityInsights:    # pylint: disable=too-many-instance-attributes
    ...
    :vartype queries: azure.mgmt.securityinsight.aio.operations.QueriesOperations
    :ivar edited_queries: EditedQueriesOperations operations
    :vartype edited_queries: azure.mgmt.securityinsight.aio.operations.EditedQueriesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.edited_queries = EditedQueriesOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
