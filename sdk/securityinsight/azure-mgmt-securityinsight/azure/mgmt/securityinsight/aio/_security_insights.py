...
class SecurityInsights:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype export_connections:
     azure.mgmt.securityinsight.aio.operations.ExportConnectionsOperations
    :ivar export_jobs: ExportJobsOperations operations
    :vartype export_jobs: azure.mgmt.securityinsight.aio.operations.ExportJobsOperations
