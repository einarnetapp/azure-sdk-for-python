...
# USAGE
    python incident_creation_rules_create_or_update.py
...
def main():
    ...
    response = client.incident_creation_rules.create_or_update(
        resource_group_name="myRg",
        workspace_name="myWorkspace",
        incident_creation_rule_id="73e01a99-5cd7-4139-a149-9f2736ff2ab5",
    )
    print(response)
