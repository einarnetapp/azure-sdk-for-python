...
class PrivateEndpointConnectionsOperations:
    ...
    async def get(
        ...
        :param cluster_name: Name of cluster. Required.
        :type cluster_name: str
        :param private_endpoint_connection_name: Name of private endpoint connection. Required.
    ...
    async def _create_initial(
        ...
        resource: Union[_models.PrivateEndpointConnection, IO],
        **kwargs: Any
    ) -> _models.PrivateEndpointConnection:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.redisenterprise.models.PrivateEndpointConnection
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param private_endpoint_connection_name: Name of private endpoint connection. Required.
        :type private_endpoint_connection_name: str
        :param resource: Resource create parameters. Is either a PrivateEndpointConnection type or a IO
         type. Required.
        :type resource: ~azure.mgmt.redisenterprise.models.PrivateEndpointConnection or IO
