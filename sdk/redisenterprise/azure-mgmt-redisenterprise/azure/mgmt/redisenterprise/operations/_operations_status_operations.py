...
def build_get_request(subscription_id: str, location: str, operation_id: str, **kwargs: Any) -> HttpRequest:
...
class OperationsStatusOperations:
    ...
    @distributed_trace
    def get(
        self, subscription_id: str, location: str, operation_id: str, **kwargs: Any
    ) -> _models.OperationStatusResult:
        """Gets information about a database in a RedisEnterprise cluster.

        :param subscription_id: ID of the subscription. Required.
        :type subscription_id: str
        :param location: Location of the long-running operation result. Required.
        :type location: str
        :param operation_id: Unique ID of the long-running operation. Required.
    ...
    get.metadata = {
        "url": "/Subscriptions/{subscriptionId}/providers/Microsoft.Cache/locations/{location}/OperationStatuses/{operationId}"
    }
