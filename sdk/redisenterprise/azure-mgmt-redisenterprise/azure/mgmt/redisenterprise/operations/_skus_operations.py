...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Cache/skus")
...
class SkusOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.SkuDetails"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.redisenterprise.models.SkuDetails]
