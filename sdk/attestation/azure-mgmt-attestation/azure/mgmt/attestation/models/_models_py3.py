...
class AttestationProvider(TrackedResource):
    ...
    :ivar status: Status of attestation service. Known values are: "Ready", "NotReady", "Error".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword status: Status of attestation service. Known values are: "Ready", "NotReady", "Error".
...
class AttestationServiceCreationParams(msrest.serialization.Model):
    ...
    :ivar location: Required. The supported Azure location where the attestation provider should be
     created.
    :vartype location: str
    :ivar tags: A set of tags. The tags that will be assigned to the attestation provider.
    :vartype tags: dict[str, str]
    :ivar properties: Required. Properties of the attestation provider.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword location: Required. The supported Azure location where the attestation provider should
         be created.
        :paramtype location: str
        :keyword tags: A set of tags. The tags that will be assigned to the attestation provider.
        :paramtype tags: dict[str, str]
        :keyword properties: Required. Properties of the attestation provider.
...
class JSONWebKey(msrest.serialization.Model):
    ...
    :vartype kid: str
    :ivar kty: Required. The "kty" (key type) parameter identifies the cryptographic algorithm
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword kid: The "kid" (key ID) parameter is used to match a specific key.  This
         ...
         value is a case-sensitive string.
        :paramtype kid: str
        :keyword kty: Required. The "kty" (key type) parameter identifies the cryptographic algorithm
         family used with the key, such as "RSA" or "EC". "kty" values should
         either be registered in the IANA "JSON Web Key Types" registry
         established by [JWA] or be a value that contains a Collision-
         Resistant Name.  The "kty" value is a case-sensitive string.
...
class JSONWebKeySet(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        keys: Optional[List["_models.JSONWebKey"]] = None,
        **kwargs
    ):
        """
