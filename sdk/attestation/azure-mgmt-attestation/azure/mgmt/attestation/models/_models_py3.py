...
class AttestationProvider(TrackedResource):
    ...
    :ivar status: Status of attestation service. Possible values include: "Ready", "NotReady",
     "Error".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword status: Status of attestation service. Possible values include: "Ready", "NotReady",
         "Error".
