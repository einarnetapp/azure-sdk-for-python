...
class Sku(_serialization.Model):
    ...
    :ivar name: The type of Redis cache to deploy. Valid values: (Basic, Standard, Premium, General
     Purpose, Memory Optimized). Required. Known values are: "Basic", "Standard", "Premium",
     "GeneralPurpose", and "MemoryOptimized".
    :vartype name: str or ~azure.mgmt.redis.models.SkuName
    :ivar family: The SKU family to use. Valid values: (C, P). (C = Basic/Standard, P = Premium, G
     = General Purpose, M = Memory Optimized). Required. Known values are: "C", "P", "G", and "M".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword name: The type of Redis cache to deploy. Valid values: (Basic, Standard, Premium,
         General Purpose, Memory Optimized). Required. Known values are: "Basic", "Standard", "Premium",
         "GeneralPurpose", and "MemoryOptimized".
        :paramtype name: str or ~azure.mgmt.redis.models.SkuName
        :keyword family: The SKU family to use. Valid values: (C, P). (C = Basic/Standard, P = Premium,
         G = General Purpose, M = Memory Optimized). Required. Known values are: "C", "P", "G", and "M".
