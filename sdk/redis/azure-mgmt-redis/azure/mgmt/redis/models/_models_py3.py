...
class RedisCacheAccessPolicyAssignment(_serialization.Model):
    ...
    _validation = {
        ...
        "object_id_alias": {"required": True},
    }

    _attribute_map = {
        "object_id": {"key": "objectId", "type": "str"},
        "object_id_alias": {"key": "objectIdAlias", "type": "str"},
    }

    def __init__(self, *, object_id: str, object_id_alias: str, **kwargs: Any) -> None:
        """
        :keyword object_id: Object Id to assign access policy to. Required.
...
class RedisCacheAccessPolicyAssignmentList(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.redis.models.RedisCacheAccessPolicyAssignmentSet]
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[RedisCacheAccessPolicyAssignmentSet]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(
        self, *, value: Optional[List["_models.RedisCacheAccessPolicyAssignmentSet"]] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: List of access policies assignments (with properties) of a Redis cache.
        :paramtype value: list[~azure.mgmt.redis.models.RedisCacheAccessPolicyAssignmentSet]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class RedisCacheAccessPolicyAssignmentSet(ProxyResource):
    ...
    :ivar assignments:
    :vartype assignments: list[~azure.mgmt.redis.models.RedisCacheAccessPolicyAssignment]
    """
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
        "assignments": {"key": "properties.assignments", "type": "[RedisCacheAccessPolicyAssignment]"},
    }

    def __init__(
        self, *, assignments: Optional[List["_models.RedisCacheAccessPolicyAssignment"]] = None, **kwargs: Any
    ) -> None:
        """
        :keyword assignments:
        :paramtype assignments: list[~azure.mgmt.redis.models.RedisCacheAccessPolicyAssignment]
        """
        super().__init__(**kwargs)
        self.provisioning_state = None
