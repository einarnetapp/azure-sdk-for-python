...
class RedisManagementClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    :keyword api_version: Api Version. Default value is "2022-06-01-privatepreview". Note that
    ...
    def __init__(self, credential: "TokenCredential", subscription_id: str, **kwargs: Any) -> None:
        ...
        api_version: Literal["2022-06-01-privatepreview"] = kwargs.pop("api_version", "2022-06-01-privatepreview")
