...
class DataPlaneAadOrApiKeyAuthOption(_serialization.Model):
    ...
    def __init__(self, *, aad_auth_failure_mode: Optional[Union[str, "_models.AadAuthFailureMode"]] = None, **kwargs):
        """
...
class EncryptionWithCmk(_serialization.Model):
    ...
    def __init__(self, *, enforcement: Optional[Union[str, "_models.SearchEncryptionWithCmk"]] = None, **kwargs):
        """
