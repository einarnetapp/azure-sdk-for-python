...
class UserAssignedIdentitiesOperations:
    ...
    :type models: ~azure.mgmt.demo.v2021_09_30_preview.models
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either UserAssignedIdentitiesListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.demo.v2021_09_30_preview.models.UserAssignedIdentitiesListResult]
    ...
    def list_associated_resources(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either AssociatedResourcesListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.demo.v2021_09_30_preview.models.AssociatedResourcesListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-09-30-preview")  # type: str
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.demo.v2021_09_30_preview.models.Identity
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Identity, or the result of cls(response)
        :rtype: ~azure.mgmt.demo.v2021_09_30_preview.models.Identity
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.demo.v2021_09_30_preview.models.IdentityUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Identity, or the result of cls(response)
        :rtype: ~azure.mgmt.demo.v2021_09_30_preview.models.Identity
        :raises: ~azure.core.exceptions.HttpResponseError
