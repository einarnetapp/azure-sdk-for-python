...
class ManagedServiceIdentityClient:
    ...
    :vartype system_assigned_identities:
     azure.mgmt.demo.v2021_09_30_preview.aio.operations.SystemAssignedIdentitiesOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.demo.v2021_09_30_preview.aio.operations.Operations
    :ivar user_assigned_identities: UserAssignedIdentitiesOperations operations
    :vartype user_assigned_identities:
     azure.mgmt.demo.v2021_09_30_preview.aio.operations.UserAssignedIdentitiesOperations
