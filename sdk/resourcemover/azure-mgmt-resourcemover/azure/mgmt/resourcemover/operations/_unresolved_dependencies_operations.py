...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}/unresolvedDependencies")  # pylint: disable=line-too-long
...
class UnresolvedDependenciesOperations:
    ...
    def get(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable[_models.UnresolvedDependencyCollection]:
        ...
        :param dependency_level: Defines the dependency level. Default value is None.
        ...
        :return: An iterator like instance of either UnresolvedDependencyCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resourcemover.models.UnresolvedDependencyCollection]
