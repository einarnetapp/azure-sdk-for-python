...
class VirtualMachineImageTemplatesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.ImageTemplate"]:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.ImageTemplate"]:
