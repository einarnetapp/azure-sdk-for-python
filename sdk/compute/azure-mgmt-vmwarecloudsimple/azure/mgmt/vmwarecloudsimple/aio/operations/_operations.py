...
from ...operations._operations import build_get_request, build_list_request
...
class Operations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.AvailableOperation"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.vmwarecloudsimple.models.AvailableOperation]
