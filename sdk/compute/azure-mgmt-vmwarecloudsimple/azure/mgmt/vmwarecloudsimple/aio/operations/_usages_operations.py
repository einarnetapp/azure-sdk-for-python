...
class UsagesOperations:
    ...
    @distributed_trace
    def list(self, region_id: str, filter: Optional[str] = None, **kwargs: Any) -> AsyncIterable["_models.Usage"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.vmwarecloudsimple.models.Usage]
