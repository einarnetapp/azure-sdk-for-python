...
def build_list_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.VMwareCloudSimple/operations")
...
def build_get_request(
    region_id: str, operation_id: str, subscription_id: str, *, referer: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class Operations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.AvailableOperation"]:
        """Implements list of available operations.

        Return list of operations.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either AvailableOperation or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.vmwarecloudsimple.models.AvailableOperation]
    ...
    @distributed_trace
    def get(
        self, region_id: str, referer: str, operation_id: str, **kwargs: Any
