...
def build_list_request(
    region_id: str, pc_name: str, subscription_id: str, *, filter: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
...
def build_get_request(
    region_id: str, pc_name: str, customization_policy_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "regionId": _SERIALIZER.url("region_id", region_id, "str"),
        "pcName": _SERIALIZER.url("pc_name", pc_name, "str"),
        "customizationPolicyName": _SERIALIZER.url("customization_policy_name", customization_policy_name, "str"),
    }
...
class CustomizationPoliciesOperations:
    ...
    def list(
    ...
    ) -> Iterable["_models.CustomizationPolicy"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.vmwarecloudsimple.models.CustomizationPolicy]
