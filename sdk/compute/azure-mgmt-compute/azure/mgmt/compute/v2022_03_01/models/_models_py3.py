...
class OSDiskImage(_serialization.Model):
    ...
    :ivar size_in_gb: The size in GB of the osDiskImage.
    :vartype size_in_gb: int
    :ivar size_in_bytes: The size in bytes of the osDiskImage.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword size_in_gb: The size in GB of the osDiskImage.
        :paramtype size_in_gb: int
        :keyword size_in_bytes: The size in bytes of the osDiskImage.
