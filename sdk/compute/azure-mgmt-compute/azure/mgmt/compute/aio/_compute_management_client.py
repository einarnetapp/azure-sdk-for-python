...
class ComputeManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    @property
    def virtual_machine_applications(self):
        """Instance depends on the API version:

           * 2022-08-01: :class:`VirtualMachineApplicationsOperations<azure.mgmt.compute.v2022_08_01.aio.operations.VirtualMachineApplicationsOperations>`
        """
        api_version = self._get_api_version('virtual_machine_applications')
        if api_version == '2022-08-01':
            from ..v2022_08_01.aio.operations import VirtualMachineApplicationsOperations as OperationClass
        else:
            raise ValueError("API version {} does not have operation group 'virtual_machine_applications'".format(api_version))
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    @property
    def virtual_machine_scale_set_applications(self):
        """Instance depends on the API version:

           * 2022-08-01: :class:`VirtualMachineScaleSetApplicationsOperations<azure.mgmt.compute.v2022_08_01.aio.operations.VirtualMachineScaleSetApplicationsOperations>`
        """
        api_version = self._get_api_version('virtual_machine_scale_set_applications')
        if api_version == '2022-08-01':
            from ..v2022_08_01.aio.operations import VirtualMachineScaleSetApplicationsOperations as OperationClass
        else:
            raise ValueError("API version {} does not have operation group 'virtual_machine_scale_set_applications'".format(api_version))
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
