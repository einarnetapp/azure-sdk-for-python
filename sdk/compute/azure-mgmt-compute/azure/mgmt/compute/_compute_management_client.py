...
class ComputeManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def virtual_machine_applications(self):
        """Instance depends on the API version:
           ...
           * 2022-08-01: :class:`VirtualMachineApplicationsOperations<azure.mgmt.compute.v2022_08_01.operations.VirtualMachineApplicationsOperations>`
        """
        api_version = self._get_api_version('virtual_machine_applications')
        if api_version == '2022-08-01':
            from .v2022_08_01.operations import VirtualMachineApplicationsOperations as OperationClass
        else:
    ...
    def virtual_machine_scale_set_applications(self):
        """Instance depends on the API version:
           ...
           * 2022-08-01: :class:`VirtualMachineScaleSetApplicationsOperations<azure.mgmt.compute.v2022_08_01.operations.VirtualMachineScaleSetApplicationsOperations>`
        """
        api_version = self._get_api_version('virtual_machine_scale_set_applications')
        if api_version == '2022-08-01':
            from .v2022_08_01.operations import VirtualMachineScaleSetApplicationsOperations as OperationClass
        else:
