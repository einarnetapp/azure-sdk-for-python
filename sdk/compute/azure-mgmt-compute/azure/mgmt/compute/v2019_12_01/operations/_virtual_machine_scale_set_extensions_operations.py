...
class VirtualMachineScaleSetExtensionsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2019_12_01.models.VirtualMachineScaleSetExtension]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type extension_parameters:
         ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineScaleSetExtension or IO
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type extension_parameters:
         ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineScaleSetExtensionUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list(
        ...
        :return: An iterator like instance of either VirtualMachineScaleSetExtension or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2019_12_01.models.VirtualMachineScaleSetExtension]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
