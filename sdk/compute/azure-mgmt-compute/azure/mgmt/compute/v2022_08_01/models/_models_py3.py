...
class VirtualMachineApplicationsListResult(_serialization.Model):
    """The List Extension operation response.

    :ivar value: The list of extensions.
    :vartype value: list[~azure.mgmt.compute.v2022_08_01.models.VMGalleryApplication]
    """

    _attribute_map = {
        "value": {"key": "value", "type": "[VMGalleryApplication]"},
    }

    def __init__(self, *, value: Optional[List["_models.VMGalleryApplication"]] = None, **kwargs):
        """
        :keyword value: The list of extensions.
        :paramtype value: list[~azure.mgmt.compute.v2022_08_01.models.VMGalleryApplication]
        """
        super().__init__(**kwargs)
        self.value = value
...
class VMGalleryApplication(_serialization.Model):
    ...
    :vartype enable_automatic_upgrade: bool
    :ivar instance_view: Contains instanceView of the VMApplication if $expand=instanceView is
     specified.
    :vartype instance_view: ~azure.mgmt.compute.v2022_08_01.models.VMGalleryApplicationInstanceView
    """
    ...
    _attribute_map = {
        ...
        "instance_view": {"key": "instanceView", "type": "VMGalleryApplicationInstanceView"},
    }
...
class VMGalleryApplicationInstanceView(_serialization.Model):
    """VMGalleryApplicationInstanceView.

    :ivar name: The application name.
    :vartype name: str
    :ivar version: The application version.
    :vartype version: str
    :ivar result: The current status of the application.
    :vartype result: str
    :ivar actions_performed: actions performed on the application.
    :vartype actions_performed:
     list[~azure.mgmt.compute.v2022_08_01.models.VMGalleryApplicationInstanceViewAction]
    """
    ...
    _attribute_map = {
        ...
        "actions_performed": {"key": "actionsPerformed", "type": "[VMGalleryApplicationInstanceViewAction]"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        actions_performed: Optional[List["_models.VMGalleryApplicationInstanceViewAction"]] = None,
        **kwargs
    ):
        """
        :keyword name: The application name.
        :paramtype name: str
        :keyword version: The application version.
        :paramtype version: str
        :keyword result: The current status of the application.
        :paramtype result: str
        :keyword actions_performed: actions performed on the application.
        :paramtype actions_performed:
         list[~azure.mgmt.compute.v2022_08_01.models.VMGalleryApplicationInstanceViewAction]
        """
        super().__init__(**kwargs)
        self.name = name
...
class VMGalleryApplicationInstanceViewAction(_serialization.Model):
    """VMGalleryApplicationInstanceViewAction.

    :ivar operation: The action performed.
    :vartype operation: str
    ...
    def __init__(self, *, operation: Optional[str] = None, result: Optional[str] = None, **kwargs):
        """
        :keyword operation: The action performed.
        :paramtype operation: str
        :keyword result: The result of the operation.
        :paramtype result: str
        """
        super().__init__(**kwargs)
