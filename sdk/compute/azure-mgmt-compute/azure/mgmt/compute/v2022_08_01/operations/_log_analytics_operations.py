...
class LogAnalyticsOperations:
    ...
    def begin_export_request_rate_by_interval(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either LogAnalyticsOperationResult or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2022_08_01.models.LogAnalyticsOperationResult]
    ...
    def begin_export_request_rate_by_interval(
        ...
        :type parameters: ~azure.mgmt.compute.v2022_08_01.models.RequestRateByIntervalInput or IO
    ...
    def begin_export_throttled_requests(
        ...
        :type parameters: ~azure.mgmt.compute.v2022_08_01.models.ThrottledRequestsInput or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
