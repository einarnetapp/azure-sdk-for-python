...
from ._virtual_machine_scale_set_applications_operations import VirtualMachineScaleSetApplicationsOperations
...
from ._virtual_machine_applications_operations import VirtualMachineApplicationsOperations
