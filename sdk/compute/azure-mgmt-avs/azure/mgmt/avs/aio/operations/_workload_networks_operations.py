...
class WorkloadNetworksOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_segments(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either WorkloadNetworkSegmentsList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.avs.models.WorkloadNetworkSegmentsList]
    ...
    @distributed_trace_async
    async def begin_delete_segment(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        private_cloud_name: str,
        segment_id: str,
    ...
    @distributed_trace_async
    async def begin_delete_dhcp(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        private_cloud_name: str,
        dhcp_id: str,
    ...
    def list_gateways(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either WorkloadNetworkGatewayList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.avs.models.WorkloadNetworkGatewayList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-12-01")  # type: str
    ...
    def list_port_mirroring(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either WorkloadNetworkPortMirroringList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.avs.models.WorkloadNetworkPortMirroringList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-12-01")  # type: str
    ...
    @distributed_trace_async
    async def begin_delete_port_mirroring(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        port_mirroring_id: str,
        private_cloud_name: str,
    ...
    def list_vm_groups(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either WorkloadNetworkVMGroupsList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.avs.models.WorkloadNetworkVMGroupsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-12-01")  # type: str
    ...
    @distributed_trace_async
    async def begin_delete_vm_group(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        vm_group_id: str,
        private_cloud_name: str,
    ...
    def list_virtual_machines(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either WorkloadNetworkVirtualMachinesList or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.avs.models.WorkloadNetworkVirtualMachinesList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-12-01")  # type: str
    ...
    def list_dns_services(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either WorkloadNetworkDnsServicesList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.avs.models.WorkloadNetworkDnsServicesList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-12-01")  # type: str
    ...
    @distributed_trace_async
    async def begin_delete_dns_service(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        dns_service_id: str,
        private_cloud_name: str,
    ...
    def list_dns_zones(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either WorkloadNetworkDnsZonesList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.avs.models.WorkloadNetworkDnsZonesList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-12-01")  # type: str
    ...
    @distributed_trace_async
    async def begin_delete_dns_zone(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        dns_zone_id: str,
        private_cloud_name: str,
    ...
    def list_public_i_ps(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either WorkloadNetworkPublicIPsList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.avs.models.WorkloadNetworkPublicIPsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-12-01")  # type: str
    ...
    @distributed_trace_async
    async def begin_delete_public_ip(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        public_ip_id: str,
        private_cloud_name: str,
