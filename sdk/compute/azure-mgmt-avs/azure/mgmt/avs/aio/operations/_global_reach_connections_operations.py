...
from ...operations._global_reach_connections_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_request
T = TypeVar('T')
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either GlobalReachConnectionList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.avs.models.GlobalReachConnectionList]
