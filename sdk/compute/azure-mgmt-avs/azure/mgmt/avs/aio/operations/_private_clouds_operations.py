...
from ...operations._private_clouds_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_admin_credentials_request, build_list_in_subscription_request, build_list_request, build_rotate_nsxt_password_request_initial, build_rotate_vcenter_password_request_initial, build_update_request_initial
T = TypeVar('T')
...
class PrivateCloudsOperations:
    ...
    @distributed_trace_async
    async def begin_rotate_vcenter_password(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        private_cloud_name: str,
        **kwargs: Any
    ...
    @distributed_trace_async
    async def begin_rotate_nsxt_password(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        private_cloud_name: str,
        **kwargs: Any
