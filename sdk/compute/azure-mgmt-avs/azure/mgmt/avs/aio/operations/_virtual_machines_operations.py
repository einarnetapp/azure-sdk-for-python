...
from ...operations._virtual_machines_operations import build_get_request, build_list_request, build_restrict_movement_request_initial
T = TypeVar('T')
...
class VirtualMachinesOperations:
    ...
    @distributed_trace_async
    async def begin_restrict_movement(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        private_cloud_name: str,
        cluster_name: str,
