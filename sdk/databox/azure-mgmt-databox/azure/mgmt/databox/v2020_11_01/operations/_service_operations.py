...
class ServiceOperations:
    ...
    def list_available_skus_by_resource_group(
        ...
        **kwargs: Any
        ...
        :param location: The location of the resource. Required.
        :type location: str
        :param available_sku_request: Filters for showing the available skus. Is either a model type or
         a IO type. Required.
        :type available_sku_request: ~azure.mgmt.databox.v2020_11_01.models.AvailableSkuRequest or IO
    ...
    def validate_address(
        ...
        :param location: The location of the resource. Required.
        :type location: str
        :param validate_address: Shipping address of the customer. Is either a model type or a IO type.
         Required.
        :type validate_address: ~azure.mgmt.databox.v2020_11_01.models.ValidateAddress or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def validate_inputs_by_resource_group(
        ...
        **kwargs: Any
        ...
        :param location: The location of the resource. Required.
        :type location: str
        :param validation_request: Inputs of the customer. Is either a model type or a IO type.
         Required.
        :type validation_request: ~azure.mgmt.databox.v2020_11_01.models.ValidationRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def region_configuration(
        ...
        **kwargs: Any
        ...
        :type region_configuration_request:
         ~azure.mgmt.databox.v2020_11_01.models.RegionConfigurationRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def region_configuration(
        ...
        :type region_configuration_request:
         ~azure.mgmt.databox.v2020_11_01.models.RegionConfigurationRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def region_configuration_by_resource_group(
        ...
        **kwargs: Any
        ...
        :type location: str
        :param region_configuration_request: Request body to get the configuration for the region at
         resource group level. Is either a model type or a IO type. Required.
        :type region_configuration_request:
         ~azure.mgmt.databox.v2020_11_01.models.RegionConfigurationRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
