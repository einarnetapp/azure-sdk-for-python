...
from ...operations._jobs_operations import build_book_shipment_pick_up_request, build_cancel_request, build_create_request, build_delete_request, build_get_request, build_list_by_resource_group_request, build_list_credentials_request, build_list_request, build_mark_devices_shipped_request, build_update_request
...
class JobsOperations:
    ...
    async def mark_devices_shipped(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param resource_group_name: The Resource Group Name. Required.
        :type resource_group_name: str
        :param mark_devices_shipped_request: Mark Devices Shipped Request. Is either a model type or a
         IO type. Required.
        :type mark_devices_shipped_request:
