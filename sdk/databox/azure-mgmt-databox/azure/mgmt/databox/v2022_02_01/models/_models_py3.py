...
class DataBoxCustomerDiskJobDetails(JobDetails):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs
        ...
        """
        super().__init__(contact_details=contact_details, shipping_address=shipping_address, data_import_details=data_import_details, data_export_details=data_export_details, preferences=preferences, key_encryption_key=key_encryption_key, expected_data_size_in_tera_bytes=expected_data_size_in_tera_bytes, **kwargs)
...
class MitigateJobRequest(_serialization.Model):
    ...
    def __init__(
        self,
        *,
        customer_resolution_code: Union[str, "_models.CustomerResolutionCode"],
        **kwargs
    ):
        """
