...
def build_get_request(
    resource_scope: str, blueprint_name: str, version_id: str, artifact_name: str, **kwargs: Any
) -> HttpRequest:
...
def build_list_request(resource_scope: str, blueprint_name: str, version_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
