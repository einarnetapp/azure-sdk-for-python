...
class ArtifactList(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.Artifact"]] = None, **kwargs):
        """
...
class ArtifactPropertiesBase(_serialization.Model):
    ...
    def __init__(self, *, depends_on: Optional[List[str]] = None, **kwargs):
        """
...
class AssignmentList(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.Assignment"]] = None, **kwargs):
        """
...
class AssignmentOperationList(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.AssignmentOperation"]] = None, **kwargs):
        """
...
class BlueprintResourcePropertiesBase(_serialization.Model):
    ...
    def __init__(self, *, display_name: Optional[str] = None, description: Optional[str] = None, **kwargs):
        """
        :keyword display_name: One-liner string explain this resource.
        :paramtype display_name: str
        :keyword description: Multi-line explain this resource.
...
class BlueprintList(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.Blueprint"]] = None, **kwargs):
        """
...
class ParameterValue(_serialization.Model):
    ...
    def __init__(
        self, *, value: Optional[JSON] = None, reference: Optional["_models.SecretValueReference"] = None, **kwargs
    ):
        """
...
class PublishedBlueprintList(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.PublishedBlueprint"]] = None, **kwargs):
        """
