...
class DataResidency(_serialization.Model):
    ...
    def __init__(self, *, type: Optional[Union[str, "_models.DataResidencyType"]] = None, **kwargs):
        """
...
class DiagnosticProactiveLogCollectionSettings(ARMBaseModel):
    ...
    def __init__(self, *, user_consent: Union[str, "_models.ProactiveDiagnosticsConsent"], **kwargs):
        """
...
class DiagnosticRemoteSupportSettings(ARMBaseModel):
    ...
    def __init__(
        self, *, remote_support_settings_list: Optional[List["_models.RemoteSupportSettings"]] = None, **kwargs
    ):
        """
