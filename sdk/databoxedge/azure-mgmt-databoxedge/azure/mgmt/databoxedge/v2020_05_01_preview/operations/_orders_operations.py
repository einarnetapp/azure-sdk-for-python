...
def build_list_by_data_box_edge_device_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/orders")  # pylint: disable=line-too-long
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/orders/default")  # pylint: disable=line-too-long
    path_format_arguments = {
        "deviceName": _SERIALIZER.url("device_name", device_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
...
class OrdersOperations(object):
    ...
    def list_by_data_box_edge_device(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.databoxedge.v2020_05_01_preview.models.OrderList]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.databoxedge.v2020_05_01_preview.models.Order
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type order: ~azure.mgmt.databoxedge.v2020_05_01_preview.models.Order
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.databoxedge.v2020_05_01_preview.models.Order]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-05-01-preview")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
