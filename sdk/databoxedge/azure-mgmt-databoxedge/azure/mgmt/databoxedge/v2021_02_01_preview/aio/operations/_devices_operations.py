...
class DevicesOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DataBoxEdgeDeviceList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databoxedge.v2021_02_01_preview.models.DataBoxEdgeDeviceList]
    ...
    @distributed_trace_async
    async def begin_download_updates(  # pylint: disable=inconsistent-return-statements
        self,
        device_name: str,
        resource_group_name: str,
        **kwargs: Any
    ...
    @distributed_trace_async
    async def begin_install_updates(  # pylint: disable=inconsistent-return-statements
        self,
        device_name: str,
        resource_group_name: str,
        **kwargs: Any
    ...
    @distributed_trace_async
    async def begin_scan_for_updates(  # pylint: disable=inconsistent-return-statements
        self,
        device_name: str,
        resource_group_name: str,
        **kwargs: Any
    ...
    @distributed_trace_async
    async def begin_create_or_update_security_settings(  # pylint: disable=inconsistent-return-statements
        self,
        device_name: str,
        resource_group_name: str,
        security_settings: "_models.SecuritySettings",
