...
class StorageAccountCredentialsOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either StorageAccountCredentialList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databoxedge.v2020_12_01.models.StorageAccountCredentialList]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2020_12_01.models.StorageAccountCredential]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-12-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
