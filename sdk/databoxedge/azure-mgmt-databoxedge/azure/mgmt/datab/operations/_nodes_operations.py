...
def build_list_by_data_box_edge_device_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/nodes")  # pylint: disable=line-too-long
...
class NodesOperations(object):
    ...
    def list_by_data_box_edge_device(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.databoxedge.v2020_12_01.models.NodeList]
