...
def build_list_by_storage_sync_service_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/registeredServers")  # pylint: disable=line-too-long
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/registeredServers/{serverId}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "storageSyncServiceName": _SERIALIZER.url("storage_sync_service_name", storage_sync_service_name, 'str'),
...
def build_create_request_initial(
    ...
    server_id: str,
    *,
    json: Optional[_models.RegisteredServerCreateParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_update_request_initial(
    ...
    server_id: str,
    *,
    json: Optional[_models.RegisteredServerUpdateParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_trigger_rollover_request_initial(
    subscription_id: str,
    resource_group_name: str,
    storage_sync_service_name: str,
    server_id: str,
    *,
    json: Optional[_models.TriggerRolloverRequest] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}//s/{serverId}/triggerRollover")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "storageSyncServiceName": _SERIALIZER.url("storage_sync_service_name", storage_sync_service_name, 'str'),
...
class RegisteredServersOperations:
    ...
    def list_by_storage_sync_service(
        ...
        storage_sync_service_name: str,
        **kwargs: Any
    ) -> Iterable[_models.RegisteredServerArray]:
        ...
        :return: An iterator like instance of either RegisteredServerArray or the result of
         cls(response)
    ...
    _update_initial.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/registeredServers/{serverId}"}  # type: ignore
    ...
    begin_update.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/registeredServers/{serverId}"}  # type: ignore
    ...
    def _trigger_rollover_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_trigger_rollover_request_initial(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            storage_sync_service_name=storage_sync_service_name,
            server_id=server_id,
    ...
    _trigger_rollover_initial.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}//s/{serverId}/triggerRollover"}  # type: ignore


    @distributed_trace
    def begin_trigger_rollover(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        storage_sync_service_name: str,
        server_id: str,
    ...
    begin_trigger_rollover.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}//s/{serverId}/triggerRollover"}  # type: ignore
