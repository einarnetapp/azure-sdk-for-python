...
from ...operations._server_endpoints_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_sync_group_request, build_recall_action_request_initial, build_update_request_initial
...
class ServerEndpointsOperations:
    ...
    def list_by_sync_group(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storagesync.models.ServerEndpointArray]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace_async
    async def begin_recall_action(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        storage_sync_service_name: str,
        sync_group_name: str,
