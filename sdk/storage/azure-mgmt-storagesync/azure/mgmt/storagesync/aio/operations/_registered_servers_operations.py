...
from ...operations._registered_servers_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_storage_sync_service_request, build_trigger_rollover_request_initial, build_update_request_initial
...
class RegisteredServersOperations:
    ...
    def list_by_storage_sync_service(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either RegisteredServerArray or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storagesync.models.RegisteredServerArray]
    ...
    @distributed_trace_async
    async def begin_trigger_rollover(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        storage_sync_service_name: str,
        server_id: str,
