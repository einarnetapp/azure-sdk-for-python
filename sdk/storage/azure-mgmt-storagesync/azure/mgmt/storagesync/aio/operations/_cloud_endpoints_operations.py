...
from ...operations._cloud_endpoints_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_sync_group_request, build_post_backup_request_initial, build_post_restore_request_initial, build_pre_backup_request_initial, build_pre_restore_request_initial, build_restoreheartbeat_request, build_trigger_change_detection_request_initial
...
class CloudEndpointsOperations:
    ...
    def list_by_sync_group(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storagesync.models.CloudEndpointArray]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace_async
    async def begin_pre_backup(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        storage_sync_service_name: str,
        sync_group_name: str,
    ...
    @distributed_trace_async
    async def begin_pre_restore(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        storage_sync_service_name: str,
        sync_group_name: str,
    ...
    @distributed_trace_async
    async def begin_post_restore(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        storage_sync_service_name: str,
        sync_group_name: str,
    ...
    @distributed_trace_async
    async def begin_trigger_change_detection(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        storage_sync_service_name: str,
        sync_group_name: str,
