...
def build_get_properties_request(
    ...
    subscription_id: str,
    *,
    expand: str = "geoReplicationStats",
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_keys_request(
    resource_group_name: str, account_name: str, subscription_id: str, *, expand: str = "kerb", **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class StorageAccountsOperations:
    ...
    @distributed_trace
    def get_properties(
        self, resource_group_name: str, account_name: str, expand: str = "geoReplicationStats", **kwargs: Any
