...
class StorageManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def account_migrations(self):
        """Instance depends on the API version:
           ...
           * 2022-09-01: :class:`AccountMigrationsOperations<azure.mgmt.storage.v2022_09_01.operations.AccountMigrationsOperations>`
        """
        api_version = self._get_api_version('account_migrations')
        if api_version == '2022-09-01':
            from .v2022_09_01.operations import AccountMigrationsOperations as OperationClass
        else:
