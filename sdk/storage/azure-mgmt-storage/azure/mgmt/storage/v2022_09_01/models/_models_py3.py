...
class StorageAccount(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar is_sku_conversion_blocked: This property value will be set as true or false as migration
     progresses. Default value is null.
...
class StorageAccountMigration(Resource):
    ...
    :ivar type: The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or
     "Microsoft.Storage/storageAccounts".
    :vartype type: str
    :ivar properties: The parameters or status associated with an ongoing or enqueued storage
     account migration in order to update its current SKU or region.
    :vartype properties: ~azure.mgmt.storage.v2022_09_01.models.StorageAccountMigrationProperties
    :ivar system_data: Metadata pertaining to creation and last modification of the resource.
    :vartype system_data: ~azure.mgmt.storage.v2022_09_01.models.SystemData
    """
    ...
    _attribute_map = {
        ...
        "name": {"key": "name", "type": "str"},
        "type": {"key": "type", "type": "str"},
        "properties": {"key": "properties", "type": "StorageAccountMigrationProperties"},
        "system_data": {"key": "systemData", "type": "SystemData"},
    }

    def __init__(self, *, properties: Optional["_models.StorageAccountMigrationProperties"] = None, **kwargs):
        """
        :keyword properties: The parameters or status associated with an ongoing or enqueued storage
         account migration in order to update its current SKU or region.
        :paramtype properties: ~azure.mgmt.storage.v2022_09_01.models.StorageAccountMigrationProperties
        """
        super().__init__(**kwargs)
...
class StorageAccountMigrationProperties(_serialization.Model):
    ...
    :ivar target_sku_name: The target sku name to migrate. Required. Known values are:
     "Standard_LRS", "Standard_GRS", "Standard_RAGRS", "Standard_ZRS", "Standard_GZRS", and
     "Standard_RAGZRS".
    :vartype target_sku_name: str or ~azure.mgmt.storage.v2022_09_01.models.TargetSkuName
    ...
    :vartype migration_status: str or ~azure.mgmt.storage.v2022_09_01.models.MigrationStatus
    """
    ...
    def __init__(self, *, target_sku_name: Union[str, "_models.TargetSkuName"], **kwargs):
        """
        :keyword target_sku_name: The target sku name to migrate. Required. Known values are:
         "Standard_LRS", "Standard_GRS", "Standard_RAGRS", "Standard_ZRS", "Standard_GZRS", and
         "Standard_RAGZRS".
        :paramtype target_sku_name: str or ~azure.mgmt.storage.v2022_09_01.models.TargetSkuName
        """
        super().__init__(**kwargs)
