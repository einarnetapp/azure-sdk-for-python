...
class BitLockerKeysOperations:
    ...
    @distributed_trace
    def list(self, job_name: str, resource_group_name: str, **kwargs: Any) -> Iterable["_models.DriveBitLockerKey"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storageimportexport.models.DriveBitLockerKey]
