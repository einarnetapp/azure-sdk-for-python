...
class AnalyticsConnectorDataDestinationType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Type of data destination."""

    DATALAKE = "datalake"


class AnalyticsConnectorDataSourceType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Type of data source."""
...
class AnalyticsConnectorMappingType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Type of data mapping."""

    FHIR_TO_PARQUET = "fhirToParquet"
    DICOM_TO_PARQUET = "dicomToParquet"
...
class FhirServiceVersion(str, Enum, metaclass=CaseInsensitiveEnumMeta):
