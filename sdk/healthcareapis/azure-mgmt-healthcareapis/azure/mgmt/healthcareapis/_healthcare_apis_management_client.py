...
class HealthcareApisManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype analytics_connectors:
     azure.mgmt.healthcareapis.operations.AnalyticsConnectorsOperations
    :ivar analytics_connector: AnalyticsConnectorOperations operations
    :vartype analytics_connector: azure.mgmt.healthcareapis.operations.AnalyticsConnectorOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.analytics_connector = AnalyticsConnectorOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
