...
from ...operations._iot_connectors_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_workspace_request, build_update_request_initial
T = TypeVar('T')
...
class IotConnectorsOperations:
    ...
    def list_by_workspace(
        ...
        workspace_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.IotConnectorCollection"]:
        ...
        :return: An iterator like instance of either IotConnectorCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.healthcareapis.models.IotConnectorCollection]
