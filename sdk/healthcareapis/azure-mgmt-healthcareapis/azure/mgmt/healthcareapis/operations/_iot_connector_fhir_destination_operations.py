...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HealthcareApis/workspaces/{workspaceName}/iotconnectors/{iotConnectorName}/fhirdestinations/{fhirDestinationName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        ...
        "fhirDestinationName": _SERIALIZER.url("fhir_destination_name", fhir_destination_name, 'str', max_length=24, min_length=3),
    }
...
def build_create_or_update_request_initial(
    ...
    fhir_destination_name: str,
    *,
    json: Optional[_models.IotFhirDestination] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
