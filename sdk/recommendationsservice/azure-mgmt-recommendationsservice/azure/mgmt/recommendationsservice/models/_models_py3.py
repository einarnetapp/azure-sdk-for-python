...
class AccountStatus(_serialization.Model):
    ...
    def __init__(self, *, scopes_statuses: Optional[List["_models.ScopeStatuses"]] = None, **kwargs: Any) -> None:
        """
...
class ModelingPatchResourceProperties(_serialization.Model):
    ...
    def __init__(self, *, input_data: Optional["_models.ModelingInputData"] = None, **kwargs: Any) -> None:
        """
...
class ModelingResourceList(_serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        value: Optional[List["_models.ModelingResource"]] = None,
        **kwargs: Any
    ) -> None:
        """
...
class ScopeStatuses(_serialization.Model):
    ...
    def __init__(
        self, *, scope: Optional[str] = None, statuses: Optional[List["_models.StageStatus"]] = None, **kwargs: Any
    ) -> None:
        """
...
class ServiceEndpointResourceProperties(_serialization.Model):
    ...
    def __init__(self, *, pre_allocated_capacity: Optional[int] = None, **kwargs: Any) -> None:
        """
