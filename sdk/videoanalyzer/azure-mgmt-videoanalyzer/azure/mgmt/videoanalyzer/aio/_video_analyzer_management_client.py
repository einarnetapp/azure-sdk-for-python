...
class VideoAnalyzerManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype edge_modules: azure.mgmt.videoanalyzer.aio.operations.EdgeModulesOperations
    :ivar pipeline_topologies: PipelineTopologiesOperations operations
    :vartype pipeline_topologies:
     azure.mgmt.videoanalyzer.aio.operations.PipelineTopologiesOperations
    :ivar live_pipelines: LivePipelinesOperations operations
    :vartype live_pipelines: azure.mgmt.videoanalyzer.aio.operations.LivePipelinesOperations
    :ivar pipeline_jobs: PipelineJobsOperations operations
    :vartype pipeline_jobs: azure.mgmt.videoanalyzer.aio.operations.PipelineJobsOperations
    ...
    :vartype live_pipeline_operation_statuses:
     azure.mgmt.videoanalyzer.aio.operations.LivePipelineOperationStatusesOperations
    ...
    :vartype pipeline_job_operation_statuses:
     azure.mgmt.videoanalyzer.aio.operations.PipelineJobOperationStatusesOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.videoanalyzer.aio.operations.Operations
    :ivar video_analyzers: VideoAnalyzersOperations operations
    :vartype video_analyzers: azure.mgmt.videoanalyzer.aio.operations.VideoAnalyzersOperations
    :ivar private_link_resources: PrivateLinkResourcesOperations operations
    :vartype private_link_resources:
     azure.mgmt.videoanalyzer.aio.operations.PrivateLinkResourcesOperations
    :ivar private_endpoint_connections: PrivateEndpointConnectionsOperations operations
    :vartype private_endpoint_connections:
     azure.mgmt.videoanalyzer.aio.operations.PrivateEndpointConnectionsOperations
    :ivar operation_statuses: OperationStatusesOperations operations
    :vartype operation_statuses:
     azure.mgmt.videoanalyzer.aio.operations.OperationStatusesOperations
    :ivar operation_results: OperationResultsOperations operations
    :vartype operation_results: azure.mgmt.videoanalyzer.aio.operations.OperationResultsOperations
    ...
    :vartype video_analyzer_operation_statuses:
     azure.mgmt.videoanalyzer.aio.operations.VideoAnalyzerOperationStatusesOperations
    ...
    :vartype video_analyzer_operation_results:
     azure.mgmt.videoanalyzer.aio.operations.VideoAnalyzerOperationResultsOperations
    :ivar locations: LocationsOperations operations
    :vartype locations: azure.mgmt.videoanalyzer.aio.operations.LocationsOperations
    :ivar videos: VideosOperations operations
    :vartype videos: azure.mgmt.videoanalyzer.aio.operations.VideosOperations
    :ivar access_policies: AccessPoliciesOperations operations
    :vartype access_policies: azure.mgmt.videoanalyzer.aio.operations.AccessPoliciesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = VideoAnalyzerManagementClientConfiguration(
    ...
    async def __aenter__(self) -> "VideoAnalyzerManagementClient":
