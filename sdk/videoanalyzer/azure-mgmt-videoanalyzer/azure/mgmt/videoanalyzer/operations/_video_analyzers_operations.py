...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Media/videoAnalyzers")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
    }
...
class VideoAnalyzersOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> _models.VideoAnalyzerCollection:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, account_name: str, **kwargs: Any) -> _models.VideoAnalyzer:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.VideoAnalyzer]:
        ...
        :return: An instance of LROPoller that returns either VideoAnalyzer or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.videoanalyzer.models.VideoAnalyzer]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> _models.VideoAnalyzerCollection:
        """List Video Analyzer accounts.
