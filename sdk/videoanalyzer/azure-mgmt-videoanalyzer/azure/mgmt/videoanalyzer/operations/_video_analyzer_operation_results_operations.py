...
class VideoAnalyzerOperationResultsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`video_analyzer_operation_results` attribute.
    """
    ...
    @distributed_trace
    def get(self, location_name: str, operation_id: str, **kwargs: Any) -> Optional[_models.VideoAnalyzer]:
        ...
        :return: VideoAnalyzer or None or the result of cls(response)
        :rtype: ~azure.mgmt.videoanalyzer.models.VideoAnalyzer or None
