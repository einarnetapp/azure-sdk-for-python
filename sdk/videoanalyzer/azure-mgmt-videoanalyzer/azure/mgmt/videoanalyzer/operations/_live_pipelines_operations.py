...
def build_get_request(
    resource_group_name: str, account_name: str, live_pipeline_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "accountName": _SERIALIZER.url("account_name", account_name, "str"),
        "livePipelineName": _SERIALIZER.url("live_pipeline_name", live_pipeline_name, "str"),
    }
...
class LivePipelinesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.videoanalyzer.models.LivePipeline]
    ...
    def _activate_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, account_name: str, live_pipeline_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_activate(
        ...
        if cont_token is None:
            raw_result = self._activate_initial(  # type: ignore
                resource_group_name=resource_group_name,
                account_name=account_name,
                live_pipeline_name=live_pipeline_name,
                api_version=api_version,
