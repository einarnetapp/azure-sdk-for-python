...
def build_list_request(
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.OperationalInsights/operations")
...
class Operations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.loganalytics.models.OperationListResult]
