...
class DataExportsOperations:
    ...
    async def delete(
        ...
        :type data_export_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ErrorResponse or None or the result of cls(response)
        :rtype: ~azure.mgmt.loganalytics.models.ErrorResponse or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", "2020-08-01"))  # type: Literal["2020-08-01"]
        cls = kwargs.pop("cls", None)  # type: ClsType[Optional[_models.ErrorResponse]]
