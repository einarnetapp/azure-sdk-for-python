...
class DataExport(ProxyResource):
    ...
    :ivar destination: destination properties. Required.
    ...
    _attribute_map = {
        ...
        "destination": {"key": "properties.destination", "type": "Destination"},
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword destination: destination properties. Required.
        :paramtype destination: ~azure.mgmt.loganalytics.models.Destination
...
class Destination(_serialization.Model):
    ...
    _attribute_map = {
        "resource_id": {"key": "resourceId", "type": "str"},
        "type": {"key": "type", "type": "str"},
        "event_hub_name": {"key": "metaData.eventHubName", "type": "str"},
    }

    def __init__(self, *, resource_id: str, event_hub_name: Optional[str] = None, **kwargs):
        """
        :keyword resource_id: The destination resource ID. This can be copied from the Properties entry
         of the destination resource in Azure. Required.
...
class LinkedStorageAccountsResource(ProxyResource):
    ...
    :ivar storage_account_ids: Linked storage accounts resources ids. Required.
    ...
    _validation = {
        ...
        "storage_account_ids": {"required": True},
    }
    ...
    def __init__(self, *, storage_account_ids: List[str], **kwargs):
        """
        :keyword storage_account_ids: Linked storage accounts resources ids. Required.
...
class LogAnalyticsQueryPackQuery(AzureResourceProperties):
    ...
    :ivar system_data: Read only system data.
    :vartype system_data: ~azure.mgmt.loganalytics.models.SystemData
    :ivar properties: Properties that define an Log Analytics QueryPack-Query resource. Required.
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "system_data": {"key": "systemData", "type": "SystemData"},
        "properties": {"key": "properties", "type": "LogAnalyticsQueryPackQueryProperties"},
    }

    def __init__(self, *, properties: "_models.LogAnalyticsQueryPackQueryProperties", **kwargs):
        """
        :keyword properties: Properties that define an Log Analytics QueryPack-Query resource.
         Required.
        :paramtype properties: ~azure.mgmt.loganalytics.models.LogAnalyticsQueryPackQueryProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
...
class LogAnalyticsQueryPackQueryProperties(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "related": {"key": "related", "type": "LogAnalyticsQueryPackQueryPropertiesRelated"},
        "tags": {"key": "tags", "type": "{[str]}"},
        "properties": {"key": "properties", "type": "object"},
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword display_name: Unique display name for your query within the Query Pack. Required.
        :paramtype display_name: str
        :keyword description: Description of the query.
        :paramtype description: str
        :keyword body: Body of the query. Required.
        :paramtype body: str
...
class Table(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar retention_in_days_as_default: True - Value originates from workspace retention in days,
     False - Customer specific. Known values are: "True" and "False".
    :vartype retention_in_days_as_default: str or
     ~azure.mgmt.loganalytics.models.RetentionInDaysAsDefault
    :ivar total_retention_in_days_as_default: True - Value originates from retention in days, False
     - Customer specific. Known values are: "True" and "False".
    :vartype total_retention_in_days_as_default: str or
     ~azure.mgmt.loganalytics.models.TotalRetentionInDaysAsDefault
    """
    ...
    _attribute_map = {
        ...
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
        "retention_in_days_as_default": {"key": "properties.retentionInDaysAsDefault", "type": "str"},
        "total_retention_in_days_as_default": {"key": "properties.totalRetentionInDaysAsDefault", "type": "str"},
    }
