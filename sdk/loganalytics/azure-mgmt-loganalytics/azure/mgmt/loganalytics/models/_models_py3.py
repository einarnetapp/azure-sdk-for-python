...
class Identity(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.loganalytics.models.IdentityTypeForCluster
    ...
    def __init__(
        self,
        *,
        type: Union[str, "_models.IdentityTypeForCluster"],
        ...
        **kwargs
        ...
        :keyword type: Type of managed service identity. Required. Known values are: "SystemAssigned",
         "UserAssigned", and "None".
        :paramtype type: str or ~azure.mgmt.loganalytics.models.IdentityTypeForCluster
