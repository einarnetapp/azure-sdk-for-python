...
class RetentionInDaysAsDefault(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class TotalRetentionInDaysAsDefault(str, Enum, metaclass=CaseInsensitiveEnumMeta):
