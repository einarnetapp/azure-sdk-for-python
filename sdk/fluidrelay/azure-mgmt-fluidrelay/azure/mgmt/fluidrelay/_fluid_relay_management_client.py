...
class FluidRelayManagementClient:
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2022-05-26". Note that overriding this
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.fluid_relay_operations = FluidRelayOperationsOperations(self._client, self._config, self._serialize, self._deserialize)
        self.fluid_relay_servers = FluidRelayServersOperations(self._client, self._config, self._serialize, self._deserialize)
        self.fluid_relay_containers = FluidRelayContainersOperations(self._client, self._config, self._serialize, self._deserialize)
