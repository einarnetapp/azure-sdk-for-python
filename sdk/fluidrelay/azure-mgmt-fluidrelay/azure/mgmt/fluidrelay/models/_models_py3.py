...
class CustomerManagedKeyEncryptionProperties(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        key_encryption_key_identity: Optional["CustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentity"] = None,
...
class CustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentity(msrest.serialization.Model):
    ...
    :ivar identity_type: Values can be SystemAssigned or UserAssigned. Possible values include:
    ...
    def __init__(
        self,
        *,
        identity_type: Optional[Union[str, "CmkIdentityType"]] = None,
        user_assigned_identity_resource_id: Optional[str] = None,
        **kwargs
    ):
        """
        :keyword identity_type: Values can be SystemAssigned or UserAssigned. Possible values include:
         "SystemAssigned", "UserAssigned".
...
class EncryptionProperties(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        customer_managed_key_encryption: Optional["CustomerManagedKeyEncryptionProperties"] = None,
        **kwargs
    ):
        """
...
class FluidRelayContainerList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["FluidRelayContainer"]] = None,
        **kwargs
    ):
        """
...
class FluidRelayServer(TrackedResource):
    ...
    :ivar storagesku: Sku of the storage associated with the resource. Possible values include:
     "standard", "basic".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword storagesku: Sku of the storage associated with the resource. Possible values include:
         "standard", "basic".
