...
from ...operations._fluid_relay_servers_operations import build_create_or_update_request, build_delete_request, build_get_keys_request, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_list_keys_request, build_regenerate_key_request, build_update_request
T = TypeVar('T')
...
class FluidRelayServersOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        api_version = kwargs.pop('api_version', "2022-05-26")  # type: str
    ...
    get_keys.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.FluidRelay/fluidRelayServers/{fluidRelayServerName}/getKeys"}  # type: ignore
