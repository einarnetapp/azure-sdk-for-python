...
class AccountForGet(TrackedResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super(AccountForGet, self).__init__(tags=tags, location=location, **kwargs)
...
class AccountForPut(TrackedResource):
    """An Azure Video Indexer account.
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype media_services: ~azure.mgmt.videoindexer.models.MediaServicesForPutRequest
        """
        super(AccountForPut, self).__init__(tags=tags, location=location, **kwargs)
        self.identity = identity
        self.system_data = None
        self.tenant_id = None
...
class AccountList(msrest.serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.videoindexer.models.AccountForGet]
    ...
    _attribute_map = {
        'value': {'key': 'value', 'type': '[AccountForGet]'},
