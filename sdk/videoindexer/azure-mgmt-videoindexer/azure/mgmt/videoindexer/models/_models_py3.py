...
class ClassicAccount(_serialization.Model):
...
class ClassicAccountMediaServices(_serialization.Model):
...
class ClassicAccountSlim(_serialization.Model):
    """An Azure Video Indexer classic account.
...
class MediaServicesForPatchRequest(_serialization.Model):
...
class MediaServicesForPutRequest(_serialization.Model):
    """The media services details.
    ...
    def __init__(self, *, resource_id: Optional[str] = None, user_assigned_identity: Optional[str] = None, **kwargs):
        """
...
class UserClassicAccountList(_serialization.Model):
