...
class Account(TrackedResource):
    ...
    :ivar provisioning_state: Gets the status of the account at the time the operation was called.
     Known values are: "Succeeded", "Failed", "Canceled", "Accepted", "Provisioning", "Deleting".
    ...
    def __init__(
        ...
        *,
        ...
        account_id: Optional[str] = "00000000-0000-0000-0000-000000000000",
        media_services: Optional["_models.MediaServicesForPutRequest"] = None,
        **kwargs
    ):
        """
        :keyword tags: A set of tags. Resource tags.
...
class AccountCheckNameAvailabilityParameters(msrest.serialization.Model):
    ...
    :vartype name: str
    :ivar type: Required. The type of resource, Microsoft.VideoIndexer/accounts. Known values are:
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype name: str
        :keyword type: Required. The type of resource, Microsoft.VideoIndexer/accounts. Known values
         are: "Microsoft.VideoIndexer/accounts".
...
class AccountPatch(Tags):
    ...
    def __init__(
        ...
        *,
        tags: Optional[Dict[str, str]] = None,
        identity: Optional["_models.ManagedServiceIdentity"] = None,
        media_services: Optional["_models.MediaServicesForPatchRequest"] = None,
        **kwargs
    ):
        """
        :keyword tags: A set of tags. Resource tags.
...
class CheckNameAvailabilityResult(msrest.serialization.Model):
    ...
    :ivar reason: Gets the reason that a Video Indexer account name could not be used. The Reason
     element is only returned if NameAvailable is false. Known values are: "AlreadyExists".
...
class ClassicAccount(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        media_services: Optional["_models.ClassicAccountMediaServices"] = None,
        **kwargs
    ):
        """
...
class GenerateAccessTokenParameters(msrest.serialization.Model):
    ...
    :ivar permission_type: Required. The requested permission. Known values are: "Contributor",
     "Reader".
    :vartype permission_type: str or ~azure.mgmt.videoindexer.models.PermissionType
    :ivar scope: Required. The requested media type. Known values are: "Video", "Account",
     "Project".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword permission_type: Required. The requested permission. Known values are: "Contributor",
         "Reader".
        :paramtype permission_type: str or ~azure.mgmt.videoindexer.models.PermissionType
        :keyword scope: Required. The requested media type. Known values are: "Video", "Account",
         "Project".
