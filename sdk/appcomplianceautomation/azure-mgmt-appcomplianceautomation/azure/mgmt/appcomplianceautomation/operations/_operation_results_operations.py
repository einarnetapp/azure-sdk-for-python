...
def build_get_request(operation_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.AppComplianceAutomation/operationResults/{operationId}")
...
class OperationResultsOperations:
    ...
    def _get_initial(self, operation_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        error_map = {
    ...
    _get_initial.metadata = {"url": "/providers/Microsoft.AppComplianceAutomation/operationResults/{operationId}"}  # type: ignore

    @distributed_trace
    def begin_get(self, operation_id: str, **kwargs: Any) -> LROPoller[None]:
    ...
    begin_get.metadata = {"url": "/providers/Microsoft.AppComplianceAutomation/operationResults/{operationId}"}  # type: ignore
