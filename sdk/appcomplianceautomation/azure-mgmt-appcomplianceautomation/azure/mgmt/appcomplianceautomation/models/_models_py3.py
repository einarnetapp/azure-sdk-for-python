...
class SnapshotDownloadProperties(_serialization.Model):
...
class SnapshotDownloadRequest(_serialization.Model):
    ...
    :ivar properties: Snapshot's download properties.
    :vartype properties: ~azure.mgmt.appcomplianceautomation.models.SnapshotDownloadProperties
    """

    _attribute_map = {
        "properties": {"key": "properties", "type": "SnapshotDownloadProperties"},
    }

    def __init__(self, *, properties: Optional["_models.SnapshotDownloadProperties"] = None, **kwargs):
        """
        :keyword properties: Snapshot's download properties.
        :paramtype properties: ~azure.mgmt.appcomplianceautomation.models.SnapshotDownloadProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
