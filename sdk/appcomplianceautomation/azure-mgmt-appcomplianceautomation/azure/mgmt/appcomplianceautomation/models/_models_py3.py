...
class Assessment(_serialization.Model):
    ...
    :ivar is_pass: Indicates whether all the resource(s) are compliant.
    :vartype is_pass: bool
...
class ComplianceReportItem(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype category_name: str
    :ivar control_id: The control Id.
    ...
    :ivar compliance_state: The compliance result's status.
    ...
    :ivar resource_id: The compliance result mapped resource Id.
    :vartype resource_id: str
    :ivar status_change_date: The compliance result last changed date. For unavailable date, set it
     as N/A.
    :vartype status_change_date: str
    """
...
class OverviewStatus(_serialization.Model):
    ...
    :ivar passed: The count of all passed full automation control.
    :vartype passed: int
    :ivar failed: The count of all failed full automation control.
    :vartype failed: int
    :ivar manual: The count of all manual control.
    :vartype manual: int
    """

    _attribute_map = {
        "passed": {"key": "passed", "type": "int"},
        "failed": {"key": "failed", "type": "int"},
        "manual": {"key": "manual", "type": "int"},
    }

    def __init__(
        self, *, passed: Optional[int] = None, failed: Optional[int] = None, manual: Optional[int] = None, **kwargs
    ):
        """
        :keyword passed: The count of all passed full automation control.
        :paramtype passed: int
        :keyword failed: The count of all failed full automation control.
        :paramtype failed: int
        :keyword manual: The count of all manual control.
        :paramtype manual: int
        """
        super().__init__(**kwargs)
        self.passed = passed
        self.failed = failed
...
class ReportProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar time_zone: Report collection trigger time's time zone. Required.
    ...
    :ivar provisioning_state: Azure lifecycle management. Known values are: "Succeeded", "Failed",
     "Cancelled", "Creating", "Deleting", and "Updating".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword time_zone: Report collection trigger time's time zone. Required.
