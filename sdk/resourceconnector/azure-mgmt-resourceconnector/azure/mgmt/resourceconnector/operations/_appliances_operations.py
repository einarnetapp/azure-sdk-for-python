...
def build_list_operations_request(**kwargs: Any) -> HttpRequest:
    ...
    api_version = kwargs.pop("api_version", _params.pop("api-version", "2022-10-27"))  # type: Literal["2022-10-27"]
...
class AppliancesOperations:
    ...
    def get_telemetry_config(self, **kwargs: Any) -> _models.ApplianceGetTelemetryConfigResult:
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.ApplianceGetTelemetryConfigResult]
    ...
    get_telemetry_config.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.ResourceConnector/telemetryconfig"}  # type: ignore
    ...
    def begin_create_or_update(
        ...
        :param resource_name: Appliances name. Required.
        :type resource_name: str
        :param parameters: Parameters supplied to create or update an Appliance. Is either a model type
    ...
    def list_keys(
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.ApplianceListKeysResults]
    ...
    list_keys.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ResourceConnector/appliances/{resourceName}/listkeys"}  # type: ignore
    ...
    def get_upgrade_graph(
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.UpgradeGraph]
