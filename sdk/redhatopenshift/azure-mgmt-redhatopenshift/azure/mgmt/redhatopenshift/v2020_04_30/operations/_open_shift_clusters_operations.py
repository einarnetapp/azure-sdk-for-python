...
def build_list_request(
    ...
    **kwargs: Any
    ...
    api_version = kwargs.pop('api_version', _params.pop('api-version', "2020-04-30"))  # type: str
...
def build_create_or_update_request_initial(
    ...
    resource_name: str,
    *,
    json: Optional[_models.OpenShiftCluster] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_update_request_initial(
    ...
    resource_name: str,
    *,
    json: Optional[_models.OpenShiftClusterUpdate] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
