...
from ...operations._subscription_operations import (
    ...
    build_cancel2023_request,
    build_cancel_request,
    build_enable2023_request,
...
class SubscriptionOperations:
    ...
    async def _cancel2023_initial(  # pylint: disable=inconsistent-return-statements
        self, subscription_id: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    @distributed_trace_async
    async def begin_cancel2023(self, subscription_id: str, **kwargs: Any) -> AsyncLROPoller[None]:
        """The operation to cancel a subscription.
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._cancel2023_initial(  # type: ignore
                subscription_id=subscription_id,
                api_version=api_version,
                cls=lambda x, y, z: x,
                headers=_headers,
    ...
    async def _enable2023_initial(  # pylint: disable=inconsistent-return-statements
        self, subscription_id: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    @distributed_trace_async
    async def begin_enable2023(self, subscription_id: str, **kwargs: Any) -> AsyncLROPoller[None]:
        """The operation to enable a subscription.
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._enable2023_initial(  # type: ignore
                subscription_id=subscription_id,
                api_version=api_version,
                cls=lambda x, y, z: x,
                headers=_headers,
