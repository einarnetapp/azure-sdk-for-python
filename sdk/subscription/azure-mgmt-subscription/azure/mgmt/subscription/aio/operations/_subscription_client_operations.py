...
from ...operations._subscription_client_operations import build_get_operation_results_request
...
class SubscriptionClientOperationsMixin(SubscriptionClientMixinABC):
    async def _get_operation_results_initial(  # pylint: disable=inconsistent-return-statements
    ...
    async def begin_get_operation_results(self, operation_id: str, **kwargs: Any) -> AsyncLROPoller[None]:
