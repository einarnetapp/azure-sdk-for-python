...
def build_get_operation_results_request(operation_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Subscription/operationresults/{operationId}")
...
class SubscriptionClientOperationsMixin(SubscriptionClientMixinABC):
    def _get_operation_results_initial(  # pylint: disable=inconsistent-return-statements
    ...
    _get_operation_results_initial.metadata = {
        "url": "/providers/Microsoft.Subscription/operationresults/{operationId}"
    }

    @distributed_trace
    def begin_get_operation_results(self, operation_id: str, **kwargs: Any) -> LROPoller[None]:
        """Get the status the given operationId.

        :param operation_id: operationId is the id returned by async operations. Required.
    ...
    begin_get_operation_results.metadata = {"url": "/providers/Microsoft.Subscription/operationresults/{operationId}"}
