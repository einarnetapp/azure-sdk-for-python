...
def build_create_request_initial(
    ...
    cluster_name: str,
    *,
    json: Optional[_models.ConnectedCluster] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_update_request(
    ...
    cluster_name: str,
    *,
    json: Optional[_models.ConnectedClusterPatch] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_list_cluster_user_credential_request(
    ...
    cluster_name: str,
    *,
    json: Optional[_models.ListClusterUserCredentialProperties] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
