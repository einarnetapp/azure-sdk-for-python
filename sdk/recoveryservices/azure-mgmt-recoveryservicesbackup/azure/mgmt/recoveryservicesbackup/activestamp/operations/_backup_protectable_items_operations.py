...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupProtectableItems")  # pylint: disable=line-too-long
...
class BackupProtectableItemsOperations(object):
    ...
    def list(
        ...
        skip_token: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.WorkloadProtectableItemResourceList"]:
