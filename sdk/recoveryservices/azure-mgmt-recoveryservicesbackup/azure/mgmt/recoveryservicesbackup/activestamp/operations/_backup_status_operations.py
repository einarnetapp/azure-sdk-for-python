...
def build_get_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.BackupStatusRequest] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/Subscriptions/{subscriptionId}/providers/Microsoft.RecoveryServices/locations/{azureRegion}/backupStatus")  # pylint: disable=line-too-long
