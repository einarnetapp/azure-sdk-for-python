...
def build_get_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.SecurityPinBase] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupSecurityPIN")  # pylint: disable=line-too-long
