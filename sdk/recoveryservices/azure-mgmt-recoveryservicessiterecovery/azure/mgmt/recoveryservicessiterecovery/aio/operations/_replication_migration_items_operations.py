...
from ...operations._replication_migration_items_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_replication_protection_containers_request, build_list_request, build_migrate_request_initial, build_pause_replication_request_initial, build_resume_replication_request_initial, build_resync_request_initial, build_test_migrate_cleanup_request_initial, build_test_migrate_request_initial, build_update_request_initial
T = TypeVar('T')
...
class ReplicationMigrationItemsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_pause_replication(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._pause_replication_initial(  # type: ignore
                fabric_name=fabric_name,
                protection_container_name=protection_container_name,
                migration_item_name=migration_item_name,
    ...
    async def begin_resume_replication(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._resume_replication_initial(  # type: ignore
                fabric_name=fabric_name,
                protection_container_name=protection_container_name,
                migration_item_name=migration_item_name,
