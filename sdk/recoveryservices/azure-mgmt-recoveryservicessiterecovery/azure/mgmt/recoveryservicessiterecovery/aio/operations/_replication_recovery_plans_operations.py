...
class ReplicationRecoveryPlansOperations:  # pylint: disable=too-many-public-methods
    ...
    def list(
        self,
        **kwargs: Any
    ) -> AsyncIterable[_models.RecoveryPlanCollection]:
        ...
        :return: An iterator like instance of either RecoveryPlanCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.RecoveryPlanCollection]
