...
from ...operations._migration_recovery_points_operations import build_get_request, build_list_by_replication_migration_items_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class MigrationRecoveryPointsOperations:
    """MigrationRecoveryPointsOperations async operations.
    ...
    def list_by_replication_migration_items(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.MigrationRecoveryPointCollection"]:
        ...
        :return: An iterator like instance of either MigrationRecoveryPointCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.MigrationRecoveryPointCollection]
