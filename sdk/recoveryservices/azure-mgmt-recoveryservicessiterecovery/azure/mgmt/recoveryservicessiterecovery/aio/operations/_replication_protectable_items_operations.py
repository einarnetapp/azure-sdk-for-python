...
from ...operations._replication_protectable_items_operations import build_get_request, build_list_by_replication_protection_containers_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class ReplicationProtectableItemsOperations:
    """ReplicationProtectableItemsOperations async operations.
    ...
    def list_by_replication_protection_containers(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.ProtectableItemCollection"]:
        ...
        :return: An iterator like instance of either ProtectableItemCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.ProtectableItemCollection]
