...
class ReplicationFabricsOperations:
    ...
    async def begin_check_consistency(self, fabric_name: str, **kwargs: Any) -> AsyncLROPoller[_models.Fabric]:
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._check_consistency_initial(  # type: ignore
                fabric_name=fabric_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
                headers=_headers,
    ...
    async def begin_reassociate_gateway(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._reassociate_gateway_initial(  # type: ignore
                fabric_name=fabric_name,
    ...
    async def begin_renew_certificate(
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._renew_certificate_initial(  # type: ignore
                fabric_name=fabric_name,
