...
class ReplicationProtectionClustersOperations:
    ...
    async def _repair_replication_initial(  # pylint: disable=inconsistent-return-statements
        self, fabric_name: str, protection_container_name: str, replication_protection_cluster_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_repair_replication(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._repair_replication_initial(  # type: ignore
                fabric_name=fabric_name,
                protection_container_name=protection_container_name,
                replication_protection_cluster_name=replication_protection_cluster_name,
                api_version=api_version,
    ...
    async def _unplanned_failover_initial(  # pylint: disable=inconsistent-return-statements
        self,
        fabric_name: str,
        protection_container_name: str,
        replication_protection_cluster_name: str,
    ...
    async def begin_unplanned_failover(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._unplanned_failover_initial(  # type: ignore
                fabric_name=fabric_name,
                protection_container_name=protection_container_name,
                replication_protection_cluster_name=replication_protection_cluster_name,
