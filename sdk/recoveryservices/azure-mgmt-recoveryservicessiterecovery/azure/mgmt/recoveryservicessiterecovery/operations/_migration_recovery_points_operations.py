...
def build_get_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationMigrationItems/{migrationItemName}/migrationRecoveryPoints/{migrationRecoveryPointName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceName": _SERIALIZER.url("resource_name", resource_name, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        ...
        "protectionContainerName": _SERIALIZER.url("protection_container_name", protection_container_name, 'str'),
        "migrationItemName": _SERIALIZER.url("migration_item_name", migration_item_name, 'str'),
        "migrationRecoveryPointName": _SERIALIZER.url("migration_recovery_point_name", migration_recovery_point_name, 'str'),
    }
...
class MigrationRecoveryPointsOperations(object):
    ...
    def list_by_replication_migration_items(
        ...
        migration_item_name: str,
        **kwargs: Any
    ) -> Iterable["_models.MigrationRecoveryPointCollection"]:
        ...
        :return: An iterator like instance of either MigrationRecoveryPointCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.MigrationRecoveryPointCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-04-01")  # type: str

        cls = kwargs.pop('cls', None)  # type: ClsType["_models.MigrationRecoveryPointCollection"]
        error_map = {
    ...
    list_by_replication_migration_items.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationMigrationItems/{migrationItemName}/migrationRecoveryPoints"}  # type: ignore
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.MigrationRecoveryPoint"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
