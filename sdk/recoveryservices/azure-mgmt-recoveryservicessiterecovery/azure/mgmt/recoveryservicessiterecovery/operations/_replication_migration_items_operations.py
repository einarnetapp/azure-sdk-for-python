...
def build_create_request_initial(
    ...
    migration_item_name: str,
    *,
    json: Optional[_models.EnableMigrationInput] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_update_request_initial(
    ...
    migration_item_name: str,
    *,
    json: Optional[_models.UpdateMigrationItemInput] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_migrate_request_initial(
    ...
    migration_item_name: str,
    *,
    json: Optional[_models.MigrateInput] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_pause_replication_request_initial(
    resource_name: str,
    resource_group_name: str,
    subscription_id: str,
    fabric_name: str,
    ...
    migration_item_name: str,
    *,
    json: Optional[_models.PauseReplicationInput] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationMigrationItems/{migrationItemName}/pauseReplication")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceName": _SERIALIZER.url("resource_name", resource_name, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_resume_replication_request_initial(
    resource_name: str,
    resource_group_name: str,
    subscription_id: str,
    fabric_name: str,
    ...
    migration_item_name: str,
    *,
    json: Optional[_models.ResumeReplicationInput] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationMigrationItems/{migrationItemName}/resumeReplication")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceName": _SERIALIZER.url("resource_name", resource_name, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_resync_request_initial(
    ...
    migration_item_name: str,
    *,
    json: Optional[_models.ResyncInput] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_test_migrate_request_initial(
    ...
    migration_item_name: str,
    *,
    json: Optional[_models.TestMigrateInput] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_test_migrate_cleanup_request_initial(
    ...
    migration_item_name: str,
    *,
    json: Optional[_models.TestMigrateCleanupInput] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class ReplicationMigrationItemsOperations:  # pylint: disable=too-many-public-methods
    ...
    def _pause_replication_initial(
        ...
        **kwargs: Any
        ...
        request = build_pause_replication_request_initial(
            resource_name=self._config.resource_name,
            resource_group_name=self._config.resource_group_name,
            subscription_id=self._config.subscription_id,
            fabric_name=fabric_name,
    ...
    _pause_replication_initial.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationMigrationItems/{migrationItemName}/pauseReplication"}  # type: ignore
    ...
    def begin_pause_replication(
        ...
        **kwargs: Any
        ...
        :param migration_item_name: Migration item name.
        :type migration_item_name: str
        :param pause_replication_input: Pause replication input.
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._pause_replication_initial(  # type: ignore
                fabric_name=fabric_name,
                protection_container_name=protection_container_name,
                migration_item_name=migration_item_name,
    ...
    begin_pause_replication.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationMigrationItems/{migrationItemName}/pauseReplication"}  # type: ignore
    ...
    def _resume_replication_initial(
        ...
        **kwargs: Any
        ...
        request = build_resume_replication_request_initial(
            resource_name=self._config.resource_name,
            resource_group_name=self._config.resource_group_name,
            subscription_id=self._config.subscription_id,
            fabric_name=fabric_name,
    ...
    def begin_resume_replication(
        ...
        **kwargs: Any
        ...
        :param migration_item_name: Migration item name.
        :type migration_item_name: str
        :param resume_replication_input: Resume replication input.
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._resume_replication_initial(  # type: ignore
                fabric_name=fabric_name,
                protection_container_name=protection_container_name,
                migration_item_name=migration_item_name,
    ...
    begin_resume_replication.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationMigrationItems/{migrationItemName}/resumeReplication"}  # type: ignore
