    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "replicationProtectionClusterName": _SERIALIZER.url(
            "replication_protection_cluster_name", replication_protection_cluster_name, "str"
        ),
    }
...
class ReplicationProtectionClustersOperations:
    ...
    def list_by_replication_protection_containers(
        ...
        def get_next(next_link=None):
            ...
            if response.status_code not in [200]:
                ...
                error = self._deserialize.failsafe_deserialize(_models.ServiceDefaultError, pipeline_response)
    ...
    list_by_replication_protection_containers.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectionClusters"
    }
    ...
    def get(
        ...
        deserialized = self._deserialize("ReplicationProtectionCluster", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectionClusters/{replicationProtectionClusterName}"
    }
    ...
    def _create_initial(
        ...
        protection_container_name: str,
        replication_protection_cluster_name: str,
        replication_protection_cluster: Union[_models.ReplicationProtectionCluster, IO],
        **kwargs: Any
    ) -> Optional[_models.ReplicationProtectionCluster]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.ReplicationProtectionCluster]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json"
        _json = None
        _content = None
        if isinstance(replication_protection_cluster, (IO, bytes)):
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param protection_container_name: Protection container name. Required.
        :type protection_container_name: str
        :param replication_protection_cluster_name: A name for the replication protection cluster.
         Required.
        :type replication_protection_cluster_name: str
    ...
    def begin_create(
        ...
        protection_container_name: str,
        replication_protection_cluster_name: str,
        replication_protection_cluster: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.ReplicationProtectionCluster]:
        ...
        :type replication_protection_cluster_name: str
        :param replication_protection_cluster: Create replication protection cluster Input. Required.
        :type replication_protection_cluster: IO
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param replication_protection_cluster: Create replication protection cluster Input. Is either a
         ReplicationProtectionCluster type or a IO type. Required.
        :type replication_protection_cluster:
         ~azure.mgmt.recoveryservicessiterecovery.models.ReplicationProtectionCluster or IO
    ...
    def get_operation_results(
        ...
        **kwargs: Any
        ...
        request = build_get_operation_results_request(
            ...
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.get_operation_results.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    get_operation_results.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectionClusters/{replicationProtectionClusterName}/operationresults/{jobId}"
    }

    def _repair_replication_initial(  # pylint: disable=inconsistent-return-statements
        self, fabric_name: str, protection_container_name: str, replication_protection_cluster_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    _repair_replication_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectionClusters/{replicationProtectionClusterName}/repairReplication"
    }
    ...
    def begin_repair_replication(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._repair_replication_initial(  # type: ignore
                fabric_name=fabric_name,
                protection_container_name=protection_container_name,
                replication_protection_cluster_name=replication_protection_cluster_name,
                api_version=api_version,
    ...
    def _unplanned_failover_initial(  # pylint: disable=inconsistent-return-statements
        self,
        fabric_name: str,
        protection_container_name: str,
        replication_protection_cluster_name: str,
        failover_input: Union[_models.ClusterUnplannedFailoverInput, IO],
        **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    _unplanned_failover_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectionClusters/{replicationProtectionClusterName}/unplannedFailover"
    }
    ...
    def begin_unplanned_failover(
        ...
        **kwargs: Any
        ...
        :param replication_protection_cluster_name: Replication protection cluster name. Required.
        :type replication_protection_cluster_name: str
        :param failover_input: Failover input. Is either a ClusterUnplannedFailoverInput type or a IO
         type. Required.
        :type failover_input:
         ~azure.mgmt.recoveryservicessiterecovery.models.ClusterUnplannedFailoverInput or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._unplanned_failover_initial(  # type: ignore
                fabric_name=fabric_name,
                protection_container_name=protection_container_name,
                replication_protection_cluster_name=replication_protection_cluster_name,
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationProtectionClusters"
    }
