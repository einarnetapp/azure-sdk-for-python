...
class CrossRegionRestore(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class StandardTierStorageRedundancy(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
