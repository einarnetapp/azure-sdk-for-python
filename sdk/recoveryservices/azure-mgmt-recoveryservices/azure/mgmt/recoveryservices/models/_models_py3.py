...
class VaultProperties(msrest.serialization.Model):
    ...
    :ivar redundancy_settings: The redundancy settings of the resource.
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword redundancy_settings: The redundancy settings of the resource.
...
class VaultPropertiesRedundancySettings(msrest.serialization.Model):
    ...
    :ivar standard_tier_storage_redundancy: The storage redundancy setting for the Vault. Possible
     values include: "GeoRedundant", "LocallyRedundant", "ZoneRedundant".
    :vartype standard_tier_storage_redundancy: str or
     ~azure.mgmt.recoveryservices.models.StandardTierStorageRedundancy
    :ivar cross_region_restore: Showing whether cross region restore is enabled or not. Possible
     values include: "Enabled", "Disabled".
