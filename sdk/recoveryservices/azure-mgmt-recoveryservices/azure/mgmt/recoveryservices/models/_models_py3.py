...
class RecoveryServicesResource(_serialization.Model):
    """ARM Resource.
...
class PatchTrackedResource(RecoveryServicesResource):
...
class RecoveryServicesTrackedResource(RecoveryServicesResource):
    """Tracked resource with location.
...
class Vault(RecoveryServicesTrackedResource):
...
class VaultExtendedInfoResource(RecoveryServicesResource):
