...
def build_get_by_resource_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{resourceUri}/providers/Microsoft.ResourceHealth/childAvailabilityStatuses/current")
...
class ChildAvailabilityStatusesOperations(object):
    """ChildAvailabilityStatusesOperations operations.
