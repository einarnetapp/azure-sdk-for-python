...
class VirtualMachine(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype inventory_item_id: str
    :ivar public_key: Gets or sets the Public Key provided by the client for enabling guest
     management.
    :vartype public_key: str
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs
        ...
        :paramtype inventory_item_id: str
        :keyword public_key: Gets or sets the Public Key provided by the client for enabling guest
         management.
        :paramtype public_key: str
