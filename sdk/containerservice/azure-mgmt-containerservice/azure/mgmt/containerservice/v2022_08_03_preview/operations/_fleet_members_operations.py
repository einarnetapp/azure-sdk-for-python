...
class FleetMembersOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either FleetMember or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2022_08_03_preview.models.FleetMember]
    ...
    def list_by_fleet(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2022_08_03_preview.models.FleetMember]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
