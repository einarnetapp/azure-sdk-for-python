...
class ContainerServiceClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.containerservice.v2022_08_03_preview.aio.operations.Operations
    :ivar managed_clusters: ManagedClustersOperations operations
    :vartype managed_clusters:
     azure.mgmt.containerservice.v2022_08_03_preview.aio.operations.ManagedClustersOperations
    :ivar maintenance_configurations: MaintenanceConfigurationsOperations operations
    :vartype maintenance_configurations:
     azure.mgmt.containerservice.v2022_08_03_preview.aio.operations.MaintenanceConfigurationsOperations
    :ivar agent_pools: AgentPoolsOperations operations
    :vartype agent_pools:
     azure.mgmt.containerservice.v2022_08_03_preview.aio.operations.AgentPoolsOperations
    :ivar private_endpoint_connections: PrivateEndpointConnectionsOperations operations
    :vartype private_endpoint_connections:
     azure.mgmt.containerservice.v2022_08_03_preview.aio.operations.PrivateEndpointConnectionsOperations
    :ivar private_link_resources: PrivateLinkResourcesOperations operations
    :vartype private_link_resources:
     azure.mgmt.containerservice.v2022_08_03_preview.aio.operations.PrivateLinkResourcesOperations
    ...
    :vartype resolve_private_link_service_id:
     azure.mgmt.containerservice.v2022_08_03_preview.aio.operations.ResolvePrivateLinkServiceIdOperations
    :ivar snapshots: SnapshotsOperations operations
    :vartype snapshots:
     azure.mgmt.containerservice.v2022_08_03_preview.aio.operations.SnapshotsOperations
    :ivar managed_cluster_snapshots: ManagedClusterSnapshotsOperations operations
    :vartype managed_cluster_snapshots:
     azure.mgmt.containerservice.v2022_08_03_preview.aio.operations.ManagedClusterSnapshotsOperations
    :ivar trusted_access_roles: TrustedAccessRolesOperations operations
    :vartype trusted_access_roles:
     azure.mgmt.containerservice.v2022_08_03_preview.aio.operations.TrustedAccessRolesOperations
    :ivar trusted_access_role_bindings: TrustedAccessRoleBindingsOperations operations
    :vartype trusted_access_role_bindings:
     azure.mgmt.containerservice.v2022_08_03_preview.aio.operations.TrustedAccessRoleBindingsOperations
    :ivar fleets: FleetsOperations operations
    :vartype fleets:
     azure.mgmt.containerservice.v2022_08_03_preview.aio.operations.FleetsOperations
    :ivar fleet_members: FleetMembersOperations operations
    :vartype fleet_members:
     azure.mgmt.containerservice.v2022_08_03_preview.aio.operations.FleetMembersOperations
    :ivar container_services: ContainerServicesOperations operations
    :vartype container_services:
     azure.mgmt.containerservice.v2022_08_03_preview.aio.operations.ContainerServicesOperations
