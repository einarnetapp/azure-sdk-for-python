...
from ...operations._container_services_operations import build_list_orchestrators_request
...
class ContainerServicesOperations:
    ...
    async def list_orchestrators(
        ...
        :type location: str
        :param resource_type: The resource type for which the OS options or list of orchestrators needs
         to be returned. Default value is None.
        :type resource_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: OrchestratorVersionProfileListResult or the result of cls(response)
        :rtype:
         ~azure.mgmt.containerservice.v2022_08_03_preview.models.OrchestratorVersionProfileListResult
