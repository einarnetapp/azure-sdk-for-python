...
class ManagedCluster(TrackedResource):
    ...
    :ivar auto_reconcile_profile: Auto reconcile profile for the managed cluster.
    :vartype auto_reconcile_profile:
     ~azure.mgmt.containerservice.v2022_05_02_preview.models.ManagedClusterAutoReconcileProfile
    """
    ...
    _attribute_map = {
        ...
        'auto_reconcile_profile': {'key': 'properties.autoReconcileProfile', 'type': 'ManagedClusterAutoReconcileProfile'},
    }
    ...
    def __init__(
        ...
        *,
        ...
        auto_reconcile_profile: Optional["ManagedClusterAutoReconcileProfile"] = None,
        **kwargs
    ):
        """
        :keyword tags: A set of tags. Resource tags.
        ...
        :paramtype public_network_access: str or
         ~azure.mgmt.containerservice.v2022_05_02_preview.models.PublicNetworkAccess
        :keyword auto_reconcile_profile: Auto reconcile profile for the managed cluster.
        :paramtype auto_reconcile_profile:
         ~azure.mgmt.containerservice.v2022_05_02_preview.models.ManagedClusterAutoReconcileProfile
        """
        ...
        self.auto_reconcile_profile = auto_reconcile_profile
...
class ManagedClusterAutoReconcileProfile(msrest.serialization.Model):
    """Auto reconciliation settings for the managed cluster.

    :ivar disable: Whether a client wants to disable the auto managed cluster reconciliation. The
     default value is false.
    :vartype disable: bool
    :ivar max_retry_count: The maximum count for reconciliation. The default value is 3.
    :vartype max_retry_count: int
    :ivar max_retry_timeout: The maximum duration in minutes for reconciliation. The default value
     is 200.
    :vartype max_retry_timeout: int
    """

    _validation = {
        'max_retry_count': {'maximum': 10, 'minimum': 1},
        'max_retry_timeout': {'maximum': 1000, 'minimum': 1},
    }

    _attribute_map = {
        'disable': {'key': 'disable', 'type': 'bool'},
        'max_retry_count': {'key': 'MaxRetryCount', 'type': 'int'},
        'max_retry_timeout': {'key': 'MaxRetryTimeout', 'type': 'int'},
    }
    ...
    def __init__(
        ...
        *,
        ...
        max_retry_timeout: Optional[int] = 200,
        **kwargs
    ):
        """
        :keyword disable: Whether a client wants to disable the auto managed cluster reconciliation.
         The default value is false.
        :paramtype disable: bool
        :keyword max_retry_count: The maximum count for reconciliation. The default value is 3.
        :paramtype max_retry_count: int
        :keyword max_retry_timeout: The maximum duration in minutes for reconciliation. The default
         value is 200.
        :paramtype max_retry_timeout: int
        """
        super(ManagedClusterAutoReconcileProfile, self).__init__(**kwargs)
...
class ManagedClusterSecurityProfile(msrest.serialization.Model):
    ...
    :vartype azure_defender:
     ~azure.mgmt.containerservice.v2022_05_02_preview.models.ManagedClusterSecurityProfileAzureDefender
