...
class ContainerServiceClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :ivar guardrails_versions: GuardrailsVersionsOperations operations
    :vartype guardrails_versions:
     azure.mgmt.containerservice.v2022_08_02_preview.aio.operations.GuardrailsVersionsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.guardrails_versions = GuardrailsVersionsOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
