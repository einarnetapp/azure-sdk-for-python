...
class SnapshotsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_08_02_preview.models.Snapshot]
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The snapshot to create or update. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.containerservice.v2022_08_02_preview.models.Snapshot or IO
