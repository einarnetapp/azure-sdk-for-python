...
class ManagedClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerservice.v2022_08_01.aio.ContainerServiceClient`'s
    ...
    async def get_os_options(
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_08_01.models.OSOptionProfile
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ManagedCluster"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_08_01.models.ManagedCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_upgrade_profile(
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_08_01.models.ManagedClusterUpgradeProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    async def get_access_profile(
        ...
        **WARNING**\ : This API will be deprecated. Instead use `ListClusterUserCredentials
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_08_01.models.ManagedClusterAccessProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    async def list_cluster_admin_credentials(
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_08_01.models.CredentialResults
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    async def list_cluster_user_credentials(
        ...
        **kwargs: Any
        ...
        :type format: str or ~azure.mgmt.containerservice.v2022_08_01.models.Format
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CredentialResults or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2022_08_01.models.CredentialResults
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.ManagedCluster:
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_08_01.models.ManagedCluster
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_08_01.models.ManagedCluster
        ...
        :return: An instance of AsyncLROPoller that returns either ManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2022_08_01.models.ManagedCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        :param parameters: The managed cluster to create or update. Is either a model type or a IO
         type. Required.
        :type parameters: ~azure.mgmt.containerservice.v2022_08_01.models.ManagedCluster or IO
    ...
    async def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_08_01.models.TagsObject
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update_tags(
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_08_01.models.TagsObject or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_reset_service_principal_profile(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2022_08_01.models.ManagedClusterServicePrincipalProfile or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_reset_aad_profile(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_08_01.models.ManagedClusterAADProfile
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_reset_aad_profile(
        ...
        **kwargs: Any
        ...
        :param parameters: The AAD profile to set on the Managed Cluster. Is either a model type or a
         IO type. Required.
        :type parameters: ~azure.mgmt.containerservice.v2022_08_01.models.ManagedClusterAADProfile or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
    ...
    async def begin_run_command(
        ...
        **kwargs: Any
        ...
        :type request_payload: ~azure.mgmt.containerservice.v2022_08_01.models.RunCommandRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either RunCommandResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2022_08_01.models.RunCommandResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_run_command(
        ...
        **kwargs: Any
        ...
        :type request_payload: ~azure.mgmt.containerservice.v2022_08_01.models.RunCommandRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def get_command_result(
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_08_01.models.RunCommandResult or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def list_outbound_network_dependencies_endpoints(
        ...
        :return: An iterator like instance of either OutboundEnvironmentEndpoint or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_08_01.models.OutboundEnvironmentEndpoint]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
