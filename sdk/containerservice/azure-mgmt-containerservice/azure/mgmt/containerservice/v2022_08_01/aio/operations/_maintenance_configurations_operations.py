...
class MaintenanceConfigurationsOperations:
    ...
    def list_by_managed_cluster(
        ...
        :return: An iterator like instance of either MaintenanceConfiguration or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_08_01.models.MaintenanceConfiguration]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_08_01.models.MaintenanceConfiguration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_08_01.models.MaintenanceConfiguration
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The maintenance configuration to create or update. Is either a model type or
         a IO type. Required.
        :type parameters: ~azure.mgmt.containerservice.v2022_08_01.models.MaintenanceConfiguration or
         IO
