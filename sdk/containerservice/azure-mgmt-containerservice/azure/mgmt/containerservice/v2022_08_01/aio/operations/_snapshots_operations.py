...
class SnapshotsOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.Snapshot"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_08_01.models.Snapshot]
    ...
    async def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.Snapshot:
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_08_01.models.Snapshot
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_08_01.models.Snapshot
    ...
    async def create_or_update(
        ...
        :param parameters: The snapshot to create or update. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.containerservice.v2022_08_01.models.Snapshot or IO
