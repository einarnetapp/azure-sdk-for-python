...
class Fleet(TrackedResource):
    ...
    _attribute_map = {
        ...
        'etag': {'key': 'etag', 'type': 'str'},
        'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'},
        'dns_prefix': {'key': 'properties.hubProfile.dnsPrefix', 'type': 'str'},
        'fqdn': {'key': 'properties.hubProfile.fqdn', 'type': 'str'},
        'kubernetes_version': {'key': 'properties.hubProfile.kubernetesVersion', 'type': 'str'},
    }
...
class FleetMember(AzureEntityResource):
    ...
    :ivar provisioning_state: The provisioning state of the last accepted operation. Known values
     are: "Succeeded", "Failed", "Canceled", "Joining", "Leaving".
    :vartype provisioning_state: str or
