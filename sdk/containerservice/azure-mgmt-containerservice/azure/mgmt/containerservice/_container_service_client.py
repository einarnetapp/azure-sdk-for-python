...
class ContainerServiceClient(MultiApiClientMixin, _SDKClient):
    ...
    def guardrails_versions(self):
        """Instance depends on the API version:
           ...
           * 2022-08-02-preview: :class:`GuardrailsVersionsOperations<azure.mgmt.containerservice.v2022_08_02_preview.operations.GuardrailsVersionsOperations>`
        """
        api_version = self._get_api_version('guardrails_versions')
        if api_version == '2022-08-02-preview':
            from .v2022_08_02_preview.operations import GuardrailsVersionsOperations as OperationClass
        else:
