...
class ContainerServiceClient(MultiApiClientMixin, _SDKClient):
    ...
    LATEST_PROFILE = ProfileDefinition({
        _PROFILE_TAG: {
            ...
            'fleet_members': '2022-06-02-preview',
            'fleets': '2022-06-02-preview',
            'managed_cluster_snapshots': '2022-06-02-preview',
            'open_shift_managed_clusters': '2019-04-30',
            'trusted_access_role_bindings': '2022-06-02-preview',
            'trusted_access_roles': '2022-06-02-preview',
        }},
        _PROFILE_TAG + " latest"
    )
