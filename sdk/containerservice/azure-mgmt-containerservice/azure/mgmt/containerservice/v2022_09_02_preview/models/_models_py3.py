...
class FleetHubProfile(_serialization.Model):
    ...
    :ivar dns_prefix: DNS prefix used to create the FQDN for the Fleet hub. Required.
    :vartype dns_prefix: str
    ...
    def __init__(self, *, dns_prefix: str, **kwargs):
        """
        :keyword dns_prefix: DNS prefix used to create the FQDN for the Fleet hub. Required.
        :paramtype dns_prefix: str
        """
        super().__init__(**kwargs)
        self.dns_prefix = dns_prefix
