...
class ManagedCluster(TrackedResource):
    ...
    :ivar workload_auto_scaler_profile: Configuration of Kubernetes workload auto scalers.
    :vartype workload_auto_scaler_profile:
     ~azure.mgmt.containerservice.v2022_03_02_preview.models.ManagedClusterWorkloadAutoScalerProfile
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype public_network_access: str or
         ~azure.mgmt.containerservice.v2022_03_02_preview.models.PublicNetworkAccess
        :keyword workload_auto_scaler_profile: Configuration of Kubernetes workload auto scalers.
...
class ManagedClusterWorkloadAutoScalerProfile(msrest.serialization.Model):
    ...
    :ivar keda: KEDA auto scaler configuration.
    :vartype keda:
     ~azure.mgmt.containerservice.v2022_03_02_preview.models.WorkloadAutoScalerKedaConfiguration
    """

    _attribute_map = {
        'keda': {'key': 'keda', 'type': 'WorkloadAutoScalerKedaConfiguration'},
    }

    def __init__(
        self,
        *,
        keda: Optional["WorkloadAutoScalerKedaConfiguration"] = None,
        **kwargs
    ):
        """
        :keyword keda: KEDA auto scaler configuration.
        :paramtype keda:
         ~azure.mgmt.containerservice.v2022_03_02_preview.models.WorkloadAutoScalerKedaConfiguration
        """
...
class WorkloadAutoScalerKedaConfiguration(msrest.serialization.Model):
    """KEDA auto scaler configuration.

    All required parameters must be populated in order to send to Azure.

    :ivar enabled: Required. Whether KEDA is enabled.
    :vartype enabled: bool
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword enabled: Required. Whether KEDA is enabled.
        :paramtype enabled: bool
        """
        super(WorkloadAutoScalerKedaConfiguration, self).__init__(**kwargs)
        self.enabled = enabled
