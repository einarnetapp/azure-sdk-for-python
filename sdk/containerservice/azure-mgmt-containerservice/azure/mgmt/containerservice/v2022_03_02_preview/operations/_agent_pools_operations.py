...
def build_delete_request_initial(
    ...
    agent_pool_name: str,
    *,
    no_poddisruptionbudget: Optional[bool] = None,
    **kwargs: Any
) -> HttpRequest:
    api_version = "2022-03-02-preview"
    accept = "application/json"
    ...
    query_parameters = kwargs.pop("params", {})  # type: Dict[str, Any]
    query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
    if no_poddisruptionbudget is not None:
        query_parameters['no-poddisruptionbudget'] = _SERIALIZER.query("no_poddisruptionbudget", no_poddisruptionbudget, 'bool')
...
class AgentPoolsOperations(object):
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2022_03_02_preview.models.AgentPoolListResult]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_03_02_preview.models.AgentPool
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_03_02_preview.models.AgentPool
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2022_03_02_preview.models.AgentPool]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def _delete_initial(
        ...
        **kwargs: Any
        ...
        request = build_delete_request_initial(
            ...
            resource_name=resource_name,
            agent_pool_name=agent_pool_name,
            no_poddisruptionbudget=no_poddisruptionbudget,
    ...
    def begin_delete(
        ...
        **kwargs: Any
        ...
        :param agent_pool_name: The name of the agent pool.
        :type agent_pool_name: str
        :param no_poddisruptionbudget: no-poddisruptionbudget=true to delete those pods on a node
         without considering Pod Disruption Budget.
        :type no_poddisruptionbudget: bool
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
    ...
    def get_upgrade_profile(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_03_02_preview.models.AgentPoolUpgradeProfile
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_available_agent_pool_versions(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_03_02_preview.models.AgentPoolAvailableVersions
        :raises: ~azure.core.exceptions.HttpResponseError
        """
