...
class AgentPoolsOperations:
    ...
    def list(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> AsyncIterable["_models.AgentPool"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_03_02_preview.models.AgentPool]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The agent pool to create or update. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.containerservice.v2022_03_02_preview.models.AgentPool or IO
