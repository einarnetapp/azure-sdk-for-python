...
class MaintenanceConfigurationsOperations:
    ...
    def list_by_managed_cluster(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either MaintenanceConfigurationListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_05_01.models.MaintenanceConfigurationListResult]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_05_01.models.MaintenanceConfiguration
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_05_01.models.MaintenanceConfiguration
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MaintenanceConfiguration, or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2022_05_01.models.MaintenanceConfiguration
        :raises: ~azure.core.exceptions.HttpResponseError
