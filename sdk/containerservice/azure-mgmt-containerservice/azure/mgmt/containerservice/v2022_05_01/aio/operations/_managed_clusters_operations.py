...
class ManagedClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    :type models: ~azure.mgmt.containerservice.v2022_05_01.models
    ...
    async def get_os_options(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_05_01.models.OSOptionProfile
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ManagedClusterListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_05_01.models.ManagedClusterListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-05-01")  # type: str
    ...
    async def get_upgrade_profile(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_05_01.models.ManagedClusterUpgradeProfile
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_access_profile(
        ...
        **WARNING**\ : This API will be deprecated. Instead use `ListClusterUserCredentials
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_05_01.models.ManagedClusterAccessProfile
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def list_cluster_admin_credentials(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_05_01.models.CredentialResults
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def list_cluster_user_credentials(
        ...
        **kwargs: Any
        ...
        :type format: str or ~azure.mgmt.containerservice.v2022_05_01.models.Format
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CredentialResults, or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2022_05_01.models.CredentialResults
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_05_01.models.ManagedCluster
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_05_01.models.ManagedCluster
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either ManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2022_05_01.models.ManagedCluster]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-05-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    async def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_05_01.models.TagsObject
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
    ...
    async def begin_reset_aad_profile(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_05_01.models.ManagedClusterAADProfile
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
    ...
    async def begin_run_command(
        ...
        **kwargs: Any
        ...
        :type request_payload: ~azure.mgmt.containerservice.v2022_05_01.models.RunCommandRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
        ...
        :return: An instance of AsyncLROPoller that returns either RunCommandResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2022_05_01.models.RunCommandResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-05-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    async def get_command_result(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_05_01.models.RunCommandResult or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.RunCommandResult"]]
        error_map = {
    ...
    def list_outbound_network_dependencies_endpoints(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_05_01.models.OutboundEnvironmentEndpointCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-05-01")  # type: str
