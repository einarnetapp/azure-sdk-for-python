...
class FleetMembersOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_10_02_preview.models.FleetMember
        ...
        :return: An instance of AsyncLROPoller that returns either FleetMember or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2022_10_02_preview.models.FleetMember]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The Fleet member to create or update. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.containerservice.v2022_10_02_preview.models.FleetMember or IO
        :param if_match: Omit this value to always overwrite the current resource. Specify the
         last-seen ETag value to prevent accidentally overwriting concurrent changes. Default value is
         None.
        :type if_match: str
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_10_02_preview.models.FleetMember
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def list_by_fleet(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_10_02_preview.models.FleetMember]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
