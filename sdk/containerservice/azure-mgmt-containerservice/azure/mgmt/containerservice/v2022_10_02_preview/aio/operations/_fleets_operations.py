...
class FleetsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_10_02_preview.models.Fleet
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2022_10_02_preview.models.Fleet]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The Fleet to create or update. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.containerservice.v2022_10_02_preview.models.Fleet or IO
        :param if_match: Omit this value to always overwrite the current resource. Specify the
         last-seen ETag value to prevent accidentally overwriting concurrent changes. Default value is
         None.
        :type if_match: str
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_10_02_preview.models.FleetPatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Fleet or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2022_10_02_preview.models.Fleet
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param parameters: The properties of a Fleet to update. Is either a model type or a IO type.
         Default value is None.
        :type parameters: ~azure.mgmt.containerservice.v2022_10_02_preview.models.FleetPatch or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.Fleet"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_10_02_preview.models.Fleet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def list_credentials(
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_10_02_preview.models.FleetCredentialResults
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
