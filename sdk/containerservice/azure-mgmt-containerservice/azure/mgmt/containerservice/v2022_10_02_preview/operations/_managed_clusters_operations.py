...
def build_get_os_options_request(
    ...
    )  # type: Literal["2022-10-02-preview"]
...
class ManagedClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    def _abort_latest_operation_initial(
        self, resource_group_name: str, resource_name: str, **kwargs: Any
    ) -> Optional[_models.ManagedCluster]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[Optional[_models.ManagedCluster]]
    ...
    _abort_latest_operation_initial.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedclusters/{resourceName}/abort"}  # type: ignore
    ...
    begin_abort_latest_operation.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedclusters/{resourceName}/abort"}  # type: ignore
