...
class ArtifactGenerationProperties(_serialization.Model):
    ...
    :ivar manifest_generation_mode: The mode of generation to be used for generating Dockerfiles.
     Known values are: "enabled" and "disabled".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword manifest_generation_mode: The mode of generation to be used for generating
         Dockerfiles. Known values are: "enabled" and "disabled".
...
class GitHubOAuthCallRequest(_serialization.Model):
    ...
    def __init__(self, *, redirect_url: Optional[str] = None, **kwargs):
        """
...
class GitHubOAuthInfoResponse(_serialization.Model):
    ...
    def __init__(self, *, auth_url: Optional[str] = None, token: Optional[str] = None, **kwargs):
        """
...
class GitHubOAuthListResponse(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.GitHubOAuthResponse"]] = None, **kwargs):
        """
...
class GitHubWorkflowProfileOidcCredentials(_serialization.Model):
    ...
    def __init__(self, *, azure_client_id: Optional[str] = None, azure_tenant_id: Optional[str] = None, **kwargs):
        """
...
class Workflow(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    _attribute_map = {
        ...
        "artifact_generation_properties": {
            "key": "properties.githubWorkflowProfile.artifactGenerationProperties",
