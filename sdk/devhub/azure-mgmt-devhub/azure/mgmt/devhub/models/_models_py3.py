...
class GeneratePreviewArtifactsResponse(_serialization.Model):
    """Dockerfile and manifest artifacts generated as a preview are returned as a map<path
    string,content string>.

    :ivar path_to_file1_with_extension: An example generated file.
    :vartype path_to_file1_with_extension: str
    :ivar path_to_file2_with_extension: A second example file.
    :vartype path_to_file2_with_extension: str
    """

    _attribute_map = {
        "path_to_file1_with_extension": {"key": "path/to/file1\\.withExtension", "type": "str"},
        "path_to_file2_with_extension": {"key": "path/to/file2\\.withExtension", "type": "str"},
    }

    def __init__(
        self,
        *,
        path_to_file1_with_extension: Optional[str] = None,
        path_to_file2_with_extension: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword path_to_file1_with_extension: An example generated file.
        :paramtype path_to_file1_with_extension: str
        :keyword path_to_file2_with_extension: A second example file.
        :paramtype path_to_file2_with_extension: str
        """
        super().__init__(**kwargs)
        self.path_to_file1_with_extension = path_to_file1_with_extension
        self.path_to_file2_with_extension = path_to_file2_with_extension
...
class Workflow(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar location: The geo-location where the resource lives. Required.
    :vartype location: str
    :ivar artifact_generation_properties: Properties used for generating artifacts such as
    ...
    _attribute_map = {
        ...
        "artifact_generation_properties": {
            "key": "properties.artifactGenerationProperties",
        ...
        "namespace": {"key": "properties.githubWorkflowProfile.namespace", "type": "str"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
        :keyword artifact_generation_properties: Properties used for generating artifacts such as
         Dockerfiles and manifests.
