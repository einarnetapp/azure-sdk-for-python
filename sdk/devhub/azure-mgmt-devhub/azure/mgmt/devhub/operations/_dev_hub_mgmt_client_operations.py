...
def build_git_hub_o_auth_request(location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version: Literal["2022-09-16-preview"] = kwargs.pop(
        "api_version", _params.pop("api-version", "2022-09-16-preview")
    )
...
class DevHubMgmtClientOperationsMixin(DevHubMgmtClientMixinABC):
    ...
    def generate_preview_artifacts(
        self,
        location: str,
        parameters: Optional[_models.ArtifactGenerationProperties] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.GeneratePreviewArtifactsResponse:
        ...
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: GeneratePreviewArtifactsResponse or the result of cls(response)
        :rtype: ~azure.mgmt.devhub.models.GeneratePreviewArtifactsResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def generate_preview_artifacts(
        self, location: str, parameters: Optional[Union[_models.ArtifactGenerationProperties, IO]] = None, **kwargs: Any
    ) -> _models.GeneratePreviewArtifactsResponse:
        """Generate preview dockerfile and manifests.
        ...
        :param location: The name of Azure region. Required.
        :type location: str
        :param parameters: Is either a ArtifactGenerationProperties type or a IO type. Default value is
         None.
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.GeneratePreviewArtifactsResponse] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("GeneratePreviewArtifactsResponse", pipeline_response)
