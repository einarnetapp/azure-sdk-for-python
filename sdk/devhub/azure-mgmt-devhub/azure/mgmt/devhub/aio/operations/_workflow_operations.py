...
class WorkflowOperations:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.Workflow"]:
    ...
    async def get(self, resource_group_name: str, **kwargs: Any) -> _models.Workflow:
        """Gets a workflow.
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, **kwargs: Any) -> Optional[_models.DeleteWorkflowResponse]:
        """Deletes a workflow.
