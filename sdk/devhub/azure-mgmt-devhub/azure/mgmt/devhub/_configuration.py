...
class DevHubMgmtClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    :keyword api_version: Api Version. Default value is "2022-09-16-preview". Note that overriding
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        api_version: Literal["2022-09-16-preview"] = kwargs.pop("api_version", "2022-09-16-preview")
