...
class IotHubLocationDescription(msrest.serialization.Model):
    ...
    :vartype location: str
    :ivar role: Specific Role assigned to this location. Known values are: "primary", "secondary".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype location: str
        :keyword role: Specific Role assigned to this location. Known values are: "primary",
         "secondary".
