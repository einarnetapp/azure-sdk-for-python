...
class IotDpsClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    :keyword api_version: Api Version. Default value is "2022-08-07-preview". Note that overriding
    ...
    def __init__(self, credential: "TokenCredential", subscription_id: str, **kwargs: Any) -> None:
        ...
        api_version = kwargs.pop("api_version", "2022-08-07-preview")  # type: str
