...
def build_list_by_workspace_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/resourceReferences")  # pylint: disable=line-too-long
...
class ResourceReferencesOperations:
    ...
    def list_by_workspace(
        ...
        orderby: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable[_models.ResourceReferenceList]:
        ...
        :return: An iterator like instance of either ResourceReferenceList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.datacollaboration.models.ResourceReferenceList]
