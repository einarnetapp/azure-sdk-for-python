...
def build_list_by_subscription_request(
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DataCollaboration/workspaces"
    )
...
class WorkspacesOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, skip_token: Optional[str] = None, **kwargs: Any) -> Iterable["_models.Workspace"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.datacollaboration.models.Workspace]
    ...
    list_by_subscription.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.DataCollaboration/workspaces"
    }
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces"
    }
    ...
    def get(self, resource_group_name: str, workspace_name: str, **kwargs: Any) -> _models.Workspace:
        ...
        :rtype: ~azure.mgmt.datacollaboration.models.Workspace
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}"
    }
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param workspace_name: The name of the workspace. Required.
        :type workspace_name: str
        :param workspace: The workspace payload. Required.
        :type workspace: ~azure.mgmt.datacollaboration.models.Workspace
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.datacollaboration.models.Workspace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        :param workspace_name: The name of the workspace. Required.
        :type workspace_name: str
        :param workspace: The workspace payload. Is either a model type or a IO type. Required.
        :type workspace: ~azure.mgmt.datacollaboration.models.Workspace or IO
    ...
    def update(
        ...
        resource_group_name: str,
        workspace_name: str,
        workspace_update_parameters: _models.WorkspaceUpdateParameters,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.Workspace:
        ...
        :param workspace_name: The name of the workspace. Required.
        :type workspace_name: str
        :param workspace_update_parameters: The workspace update parameters. Required.
        :type workspace_update_parameters:
         ~azure.mgmt.datacollaboration.models.WorkspaceUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update(
        ...
        resource_group_name: str,
        workspace_name: str,
        workspace_update_parameters: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.Workspace:
        ...
        :type workspace_name: str
        :param workspace_update_parameters: The workspace update parameters. Required.
        :type workspace_update_parameters: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update(
        ...
        resource_group_name: str,
        workspace_name: str,
        workspace_update_parameters: Union[_models.WorkspaceUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.Workspace:
        """Patch a given workspace.
        ...
        :param workspace_name: The name of the workspace. Required.
        :type workspace_name: str
        :param workspace_update_parameters: The workspace update parameters. Is either a model type or
         a IO type. Required.
        :type workspace_update_parameters:
         ~azure.mgmt.datacollaboration.models.WorkspaceUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        _json = None
        _content = None
        if isinstance(workspace_update_parameters, (IO, bytes)):
            _content = workspace_update_parameters
        else:
            _json = self._serialize.body(workspace_update_parameters, "WorkspaceUpdateParameters")
