...
class DataAssetReferencesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`data_asset_references` attribute.
    """
    ...
    def list_by_proposal(
        ...
        skip_token: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.DataAssetReference"]:
        ...
        :return: An iterator like instance of either DataAssetReference or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.datacollaboration.models.DataAssetReference]
        ...
        cls: ClsType[_models.DataAssetReferenceList] = kwargs.pop("cls", None)
    ...
    list_by_proposal.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/dataAssetReferences"
    }
    ...
    def get(
        ...
        cls: ClsType[_models.DataAssetReference] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/dataAssetReferences/{referenceName}"
    }
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param reference_name: The name of the reference. Required.
        :type reference_name: str
        :param data_asset_reference: The new dataset reference information. Required.
    ...
    def create_or_update(
        ...
        proposal_name: str,
        reference_name: str,
        data_asset_reference: Union[_models.DataAssetReference, IO],
        **kwargs: Any
    ) -> _models.DataAssetReference:
        """Adds a new DataAssetReference to a Proposal.
        ...
        :param reference_name: The name of the reference. Required.
        :type reference_name: str
        :param data_asset_reference: The new dataset reference information. Is either a model type or a
         IO type. Required.
        :type data_asset_reference: ~azure.mgmt.datacollaboration.models.DataAssetReference or IO
        ...
        _json = None
        _content = None
        if isinstance(data_asset_reference, (IO, bytes)):
            _content = data_asset_reference
        else:
    ...
    resolve.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/dataAssetReferences/{referenceName}/resolve"
    }
