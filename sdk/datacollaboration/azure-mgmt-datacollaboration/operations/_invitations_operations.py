...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, "str", pattern=r"^[\w_-]+$"),
        "proposalName": _SERIALIZER.url("proposal_name", proposal_name, "str", pattern=r"^[\w_-]+$"),
        "invitationName": _SERIALIZER.url("invitation_name", invitation_name, "str", pattern=r"^[\w_-]+$"),
    }
...
class InvitationsOperations:
    ...
    def list_by_proposal(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.datacollaboration.models.Invitation]
    ...
    list_by_proposal.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/invitations"
    }

    @distributed_trace
    def get(
        self, resource_group_name: str, workspace_name: str, proposal_name: str, invitation_name: str, **kwargs: Any
    ) -> _models.Invitation:
        ...
        :rtype: ~azure.mgmt.datacollaboration.models.Invitation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/invitations/{invitationName}"
    }
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :param workspace_name: The name of the workspace. Required.
        :type workspace_name: str
        :param proposal_name: The name of the proposal to send the invitation for. Required.
        :type proposal_name: str
        :param invitation_name: The name of the invitation. Required.
        :type invitation_name: str
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :type invitation: ~azure.mgmt.datacollaboration.models.Invitation or IO
    ...
    def delete(
        ...
        :type invitation_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: OperationResponse or None or the result of cls(response)
        :rtype: ~azure.mgmt.datacollaboration.models.OperationResponse or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
