...
def build_list_by_proposal_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/entitlements")  # pylint: disable=line-too-long
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/entitlements/{entitlementName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str'),
...
def build_create_or_update_request(
    ...
    entitlement_name: str,
    *,
    json: Optional[_models.Entitlement] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class EntitlementsOperations:
    ...
    def list_by_proposal(
        ...
        orderby: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable[_models.EntitlementList]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.datacollaboration.models.EntitlementList]
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param entitlement_name: The name of the entitlement.
        :type entitlement_name: str
        :param entitlement: The new entitlement information.
