...
def build_get_request(
    resource_group_name: str, workspace_name: str, data_asset_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DataAssetsOperations:
    ...
    def list_by_workspace(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DataAsset or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.datacollaboration.models.DataAsset]
        ...
        cls: ClsType[_models.DataAssetList] = kwargs.pop("cls", None)
    ...
    list_by_workspace.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/dataAssets"
    }

    @distributed_trace
    def get(
        self, resource_group_name: str, workspace_name: str, data_asset_name: str, **kwargs: Any
    ) -> _models.DataAsset:
        ...
        :param workspace_name: The name of the workspace. Required.
        :type workspace_name: str
        :param data_asset_name: The name of the dataAssetName. Required.
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/dataAssets/{dataAssetName}"
    }
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type data_asset_name: str
        :param data_asset: The new DataAsset information. Required.
    ...
    def create_or_update(
        ...
        workspace_name: str,
        data_asset_name: str,
        data_asset: Union[_models.DataAsset, IO],
        **kwargs: Any
    ) -> _models.DataAsset:
        """Adds a new DataAsset to an existing Workspace.
        ...
        :param data_asset_name: The name of the DataAsset. Required.
        :type data_asset_name: str
        :param data_asset: The new DataAsset information. Is either a model type or a IO type.
         Required.
        :type data_asset: ~azure.mgmt.datacollaboration.models.DataAsset or IO
        ...
        _json = None
        _content = None
        if isinstance(data_asset, (IO, bytes)):
            _content = data_asset
        else:
            _json = self._serialize.body(data_asset, "DataAsset")
