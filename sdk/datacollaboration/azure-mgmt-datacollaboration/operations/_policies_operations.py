...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "proposalName": _SERIALIZER.url("proposal_name", proposal_name, "str", pattern=r"^[\w_-]+$"),
        "entitlementName": _SERIALIZER.url("entitlement_name", entitlement_name, "str", pattern=r"^[\w_-]+$"),
        "policyName": _SERIALIZER.url("policy_name", policy_name, "str", pattern=r"^[\w_-]+$"),
    }
...
class PoliciesOperations:
    ...
    def list_by_entitlement(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.datacollaboration.models.Policy]
    ...
    list_by_entitlement.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/entitlements/{entitlementName}/policies"
    }
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/entitlements/{entitlementName}/policies/{policyName}"
    }
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param policy_name: The name of the policy. Required.
        :type policy_name: str
        :param policy: The new policy information. Required.
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param policy_name: The name of the policy. Required.
        :type policy_name: str
        :param policy: The new policy information. Is either a model type or a IO type. Required.
        :type policy: ~azure.mgmt.datacollaboration.models.Policy or IO
