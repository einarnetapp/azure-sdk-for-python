...
def build_list_by_entitlement_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/entitlements/{entitlementName}/constraints")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str'),
        "proposalName": _SERIALIZER.url("proposal_name", proposal_name, 'str'),
        "entitlementName": _SERIALIZER.url("entitlement_name", entitlement_name, 'str'),
    }
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/proposals/{proposalName}/entitlements/{entitlementName}/constraints/{constraintName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str'),
        "proposalName": _SERIALIZER.url("proposal_name", proposal_name, 'str'),
        "entitlementName": _SERIALIZER.url("entitlement_name", entitlement_name, 'str'),
        "constraintName": _SERIALIZER.url("constraint_name", constraint_name, 'str'),
    }
...
def build_create_or_update_request(
    ...
    constraint_name: str,
    *,
    json: Optional[_models.Constraint] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class ConstraintsOperations:
    ...
    def list_by_entitlement(
        ...
        orderby: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable[_models.ConstraintList]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.datacollaboration.models.ConstraintList]
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', "2020-05-04-preview"))  # type: str
        cls = kwargs.pop('cls', None)  # type: ClsType[_models.ConstraintList]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', "2020-05-04-preview"))  # type: str
        cls = kwargs.pop('cls', None)  # type: ClsType[_models.Constraint]
