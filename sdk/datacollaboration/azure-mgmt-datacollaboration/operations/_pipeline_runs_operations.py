...
def build_get_request(
    resource_group_name: str, workspace_name: str, pipeline_run_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PipelineRunsOperations:
    ...
    def list_by_workspace(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.datacollaboration.models.PipelineRun]
        ...
        cls: ClsType[_models.PipelineRunList] = kwargs.pop("cls", None)
    ...
    list_by_workspace.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/pipelineRuns"
    }

    @distributed_trace
    def get(
        self, resource_group_name: str, workspace_name: str, pipeline_run_name: str, **kwargs: Any
    ) -> _models.PipelineRun:
        """Get pipeline run.
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/pipelineRuns/{pipelineRunName}"
    }
    ...
    _cancel_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataCollaboration/workspaces/{workspaceName}/pipelineRuns/{pipelineRunName}/cancel"
    }
