...
from ...operations._constraints_operations import build_create_or_update_request, build_delete_request_initial, build_get_request, build_list_by_entitlement_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class ConstraintsOperations:
    """ConstraintsOperations async operations.
    ...
    def list_by_entitlement(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.ConstraintList"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datacollaboration.models.ConstraintList]
