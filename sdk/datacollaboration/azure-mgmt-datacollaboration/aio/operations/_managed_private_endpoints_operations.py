...
class ManagedPrivateEndpointsOperations:
    ...
    def list_by_workspace(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ManagedPrivateEndpoint or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datacollaboration.models.ManagedPrivateEndpoint]
    ...
    async def _create_initial(
        ...
        managed_private_endpoint: Union[_models.ManagedPrivateEndpoint, IO],
        **kwargs: Any
    ) -> _models.ManagedPrivateEndpoint:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param managed_private_endpoint_name: The name of the managed private endpoint. Required.
        :type managed_private_endpoint_name: str
        :param managed_private_endpoint: The new managed private endpoint information. Required.
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param managed_private_endpoint_name: The name of the managed private endpoint. Required.
        :type managed_private_endpoint_name: str
        :param managed_private_endpoint: The new managed private endpoint information. Is either a
         model type or a IO type. Required.
        :type managed_private_endpoint: ~azure.mgmt.datacollaboration.models.ManagedPrivateEndpoint or
         IO
