...
from ...operations._proposals_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_workspace_request, build_revoke_request, build_sign_request_initial
T = TypeVar('T')
...
class ProposalsOperations:
    ...
    def list_by_workspace(
        ...
        **kwargs: Any
    ) -> AsyncIterable[_models.ProposalList]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datacollaboration.models.ProposalList]
