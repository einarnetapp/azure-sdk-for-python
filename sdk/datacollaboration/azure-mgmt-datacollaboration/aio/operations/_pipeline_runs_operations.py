...
from ...operations._pipeline_runs_operations import build_cancel_request_initial, build_get_request, build_list_by_workspace_request
T = TypeVar('T')
...
class PipelineRunsOperations:
    ...
    def list_by_workspace(
        ...
        **kwargs: Any
    ) -> AsyncIterable[_models.PipelineRunList]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datacollaboration.models.PipelineRunList]
