...
class PipelineRunsOperations:
    ...
    def list_by_workspace(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.PipelineRun"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datacollaboration.models.PipelineRun]
    ...
    async def begin_cancel(
        ...
        :return: An instance of AsyncLROPoller that returns either PipelineRun or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.datacollaboration.models.PipelineRun]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
