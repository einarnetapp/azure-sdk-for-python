...
from ...operations._invitations_operations import build_create_request, build_delete_request, build_get_request, build_list_by_proposal_request
T = TypeVar('T')
...
class InvitationsOperations:
    ...
    def list_by_proposal(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datacollaboration.models.InvitationList]
