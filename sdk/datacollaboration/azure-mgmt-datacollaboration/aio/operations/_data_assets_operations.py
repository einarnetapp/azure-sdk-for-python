...
from ...operations._data_assets_operations import build_create_or_update_request, build_delete_request_initial, build_get_request, build_list_by_workspace_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class DataAssetsOperations:
    """DataAssetsOperations async operations.
    ...
    def list_by_workspace(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.DataAssetList"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datacollaboration.models.DataAssetList]
