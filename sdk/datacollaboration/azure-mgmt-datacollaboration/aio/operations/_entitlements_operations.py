...
from ...operations._entitlements_operations import build_create_or_update_request, build_delete_request_initial, build_get_request, build_list_by_proposal_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class EntitlementsOperations:
    """EntitlementsOperations async operations.
    ...
    def list_by_proposal(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.EntitlementList"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datacollaboration.models.EntitlementList]
