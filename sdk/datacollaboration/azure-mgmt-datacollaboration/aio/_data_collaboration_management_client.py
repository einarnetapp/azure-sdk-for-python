...
class DataCollaborationManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype script_references:
     azure.mgmt.datacollaboration.aio.operations.ScriptReferencesOperations
    ...
    :vartype scripts: azure.mgmt.datacollaboration.aio.operations.ScriptsOperations
    :ivar script_revisions: ScriptRevisionsOperations operations
    :vartype script_revisions:
     azure.mgmt.datacollaboration.aio.operations.ScriptRevisionsOperations
