...
class DataSet(ProxyDto):
    ...
    :ivar type: Type of the azure resource.
    :vartype type: str
    :ivar kind: Required. Kind of Data Set.Constant filled by server. Known values are:
     "DataAsset", "ScriptOutput", "SynapseSparkPool", "Script", "Location", "ScriptParameter",
     ...
     "DiagnosticLevel", "Output", "DataAssetReference", "ScriptReference".
...
class BoundDataDescriptor(msrest.serialization.Model):
    ...
    :ivar kind: Required. Kind of bound data descriptor.Constant filled by server. Known values
     are: "DataAsset", "ScriptOutput", "SynapseSparkPool", "Script", "Location", "ScriptParameter",
     "Blob", "Container", "BlobFolder", "AdlsGen2FileSystem", "AdlsGen2Folder", "AdlsGen2File",
     "ConsoleLog", "EventLog", "SynapseSpark", "DataMovement", "ScriptExecution", "DiagnosticsLog",
     "DiagnosticLevel", "Output", "DataAssetReference", "ScriptReference".
    :vartype kind: str or ~azure.mgmt.datacollaboration.models.Kind
...
class Constraint(ProxyDto):
    ...
    :ivar type: Type of the azure resource.
    :vartype type: str
    :ivar kind: Required. Kind of constraint.Constant filled by server. Known values are:
     "DataAsset", "ScriptOutput", "SynapseSparkPool", "Script", "Location", "ScriptParameter",
     "Blob", "Container", "BlobFolder", "AdlsGen2FileSystem", "AdlsGen2Folder", "AdlsGen2File",
     "ConsoleLog", "EventLog", "SynapseSpark", "DataMovement", "ScriptExecution", "DiagnosticsLog",
     "DiagnosticLevel", "Output", "DataAssetReference", "ScriptReference".
...
class Policy(ProxyDto):
    ...
    :ivar type: Type of the azure resource.
    :vartype type: str
    :ivar kind: Required. Kind of policy.Constant filled by server. Known values are: "DataAsset",
...
class Script(ProxyDto):
    ...
    :ivar type: Type of the azure resource.
    :vartype type: str
    :ivar kind: Required. Kind of script.Constant filled by server. Known values are: "DataAsset",
     "ScriptOutput", "SynapseSparkPool", "Script", "Location", "ScriptParameter", "Blob",
     "Container", "BlobFolder", "AdlsGen2FileSystem", "AdlsGen2Folder", "AdlsGen2File",
     "ConsoleLog", "EventLog", "SynapseSpark", "DataMovement", "ScriptExecution", "DiagnosticsLog",
     "DiagnosticLevel", "Output", "DataAssetReference", "ScriptReference".
