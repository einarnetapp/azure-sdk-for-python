...
class DataSet(ProxyDto):
    ...
    :ivar type: Type of the azure resource.
    :vartype type: str
    :ivar kind: Required. Kind of Data Set.Constant filled by server. Possible values include:
...
class PipelineRunParameterAssignment(msrest.serialization.Model):
    ...
    :ivar parameter_type: Required. Parameter type.Constant filled by server. Possible values
     include: "Boolean", "Integer", "Float", "String", "DateTime".
...
class BoundAdapter(msrest.serialization.Model):
    ...
    :ivar adapter_type: Required. The adapter type. Possible values include: "Standard", "Custom".
    ...
    def __init__(
        self,
        *,
        adapter_type: Union[str, "AdapterType"],
        script_id: str,
        script_revision: int,
        **kwargs
    ):
        """
        :keyword adapter_type: Required. The adapter type. Possible values include: "Standard",
         "Custom".
...
class BoundDataDescriptor(msrest.serialization.Model):
    ...
    :ivar kind: Required. Kind of bound data descriptor.Constant filled by server. Possible values
     include: "DataAsset", "ScriptOutput".
...
class ConstrainedResource(ProxyDto):
    ...
    :ivar type: Type of the azure resource.
    :vartype type: str
    :ivar kind: Required. Kind of constrained resource.Constant filled by server. Possible values
     include: "SynapseSparkPool".
...
class Constraint(ProxyDto):
    ...
    :ivar type: Type of the azure resource.
    :vartype type: str
    :ivar kind: Required. Kind of constraint.Constant filled by server. Possible values include:
     "Script", "Location", "ScriptParameter".
...
class DataAssetReference(ProxyDto):
    ...
    :ivar data_access_type: The data asset reference type. Represents the data access allowed using
     this data in pipeline. Possible values include: "ReadOnly", "WriteOnly".
    ...
    :ivar placeholder_state: The placeholder state. Possible values include: "None", "Unassigned",
     "Assigned".
    ...
    def __init__(
        self,
        *,
        data_access_type: Optional[Union[str, "DataAccessType"]] = None,
        data_asset_id: Optional[str] = None,
        description: Optional[str] = None,
        display_name: Optional[str] = None,
        placeholder_info: Optional["DataAssetReferencePlaceholderInfo"] = None,
        **kwargs
    ):
        """
        :keyword data_access_type: The data asset reference type. Represents the data access allowed
         using this data in pipeline. Possible values include: "ReadOnly", "WriteOnly".
...
class ResourceReference(msrest.serialization.Model):
    ...
    :ivar kind: Required. Kind of resource reference.Constant filled by server. Possible values
     include: "DataAsset", "DataAssetReference", "Script", "ScriptReference".
...
class PipelineSubstep(msrest.serialization.Model):
    ...
    :ivar kind: Required. Kind of pipeline substep.Constant filled by server. Possible values
     include: "DataMovement", "ScriptExecution", "DiagnosticsLog".
...
class DataMovementPipelineSubstep(PipelineSubstep):
    ...
    def __init__(
        self,
        *,
        source: Optional["SubstepReference"] = None,
        **kwargs
    ):
        """
...
class SubstepReference(msrest.serialization.Model):
    ...
    :ivar kind: Required. Kind of substep reference.Constant filled by server. Possible values
     include: "DataMovement", "ScriptExecution", "DiagnosticsLog".
...
class ScriptParameterValidationRule(msrest.serialization.Model):
    ...
    :ivar script_parameter_validation_rule_type: Required. Script parameter validation rule
     type.Constant filled by server. Possible values include: "IntegerRange", "FloatRange",
...
class Policy(ProxyDto):
    ...
    :ivar type: Type of the azure resource.
    :vartype type: str
    :ivar kind: Required. Kind of policy.Constant filled by server. Possible values include:
...
class DiagnosticPolicy(Policy):
    ...
    :vartype description: str
    :ivar log_level: Required. The policy log level. Possible values include: "Verbose",
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype description: str
        :keyword log_level: Required. The policy log level. Possible values include: "Verbose",
         "Information", "Warning", "Error", "Critical".
...
class DiagnosticsLog(msrest.serialization.Model):
    ...
    :vartype data_asset_id: str
    :ivar kind: Required. Kind of diagnostics log.Constant filled by server. Possible values
     include: "ConsoleLog", "EventLog".
...
class Entitlement(ProxyDto):
    ...
    :vartype resource_id: str
    :ivar resource_type: Required. The type of resourced used by the entitlement. Possible values
     include: "DataAssetReference", "ScriptReference", "VirtualOutputReference".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword resource_type: Required. The type of resourced used by the entitlement. Possible
         values include: "DataAssetReference", "ScriptReference", "VirtualOutputReference".
...
class Identity(msrest.serialization.Model):
    ...
    :ivar type: Identity Type. Possible values include: "SystemAssigned".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword type: Identity Type. Possible values include: "SystemAssigned".
...
class ManagedPrivateEndpoint(ProxyDto):
    ...
    :ivar group_id: Required. The type of endpoint on the linked resource. Possible values include:
    ...
    :ivar provisioning_state: Provisioning state of the Managed Private Endpoint. Possible values
    ...
    def __init__(
        self,
        *,
        group_id: Union[str, "GroupId"],
        private_link_resource_id: str,
        **kwargs
    ):
        """
        :keyword group_id: Required. The type of endpoint on the linked resource. Possible values
         include: "blob", "blob_secondary", "dfs", "dfs_secondary".
...
class PrivateEndpointConnectionState(msrest.serialization.Model):
    ...
    :vartype description: str
    :ivar private_endpoint_status: The approval status. Possible values include: "Pending",
...
class OperationResponse(msrest.serialization.Model):
    ...
    :vartype start_time: ~datetime.datetime
    :ivar status: Required. Operation state of the long running operation. Possible values include:
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword status: Required. Operation state of the long running operation. Possible values
...
class Participant(ProxyDto):
    ...
    def __init__(
        self,
        *,
        placeholder_info: Optional["ParticipantPlaceholderInfo"] = None,
        **kwargs
    ):
        """
        :keyword placeholder_info: The placeholder information.
...
class Pipeline(ProxyDto):
    ...
    def __init__(
        ...
        *,
        description: Optional[str] = None,
        script_parameters: Optional[List["ScriptParameter"]] = None,
        **kwargs
    ):
        """
...
class PipelineRunParameters(msrest.serialization.Model):
    ...
    :ivar pipeline_run_mode: Mode of pipeline run used. Possible values include: "Production",
     "Test".
    :vartype pipeline_run_mode: str or ~azure.mgmt.datacollaboration.models.PipelineRunMode
    ...
    def __init__(
        ...
        *,
        ...
        pipeline_run_parameter_assignments: Optional[List["PipelineRunParameterAssignment"]] = None,
        **kwargs
    ):
        """
        :keyword pipeline_run_mode: Mode of pipeline run used. Possible values include: "Production",
         "Test".
...
class PipelineStep(ProxyDto):
    ...
    :ivar type: Type of the azure resource.
    :vartype type: str
    :ivar kind: Required. Kind of pipeline step.Constant filled by server. Possible values include:
     "SynapseSpark".
...
class Script(ProxyDto):
    ...
    :ivar type: Type of the azure resource.
    :vartype type: str
    :ivar kind: Required. Kind of script.Constant filled by server. Possible values include:
     "SynapseSpark".
...
class ScriptConstraint(Constraint):
    ...
    def __init__(
        ...
        *,
        script_reference_id: str,
        adapter_binding_constraints: Optional[List["AdapterBindingConstraint"]] = None,
        description: Optional[str] = None,
        **kwargs
    ):
        """
...
class ScriptDataAssetBinding(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        bound_data_descriptor: Optional["BoundDataDescriptor"] = None,
...
class ScriptExecutionParameter(msrest.serialization.Model):
    ...
    :vartype name: str
    :ivar parameter_type: Parameter type. Possible values include: "Boolean", "Integer", "Float",
     "String", "DateTime".
    :vartype parameter_type: str or ~azure.mgmt.datacollaboration.models.ParameterType
    :ivar resolved_by: Parameter resolution by. Possible values include: "Default", "Constant",
     "PipelineRun".
    ...
    def __init__(
        ...
        *,
        ...
        resolved_by: Optional[Union[str, "ResolvedBy"]] = None,
        ...
        **kwargs
        ...
        :paramtype name: str
        :keyword parameter_type: Parameter type. Possible values include: "Boolean", "Integer",
         "Float", "String", "DateTime".
        :paramtype parameter_type: str or ~azure.mgmt.datacollaboration.models.ParameterType
        :keyword resolved_by: Parameter resolution by. Possible values include: "Default", "Constant",
         "PipelineRun".
...
class ScriptExecutionPipelineSubstep(PipelineSubstep):
    ...
    def __init__(
        self,
        *,
        script_execution_information: Optional["ScriptExecutionInformation"] = None,
        sink_bindings: Optional[List["SinkBindingExecutionInformation"]] = None,
        source_bindings: Optional[List["SourceBindingExecutionInformation"]] = None,
        synapse_spark_information: Optional["SynapseSparkInformation"] = None,
        **kwargs
    ):
        """
...
class ScriptParameterConstraint(Constraint):
    ...
    :ivar parameter_type: Parameter should be of type. Possible values include: "Boolean",
    ...
    def __init__(
        ...
        *,
        ...
        parameter_type: Optional[Union[str, "ParameterType"]] = None,
        validation_rule: Optional["ScriptParameterValidationRule"] = None,
        **kwargs
    ):
        """
        :keyword description: Description of the constraint.
        ...
        :keyword parameter_type: Parameter should be of type. Possible values include: "Boolean",
         "Integer", "Float", "String", "DateTime".
        :paramtype parameter_type: str or ~azure.mgmt.datacollaboration.models.ParameterType
...
class ScriptReference(ProxyDto):
    ...
    :ivar placeholder_state: The placeholder state. Possible values include: "None", "Unassigned",
     "Assigned".
    :vartype placeholder_state: str or ~azure.mgmt.datacollaboration.models.PlaceholderState
    :ivar purpose: Script purpose. Possible values include: "Body", "InputAdapter",
     "OutputAdapter".
    ...
    def __init__(
        ...
        *,
        display_name: Optional[str] = None,
        placeholder_info: Optional["ScriptReferencePlaceholderInfo"] = None,
...
class ScriptReferencePlaceholderInfo(msrest.serialization.Model):
    ...
    :ivar display_name: Required. Display name of the placeholder.
    :vartype display_name: str
    :ivar purpose: Required. Script purpose. Possible values include: "Body", "InputAdapter",
     "OutputAdapter".
    :vartype purpose: str or ~azure.mgmt.datacollaboration.models.Purpose
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword display_name: Required. Display name of the placeholder.
        :paramtype display_name: str
        :keyword purpose: Required. Script purpose. Possible values include: "Body", "InputAdapter",
         "OutputAdapter".
...
class SinkBindingExecutionInformation(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        adapter: Optional["ScriptExecutionInformation"] = None,
        **kwargs
    ):
        """
...
class SourceBindingExecutionInformation(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        adapter: Optional["ScriptExecutionInformation"] = None,
        source_substep_reference: Optional["SubstepReference"] = None,
        **kwargs
    ):
        """
        :keyword adapter: The bounded adapter.
...
class SynapseSparkInformation(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        spark_pool_execution_information: Optional["SparkPoolExecutionInformation"] = None,
        spark_pool_information: Optional["SparkPoolInformation"] = None,
        **kwargs
    ):
        """
...
class SynapseSparkPipelineStep(PipelineStep):
    ...
    :ivar executor_node_size: The node size to use per executor. Possible values include: "None",
    ...
    def __init__(
        ...
        *,
        ...
        diagnostics_log_bindings: Optional[List["DiagnosticsLog"]] = None,
        ...
        script_parameter_bindings: Optional[List["ScriptParameterBinding"]] = None,
        script_parameters: Optional[List["ScriptParameter"]] = None,
        ...
        **kwargs
        ...
        :keyword executor_node_size: The node size to use per executor. Possible values include:
...
class SynapseSparkPool(ConstrainedResource):
    ...
    :ivar node_size_family: Gets or sets the kind of nodes that the Big Data pool provides.
    ...
    def __init__(
        ...
        *,
        ...
        library_requirements: Optional["SynapseSparkPoolLibraryRequirementsProperties"] = None,
...
class SynapseSparkScript(Script):
    ...
    :vartype content: str
    :ivar language: Required. The script language. Possible values include: "Python".
    ...
    :vartype sources: list[str]
    :ivar visibility: Required. Script visibility mode. Possible values include: "ShowAll",
     "HiddenContent".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype content: str
        :keyword language: Required. The script language. Possible values include: "Python".
        ...
        :keyword visibility: Required. Script visibility mode. Possible values include: "ShowAll",
         "HiddenContent".
...
class VirtualOutputReferenceList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: List["VirtualOutputReference"],
        next_link: Optional[str] = None,
        **kwargs
    ):
        """
