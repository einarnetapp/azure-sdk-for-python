...
class StorageAccount(_serialization.Model):
    ...
    :ivar enable_secure_channel: Customer specify use secure channel or not. Only work when
     IsDefault is true. It will impact the setting of FS.defaultFS for ambari and could be null.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword enable_secure_channel: Customer specify use secure channel or not. Only work when
         IsDefault is true. It will impact the setting of FS.defaultFS for ambari and could be null.
