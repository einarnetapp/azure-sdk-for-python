...
class OutboundNetworkDependenciesEndpoint(_serialization.Model):
...
class OutboundNetworkDependenciesEndpointDetail(_serialization.Model):
    ...
    def __init__(self, *, port: Optional[str] = None, protocol: Optional[str] = None, **kwargs):
        """
...
class OutboundNetworkDependenciesEndpointListResult(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.OutboundNetworkDependenciesEndpoint"]] = None, **kwargs):
        """
...
class OutboundNetworkDependenciesEndpointProperties(_serialization.Model):
