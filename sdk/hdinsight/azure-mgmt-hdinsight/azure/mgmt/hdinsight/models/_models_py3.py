...
class AsyncOperationResult(msrest.serialization.Model):
    ...
    :ivar status: The async operation state. Known values are: "InProgress", "Succeeded", "Failed".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword status: The async operation state. Known values are: "InProgress", "Succeeded",
         "Failed".
...
class ClusterCreateProperties(msrest.serialization.Model):
    ...
    :ivar os_type: The type of operating system. Known values are: "Windows", "Linux".
    :vartype os_type: str or ~azure.mgmt.hdinsight.models.OSType
    :ivar tier: The cluster tier. Known values are: "Standard", "Premium".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword os_type: The type of operating system. Known values are: "Windows", "Linux".
        :paramtype os_type: str or ~azure.mgmt.hdinsight.models.OSType
        :keyword tier: The cluster tier. Known values are: "Standard", "Premium".
...
class ClusterGetProperties(msrest.serialization.Model):
    ...
    :ivar provisioning_state: The provisioning state, which only appears in the response. Known
     values are: "InProgress", "Failed", "Succeeded", "Canceled", "Deleting".
...
class ClusterIdentity(msrest.serialization.Model):
    ...
    :ivar type: The type of identity used for the cluster. The type 'SystemAssigned, UserAssigned'
     ...
     values are: "SystemAssigned", "UserAssigned", "SystemAssigned, UserAssigned", "None".
...
class ClusterListPersistedScriptActionsResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.RuntimeScriptAction"]] = None,
        **kwargs
    ):
        """
...
class DiskBillingMeters(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype sku: str
        :keyword tier: The managed disk billing tier, Standard or Premium. Known values are:
         "Standard", "Premium".
        :paramtype tier: str or ~azure.mgmt.hdinsight.models.Tier
        """
...
class DiskEncryptionProperties(msrest.serialization.Model):
    ...
    :ivar encryption_algorithm: Algorithm identifier for encryption, default RSA-OAEP. Known values
     are: "RSA-OAEP", "RSA-OAEP-256", "RSA1_5".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword encryption_algorithm: Algorithm identifier for encryption, default RSA-OAEP. Known
         values are: "RSA-OAEP", "RSA-OAEP-256", "RSA1_5".
...
class IPConfiguration(msrest.serialization.Model):
    ...
    :ivar provisioning_state: The private link configuration provisioning state, which only appears
     in the response. Known values are: "InProgress", "Failed", "Succeeded", "Canceled", "Deleting".
    :vartype provisioning_state: str or
...
class OutboundNetworkDependenciesEndpoint(msrest.serialization.Model):
    """A outbound network dependencies endpoint.

    :ivar category: The category of endpoint.
    :vartype category: str
    :ivar endpoints: Array of endpoints.
    :vartype endpoints:
     list[~azure.mgmt.hdinsight.models.OutboundNetworkDependenciesEndpointProperties]
    """

    _attribute_map = {
        'category': {'key': 'category', 'type': 'str'},
        'endpoints': {'key': 'endpoints', 'type': '[OutboundNetworkDependenciesEndpointProperties]'},
    }
    ...
    def __init__(
        ...
        *,
        category: Optional[str] = None,
        endpoints: Optional[List["_models.OutboundNetworkDependenciesEndpointProperties"]] = None,
        **kwargs
    ):
        """
        :keyword category: The category of endpoint.
        :paramtype category: str
        :keyword endpoints: Array of endpoints.
        :paramtype endpoints:
         list[~azure.mgmt.hdinsight.models.OutboundNetworkDependenciesEndpointProperties]
        """
...
class OutboundNetworkDependenciesEndpointDetail(msrest.serialization.Model):
    """Outbound network dependencies endpoint detail.

    :ivar port: The port of endpoint.
    :vartype port: str
    :ivar protocol: The protocol of endpoint.
    :vartype protocol: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype port: str
        :keyword protocol: The protocol of endpoint.
        :paramtype protocol: str
        """
        super(OutboundNetworkDependenciesEndpointDetail, self).__init__(**kwargs)
        self.port = port
        self.protocol = protocol
...
class OutboundNetworkDependenciesEndpointListResult(msrest.serialization.Model):
    ...
    :ivar value: Array of outbound network dependencies endpoints.
    :vartype value: list[~azure.mgmt.hdinsight.models.OutboundNetworkDependenciesEndpoint]
    :ivar next_link: The link (url) to the next page of results.
    :vartype next_link: str
    """
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.OutboundNetworkDependenciesEndpoint"]] = None,
        **kwargs
    ):
        """
        :keyword value: Array of outbound network dependencies endpoints.
        :paramtype value: list[~azure.mgmt.hdinsight.models.OutboundNetworkDependenciesEndpoint]
        """
...
class OutboundNetworkDependenciesEndpointProperties(msrest.serialization.Model):
    """Outbound network dependencies endpoint properties.

    :ivar domain_name: The domain name of endpoint.
    :vartype domain_name: str
    :ivar endpoint_details: Array of endpoint details.
    :vartype endpoint_details:
     list[~azure.mgmt.hdinsight.models.OutboundNetworkDependenciesEndpointDetail]
    """

    _attribute_map = {
        'domain_name': {'key': 'domainName', 'type': 'str'},
        'endpoint_details': {'key': 'endpointDetails', 'type': '[OutboundNetworkDependenciesEndpointDetail]'},
    }
    ...
    def __init__(
        ...
        *,
        domain_name: Optional[str] = None,
        endpoint_details: Optional[List["_models.OutboundNetworkDependenciesEndpointDetail"]] = None,
        **kwargs
    ):
        """
        :keyword domain_name: The domain name of endpoint.
        :paramtype domain_name: str
        :keyword endpoint_details: Array of endpoint details.
        :paramtype endpoint_details:
         list[~azure.mgmt.hdinsight.models.OutboundNetworkDependenciesEndpointDetail]
        """
        super(OutboundNetworkDependenciesEndpointProperties, self).__init__(**kwargs)
        self.domain_name = domain_name
...
class PrivateEndpointConnection(Resource):
    ...
    :ivar provisioning_state: The provisioning state, which only appears in the response. Known
     values are: "InProgress", "Updating", "Failed", "Succeeded", "Canceled", "Deleting".
    :vartype provisioning_state: str or
...
class PrivateLinkServiceConnectionState(msrest.serialization.Model):
    ...
    :ivar status: Required. The concrete private link service connection. Known values are:
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword status: Required. The concrete private link service connection. Known values are:
         "Approved", "Rejected", "Pending", "Removed".
...
class ScriptActionsList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.RuntimeScriptActionDetail"]] = None,
        **kwargs
    ):
        """
...
class SecurityProfile(msrest.serialization.Model):
    ...
    :ivar directory_type: The directory type. Known values are: "ActiveDirectory".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword directory_type: The directory type. Known values are: "ActiveDirectory".
...
class VersionsCapability(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        available: Optional[List["_models.VersionSpec"]] = None,
        **kwargs
    ):
        """
...
class VmSizeCompatibilityFilterV2(msrest.serialization.Model):
    ...
    :ivar filter_mode: The filtering mode. Effectively this can enabling or disabling the VM sizes
     in a particular set. Known values are: "Exclude", "Include", "Recommend", "Default".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword filter_mode: The filtering mode. Effectively this can enabling or disabling the VM
         sizes in a particular set. Known values are: "Exclude", "Include", "Recommend", "Default".
