...
from ...operations._clusters_operations import build_create_request_initial, build_delete_request_initial, build_execute_script_actions_request_initial, build_get_azure_async_operation_status_request, build_get_gateway_settings_request, build_get_request, build_list_by_resource_group_request, build_list_outbound_network_dependencies_endpoints_request, build_list_request, build_resize_request_initial, build_rotate_disk_encryption_key_request_initial, build_update_auto_scale_configuration_request_initial, build_update_gateway_settings_request_initial, build_update_identity_certificate_request_initial, build_update_request
T = TypeVar('T')
...
class ClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_outbound_network_dependencies_endpoints(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hdinsight.models.OutboundNetworkDependenciesEndpointListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    list_outbound_network_dependencies_endpoints.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HDInsight/clusters/{clusterName}/outboundNetworkDependenciesEndpoints"}  # type: ignore
