...
class CustomLocationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.extendedlocation.v2023_04_01_preview.aio.CustomLocations`'s
    ...
    def list_operations(self, **kwargs: Any) -> AsyncIterable["_models.CustomLocationOperation"]:
        ...
        :return: An iterator like instance of either CustomLocationOperation or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.extendedlocation.v2023_04_01_preview.models.CustomLocationOperation]
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.CustomLocation"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.extendedlocation.v2023_04_01_preview.models.CustomLocation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.CustomLocation:
        ...
        :rtype: ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.CustomLocation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.CustomLocation
        ...
        :return: An instance of AsyncLROPoller that returns either CustomLocation or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.extendedlocation.v2023_04_01_preview.models.CustomLocation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        :param resource_name: Custom Locations name. Required.
        :type resource_name: str
        :param parameters: Parameters supplied to create or update a Custom Location. Is either a model
         type or a IO type. Required.
        :type parameters: ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.CustomLocation or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type identity: ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.Identity
        ...
        :param host_type: Type of host the Custom Locations is referencing (Kubernetes, etc...). Known
         values are: "Kubernetes", "AWS", and "GCP". Default value is None.
        :type host_type: str or ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.HostType
        ...
        :param project_id: Project id for the GCP single account. Default value is None.
        :type project_id: str
        :param project_number: Project number for GCP single account. Default value is None.
        :type project_number: str
        :param excluded_folder_ids: List of folder id's that needs to be excluded. Default value is
         None.
        :type excluded_folder_ids: list[str]
        :param excluded_project_numbers: List of project numbers that needs to be excluded. Default
         value is None.
        :type excluded_project_numbers: list[str]
        :param organization_id: Organization id for the GCP organization. Default value is None.
        :type organization_id: str
        :param account_id: Account id for the AWS account. Default value is None.
        :type account_id: str
        :param excluded_accounts: List of AWS accounts which needs to be excluded. Default value is
         None.
    ...
    def list_enabled_resource_types(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.extendedlocation.v2023_04_01_preview.models.EnabledResourceType]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def find_target_resource_group(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.CustomLocationFindTargetResourceGroupProperties
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype:
         ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.CustomLocationFindTargetResourceGroupResult
         or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def find_target_resource_group(
        ...
        **kwargs: Any
        ...
        :param resource_name: Custom Locations name. Required.
        :type resource_name: str
        :param parameters: Parameters of the find target resource group request. Is either a model type
