...
class CustomLocation(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype identity: ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.Identity
    :ivar system_data: Metadata pertaining to creation and last modification of the resource.
    :vartype system_data: ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.SystemData
    ...
    :vartype authentication:
     ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.CustomLocationPropertiesAuthentication
    ...
    :ivar host_type: Type of host the Custom Locations is referencing (Kubernetes, etc...). Known
     values are: "Kubernetes", "AWS", and "GCP".
    :vartype host_type: str or ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.HostType
    ...
    :ivar project_id: Project id for the GCP single account.
    :vartype project_id: str
    :ivar project_number: Project number for GCP single account.
    :vartype project_number: str
    :ivar excluded_folder_ids: List of folder id's that needs to be excluded.
    :vartype excluded_folder_ids: list[str]
    :ivar excluded_project_numbers: List of project numbers that needs to be excluded.
    :vartype excluded_project_numbers: list[str]
    :ivar organization_id: Organization id for the GCP organization.
    :vartype organization_id: str
    :ivar account_id: Account id for the AWS account.
    :vartype account_id: str
    :ivar excluded_accounts: List of AWS accounts which needs to be excluded.
    ...
    _attribute_map = {
        ...
        "project_id": {"key": "properties.gcpCloudProfile.singleProject.projectId", "type": "str"},
        "project_number": {"key": "properties.gcpCloudProfile.singleProject.projectNumber", "type": "str"},
        "excluded_folder_ids": {
            "key": "properties.gcpCloudProfile.organizationProject.excludedFolderIds",
            "type": "[str]",
        },
        "excluded_project_numbers": {
            "key": "properties.gcpCloudProfile.organizationProject.excludedProjectNumbers",
            "type": "[str]",
        },
        "organization_id": {"key": "properties.gcpCloudProfile.organizationProject.organizationId", "type": "str"},
        "account_id": {"key": "properties.awsCloudProfile.accountId", "type": "str"},
        "excluded_accounts": {"key": "properties.awsCloudProfile.excludedAccounts", "type": "[str]"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype identity: ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.Identity
        ...
        :keyword host_type: Type of host the Custom Locations is referencing (Kubernetes, etc...).
         Known values are: "Kubernetes", "AWS", and "GCP".
        :paramtype host_type: str or ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.HostType
        ...
        :keyword project_id: Project id for the GCP single account.
        :paramtype project_id: str
        :keyword project_number: Project number for GCP single account.
        :paramtype project_number: str
        :keyword excluded_folder_ids: List of folder id's that needs to be excluded.
        :paramtype excluded_folder_ids: list[str]
        :keyword excluded_project_numbers: List of project numbers that needs to be excluded.
        :paramtype excluded_project_numbers: list[str]
        :keyword organization_id: Organization id for the GCP organization.
        :paramtype organization_id: str
        :keyword account_id: Account id for the AWS account.
        :paramtype account_id: str
        :keyword excluded_accounts: List of AWS accounts which needs to be excluded.
        ...
        self.excluded_folder_ids = excluded_folder_ids
...
class CustomLocationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.extendedlocation.v2023_04_01_preview.models.CustomLocation]
    """
...
class CustomLocationOperationsList(_serialization.Model):
    ...
    :vartype value:
     list[~azure.mgmt.extendedlocation.v2023_04_01_preview.models.CustomLocationOperation]
    """
...
class EnabledResourceType(ProxyResource):
    ...
    :vartype types_metadata:
     list[~azure.mgmt.extendedlocation.v2023_04_01_preview.models.EnabledResourceTypePropertiesTypesMetadataItem]
    """
...
class EnabledResourceTypesListResult(_serialization.Model):
    ...
    :vartype value:
     list[~azure.mgmt.extendedlocation.v2023_04_01_preview.models.EnabledResourceType]
    """
...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.extendedlocation.v2023_04_01_preview.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.extendedlocation.v2023_04_01_preview.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class Identity(_serialization.Model):
    ...
    :vartype type: str or
     ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.ResourceIdentityType
    """
...
class PatchableCustomLocations(_serialization.Model):  # pylint: disable=too-many-instance-attributes
...
class PatchableResourceSyncRule(_serialization.Model):
    ...
    :vartype selector:
     ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.ResourceSyncRulePropertiesSelector
...
class ResourceSyncRuleListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.extendedlocation.v2023_04_01_preview.models.ResourceSyncRule]
    """
...
class ResourceSyncRulePropertiesSelector(_serialization.Model):
    ...
    :vartype match_expressions:
     list[~azure.mgmt.extendedlocation.v2023_04_01_preview.models.MatchExpressionsProperties]
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or
     ~azure.mgmt.extendedlocation.v2023_04_01_preview.models.CreatedByType
