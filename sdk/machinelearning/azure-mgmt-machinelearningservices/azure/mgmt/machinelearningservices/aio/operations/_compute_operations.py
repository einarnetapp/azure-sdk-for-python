...
from ...operations._compute_operations import (
    ...
    build_update_schedules_request,
)
...
class ComputeOperations:
    ...
    @overload
    async def update_schedules(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        workspace_name: str,
        compute_name: str,
        parameters: Optional[_models.ComputeSchedules] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> None:
        ...
        :param compute_name: Name of the Azure Machine Learning compute. Required.
        :type compute_name: str
        :param parameters: The object for updating schedules of specified ComputeInstance. Default
         value is None.
        :type parameters: ~azure.mgmt.machinelearningservices.models.ComputeSchedules
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update_schedules(  # pylint: disable=inconsistent-return-statements
        ...
        workspace_name: str,
        compute_name: str,
        parameters: Optional[Union[_models.ComputeSchedules, IO]] = None,
        **kwargs: Any
    ) -> None:
        """Updates schedules of a compute instance.
        ...
        :param compute_name: Name of the Azure Machine Learning compute. Required.
        :type compute_name: str
        :param parameters: The object for updating schedules of specified ComputeInstance. Is either a
         model type or a IO type. Default value is None.
        :type parameters: ~azure.mgmt.machinelearningservices.models.ComputeSchedules or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            if parameters is not None:
                _json = self._serialize.body(parameters, "ComputeSchedules")
            else:
                _json = None

        request = build_update_schedules_request(
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            compute_name=compute_name,
            subscription_id=self._config.subscription_id,
            ...
            json=_json,
            content=_content,
            template_url=self.update_schedules.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
