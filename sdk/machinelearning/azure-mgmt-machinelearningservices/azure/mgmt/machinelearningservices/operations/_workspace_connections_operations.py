...
def build_create_request(
    ...
    connection_name: str,
    *,
    json: Optional[_models.WorkspaceConnectionPropertiesV2BasicResource] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
...
class WorkspaceConnectionsOperations:
    ...
    def list(
        ...
        category: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable[_models.WorkspaceConnectionPropertiesV2BasicResourceArmPaginatedResult]:
        """list.
