...
def build_update_request_initial(
    ...
    deployment_name: str,
    *,
    json: Optional[_models.PartialBatchDeploymentPartialMinimalTrackedResourceWithProperties] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_create_or_update_request_initial(
    ...
    deployment_name: str,
    *,
    json: Optional[_models.BatchDeployment] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class BatchDeploymentsOperations:
    ...
    def list(
        ...
        skip: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable[_models.BatchDeploymentTrackedResourceArmPaginatedResult]:
