...
def build_update_request_initial(
    ...
    endpoint_name: str,
    *,
    json: Optional[_models.PartialMinimalTrackedResourceWithIdentity] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_create_or_update_request_initial(
    ...
    endpoint_name: str,
    *,
    json: Optional[_models.OnlineEndpoint] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_regenerate_keys_request_initial(
    ...
    endpoint_name: str,
    *,
    json: Optional[_models.RegenerateEndpointKeysRequest] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class OnlineEndpointsOperations:
    ...
    def list(
        ...
        order_by: Optional[Union[str, "_models.OrderString"]] = None,
        **kwargs: Any
    ) -> Iterable[_models.OnlineEndpointTrackedResourceArmPaginatedResult]:
