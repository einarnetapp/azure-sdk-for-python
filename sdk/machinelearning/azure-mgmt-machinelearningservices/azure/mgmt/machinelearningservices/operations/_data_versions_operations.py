...
def build_create_or_update_request(
    ...
    version: str,
    *,
    json: Optional[_models.DataVersionBase] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class DataVersionsOperations:
    ...
    def list(
        ...
        list_view_type: Optional[Union[str, "_models.ListViewType"]] = None,
        **kwargs: Any
    ) -> Iterable[_models.DataVersionBaseResourceArmPaginatedResult]:
        ...
        :param list_view_type: [ListViewType.ActiveOnly, ListViewType.ArchivedOnly,
         ListViewType.All]View type for including/excluding (for example) archived entities. Default
         value is None.
