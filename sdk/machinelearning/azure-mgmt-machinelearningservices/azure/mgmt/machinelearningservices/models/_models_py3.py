...
class Compute(_serialization.Model):
    ...
    def __init__(self, *, description: Optional[str] = None, resource_id: Optional[str] = None, **kwargs):
        """
...
class AKS(Compute, AKSSchema):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype resource_id: str
        """
        super().__init__(description=description, resource_id=resource_id, properties=properties, **kwargs)
        self.properties = properties
...
class Cron(_serialization.Model):
    ...
    def __init__(
        self, *, start_time: Optional[str] = None, time_zone: str = "UTC", expression: Optional[str] = None, **kwargs
    ):
        """
...
class DataFactory(Compute):
    ...
    def __init__(self, *, description: Optional[str] = None, resource_id: Optional[str] = None, **kwargs):
        ...
        :paramtype resource_id: str
        """
        super().__init__(description=description, resource_id=resource_id, **kwargs)
...
class RecurrenceSchedule(_serialization.Model):
    ...
    :ivar minutes: [Required] List of minutes for the schedule.
    :vartype minutes: list[int]
    :ivar hours: [Required] List of hours for the schedule.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword minutes: [Required] List of minutes for the schedule.
        :paramtype minutes: list[int]
        :keyword hours: [Required] List of hours for the schedule.
