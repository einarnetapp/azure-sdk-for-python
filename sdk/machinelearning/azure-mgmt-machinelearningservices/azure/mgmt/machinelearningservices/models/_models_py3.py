...
class DatastoreCredentials(msrest.serialization.Model):
    ...
    :ivar credentials_type: Required. [Required] Credential type used to authentication with
     storage.Constant filled by server. Known values are: "AccountKey", "Certificate", "None",
     "Sas", "ServicePrincipal".
...
class DatastoreSecrets(msrest.serialization.Model):
    ...
    :ivar secrets_type: Required. [Required] Credential type used to authentication with
     storage.Constant filled by server. Known values are: "AccountKey", "Certificate", "Sas",
     "ServicePrincipal".
...
class Compute(msrest.serialization.Model):
    ...
    :ivar compute_type: Required. The type of compute.Constant filled by server. Known values are:
     "AKS", "Kubernetes", "AmlCompute", "ComputeInstance", "DataFactory", "VirtualMachine",
...
class AKSSchemaProperties(msrest.serialization.Model):
    ...
    :ivar load_balancer_type: Load Balancer Type. Known values are: "PublicIp",
    ...
    def __init__(
        ...
        *,
        ...
        cluster_purpose: Optional[Union[str, "_models.ClusterPurpose"]] = "FastProd",
        ...
        load_balancer_type: Optional[Union[str, "_models.LoadBalancerType"]] = "PublicIp",
        ...
        **kwargs
        ...
        :paramtype aks_networking_configuration:
         ~azure.mgmt.machinelearningservices.models.AksNetworkingConfiguration
        :keyword load_balancer_type: Load Balancer Type. Known values are: "PublicIp",
         "InternalLoadBalancer". Default value: "PublicIp".
...
class AmlComputeProperties(msrest.serialization.Model):
    ...
    :ivar os_type: Compute OS Type. Known values are: "Linux", "Windows". Default value: "Linux".
    :vartype os_type: str or ~azure.mgmt.machinelearningservices.models.OsType
    :ivar vm_size: Virtual Machine Size.
    :vartype vm_size: str
    :ivar vm_priority: Virtual Machine priority. Known values are: "Dedicated", "LowPriority".
    ...
    :ivar allocation_state: Allocation state of the compute. Possible values are: steady -
     ...
     from the compute. Known values are: "Steady", "Resizing".
    ...
    def __init__(
        ...
        *,
        ...
        remote_login_port_public_access: Optional[Union[str, "_models.RemoteLoginPortPublicAccess"]] = "NotSpecified",
        enable_node_public_ip: Optional[bool] = True,
        property_bag: Optional[Any] = None,
        **kwargs
    ):
        """
        :keyword os_type: Compute OS Type. Known values are: "Linux", "Windows". Default value:
         "Linux".
        :paramtype os_type: str or ~azure.mgmt.machinelearningservices.models.OsType
        :keyword vm_size: Virtual Machine Size.
        :paramtype vm_size: str
        :keyword vm_priority: Virtual Machine priority. Known values are: "Dedicated", "LowPriority".
...
class AmlOperationListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.AmlOperation"]] = None,
        **kwargs
    ):
        """
...
class IdentityConfiguration(msrest.serialization.Model):
    ...
    :ivar identity_type: Required. [Required] Specifies the type of identity framework.Constant
     filled by server. Known values are: "Managed", "AMLToken", "UserIdentity".
...
class AssetJobInput(msrest.serialization.Model):
    ...
    :ivar mode: Input Asset Delivery Mode. Known values are: "ReadOnlyMount", "ReadWriteMount",
     "Download", "Direct", "EvalMount", "EvalDownload".
...
class AssetJobOutput(msrest.serialization.Model):
    ...
    :ivar mode: Output Asset Delivery Mode. Known values are: "ReadWriteMount", "Upload".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword mode: Output Asset Delivery Mode. Known values are: "ReadWriteMount", "Upload".
...
class AssetReferenceBase(msrest.serialization.Model):
    ...
    :ivar reference_type: Required. [Required] Specifies the type of asset reference.Constant
     filled by server. Known values are: "Id", "DataPath", "OutputPath".
...
class DatastoreProperties(ResourceBase):
    ...
    :ivar datastore_type: Required. [Required] Storage type backing the datastore.Constant filled
     by server. Known values are: "AzureBlob", "AzureDataLakeGen1", "AzureDataLakeGen2",
     "AzureFile".
...
class EarlyTerminationPolicy(msrest.serialization.Model):
    ...
    :ivar policy_type: Required. [Required] Name of policy configuration.Constant filled by server.
     Known values are: "Bandit", "MedianStopping", "TruncationSelection".
...
class BatchDeploymentProperties(EndpointDeploymentPropertiesBase):
    ...
    :ivar provisioning_state: Provisioning state for the endpoint deployment. Known values are:
     "Creating", "Deleting", "Scaling", "Updating", "Succeeded", "Failed", "Canceled".
    :vartype provisioning_state: str or
...
class BatchDeploymentTrackedResourceArmPaginatedResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        value: Optional[List["_models.BatchDeployment"]] = None,
        **kwargs
    ):
        """
...
class EndpointPropertiesBase(msrest.serialization.Model):
    ...
    :ivar auth_mode: Required. [Required] Use 'Key' for key based authentication and 'AMLToken' for
     ...
     Known values are: "AMLToken", "Key", "AADToken".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword auth_mode: Required. [Required] Use 'Key' for key based authentication and 'AMLToken'
         ...
         does. Known values are: "AMLToken", "Key", "AADToken".
...
class BatchEndpointTrackedResourceArmPaginatedResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.BatchEndpoint"]] = None,
        **kwargs
    ):
        """
...
configure the algorithm.
    ...
    :ivar sampling_algorithm_type: Required. [Required] The algorithm used for generating
     hyperparameter values, along with configuration properties.Constant filled by server. Known
     values are: "Grid", "Random", "Bayesian".
...
class CodeContainerResourceArmPaginatedResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.CodeContainer"]] = None,
        **kwargs
    ):
        """
...
class CodeVersionResourceArmPaginatedResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.CodeVersion"]] = None,
        **kwargs
    ):
        """
...
class JobBaseProperties(ResourceBase):
    ...
    :ivar is_archived: Is the asset archived?.
    :vartype is_archived: bool
    :ivar job_type: Required. [Required] Specifies the type of job.Constant filled by server. Known
     values are: "Command", "Sweep", "Pipeline".
    ...
    :ivar status: Status of the job. Known values are: "NotStarted", "Starting", "Provisioning",
     ...
     "Canceled", "NotResponding", "Paused", "Unknown".
...
class JobLimits(msrest.serialization.Model):
    ...
    :ivar job_limits_type: Required. [Required] JobLimit type.Constant filled by server. Known
     values are: "Command", "Sweep".
...
class ComputeInstanceContainer(msrest.serialization.Model):
    ...
    :vartype name: str
    :ivar autosave: Auto save settings. Known values are: "None", "Local", "Remote".
    :vartype autosave: str or ~azure.mgmt.machinelearningservices.models.Autosave
    :ivar gpu: Information of GPU.
    :vartype gpu: str
    :ivar network: network of this container. Known values are: "Bridge", "Host".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype name: str
        :keyword autosave: Auto save settings. Known values are: "None", "Local", "Remote".
        :paramtype autosave: str or ~azure.mgmt.machinelearningservices.models.Autosave
        :keyword gpu: Information of GPU.
        :paramtype gpu: str
        :keyword network: network of this container. Known values are: "Bridge", "Host".
...
class ComputeInstanceDataDisk(msrest.serialization.Model):
    ...
    :ivar caching: Caching type of Data Disk. Known values are: "None", "ReadOnly", "ReadWrite".
    ...
    :vartype lun: int
    :ivar storage_account_type: type of this storage account. Known values are: "Standard_LRS",
     "Premium_LRS". Default value: "Standard_LRS".
    ...
    def __init__(
        ...
        *,
        ...
        storage_account_type: Optional[Union[str, "_models.StorageAccountType"]] = "Standard_LRS",
        **kwargs
    ):
        """
        :keyword caching: Caching type of Data Disk. Known values are: "None", "ReadOnly", "ReadWrite".
...
class ComputeInstanceDataMount(msrest.serialization.Model):
    ...
    :vartype source: str
    :ivar source_type: Data source type. Known values are: "Dataset", "Datastore", "URI".
    ...
    :ivar mount_action: Mount Action. Known values are: "Mount", "Unmount".
    ...
    :ivar mount_state: Mount state. Known values are: "MountRequested", "Mounted", "MountFailed",
     "UnmountRequested", "UnmountFailed", "Unmounted".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword source_type: Data source type. Known values are: "Dataset", "Datastore", "URI".
        ...
        :keyword mount_action: Mount Action. Known values are: "Mount", "Unmount".
...
class ComputeInstanceLastOperation(msrest.serialization.Model):
    ...
    :ivar operation_trigger: Trigger of operation. Known values are: "User", "Schedule",
     "IdleShutdown".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword operation_trigger: Trigger of operation. Known values are: "User", "Schedule",
         "IdleShutdown".
...
class ComputeInstanceProperties(msrest.serialization.Model):
    ...
    :ivar application_sharing_policy: Policy for sharing applications on this compute instance
     ...
     depending on his/her assigned role. Known values are: "Personal", "Shared". Default value:
     "Shared".
    ...
    :ivar compute_instance_authorization_type: The Compute Instance Authorization type. Available
     values are personal (default). Known values are: "personal". Default value: "personal".
    ...
    def __init__(
        ...
        *,
        vm_size: Optional[str] = None,
        subnet: Optional["_models.ResourceId"] = None,
        application_sharing_policy: Optional[Union[str, "_models.ApplicationSharingPolicy"]] = "Shared",
        ssh_settings: Optional["_models.ComputeInstanceSshSettings"] = None,
        compute_instance_authorization_type: Optional[Union[str, "_models.ComputeInstanceAuthorizationType"]] = "personal",
        ...
        **kwargs
        ...
        :keyword compute_instance_authorization_type: The Compute Instance Authorization type.
         Available values are personal (default). Known values are: "personal". Default value:
         "personal".
...
class ComputeInstanceSshSettings(msrest.serialization.Model):
    ...
    :ivar ssh_public_access: State of the public SSH port. Possible values are: Disabled -
     ...
     values are: "Enabled", "Disabled". Default value: "Disabled".
    ...
    :ivar admin_public_keys: List of keys (with friendly names) authorized for SSH. If specified,
     the value of 'adminPublicKey' is ignored.
    :vartype admin_public_keys: dict[str,
     ~azure.mgmt.machinelearningservices.models.SshPublicKeyReference]
    """
    ...
    _attribute_map = {
        ...
        'admin_public_keys': {'key': 'adminPublicKeys', 'type': '{SshPublicKeyReference}'},
    }

    def __init__(
        self,
        *,
        ssh_public_access: Optional[Union[str, "_models.SshPublicAccess"]] = "Disabled",
        admin_public_key: Optional[str] = None,
        admin_public_keys: Optional[Dict[str, "_models.SshPublicKeyReference"]] = None,
        **kwargs
    ):
        """
        ...
        :keyword admin_public_keys: List of keys (with friendly names) authorized for SSH. If
         specified, the value of 'adminPublicKey' is ignored.
        :paramtype admin_public_keys: dict[str,
         ~azure.mgmt.machinelearningservices.models.SshPublicKeyReference]
        """
...
class ComputeStartStopSchedule(msrest.serialization.Model):
    ...
    :ivar action: The compute power action. Known values are: "Start", "Stop".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword action: The compute power action. Known values are: "Start", "Stop".
...
class JobInput(msrest.serialization.Model):
    ...
    :ivar job_input_type: Required. [Required] Specifies the type of job.Constant filled by server.
     Known values are: "literal", "uri_file", "uri_folder", "mltable", "custom_model",
...
class JobOutput(msrest.serialization.Model):
    ...
    :ivar job_output_type: Required. [Required] Specifies the type of job.Constant filled by
     server. Known values are: "uri_file", "uri_folder", "mltable", "custom_model", "mlflow_model",
     "triton_model".
...
class DataContainerProperties(AssetContainer):
    ...
    :ivar next_version: The next auto incremental version.
    :vartype next_version: str
    :ivar data_type: Required. [Required] Specifies the type of data. Known values are: "uri_file",
     "uri_folder", "mltable".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword is_archived: Is the asset archived?.
        :paramtype is_archived: bool
        :keyword data_type: Required. [Required] Specifies the type of data. Known values are:
...
class DataContainerResourceArmPaginatedResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.DataContainer"]] = None,
        **kwargs
    ):
        """
...
class DatastoreResourceArmPaginatedResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.Datastore"]] = None,
        **kwargs
    ):
        """
...
class DataVersionBaseProperties(AssetBase):
    ...
    :ivar data_type: Required. [Required] Specifies the type of data.Constant filled by server.
     Known values are: "uri_file", "uri_folder", "mltable".
    :vartype data_type: str or ~azure.mgmt.machinelearningservices.models.DataType
...
class DataVersionBaseResourceArmPaginatedResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.DataVersionBase"]] = None,
        **kwargs
    ):
        """
...
class OnlineScaleSettings(msrest.serialization.Model):
    ...
    :ivar scale_type: Required. [Required] Type of deployment scaling algorithm.Constant filled by
     server. Known values are: "Default", "TargetUtilization".
...
class DistributionConfiguration(msrest.serialization.Model):
    ...
    :ivar distribution_type: Required. [Required] Specifies the type of distribution
     framework.Constant filled by server. Known values are: "PyTorch", "TensorFlow", "Mpi".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword status: Required. Indicates whether or not the encryption is enabled for the
         workspace. Known values are: "Enabled", "Disabled".
...
class EnvironmentVersionProperties(AssetBase):
    ...
    :ivar environment_type: Environment type is either user managed or curated by the Azure ML
     ...
     />. Known values are: "Curated", "UserCreated".
    ...
    :ivar os_type: The OS type of the environment. Known values are: "Linux", "Windows".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype inference_config:
         ~azure.mgmt.machinelearningservices.models.InferenceContainerProperties
        :keyword os_type: The OS type of the environment. Known values are: "Linux", "Windows".
...
class EstimatedVMPrice(msrest.serialization.Model):
    ...
    :ivar os_type: Required. Operating system type used by the VM. Known values are: "Linux",
     "Windows".
    :vartype os_type: str or ~azure.mgmt.machinelearningservices.models.VMPriceOSType
    :ivar vm_tier: Required. The type of the VM. Known values are: "Standard", "LowPriority",
     "Spot".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword os_type: Required. Operating system type used by the VM. Known values are: "Linux",
         "Windows".
        :paramtype os_type: str or ~azure.mgmt.machinelearningservices.models.VMPriceOSType
        :keyword vm_tier: Required. The type of the VM. Known values are: "Standard", "LowPriority",
         "Spot".
...
class EstimatedVMPrices(msrest.serialization.Model):
    ...
    :ivar billing_currency: Required. Three lettered code specifying the currency of the VM price.
     Example: USD. Known values are: "USD".
    ...
    :ivar unit_of_measure: Required. The unit of time measurement for the specified VM price.
     Example: OneHour. Known values are: "OneHour".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword billing_currency: Required. Three lettered code specifying the currency of the VM
         price. Example: USD. Known values are: "USD".
...
class ExternalFQDNResponse(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.FQDNEndpoints"]] = None,
        **kwargs
    ):
        """
        :keyword value:
...
class JobBaseResourceArmPaginatedResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.JobBase"]] = None,
        **kwargs
    ):
        """
...
class OnlineDeploymentProperties(EndpointDeploymentPropertiesBase):
    ...
    :ivar endpoint_compute_type: Required. [Required] The compute type of the endpoint.Constant
     filled by server. Known values are: "Managed", "Kubernetes", "AzureMLCompute".
...
class WorkspaceConnectionPropertiesV2(msrest.serialization.Model):
    ...
    :ivar auth_type: Required. Authentication type of the connection target.Constant filled by
     server. Known values are: "PAT", "ManagedIdentity", "UsernamePassword", "None", "SAS".
    ...
    :vartype value: str
    :ivar value_format: format for the workspace connection value. Known values are: "JSON".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype value: str
        :keyword value_format: format for the workspace connection value. Known values are: "JSON".
...
class ModelContainerResourceArmPaginatedResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.ModelContainer"]] = None,
        **kwargs
    ):
        """
...
class ModelVersionResourceArmPaginatedResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.ModelVersion"]] = None,
        **kwargs
    ):
        """
...
class Objective(msrest.serialization.Model):
    ...
    :ivar goal: Required. [Required] Defines supported metric goals for hyperparameter tuning.
     Known values are: "Minimize", "Maximize".
...
class OnlineEndpointTrackedResourceArmPaginatedResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.OnlineEndpoint"]] = None,
        **kwargs
    ):
        """
...
class PaginatedComputeResourcesList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.ComputeResource"]] = None,
        next_link: Optional[str] = None,
        **kwargs
    ):
        """
...
class PartialManagedServiceIdentity(msrest.serialization.Model):
    ...
    :ivar type: Managed service identity (system assigned and/or user assigned identities). Known
     values are: "None", "SystemAssigned", "UserAssigned", "SystemAssigned,UserAssigned".
    :vartype type: str or ~azure.mgmt.machinelearningservices.models.ManagedServiceIdentityType
    :ivar user_assigned_identities: The set of user assigned identities associated with the
     resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form:
     '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}.
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword type: Managed service identity (system assigned and/or user assigned identities).
         Known values are: "None", "SystemAssigned", "UserAssigned", "SystemAssigned,UserAssigned".
        :paramtype type: str or ~azure.mgmt.machinelearningservices.models.ManagedServiceIdentityType
        :keyword user_assigned_identities: The set of user assigned identities associated with the
         resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form:
         '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}.
...
class PrivateLinkServiceConnectionState(msrest.serialization.Model):
    ...
    :ivar status: Indicates whether the connection has been Approved/Rejected/Removed by the owner
     of the service. Known values are: "Pending", "Approved", "Rejected", "Disconnected", "Timeout".
...
class QuotaBaseProperties(msrest.serialization.Model):
    ...
    :vartype limit: long
    :ivar unit: An enum describing the unit of quota measurement. Known values are: "Count".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword unit: An enum describing the unit of quota measurement. Known values are: "Count".
...
class RandomSamplingAlgorithm(SamplingAlgorithm):
    ...
    :vartype sampling_algorithm_type: str or
     ~azure.mgmt.machinelearningservices.models.SamplingAlgorithmType
    :ivar rule: The specific type of random algorithm. Known values are: "Random", "Sobol".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword rule: The specific type of random algorithm. Known values are: "Random", "Sobol".
...
class RegenerateEndpointKeysRequest(msrest.serialization.Model):
    ...
    :ivar key_type: Required. [Required] Specification for which type of key to generate. Primary
     or Secondary. Known values are: "Primary", "Secondary".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword key_type: Required. [Required] Specification for which type of key to generate.
         Primary or Secondary. Known values are: "Primary", "Secondary".
...
class ScheduleBase(msrest.serialization.Model):
    ...
    :ivar id:
    :vartype id: str
    :ivar provisioning_status: Known values are: "Completed", "Provisioning", "Failed".
    :vartype provisioning_status: str or
     ~azure.mgmt.machinelearningservices.models.ScheduleProvisioningState
    :ivar status: Known values are: "Enabled", "Disabled".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword id:
        :paramtype id: str
        :keyword provisioning_status: Known values are: "Completed", "Provisioning", "Failed".
        :paramtype provisioning_status: str or
         ~azure.mgmt.machinelearningservices.models.ScheduleProvisioningState
        :keyword status: Known values are: "Enabled", "Disabled".
...
class SkuResourceArmPaginatedResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.SkuResource"]] = None,
        **kwargs
    ):
        """
...
class SshPublicKeyReference(msrest.serialization.Model):
    """SshPublicKeyReference.

    :ivar source:
    :vartype source: str
    :ivar data: SSH public key data as string (local).
    :vartype data: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword source:
        :paramtype source: str
        :keyword data: SSH public key data as string (local).
        :paramtype data: str
        """
        super(SshPublicKeyReference, self).__init__(**kwargs)
        self.source = source
        self.data = data
...
class SslConfiguration(msrest.serialization.Model):
    ...
    :ivar status: Enable or disable ssl for scoring. Known values are: "Disabled", "Enabled",
     "Auto".
...
class UpdateWorkspaceQuotas(msrest.serialization.Model):
    ...
    :ivar status: Status of update workspace quota. Known values are: "Undefined", "Success",
     ...
     "InvalidVMFamilyName", "OperationNotSupportedForSku", "OperationNotEnabledForRegion".
...
class Usage(msrest.serialization.Model):
    ...
    :ivar type: Specifies the resource type.
    :vartype type: str
    :ivar unit: An enum describing the unit of usage measurement. Known values are: "Count".
