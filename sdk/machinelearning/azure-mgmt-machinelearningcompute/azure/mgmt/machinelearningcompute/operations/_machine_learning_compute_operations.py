...
def build_list_available_operations_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.MachineLearningCompute/operations")
...
class MachineLearningComputeOperations:
    ...
    @distributed_trace
    def list_available_operations(self, **kwargs: Any) -> _models.AvailableOperations:
