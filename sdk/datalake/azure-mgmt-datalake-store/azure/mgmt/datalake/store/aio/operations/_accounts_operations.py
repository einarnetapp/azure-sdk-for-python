...
from ...operations._accounts_operations import (
    ...
    build_enable_key_vault_request,
    build_get_request,
...
class AccountsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.DataLakeStoreAccountBasic"]:
        ...
        :return: An iterator like instance of either DataLakeStoreAccountBasic or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datalake.store.models.DataLakeStoreAccountBasic]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either DataLakeStoreAccount or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.datalake.store.models.DataLakeStoreAccount]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, account_name: str, **kwargs: Any) -> _models.DataLakeStoreAccount:
    ...
    @distributed_trace_async
    async def enable_key_vault(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, account_name: str, **kwargs: Any
    ) -> None:
