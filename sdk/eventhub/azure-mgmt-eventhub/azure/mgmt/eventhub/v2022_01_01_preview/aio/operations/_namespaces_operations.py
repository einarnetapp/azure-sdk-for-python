...
class NamespacesOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.EHNamespace"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.eventhub.v2022_01_01_preview.models.EHNamespace]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either EHNamespace or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.eventhub.v2022_01_01_preview.models.EHNamespace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        :param namespace_name: The Namespace name. Required.
        :type namespace_name: str
        :param parameters: Parameters for creating a namespace resource. Is either a model type or a IO
         type. Required.
    ...
    async def create_or_update_authorization_rule(
        ...
        **kwargs: Any
        ...
        :param authorization_rule_name: The authorization rule name. Required.
        :type authorization_rule_name: str
        :param parameters: The shared access AuthorizationRule. Is either a model type or a IO type.
         Required.
    ...
    async def regenerate_keys(
        ...
        **kwargs: Any
        ...
        :param authorization_rule_name: The authorization rule name. Required.
        :type authorization_rule_name: str
        :param parameters: Parameters required to regenerate the connection string. Is either a model
