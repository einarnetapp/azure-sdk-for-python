...
from ...operations._consumer_groups_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_event_hub_request
T = TypeVar('T')
    ...
    def list_by_event_hub(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ConsumerGroupListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.eventhub.v2021_01_01_preview.models.ConsumerGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
