...
class DisasterRecoveryConfigsOperations:
    ...
    async def check_name_availability(
        ...
        **kwargs: Any
        ...
        :param namespace_name: The Namespace name. Required.
        :type namespace_name: str
        :param parameters: Parameters to check availability of the given Alias name. Is either a model
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.eventhub.v2021_06_01_preview.models.ArmDisasterRecovery]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
