...
class MicrosoftSerialConsoleClientOperationsMixin(MixinABC):
    @distributed_trace_async
    async def list_operations(
        self, **kwargs: Any
    ) -> Union[_models.SerialConsoleOperations, _models.SerialConsoleOperationsForbidden]:
        """Gets a list of Serial Console API operations.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SerialConsoleOperations or SerialConsoleOperationsForbidden or the result of
         cls(response)
        :rtype: ~azure.mgmt.serialconsole.models.SerialConsoleOperations or
         ~azure.mgmt.serialconsole.models.SerialConsoleOperationsForbidden
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[Union[_models.SerialConsoleOperations, _models.SerialConsoleOperationsForbidden]]
        ...
        if response.status_code == 403:
            deserialized = self._deserialize("SerialConsoleOperationsForbidden", pipeline_response)
