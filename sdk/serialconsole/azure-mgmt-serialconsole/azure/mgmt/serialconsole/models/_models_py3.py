...
class DisableSerialConsoleResult(_serialization.Model):
    ...
    :ivar properties: Returns whether or not Serial Console is disabled.
    :vartype properties: ~azure.mgmt.serialconsole.models.SerialConsoleState
    """

    _attribute_map = {
        "properties": {"key": "properties", "type": "SerialConsoleState"},
    }

    def __init__(self, *, properties: Optional["_models.SerialConsoleState"] = None, **kwargs):
        """
        :keyword properties: Returns whether or not Serial Console is disabled.
        :paramtype properties: ~azure.mgmt.serialconsole.models.SerialConsoleState
        """
        super().__init__(**kwargs)
...
class SerialConsoleOperationsForbidden(_serialization.Model):
    """The provided authentication information was insufficient for access to Serial Console.

    :ivar code: Error code.
    :vartype code: str
    :ivar message: Serial console access forbidden.
    :vartype message: str
    """
    ...
    def __init__(self, *, code: Optional[str] = None, message: Optional[str] = None, **kwargs):
        ...
        :keyword code: Error code.
        :paramtype code: str
        :keyword message: Serial console access forbidden.
        :paramtype message: str
        """
        super().__init__(**kwargs)
        self.code = code
...
class SerialConsoleState(_serialization.Model):
    """Returns whether or not Serial Console is disabled.
