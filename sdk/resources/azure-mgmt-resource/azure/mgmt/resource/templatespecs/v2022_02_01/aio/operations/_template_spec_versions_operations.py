...
from ...operations._template_spec_versions_operations import build_create_or_update_request, build_delete_request, build_get_built_in_request, build_get_request, build_list_built_ins_request, build_list_request, build_update_request
T = TypeVar('T')
