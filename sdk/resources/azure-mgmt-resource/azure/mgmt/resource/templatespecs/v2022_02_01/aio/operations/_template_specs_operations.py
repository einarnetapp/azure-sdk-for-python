...
from ...operations._template_specs_operations import build_create_or_update_request, build_delete_request, build_get_built_in_request, build_get_request, build_list_built_ins_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_update_request
T = TypeVar('T')
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_built_ins_request(
                    expand=expand,
