...
class ResourcePrivateLinkClient(MultiApiClientMixin, _SDKClient):
    ...
    def private_link_resources(self):
        """Instance depends on the API version:
           ...
           * 2020-05-01: :class:`PrivateLinkResourcesOperations<azure.mgmt.resource.privatelinks.v2020_05_01.aio.operations.PrivateLinkResourcesOperations>`
        """
        api_version = self._get_api_version('private_link_resources')
        if api_version == '2020-05-01':
            from ..v2020_05_01.aio.operations import PrivateLinkResourcesOperations as OperationClass
        else:
