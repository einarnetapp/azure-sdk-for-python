...
class ApplicationClientOperationsMixin(MixinABC):
    ...
    def list_operations(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.managedapplications.v2018_06_01.models.OperationListResult]
...
class ApplicationsOperations:
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ApplicationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.managedapplications.v2018_06_01.models.ApplicationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def update_access(
        ...
        **kwargs: Any
    ) -> _models.UpdateAccessDefinition:
        ...
        :type parameters:
         ~azure.mgmt.resource.managedapplications.v2018_06_01.models.UpdateAccessDefinition
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: UpdateAccessDefinition, or the result of cls(response)
        :rtype: ~azure.mgmt.resource.managedapplications.v2018_06_01.models.UpdateAccessDefinition
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        ...
        request = build_applications_update_access_request(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            application_name=application_name,
            api_version=api_version,
            content_type=content_type,
            json=_json,
            template_url=self.update_access.metadata['url'],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    update_access.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Solutions/applications/{applicationName}/updateAccess"}  # type: ignore
    ...
    def list_tokens(
        ...
        **kwargs: Any
        ...
        :type application_name: str
        :param parameters: Request body parameters to list tokens.
        :type parameters: ~azure.mgmt.resource.managedapplications.v2018_06_01.models.ListTokenRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ManagedIdentityTokenResult, or the result of cls(response)
        :rtype: ~azure.mgmt.resource.managedapplications.v2018_06_01.models.ManagedIdentityTokenResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        ...
        request = build_applications_list_tokens_request(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            application_name=application_name,
            api_version=api_version,
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ApplicationDefinitionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.managedapplications.v2018_06_01.models.ApplicationDefinitionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
