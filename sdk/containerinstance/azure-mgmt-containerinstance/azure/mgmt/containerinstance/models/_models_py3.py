...
class ContainerGroupProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar retry_timeout_minutes: The retry timeout from 1 to 30 minutes for container group.
    :vartype retry_timeout_minutes: int
    ...
    _attribute_map = {
        ...
        "retry_timeout_minutes": {"key": "properties.retryTimeoutMinutes", "type": "int"},
    ...
    def __init__(
        ...
        *,
        ...
        retry_timeout_minutes: Optional[int] = None,
        ...
        **kwargs
        ...
        :paramtype restart_policy: str or
         ~azure.mgmt.containerinstance.models.ContainerGroupRestartPolicy
        :keyword retry_timeout_minutes: The retry timeout from 1 to 30 minutes for container group.
        :paramtype retry_timeout_minutes: int
        ...
        self.retry_timeout_minutes = retry_timeout_minutes
