...
class IpAddress(_serialization.Model):
    ...
    :ivar auto_generated_domain_name_label_scope: The value representing the security enum. Known
     values are: "Default value if not selected and means the object's domain name label is not
     secured against subdomain takeover.", "Default value if selected and means the object's domain
     name label can be reused within the same tenant.", "Object's domain name label can be reused
     within the same subscription.", "Object's domain name label can be reused within the same
     resource group.", and "Object's domain name label cannot be reused within the same resource
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword auto_generated_domain_name_label_scope: The value representing the security enum.
         Known values are: "Default value if not selected and means the object's domain name label is
         not secured against subdomain takeover.", "Default value if selected and means the object's
         domain name label can be reused within the same tenant.", "Object's domain name label can be
         reused within the same subscription.", "Object's domain name label can be reused within the
         same resource group.", and "Object's domain name label cannot be reused within the same
         resource group, subscription, or tenant.".
