...
class ContainerGroupProperties(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super(ContainerGroupProperties, self).__init__(**kwargs)
...
class IpAddress(msrest.serialization.Model):
    ...
    :ivar auto_generated_domain_name_label_scope: The value representing the security enum. Known
     values are: "Unsecure", "TenantReuse", "SubscriptionReuse", "ResourceGroupReuse", "Noreuse".
     Default value: "Unsecure".
    ...
    def __init__(
        ...
        *,
        ...
        auto_generated_domain_name_label_scope: Optional[Union[str, "_models.DnsNameLabelReusePolicy"]] = "Unsecure",
        **kwargs
    ):
        """
        ...
        :keyword auto_generated_domain_name_label_scope: The value representing the security enum.
         Known values are: "Unsecure", "TenantReuse", "SubscriptionReuse", "ResourceGroupReuse",
         "Noreuse". Default value: "Unsecure".
