...
class CheckQuotaAvailabilityResponse(Resource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.loadtestservice.models.SystemData
    :ivar is_available: true if Quota is Available, else false.
    :vartype is_available: bool
    :ivar availability_status: availability Status of the quota bucket.
    ...
    def __init__(self, *, is_available: Optional[bool] = None, availability_status: Optional[str] = None, **kwargs):
        """
        :keyword is_available: true if Quota is Available, else false.
        :paramtype is_available: bool
        :keyword availability_status: availability Status of the quota bucket.
...
class EndpointDependency(_serialization.Model):
    ...
    :vartype endpoint_details: list[~azure.mgmt.loadtestservice.models.EndpointDetail]
    """
...
class OutboundEnvironmentEndpoint(_serialization.Model):
    ...
    :ivar endpoints: The endpoints for this service to which the Batch service makes outbound
     calls.
    :vartype endpoints: list[~azure.mgmt.loadtestservice.models.EndpointDependency]
    """
...
class OutboundEnvironmentEndpointCollection(_serialization.Model):
    ...
    :ivar value: The collection of outbound network dependency endpoints returned by the listing
     operation.
    :vartype value: list[~azure.mgmt.loadtestservice.models.OutboundEnvironmentEndpoint]
...
class QuotaBucketRequest(Resource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.loadtestservice.models.SystemData
    :ivar current_usage: Current Usage of the quota bucket.
    :vartype current_usage: int
    :ivar current_quota: Current Quota of the quota bucket.
    :vartype current_quota: int
    :ivar new_quota: New Requested Quota of the quota bucket.
    :vartype new_quota: int
    :ivar dimensions: Dimensions for new quota request of the quota bucket.
    :vartype dimensions: ~azure.mgmt.loadtestservice.models.QuotaBucketRequestPropertiesDimensions
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword current_usage: Current Usage of the quota bucket.
        :paramtype current_usage: int
        :keyword current_quota: Current Quota of the quota bucket.
        :paramtype current_quota: int
        :keyword new_quota: New Requested Quota of the quota bucket.
        :paramtype new_quota: int
        :keyword dimensions: Dimensions for new quota request of the quota bucket.
        :paramtype dimensions:
         ~azure.mgmt.loadtestservice.models.QuotaBucketRequestPropertiesDimensions
        """
        super().__init__(**kwargs)
...
class QuotaResource(Resource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.loadtestservice.models.SystemData
    :ivar limit: Quota Limit of the quota bucket.
    :vartype limit: int
    :ivar usage: Current Usage of the quota bucket.
    :vartype usage: int
    :ivar provisioning_state: Resource provisioning state. Known values are: "Succeeded", "Failed",
     "Canceled", and "Deleted".
    :vartype provisioning_state: str or ~azure.mgmt.loadtestservice.models.ResourceState
    ...
    def __init__(self, *, limit: Optional[int] = None, usage: Optional[int] = None, **kwargs):
        """
        :keyword limit: Quota Limit of the quota bucket.
        :paramtype limit: int
        :keyword usage: Current Usage of the quota bucket.
        :paramtype usage: int
        """
        super().__init__(**kwargs)
        self.limit = limit
...
class QuotaResourceList(_serialization.Model):
    ...
    :ivar value: List of Quota Bucket details by the loadtestservice resource provider.
    :vartype value: list[~azure.mgmt.loadtestservice.models.QuotaResource]
    :ivar next_link: URL to get the next set of Quota Bucket details results (if there are any).
    :vartype next_link: str
    """
