...
def build_app_component_get_request(name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_app_component_get_by_test_or_test_run_request(
...
def build_server_metrics_create_or_update_request(name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_server_metrics_get_request(name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_server_metrics_delete_request(name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_server_metrics_get_by_test_or_test_run_request(
    *, test_run_id: Optional[str] = None, test_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_server_metrics_get_default_metrics_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_test_create_or_update_request(test_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_test_delete_request(test_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_test_get_request(test_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_test_get_file_request(test_id: str, file_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_test_delete_file_request(test_id: str, file_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_test_get_all_files_request(
...
def build_test_run_delete_request(test_run_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_test_run_create_or_update_request(
...
def build_test_run_get_request(test_run_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_test_run_get_file_request(test_run_id: str, file_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_test_run_list_request(
    *,
    order_by: Optional[str] = None,
    continuation_token_parameter: Optional[str] = None,
    search: Optional[str] = None,
...
def build_test_run_stop_request(test_run_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_test_run_metric_namespaces_request(test_run_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/testRuns/{testRunId}/metricNamespaces"
    path_format_arguments = {
        "testRunId": _SERIALIZER.url(
            "test_run_id", test_run_id, "str", max_length=50, min_length=2, pattern=r"^[a-z0-9_-]*$"
        ),
...
def build_test_run_metric_definitions_request(test_run_id: str, *, metricnamespace: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/testRuns/{testRunId}/metricDefinitions"
    path_format_arguments = {
        "testRunId": _SERIALIZER.url(
            "test_run_id", test_run_id, "str", max_length=50, min_length=2, pattern=r"^[a-z0-9_-]*$"
        ),
...
def build_test_run_metrics_request(
    test_run_id: str,
    *,
    metricname: str,
    metricnamespace: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/testRuns/{testRunId}/metrics"
    path_format_arguments = {
        "testRunId": _SERIALIZER.url(
            "test_run_id", test_run_id, "str", max_length=50, min_length=2, pattern=r"^[a-z0-9_-]*$"
        ),
...
class AppComponentOperations:
    ...
    def create_or_update(
        ...
        :param name: Unique name of the app component, must contain only lower-case alphabetic,
    ...
    @distributed_trace
    def get(self, name: str, **kwargs: Any) -> JSON:
        ...
        request = build_app_component_get_request(
            name=name,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    @distributed_trace
    def get_by_test_or_test_run(self, *, test_run_id: Optional[str] = None, **kwargs: Any) -> JSON:
        """Get an app component for a test or a test run by its name.

        Get an app component for a test or a test run by its name.

        :keyword test_run_id: Required testRunId, if testId field is not provided. Default value is
         None.
        ...
        request = build_app_component_get_by_test_or_test_run_request(
...
class ServerMetricsOperations:
    ...
    def create_or_update(
        ...
        :param name: Unique name for server metrics, must contain only lower-case alphabetic, numeric,
        ...
        Example:
            .. code-block:: python
                ...
                body = {
                    ...
                    "name": "str",  # Optional. Server metrics configuration model.
                    "testId": "str",  # Optional. [Required, if test run Id is not given] Load
                      test unique name.
                    "testRunId": "str"  # Optional. [Required, if test Id is not given] Load test
                      run unique name.
                }
    ...
    def get(self, name: str, **kwargs: Any) -> JSON:
        ...
        request = build_server_metrics_get_request(
            name=name,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    def delete(self, name: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        request = build_server_metrics_delete_request(
            name=name,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    def get_by_test_or_test_run(self, *, test_run_id: Optional[str] = None, **kwargs: Any) -> JSON:
        ...
        request = build_server_metrics_get_by_test_or_test_run_request(
            test_run_id=test_run_id,
            test_id=self._config.test_id,
            api_version=self._config.api_version,
            headers=_headers,
    ...
    @distributed_trace
    def get_default_metrics(self, **kwargs: Any) -> JSON:
            ...
            .. code-block:: python
                ...
                response == {
                    "defaultMetrics": {
                        "str": [
                            {
                                "aggregation": "str",  # Optional. Metric
                                  aggregation.
                                "displayDescription": "str",  # Optional. Metric
                                  display description.
                                "metricnamespace": "str",  # Optional. Metric
                                  namespace.
                                "name": {
        ...
        request = build_server_metrics_get_default_metrics_request(
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
        )
...
class TestOperations:
                ...
                body = {
                    ...
                    "inputArtifacts": {
                        "additionalUrls": [
                            {
                                ...
                                "validationStatus": "str"  # Optional. Validation
                                  ...
                                  "VALIDATION_SUCCESS", "VALIDATION_FAILURE", and
                        ...
                        "configUrl": {
                            ...
                            "validationStatus": "str"  # Optional. Validation status of
                              ...
                              "VALIDATION_FAILURE", and "VALIDATION_INITIATED".
                        },
                    ...
                    "loadTestConfig": {
                        ...
                        "optionalLoadTestConfig": {
                            ...
                            "endpointUrl": "str",  # Optional. Endpoint url.
                            "rampUpTime": 0,  # Optional. ramp up time.
                            "vusers": 0  # Optional. No of virtual users.
                        },
    ...
    @distributed_trace
    def create_or_update(self, test_id: str, body: Union[JSON, IO], **kwargs: Any) -> JSON:
        """Create a new test or update an existing test.
        ...
        request = build_test_create_or_update_request(
            test_id=test_id,
            content_type=content_type,
            api_version=self._config.api_version,
            json=_json,
    ...
    @distributed_trace
    def delete(self, test_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        request = build_test_delete_request(
            test_id=test_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    @distributed_trace
    def get(self, test_id: str, **kwargs: Any) -> JSON:
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_test_list_request(
                    order_by=order_by,
                    search=search,
    ...
    @distributed_trace
    def get_file(self, test_id: str, file_id: str, **kwargs: Any) -> JSON:
            ...
            .. code-block:: python
                ...
                response == {
                    ...
                    "validationStatus": "str"  # Optional. Validation status of the file. Known
                      values are: "NOT_VALIDATED", "VALIDATION_SUCCESS", "VALIDATION_FAILURE", and
                      "VALIDATION_INITIATED".
                }
        """
        error_map = {
        ...
        request = build_test_get_file_request(
            test_id=test_id,
            file_id=file_id,
            api_version=self._config.api_version,
            headers=_headers,
    ...
    def delete_file(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_test_delete_file_request(
            test_id=test_id,
            file_id=file_id,
            api_version=self._config.api_version,
            headers=_headers,
    ...
    def get_all_files(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_test_get_all_files_request(
                    test_id=test_id,
                    continuation_token_parameter=continuation_token_parameter,
                    api_version=self._config.api_version,
                    headers=_headers,
...
class TestRunOperations:
    ...
    @distributed_trace
    def delete(self, test_run_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        request = build_test_run_delete_request(
            test_run_id=test_run_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    def create_or_update(
        ...
        request = build_test_run_create_or_update_request(
            test_run_id=test_run_id,
    ...
    @distributed_trace
    def get(self, test_run_id: str, **kwargs: Any) -> JSON:
        ...
        request = build_test_run_get_request(
            test_run_id=test_run_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    @distributed_trace
    def get_file(self, test_run_id: str, file_id: str, **kwargs: Any) -> JSON:
        ...
        request = build_test_run_get_file_request(
            test_run_id=test_run_id,
            file_id=file_id,
            api_version=self._config.api_version,
            headers=_headers,
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :keyword search: Filter search based on searchable fields - description, executedUser. Default
         value is None.
        :paramtype search: str
        :keyword execution_from: End DateTime(ISO 8601 literal format) of test-run execution time
         filter range. Default value is None.
        :paramtype execution_from: ~datetime.datetime
        :keyword execution_to: Start DateTime(ISO 8601 literal format) of test-run execution time
         filter range. Default value is None.
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_test_run_list_request(
                    order_by=order_by,
                    continuation_token_parameter=continuation_token_parameter,
                    search=search,
    ...
    @distributed_trace
    def stop(self, test_run_id: str, **kwargs: Any) -> JSON:
        ...
        request = build_test_run_stop_request(
            test_run_id=test_run_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    @distributed_trace
    def metric_namespaces(self, test_run_id: str, **kwargs: Any) -> JSON:
        ...
        request = build_test_run_metric_namespaces_request(
            test_run_id=test_run_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    @distributed_trace
    def metric_definitions(self, test_run_id: str, *, metricnamespace: str, **kwargs: Any) -> JSON:
        ...
        :param test_run_id: Unique name for the load test run, must contain only lower-case alphabetic,
         numeric, underscore or hyphen characters. Required.
        :type test_run_id: str
        :keyword metricnamespace: Metric namespace to query metric definitions for. Required.
        ...
        request = build_test_run_metric_definitions_request(
            test_run_id=test_run_id,
            ...
            .. code-block:: python
                ...
                response == {
                    ...
                    "timespan": "str",  # Optional. The timespan for which the data was
                      ...
                      requested.
                    "value": {
                        "displayDescription": "str",  # Optional. Detailed description of
                          this metric.
                        "id": "str",  # Optional. The Metric Id.
                        "name": {
    ...
    def metrics(
        ...
        **kwargs: Any
        ...
        request = build_test_run_metrics_request(
            test_run_id=test_run_id,
