...
class CustomerManagedKeyEncryptionProperties(_serialization.Model):
    ...
    :ivar customer_managed_key_identity: All identity configuration for Customer-managed key
     settings defining which identity should be used to auth to Key Vault.
    :vartype customer_managed_key_identity:
     ~azure.mgmt.loadtesting.models.EncryptionPropertiesIdentity
    ...
    _attribute_map = {
        "customer_managed_key_identity": {"key": "identity", "type": "EncryptionPropertiesIdentity"},
    ...
    def __init__(
        self,
        *,
        customer_managed_key_identity: Optional["_models.EncryptionPropertiesIdentity"] = None,
        key_url: Optional[str] = None,
        **kwargs
    ):
        """
        :keyword customer_managed_key_identity: All identity configuration for Customer-managed key
         settings defining which identity should be used to auth to Key Vault.
        :paramtype customer_managed_key_identity:
         ~azure.mgmt.loadtesting.models.EncryptionPropertiesIdentity
        ...
        self.customer_managed_key_identity = customer_managed_key_identity
...
class EncryptionPropertiesIdentity(_serialization.Model):
    ...
    :ivar customer_managed_key_identity_type: Managed identity type to use for accessing encryption
     key Url. Known values are: "SystemAssigned" and "UserAssigned".
    :vartype customer_managed_key_identity_type: str or ~azure.mgmt.loadtesting.models.Type
    :ivar resource_identifier: user assigned identity to use for accessing key encryption key Url.
     Ex: /subscriptions/fa5fc227-a624-475e-b696-cdd604c735bc/resourceGroups/:code:`<resource
     group>`/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myId.
    :vartype resource_identifier: str
    """

    _attribute_map = {
        "customer_managed_key_identity_type": {"key": "type", "type": "str"},
        "resource_identifier": {"key": "resourceId", "type": "str"},
    }

    def __init__(
        self,
        *,
        customer_managed_key_identity_type: Optional[Union[str, "_models.Type"]] = None,
        resource_identifier: Optional[str] = None,
        **kwargs
    ):
        """
        :keyword customer_managed_key_identity_type: Managed identity type to use for accessing
         encryption key Url. Known values are: "SystemAssigned" and "UserAssigned".
        :paramtype customer_managed_key_identity_type: str or ~azure.mgmt.loadtesting.models.Type
        :keyword resource_identifier: user assigned identity to use for accessing key encryption key
         Url. Ex: /subscriptions/fa5fc227-a624-475e-b696-cdd604c735bc/resourceGroups/:code:`<resource
         group>`/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myId.
        :paramtype resource_identifier: str
        """
        super().__init__(**kwargs)
        self.customer_managed_key_identity_type = customer_managed_key_identity_type
...
class LoadTestingEndpointDependency(_serialization.Model):
    ...
    :vartype endpoint_details: list[~azure.mgmt.loadtesting.models.LoadTestingEndpointDetail]
    """
    ...
    _attribute_map = {
        ...
        "endpoint_details": {"key": "endpointDetails", "type": "[LoadTestingEndpointDetail]"},
    }
...
class LoadTestingEndpointDetail(_serialization.Model):
...
class LoadTestingQuota(Resource):
...
class LoadTestingQuotaAvailabilityResponse(Resource):
...
class LoadTestingQuotaBucketContent(Resource):
    ...
    :ivar load_testing_quota_bucket_dimensions: Dimensions for new quota request.
    :vartype load_testing_quota_bucket_dimensions:
     ~azure.mgmt.loadtesting.models.QuotaBucketRequestPropertiesDimensions
    """
    ...
    _attribute_map = {
        ...
        "load_testing_quota_bucket_dimensions": {
    ...
    def __init__(
        ...
        *,
        ...
        load_testing_quota_bucket_dimensions: Optional["_models.QuotaBucketRequestPropertiesDimensions"] = None,
        **kwargs
    ):
        """
        ...
        :keyword load_testing_quota_bucket_dimensions: Dimensions for new quota request.
        :paramtype load_testing_quota_bucket_dimensions:
         ~azure.mgmt.loadtesting.models.QuotaBucketRequestPropertiesDimensions
        """
        super().__init__(**kwargs)
        ...
        self.load_testing_quota_bucket_dimensions = load_testing_quota_bucket_dimensions


class LoadTestingQuotaListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.loadtesting.models.LoadTestingQuota]
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[LoadTestingQuota]"},
...
class LoadTestingResource(TrackedResource):  # pylint: disable=too-many-instance-attributes
    """LoadTest details.
    ...
    :vartype encryption: ~azure.mgmt.loadtesting.models.CustomerManagedKeyEncryptionProperties
    """
    ...
    _attribute_map = {
        ...
        "encryption": {"key": "properties.encryption", "type": "CustomerManagedKeyEncryptionProperties"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        encryption: Optional["_models.CustomerManagedKeyEncryptionProperties"] = None,
        **kwargs
    ):
        """
        :keyword tags: Resource tags.
        ...
        :paramtype encryption: ~azure.mgmt.loadtesting.models.CustomerManagedKeyEncryptionProperties
        """
...
class LoadTestingResourcePageList(_serialization.Model):
    """List of resources page result.

    :ivar value: List of resources in current page.
    :vartype value: list[~azure.mgmt.loadtesting.models.LoadTestingResource]
    :ivar next_link: Link to next page of resources.
    :vartype next_link: str
    """

    _attribute_map = {
        "value": {"key": "value", "type": "[LoadTestingResource]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(
        self, *, value: Optional[List["_models.LoadTestingResource"]] = None, next_link: Optional[str] = None, **kwargs
    ):
        """
        :keyword value: List of resources in current page.
        :paramtype value: list[~azure.mgmt.loadtesting.models.LoadTestingResource]
...
class LoadTestingResourcePatch(_serialization.Model):
...
class OutboundEnvironmentEndpoint(_serialization.Model):
    ...
    :ivar endpoints: The endpoints for this service to which the Batch service makes outbound
     calls.
    :vartype endpoints: list[~azure.mgmt.loadtesting.models.LoadTestingEndpointDependency]
    """
    ...
    _attribute_map = {
        ...
        "endpoints": {"key": "endpoints", "type": "[LoadTestingEndpointDependency]"},
    }
...
class OutboundEnvironmentEndpointListResult(_serialization.Model):
