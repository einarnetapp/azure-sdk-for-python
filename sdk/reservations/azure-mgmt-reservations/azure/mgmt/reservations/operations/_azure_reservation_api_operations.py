...
def build_get_catalog_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Capacity/catalogs')
    ...
    if reserved_resource_type is not None:
        query_parameters['reservedResourceType'] = _SERIALIZER.query("reserved_resource_type", reserved_resource_type, 'str')
    if location is not None:
        query_parameters['location'] = _SERIALIZER.query("location", location, 'str')
    if publisher_id is not None:
        query_parameters['publisherId'] = _SERIALIZER.query("publisher_id", publisher_id, 'str')
    if offer_id is not None:
        query_parameters['offerId'] = _SERIALIZER.query("offer_id", offer_id, 'str')
    if plan_id is not None:
        query_parameters['planId'] = _SERIALIZER.query("plan_id", plan_id, 'str')
...
def build_get_applied_reservation_list_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Capacity/appliedReservations')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
...
class AzureReservationAPIOperationsMixin(object):
    ...
    def get_catalog(
        ...
        **kwargs: Any
        ...
        :type location: str
        :param publisher_id: Publisher id used to get the third party products.
        :type publisher_id: str
        :param offer_id: Offer id used to get the third party products.
        :type offer_id: str
        :param plan_id: Plan id used to get the third party products.
        :type plan_id: str
