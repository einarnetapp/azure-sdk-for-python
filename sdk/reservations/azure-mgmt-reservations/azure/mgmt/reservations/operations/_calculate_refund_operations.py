...
def build_post_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Capacity/calculateRefund")
...
class CalculateRefundOperations:
    ...
    @overload
    def post(
        self, body: _models.CalculateRefundRequest, *, content_type: str = "application/json", **kwargs: Any
    ...
    @distributed_trace
    def post(self, body: Union[_models.CalculateRefundRequest, IO], **kwargs: Any) -> _models.CalculateRefundResponse:
        """Calculate the refund amount of a reservation order.
    ...
    post.metadata = {"url": "/providers/Microsoft.Capacity/calculateRefund"}  # type: ignore
