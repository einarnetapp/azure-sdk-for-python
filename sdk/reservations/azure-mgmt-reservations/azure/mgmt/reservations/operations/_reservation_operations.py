...
def build_available_scopes_request_initial(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Capacity/reservationOrders/{reservationOrderId}/reservations/{reservationId}/availableScopes')
...
def build_split_request_initial(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Capacity/reservationOrders/{reservationOrderId}/split')
    path_format_arguments = {
        "reservationOrderId": _SERIALIZER.url("reservation_order_id", reservation_order_id, 'str'),
    }
...
def build_merge_request_initial(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Capacity/reservationOrders/{reservationOrderId}/merge')
    path_format_arguments = {
        "reservationOrderId": _SERIALIZER.url("reservation_order_id", reservation_order_id, 'str'),
    }
...
def build_list_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Capacity/reservationOrders/{reservationOrderId}/reservations')
    path_format_arguments = {
        "reservationOrderId": _SERIALIZER.url("reservation_order_id", reservation_order_id, 'str'),
    }
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Capacity/reservationOrders/{reservationOrderId}/reservations/{reservationId}')
    path_format_arguments = {
        "reservationId": _SERIALIZER.url("reservation_id", reservation_id, 'str'),
        "reservationOrderId": _SERIALIZER.url("reservation_order_id", reservation_order_id, 'str'),
    }
...
def build_list_revisions_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Capacity/reservationOrders/{reservationOrderId}/reservations/{reservationId}/revisions')
    path_format_arguments = {
        "reservationId": _SERIALIZER.url("reservation_id", reservation_id, 'str'),
        "reservationOrderId": _SERIALIZER.url("reservation_order_id", reservation_order_id, 'str'),
    }
...
def build_list_all_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Capacity/reservations')
    ...
    if refresh_summary is not None:
        query_parameters['refreshSummary'] = _SERIALIZER.query("refresh_summary", refresh_summary, 'str')
    if skiptoken is not None:
        query_parameters['$skiptoken'] = _SERIALIZER.query("skiptoken", skiptoken, 'float')
    if selected_state is not None:
        query_parameters['selectedState'] = _SERIALIZER.query("selected_state", selected_state, 'str')
    if take is not None:
        query_parameters['take'] = _SERIALIZER.query("take", take, 'float')
