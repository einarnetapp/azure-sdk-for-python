...
def build_available_scopes_request_initial(
    ...
    reservation_id: str,
    *,
    json: Optional[_models.AvailableScopeRequest] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_split_request_initial(
    reservation_order_id: str,
    *,
    json: Optional[_models.SplitRequest] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_merge_request_initial(
    reservation_order_id: str,
    *,
    json: Optional[_models.MergeRequest] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_update_request_initial(
    ...
    reservation_id: str,
    *,
    json: Optional[_models.Patch] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
