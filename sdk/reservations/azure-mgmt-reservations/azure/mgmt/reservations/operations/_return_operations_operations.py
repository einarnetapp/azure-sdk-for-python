...
def build_post_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Capacity/return")
...
class ReturnOperations:
    ...
    @overload
    def post(
        self, body: _models.RefundRequest, *, content_type: str = "application/json", **kwargs: Any
    ...
    @overload
    def post(self, body: IO, *, content_type: str = "application/json", **kwargs: Any) -> _models.RefundResponse:
        """Return a reservation.
    ...
    @distributed_trace
    def post(self, body: Union[_models.RefundRequest, IO], **kwargs: Any) -> _models.RefundResponse:
        """Return a reservation.
    ...
    post.metadata = {"url": "/providers/Microsoft.Capacity/return"}  # type: ignore
