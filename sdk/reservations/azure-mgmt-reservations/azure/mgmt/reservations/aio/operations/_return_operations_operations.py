...
class ReturnOperations:
    ...
    @overload
    async def post(self, body: IO, *, content_type: str = "application/json", **kwargs: Any) -> _models.RefundResponse:
        """Return a reservation.
    ...
    async def post(self, body: Union[_models.RefundRequest, IO], **kwargs: Any) -> _models.RefundResponse:
        """Return a reservation.
