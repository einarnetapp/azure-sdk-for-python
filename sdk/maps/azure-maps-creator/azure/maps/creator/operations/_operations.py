...
def build_alias_create_request(
    *,
    ...
    **kwargs: Any
    ...
    if creator_data_item_id is not None:
        _params['creatorDataItemId'] = _SERIALIZER.query("creator_data_item_id", creator_data_item_id, 'str')
...
def build_alias_assign_request(
    alias_id: str,
    *,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/aliases/{aliasId}"
    path_format_arguments = {
        "aliasId": _SERIALIZER.url("alias_id", alias_id, 'str'),
    }
...
def build_alias_delete_request(
    alias_id: str,
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
...
def build_data_upload_request_initial(
    *,
    data_format: str,
    json: Any = None,
    content: Any = None,
...
def build_data_update_request_initial(
    udid: str,
    *,
    json: Any = None,
    content: Any = None,
    ...
    **kwargs: Any
    ...
    _url = "/mapData/{udid}"
    path_format_arguments = {
        "udid": _SERIALIZER.url("udid", udid, 'str'),
    }
...
def build_data_download_request(
    udid: str,
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
    ...
    api_version = kwargs.pop('api_version', _params.pop('api-version', "2.0"))  # type: str
    accept = _headers.pop('Accept', "application/json, application/vnd.geo+json, application/octet-stream")
...
def build_data_get_operation_request(
    operation_id: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/mapData/operations/{operationId}"
    path_format_arguments = {
...
def build_dataset_create_request_initial(
    *,
    conversion_id: str,
    client_id: Optional[str] = None,
    ...
    **kwargs: Any
    ...
    # Construct parameters
    _params['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
    _params['conversionId'] = _SERIALIZER.query("conversion_id", conversion_id, 'str')
...
def build_dataset_list_request(
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_dataset_delete_request(
    dataset_id: str,
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
...
def build_dataset_get_operation_request(
    operation_id: str,
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/datasets/operations/{operationId}"
    path_format_arguments = {
        "operationId": _SERIALIZER.url("operation_id", operation_id, 'str'),
    }
...
def build_conversion_convert_request_initial(
    *,
    udid: str,
    client_id: Optional[str] = None,
    ...
    **kwargs: Any
    ...
    # Construct parameters
    _params['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
    _params['udid'] = _SERIALIZER.query("udid", udid, 'str')
    _params['outputOntology'] = _SERIALIZER.query("output_ontology", output_ontology, 'str')
    if description is not None:
        _params['description'] = _SERIALIZER.query("description", description, 'str')
...
def build_conversion_list_request(
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_conversion_get_request(
    conversion_id: str,
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/conversions/{conversionId}"
    path_format_arguments = {
        "conversionId": _SERIALIZER.url("conversion_id", conversion_id, 'str'),
    }
...
def build_conversion_delete_request(
    conversion_id: str,
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
...
def build_conversion_get_operation_request(
    operation_id: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/conversions/operations/{operationId}"
    path_format_arguments = {
        "operationId": _SERIALIZER.url("operation_id", operation_id, 'str'),
    }
...
def build_feature_state_create_stateset_request(
    *,
    dataset_id: str,
...
def build_feature_state_list_statesets_request(
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_feature_state_update_stateset_request(
    stateset_id: str,
    *,
    json: Optional[JSON] = None,
    content: Any = None,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/featureStateSets/{statesetId}"
    path_format_arguments = {
        "statesetId": _SERIALIZER.url("stateset_id", stateset_id, 'str'),
    }
...
def build_feature_state_delete_stateset_request(
    stateset_id: str,
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
...
def build_feature_state_get_stateset_request(
    stateset_id: str,
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
...
def build_feature_state_update_states_request(
    stateset_id: str,
    feature_id: str,
    *,
    json: Optional[JSON] = None,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/featureStateSets/{statesetId}/featureStates/{featureId}"
    path_format_arguments = {
        "statesetId": _SERIALIZER.url("stateset_id", stateset_id, 'str'),
...
def build_feature_state_delete_state_request(
    stateset_id: str,
    feature_id: str,
    *,
    key_name: str,
    ...
    **kwargs: Any
    ...
    # Construct parameters
    _params['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
    _params['stateKeyName'] = _SERIALIZER.query("key_name", key_name, 'str')
...
def build_feature_state_list_states_request(
    stateset_id: str,
    feature_id: str,
    *,
    client_id: Optional[str] = None,
...
def build_spatial_get_geofence_request(
    format: str = "json",
    *,
    device_id: str,
    udid: str,
    ...
    **kwargs: Any
    ...
    # Construct parameters
    _params['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
    _params['deviceId'] = _SERIALIZER.query("device_id", device_id, 'str')
    _params['udid'] = _SERIALIZER.query("udid", udid, 'str')
    _params['lat'] = _SERIALIZER.query("latitude", latitude, 'float')
    _params['lon'] = _SERIALIZER.query("longitude", longitude, 'float')
    if altitude is not None:
        _params['z'] = _SERIALIZER.query("altitude", altitude, 'float')
    if user_time is not None:
        _params['userTime'] = _SERIALIZER.query("user_time", user_time, 'iso-8601')
    if search_buffer_in_meters is not None:
        _params['searchBuffer'] = _SERIALIZER.query("search_buffer_in_meters", search_buffer_in_meters, 'float', maximum=500, minimum=0)
    if is_async is not None:
        _params['isAsync'] = _SERIALIZER.query("is_async", is_async, 'bool')
    if mode is not None:
...
def build_spatial_post_geofence_request(
    format: str = "json",
    *,
    device_id: str,
    latitude: float,
    ...
    **kwargs: Any
    ...
    if search_buffer is not None:
        _params['searchBuffer'] = _SERIALIZER.query("search_buffer", search_buffer, 'float', maximum=500, minimum=0)
    if is_async is not None:
        _params['isAsync'] = _SERIALIZER.query("is_async", is_async, 'bool')
    if mode is not None:
        _params['mode'] = _SERIALIZER.query("mode", mode, 'str')
...
def build_spatial_post_buffer_request(
    format: str = "json",
    *,
    json: Optional[JSON] = None,
    content: Any = None,
...
def build_spatial_get_buffer_request(
    format: str = "json",
    *,
    udid: str,
    distances: str,
    ...
    **kwargs: Any
    ...
    _params['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
    _params['udid'] = _SERIALIZER.query("udid", udid, 'str')
    _params['distances'] = _SERIALIZER.query("distances", distances, 'str')
...
def build_spatial_post_closest_point_request(
    format: str = "json",
    *,
    latitude: float,
    longitude: float,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/spatial/closestPoint/{format}"
    path_format_arguments = {
        "format": _SERIALIZER.url("format", format, 'str'),
    }
    ...
    if number_of_closest_points is not None:
        _params['numberOfClosestPoints'] = _SERIALIZER.query("number_of_closest_points", number_of_closest_points, 'int')
...
def build_spatial_get_closest_point_request(
    format: str = "json",
    *,
    udid: str,
    latitude: float,
...
def build_spatial_post_point_in_polygon_request(
    format: str = "json",
    *,
    latitude: float,
    longitude: float,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/spatial/pointInPolygon/{format}"
    path_format_arguments = {
        "format": _SERIALIZER.url("format", format, 'str'),
    }
...
def build_spatial_evaluate_point_in_polygon_request(
    format: str = "json",
    *,
    udid: str,
    latitude: float,
...
def build_spatial_get_great_circle_distance_request(
    format: str = "json",
    *,
    query: str,
    client_id: Optional[str] = None,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/spatial/greatCircleDistance/{format}"
    path_format_arguments = {
        "format": _SERIALIZER.url("format", format, 'str'),
    }
...
def build_tileset_create_request_initial(
    *,
    dataset_id: str,
    client_id: Optional[str] = None,
    description: Optional[str] = None,
...
def build_tileset_list_request(
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_tileset_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/tilesets/{tilesetId}"
    path_format_arguments = {
        "tilesetId": _SERIALIZER.url("tileset_id", tileset_id, 'str'),
    }
...
def build_tileset_delete_request(
    tileset_id: str,
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
...
def build_tileset_get_operation_request(
    operation_id: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/tilesets/operations/{operationId}"
    path_format_arguments = {
        "operationId": _SERIALIZER.url("operation_id", operation_id, 'str'),
    }
...
def build_wfs_get_landing_page_request(
    dataset_id: str,
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
...
def build_wfs_list_conformance_request(
    dataset_id: str,
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/wfs/datasets/{datasetId}/conformance"
    path_format_arguments = {
        "datasetId": _SERIALIZER.url("dataset_id", dataset_id, 'str'),
    }
...
def build_wfs_get_collections_request(
    dataset_id: str,
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/wfs/datasets/{datasetId}/collections"
    path_format_arguments = {
        "datasetId": _SERIALIZER.url("dataset_id", dataset_id, 'str'),
    }
...
def build_wfs_get_collection_request(
    dataset_id: str,
    collection_id: str,
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/wfs/datasets/{datasetId}/collections/{collectionId}"
    path_format_arguments = {
        "datasetId": _SERIALIZER.url("dataset_id", dataset_id, 'str'),
...
def build_wfs_get_collection_definition_request(
    dataset_id: str,
    collection_id: str,
    *,
    client_id: Optional[str] = None,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/wfs/datasets/{datasetId}/collections/{collectionId}/definition"
    path_format_arguments = {
        "datasetId": _SERIALIZER.url("dataset_id", dataset_id, 'str'),
        "collectionId": _SERIALIZER.url("collection_id", collection_id, 'str'),
    }
...
def build_wfs_get_features_request(
    dataset_id: str,
    collection_id: str,
    *,
    client_id: Optional[str] = None,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/wfs/datasets/{datasetId}/collections/{collectionId}/items"
    path_format_arguments = {
        "datasetId": _SERIALIZER.url("dataset_id", dataset_id, 'str'),
        "collectionId": _SERIALIZER.url("collection_id", collection_id, 'str'),
    }
    ...
    if limit is not None:
        _params['limit'] = _SERIALIZER.query("limit", limit, 'int', maximum=500, minimum=1)
...
def build_wfs_get_feature_request(
    dataset_id: str,
    collection_id: str,
    feature_id: str,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/wfs/datasets/{datasetId}/collections/{collectionId}/items/{featureId}"
    path_format_arguments = {
        "datasetId": _SERIALIZER.url("dataset_id", dataset_id, 'str'),
        "collectionId": _SERIALIZER.url("collection_id", collection_id, 'str'),
        "featureId": _SERIALIZER.url("feature_id", feature_id, 'str'),
...
def build_wfs_delete_feature_request(
    dataset_id: str,
    collection_id: str,
    feature_id: str,
    **kwargs: Any
...
class AliasOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.maps.creator.CreatorClient`'s
    ...
    def begin_upload(
        ...
        * ``application/octet-stream``
        ...
        if cont_token is None:
            raw_result = self._upload_initial(  # type: ignore
...
class ConversionOperations:
    ...
    def begin_convert(
        ...
        *diagnostic package* to visualize and diagnose these issues. In case any issues are encountered
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._convert_initial(  # type: ignore
                udid=udid,
                output_ontology=output_ontology,
                description=description,
                api_version=api_version,
...
class FeatureStateOperations:
    ...
    @distributed_trace
    def update_stateset(  # pylint: disable=inconsistent-return-statements
        self,
        stateset_id: str,
        style_rules: JSON,
        **kwargs: Any
    ...
    @distributed_trace
    def delete_stateset(  # pylint: disable=inconsistent-return-statements
        self,
        stateset_id: str,
        **kwargs: Any
    ) -> None:
    ...
    @distributed_trace
    def update_states(  # pylint: disable=inconsistent-return-statements
        self,
        stateset_id: str,
        feature_id: str,
        feature_states: JSON,
    ...
    @distributed_trace
    def delete_state(  # pylint: disable=inconsistent-return-statements
        self,
        stateset_id: str,
        feature_id: str,
        *,
...
class WFSOperations:
    ...
    @distributed_trace
    def delete_feature(  # pylint: disable=inconsistent-return-statements
        self,
        dataset_id: str,
        collection_id: str,
        feature_id: str,
