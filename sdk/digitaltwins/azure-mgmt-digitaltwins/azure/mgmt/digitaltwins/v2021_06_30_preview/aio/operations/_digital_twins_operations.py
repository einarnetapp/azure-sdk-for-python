...
class DigitalTwinsOperations:
    ...
    async def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.DigitalTwinsDescription:
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", "2021-06-30-preview"))  # type: str
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.digitaltwins.v2021_06_30_preview.models.DigitalTwinsDescription]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.DigitalTwinsDescription"]:
        ...
        :return: An iterator like instance of either DigitalTwinsDescription or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.digitaltwins.v2021_06_30_preview.models.DigitalTwinsDescription]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
