...
class TimeSeriesDatabaseConnectionsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either TimeSeriesDatabaseConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.digitaltwins.v2022_05_31.models.TimeSeriesDatabaseConnection]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.digitaltwins.v2022_05_31.models.TimeSeriesDatabaseConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
