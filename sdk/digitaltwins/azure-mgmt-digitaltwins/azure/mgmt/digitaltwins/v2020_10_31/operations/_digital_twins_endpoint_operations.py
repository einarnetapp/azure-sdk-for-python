...
def build_list_request(
    ...
    api_version = kwargs.pop("api_version", _params.pop("api-version", "2020-10-31"))  # type: str
...
class DigitalTwinsEndpointOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either DigitalTwinsEndpointResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.digitaltwins.v2020_10_31.models.DigitalTwinsEndpointResource]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.digitaltwins.v2020_10_31.models.DigitalTwinsEndpointResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
