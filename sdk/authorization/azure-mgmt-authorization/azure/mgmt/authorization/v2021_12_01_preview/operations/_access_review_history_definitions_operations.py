...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions")  # pylint: disable=line-too-long
...
def build_get_by_id_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
class AccessReviewHistoryDefinitionsOperations:
    ...
    def list(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable[_models.AccessReviewHistoryDefinitionListResult]:
        ...
        :return: An iterator like instance of either AccessReviewHistoryDefinitionListResult or the
         result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.authorization.v2021_12_01_preview.models.AccessReviewHistoryDefinitionListResult]
    ...
    def get_by_id(
        ...
        **kwargs: Any
        ...
        :param history_definition_id: The id of the access review history definition.
