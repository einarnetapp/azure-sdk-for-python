...
class AccessReviewDecision(msrest.serialization.Model):
    ...
    :ivar recommendation: The feature- generated recommendation shown to the reviewer. Known values
     are: "Approve", "Deny", "NoInfoAvailable".
    ...
    :ivar principal_type_properties_applied_by_principal_type: The identity type :
     user/servicePrincipal. Known values are: "user", "servicePrincipal".
    ...
    :ivar type_properties_resource_type: The type of resource. Known values are: "azureRole".
    ...
    :ivar type_properties_principal_type: The type of decision target :
     User/ServicePrincipal.Constant filled by server. Known values are: "user", "servicePrincipal".
    ...
    def __init__(
        ...
        *,
        ...
        membership_types: Optional[List[Union[str, "_models.AccessReviewDecisionPrincipalResourceMembershipType"]]] = None,
        ...
        **kwargs
        ...
        :paramtype membership_types: list[str or
         ~azure.mgmt.authorization.v2021_12_01_preview.models.AccessReviewDecisionPrincipalResourceMembershipType]
        :keyword type_properties_resource_type: The type of resource. Known values are: "azureRole".
...
class AccessReviewDecisionIdentity(msrest.serialization.Model):
    ...
    :ivar type: Required. The type of decision target : User/ServicePrincipal.Constant filled by
     server. Known values are: "user", "servicePrincipal".
...
class AccessReviewDecisionInsight(msrest.serialization.Model):
    ...
    :ivar type: The resource type.
    :vartype type: str
    :ivar type_properties_type: The type of insight.Constant filled by server. Known values are:
     "userSignInInsight".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(AccessReviewDecisionInsight, self).__init__(**kwargs)
        self.id = None
        self.name = None
        self.type = None
...
class AccessReviewDecisionInsightProperties(msrest.serialization.Model):
    """Details of the Insight.

    You probably want to use the sub-classes and not this class directly. Known
    sub-classes are: AccessReviewDecisionUserSignInInsightProperties.

    Variables are only populated by the server, and will be ignored when sending a request.

    All required parameters must be populated in order to send to Azure.

    :ivar type: Required. The type of insight.Constant filled by server. Known values are:
     "userSignInInsight".
    :vartype type: str or
     ~azure.mgmt.authorization.v2021_12_01_preview.models.AccessReviewDecisionInsightType
    :ivar insight_created_date_time: Date Time when the insight was created.
    ...
    _subtype_map = {
        'type': {'userSignInInsight': 'AccessReviewDecisionUserSignInInsightProperties'}
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(AccessReviewDecisionInsightProperties, self).__init__(**kwargs)
        self.type = None  # type: Optional[str]
        self.insight_created_date_time = None
...
class AccessReviewDecisionProperties(msrest.serialization.Model):
    ...
    :ivar principal_type_applied_by_principal_type: The identity type : user/servicePrincipal.
     Known values are: "user", "servicePrincipal".
    ...
    :ivar type_resource_type: The type of resource. Known values are: "azureRole".
    ...
    :ivar type_principal_type: The type of decision target : User/ServicePrincipal.Constant filled
     by server. Known values are: "user", "servicePrincipal".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype membership_types: list[str or
         ~azure.mgmt.authorization.v2021_12_01_preview.models.AccessReviewDecisionPrincipalResourceMembershipType]
        :keyword type_resource_type: The type of resource. Known values are: "azureRole".
...
class AccessReviewDecisionUserSignInInsightProperties(AccessReviewDecisionInsightProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(AccessReviewDecisionUserSignInInsightProperties, self).__init__(**kwargs)
...
class AccessReviewDefaultSettings(msrest.serialization.Model):
    ...
    :ivar default_decision: This specifies the behavior for the autoReview feature when an access
     review completes. Known values are: "Approve", "Deny", "Recommendation".
    ...
    :ivar type_properties_recurrence_range_type: The recurrence range type. The possible values
     are: endDate, noEnd, numbered. Known values are: "endDate", "noEnd", "numbered".
    ...
    :ivar type_properties_recurrence_pattern_type: The recurrence type : weekly, monthly, etc.
     Known values are: "weekly", "absoluteMonthly".
    ...
    def __init__(
        ...
        *,
        ...
        type_properties_recurrence_pattern_type: Optional[Union[str, "_models.AccessReviewRecurrencePatternType"]] = None,
        ...
        **kwargs
        ...
        :keyword default_decision: This specifies the behavior for the autoReview feature when an
         access review completes. Known values are: "Approve", "Deny", "Recommendation".
...
class AccessReviewHistoryDefinition(msrest.serialization.Model):
    ...
    :ivar type_properties_settings_range_type: The recurrence range type. The possible values are:
     endDate, noEnd, numbered. Known values are: "endDate", "noEnd", "numbered".
    ...
    :ivar type_properties_settings_pattern_type: The recurrence type : weekly, monthly, etc. Known
     values are: "weekly", "absoluteMonthly".
    ...
    :ivar principal_type: The identity type : user/servicePrincipal. Known values are: "user",
     "servicePrincipal".
    ...
    _attribute_map = {
        ...
        'review_history_period_start_date_time': {'key': 'properties.reviewHistoryPeriodStartDateTime', 'type': 'iso-8601'},
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype interval: int
        """
        super(AccessReviewHistoryDefinition, self).__init__(**kwargs)
        self.id = None
        self.name = None
        self.type = None
...
class AccessReviewHistoryDefinitionInstanceListResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype next_link: str
        """
        super(AccessReviewHistoryDefinitionInstanceListResult, self).__init__(**kwargs)
        self.value = value
        self.next_link = next_link


class AccessReviewHistoryDefinitionListResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype next_link: str
        """
        super(AccessReviewHistoryDefinitionListResult, self).__init__(**kwargs)
        self.value = value
        self.next_link = next_link


class AccessReviewHistoryDefinitionProperties(msrest.serialization.Model):
    ...
    :ivar type_settings_range_type: The recurrence range type. The possible values are: endDate,
     noEnd, numbered. Known values are: "endDate", "noEnd", "numbered".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype interval: int
        """
        super(AccessReviewHistoryDefinitionProperties, self).__init__(**kwargs)
        self.display_name = display_name
        self.review_history_period_start_date_time = None
        self.review_history_period_end_date_time = None
        self.decisions = decisions
...
class AccessReviewHistoryInstance(msrest.serialization.Model):
    ...
    :ivar status: Status of the requested review history instance data. This is either requested,
     ...
     Done -> Expired. Known values are: "Requested", "InProgress", "Done", "Error".
    :vartype status: str or
     ~azure.mgmt.authorization.v2021_12_01_preview.models.AccessReviewHistoryDefinitionStatus
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super(AccessReviewHistoryInstance, self).__init__(**kwargs)
        self.id = None
        self.name = None
        self.type = None
...
class AccessReviewInstance(msrest.serialization.Model):
    ...
    :ivar reviewers_type: This field specifies the type of reviewers for a review. Usually for a
     ...
     values are: "Assigned", "Self", "Managers".
...
class AccessReviewScheduleDefinition(msrest.serialization.Model):
    ...
    :ivar type_properties_settings_recurrence_range_type: The recurrence range type. The possible
     values are: endDate, noEnd, numbered. Known values are: "endDate", "noEnd", "numbered".
    ...
    :ivar type_properties_settings_recurrence_pattern_type: The recurrence type : weekly, monthly,
     etc. Known values are: "weekly", "absoluteMonthly".
    ...
    def __init__(
        ...
        *,
        ...
        recommendation_look_back_duration: Optional[datetime.timedelta] = None,
        instance_duration_in_days: Optional[int] = None,
        type_properties_settings_recurrence_range_type: Optional[Union[str, "_models.AccessReviewRecurrenceRangeType"]] = None,
        number_of_occurrences: Optional[int] = None,
        start_date: Optional[datetime.datetime] = None,
        end_date: Optional[datetime.datetime] = None,
        type_properties_settings_recurrence_pattern_type: Optional[Union[str, "_models.AccessReviewRecurrencePatternType"]] = None,
        interval: Optional[int] = None,
        **kwargs
    ):
        """
        ...
        :keyword type_properties_settings_recurrence_range_type: The recurrence range type. The
         possible values are: endDate, noEnd, numbered. Known values are: "endDate", "noEnd",
         "numbered".
        ...
        :keyword type_properties_settings_recurrence_pattern_type: The recurrence type : weekly,
         monthly, etc. Known values are: "weekly", "absoluteMonthly".
...
class AccessReviewScheduleDefinitionProperties(msrest.serialization.Model):
    ...
    :ivar principal_type_scope_principal_type: The identity type user/servicePrincipal to review.
     Known values are: "user", "guestUser", "servicePrincipal", "user,group", "redeemedGuestUser".
...
class AccessReviewScope(msrest.serialization.Model):
    """Descriptor for what needs to be reviewed.
    ...
    :ivar principal_type: The identity type user/servicePrincipal to review. Known values are:
     "user", "guestUser", "servicePrincipal", "user,group", "redeemedGuestUser".
    :vartype principal_type: str or
     ~azure.mgmt.authorization.v2021_12_01_preview.models.AccessReviewScopePrincipalType
    :ivar assignment_state: The role assignment state eligible/active to review. Known values are:
     "eligible", "active".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype exclude_role_definition_id: str
        """
        super(AccessReviewScope, self).__init__(**kwargs)
        self.resource_id = None
        self.role_definition_id = None
        self.principal_type = None
        self.assignment_state = None
...
class RecordAllDecisionsProperties(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword decision: The decision to make. Approvers can take action of Approve/Deny. Known
         values are: "Approve", "Deny".
        :paramtype decision: str or
         ~azure.mgmt.authorization.v2021_12_01_preview.models.RecordAllDecisionsResult
        :keyword justification: Justification provided by approvers for their action.
        :paramtype justification: str
        """
        super(RecordAllDecisionsProperties, self).__init__(**kwargs)
        self.principal_id = None
        self.resource_id = None
        self.decision = decision
        self.justification = justification
