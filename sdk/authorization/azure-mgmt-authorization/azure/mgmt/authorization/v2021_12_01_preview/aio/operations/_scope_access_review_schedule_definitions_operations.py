...
from ...operations._scope_access_review_schedule_definitions_operations import build_create_or_update_by_id_request, build_delete_by_id_request, build_get_by_id_request, build_list_request, build_stop_request
T = TypeVar('T')
...
class ScopeAccessReviewScheduleDefinitionsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.authorization.v2021_12_01_preview.models.AccessReviewScheduleDefinitionListResult]
