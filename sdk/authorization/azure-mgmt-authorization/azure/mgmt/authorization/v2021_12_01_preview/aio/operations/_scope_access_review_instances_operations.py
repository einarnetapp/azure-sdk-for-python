...
from ...operations._scope_access_review_instances_operations import build_create_request, build_get_by_id_request, build_list_request
T = TypeVar('T')
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either AccessReviewInstanceListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.authorization.v2021_12_01_preview.models.AccessReviewInstanceListResult]
