...
class AccessReviewHistoryDefinitionInstancesOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable[_models.AccessReviewHistoryDefinitionInstanceListResult]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.authorization.v2021_12_01_preview.models.AccessReviewHistoryDefinitionInstanceListResult]
