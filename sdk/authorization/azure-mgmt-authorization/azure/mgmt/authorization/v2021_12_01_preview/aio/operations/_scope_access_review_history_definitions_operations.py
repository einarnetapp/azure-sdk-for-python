...
from ...operations._scope_access_review_history_definitions_operations import build_get_by_id_request, build_list_request
T = TypeVar('T')
...
class ScopeAccessReviewHistoryDefinitionsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable[_models.AccessReviewHistoryDefinitionListResult]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.authorization.v2021_12_01_preview.models.AccessReviewHistoryDefinitionListResult]
