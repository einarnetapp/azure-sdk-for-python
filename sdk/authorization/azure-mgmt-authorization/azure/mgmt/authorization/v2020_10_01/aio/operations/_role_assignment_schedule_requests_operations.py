...
from ...operations._role_assignment_schedule_requests_operations import build_cancel_request, build_create_request, build_get_request, build_list_for_scope_request, build_validate_request
T = TypeVar('T')
...
class RoleAssignmentScheduleRequestsOperations:
    ...
    def list_for_scope(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.authorization.v2020_10_01.models.RoleAssignmentScheduleRequestListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
