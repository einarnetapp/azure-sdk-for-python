...
def build_get_metrics_for_subscription_request(
    subscription_id: str,
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/roleAssignmentsUsageMetrics")  # pylint: disable=line-too-long
...
class RoleAssignmentMetricsOperations:
    ...
    @distributed_trace
    def get_metrics_for_subscription(
        self,
        **kwargs: Any
