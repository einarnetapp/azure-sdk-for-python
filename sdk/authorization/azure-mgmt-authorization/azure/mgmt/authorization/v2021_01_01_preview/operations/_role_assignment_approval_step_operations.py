...
def build_get_by_id_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Authorization/roleAssignmentApprovals/{approvalId}/stages/{stageId}")  # pylint: disable=line-too-long
...
def build_patch_request(
    ...
    stage_id: str,
    *,
    json: Optional[_models.RoleAssignmentApprovalStepProperties] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
