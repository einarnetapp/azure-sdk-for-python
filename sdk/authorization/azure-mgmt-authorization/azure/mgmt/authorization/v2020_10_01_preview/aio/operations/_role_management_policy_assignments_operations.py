...
from ...operations._role_management_policy_assignments_operations import build_create_request, build_delete_request, build_get_request, build_list_for_scope_request
T = TypeVar('T')
...
class RoleManagementPolicyAssignmentsOperations:
    ...
    def list_for_scope(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.authorization.v2020_10_01_preview.models.RoleManagementPolicyAssignmentListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
