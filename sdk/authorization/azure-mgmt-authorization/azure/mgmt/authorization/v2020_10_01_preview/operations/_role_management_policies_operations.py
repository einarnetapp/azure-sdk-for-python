...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.Authorization/roleManagementPolicies/{roleManagementPolicyName}")  # pylint: disable=line-too-long
...
def build_update_request(
    ...
    role_management_policy_name: str,
    *,
    json: Optional[_models.RoleManagementPolicy] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class RoleManagementPoliciesOperations:
    ...
    def list_for_scope(
        ...
        scope: str,
        **kwargs: Any
    ) -> Iterable[_models.RoleManagementPolicyListResult]:
        ...
        :return: An iterator like instance of either RoleManagementPolicyListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.authorization.v2020_10_01_preview.models.RoleManagementPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
