...
class ValidationResultItem(msrest.serialization.Model):
    ...
    :ivar result: The result of validation. Possible values include: "success", "failed",
     "warning".
    :vartype result: str or ~azure.mgmt.servicelinker.models.ValidationItemResult
    ...
    def __init__(
        ...
        *,
        ...
        result: Optional[Union[str, "ValidationItemResult"]] = None,
        ...
        **kwargs
        ...
        :keyword result: The result of validation. Possible values include: "success", "failed",
         "warning".
        :paramtype result: str or ~azure.mgmt.servicelinker.models.ValidationItemResult
