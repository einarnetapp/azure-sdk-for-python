...
from ...operations._data_set_mappings_operations import build_create_request_initial, build_delete_request, build_get_request, build_list_by_share_subscription_request
T = TypeVar('T')
...
class DataSetMappingsOperations:
    ...
    async def begin_create(
        ...
        data_set_mapping: "_models.DataSetMapping",
        **kwargs: Any
    ) -> AsyncLROPoller["_models.DataSetMapping"]:
        ...
        :return: An instance of AsyncLROPoller that returns either DataSetMapping or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.datashare.models.DataSetMapping]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-09-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_by_share_subscription(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datashare.models.DataSetMappingList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-09-01")  # type: str
