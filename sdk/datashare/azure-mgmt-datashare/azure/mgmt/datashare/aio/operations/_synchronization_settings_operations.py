...
from ...operations._synchronization_settings_operations import build_create_request, build_delete_request_initial, build_get_request, build_list_by_share_request
T = TypeVar('T')
    ...
    def list_by_share(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either SynchronizationSettingList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datashare.models.SynchronizationSettingList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-09-01")  # type: str
