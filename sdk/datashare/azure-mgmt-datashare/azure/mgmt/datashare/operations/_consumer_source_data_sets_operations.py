...
def build_list_by_share_subscription_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataShare/accounts/{accountName}/shareSubscriptions/{shareSubscriptionName}/consumerSourceDataSets")  # pylint: disable=line-too-long
...
class ConsumerSourceDataSetsOperations(object):
    ...
    def list_by_share_subscription(
        ...
        skip_token: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.ConsumerSourceDataSetList"]:
        ...
        :return: An iterator like instance of either ConsumerSourceDataSetList or the result of
         cls(response)
