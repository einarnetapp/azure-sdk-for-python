...
class MarketplaceType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class OperationActionType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):

    NOT_SPECIFIED = "NotSpecified"
    INTERNAL = "Internal"

class OperationOrigins(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ResourceAccessPolicy(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
