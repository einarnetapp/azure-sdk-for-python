...
from ...operations._record_sets_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_dns_zone_request, build_list_by_type_request, build_update_request
T = TypeVar('T')
...
class RecordSetsOperations:
    ...
    def list_by_type(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dns.v2016_04_01.models.RecordSetListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
