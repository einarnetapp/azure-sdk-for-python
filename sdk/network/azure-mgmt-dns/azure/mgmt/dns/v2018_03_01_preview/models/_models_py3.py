...
class RecordSet(msrest.serialization.Model):
    ...
    :ivar target_resource: The target resource for alias record.
    :vartype target_resource: ~azure.mgmt.dns.v2018_03_01_preview.models.TargetResource
    """
    ...
    _attribute_map = {
        ...
        'target_resource': {'key': 'properties.targetResource', 'type': 'TargetResource'},
    }
    ...
    def __init__(
        ...
        *,
        ...
        target_resource: Optional["_models.TargetResource"] = None,
        **kwargs
    ):
        """
        ...
        :keyword target_resource: The target resource for alias record.
        :paramtype target_resource: ~azure.mgmt.dns.v2018_03_01_preview.models.TargetResource
        """
...
class RecordSetListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.RecordSet"]] = None,
        **kwargs
    ):
        """
...
class RecordSetUpdateParameters(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        record_set: Optional["_models.RecordSet"] = None,
        **kwargs
    ):
        """
...
class TargetResource(msrest.serialization.Model):
    """A target resource of an alias record.

    :ivar id: The id of the target resource of alias record.
    :vartype id: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword id: The id of the target resource of alias record.
        :paramtype id: str
        """
...
class Zone(TrackedResource):
    ...
    :ivar zone_type: The type of this DNS zone (Public or Private). Known values are: "Public",
     "Private". Default value: "Public".
    ...
    def __init__(
        ...
        *,
        ...
        tags: Optional[Dict[str, str]] = None,
        etag: Optional[str] = None,
        zone_type: Optional[Union[str, "_models.ZoneType"]] = "Public",
...
class ZoneListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.Zone"]] = None,
        **kwargs
    ):
        """
