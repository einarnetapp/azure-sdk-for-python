...
def build_create_or_update_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.Zone] = None,
    content: Any = None,
...
def build_update_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ZoneUpdate] = None,
    content: Any = None,
    if_match: Optional[str] = None,
    **kwargs: Any
) -> HttpRequest:
...
class ZonesOperations:
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.dns.v2018_03_01_preview.models.ZoneListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
