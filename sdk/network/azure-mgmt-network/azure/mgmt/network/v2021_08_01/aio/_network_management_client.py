...
class NetworkManagementClient(NetworkManagementClientOperationsMixin):    # pylint: disable=too-many-instance-attributes
    ...
    :vartype express_route_provider_ports_location:
     azure.mgmt.network.v2021_08_01.aio.operations.ExpressRouteProviderPortsLocationOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.express_route_provider_ports_location = ExpressRouteProviderPortsLocationOperations(self._client, self._config, self._serialize, self._deserialize)
