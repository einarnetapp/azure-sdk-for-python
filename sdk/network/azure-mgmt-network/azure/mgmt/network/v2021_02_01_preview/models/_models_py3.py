...
class NspAssociation(Resource):
    ...
    :ivar access_mode: Access mode on the association. Possible values include: "Unspecified",
     "EnforceMode", "LearningMode", "DryRunMode".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword access_mode: Access mode on the association. Possible values include: "Unspecified",
         "EnforceMode", "LearningMode", "DryRunMode".
