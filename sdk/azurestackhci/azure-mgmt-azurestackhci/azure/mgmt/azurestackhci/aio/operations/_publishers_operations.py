...
class PublishersOperations:
    ...
    def list_by_cluster(
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.PublisherList]
    ...
    list_by_cluster.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/publishers"}  # type: ignore
    ...
    get.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/publishers/{publisherName}"}  # type: ignore
