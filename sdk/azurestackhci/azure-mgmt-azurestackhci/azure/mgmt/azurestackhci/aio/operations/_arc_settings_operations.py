...
from ...operations._arc_settings_operations import build_create_identity_request_initial, build_create_request, build_delete_request_initial, build_generate_password_request, build_get_request, build_list_by_cluster_request, build_update_request
T = TypeVar('T')
...
class ArcSettingsOperations:
    ...
    def list_by_cluster(
        ...
        cluster_name: str,
        **kwargs: Any
    ) -> AsyncIterable[_models.ArcSettingList]:
