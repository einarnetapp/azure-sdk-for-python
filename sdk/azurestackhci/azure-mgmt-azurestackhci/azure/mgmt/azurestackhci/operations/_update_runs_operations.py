...
class UpdateRunsOperations:
    ...
    def list(
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.UpdateRunList]
    ...
    list.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/updates/{updateName}/updateRuns"}  # type: ignore
    ...
    def get(
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.UpdateRun]
    ...
    get.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/updates/{updateName}/updateRuns/{updateRunName}"}  # type: ignore
