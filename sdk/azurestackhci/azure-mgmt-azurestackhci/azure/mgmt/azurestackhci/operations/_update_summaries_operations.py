...
class UpdateSummariesOperations:
    ...
    def list(self, resource_group_name: str, cluster_name: str, **kwargs: Any) -> Iterable["_models.UpdateSummaries"]:
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.UpdateSummariesList]
    ...
    list.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/updateSummaries"}  # type: ignore
    ...
    def get(self, resource_group_name: str, cluster_name: str, **kwargs: Any) -> _models.UpdateSummaries:
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.UpdateSummaries]
    ...
    get.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/updateSummaries/default"}  # type: ignore
