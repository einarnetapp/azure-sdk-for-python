...
def build_list_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "providerName": _SERIALIZER.url(
            "provider_name", provider_name, "str", max_length=63, min_length=3, pattern=r"^[A-Za-z0-9.]*$"
        ),
        "resourceCollectionName": _SERIALIZER.url(
        ...
        "resourceName": _SERIALIZER.url(
            "resource_name", resource_name, "str", max_length=63, min_length=3, pattern=r"^[A-Za-z0-9]*$"
        ),
    }
