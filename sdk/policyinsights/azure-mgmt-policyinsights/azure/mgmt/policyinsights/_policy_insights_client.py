...
from .operations import AttestationsOperations, Operations, PolicyEventsOperations, PolicyMetadataOperations, PolicyRestrictionsOperations, PolicyStatesOperations, PolicyTrackedResourcesOperations, RemediationsOperations

if TYPE_CHECKING:
    # pylint: disable=unused-import,ungrouped-imports
    from azure.core.credentials import TokenCredential

class PolicyInsightsClient:    # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = PolicyInsightsClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
