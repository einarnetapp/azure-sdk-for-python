...
class PolicyStatesOperations:
    ...
    def list_query_results_for_management_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PolicyStatesQueryResults or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.policyinsights.models.PolicyStatesQueryResults]
    ...
    async def summarize_for_management_group(
        ...
        **kwargs: Any
        ...
        :param query_options: Parameter group. Default value is None.
        :type query_options: ~azure.mgmt.policyinsights.models.QueryOptions
        :keyword policy_states_summary_resource: The virtual resource under PolicyStates resource type
         for summarize action. In a given time range, 'latest' represents the latest policy state(s) and
         is the only allowed value. Default value is "latest". Note that overriding this default value
         may result in unsupported behavior.
        :paramtype policy_states_summary_resource: str
        :keyword management_groups_namespace: The namespace for Microsoft Management RP; only
         "Microsoft.Management" is allowed. Default value is "Microsoft.Management". Note that
         overriding this default value may result in unsupported behavior.
        :paramtype management_groups_namespace: str
        ...
        policy_states_summary_resource = kwargs.pop('policy_states_summary_resource', "latest")  # type: str
        management_groups_namespace = kwargs.pop('management_groups_namespace', "Microsoft.Management")  # type: str
        api_version = kwargs.pop('api_version', _params.pop('api-version', "2022-06-01"))  # type: str
    ...
    @distributed_trace_async
    async def begin_trigger_subscription_evaluation(  # pylint: disable=inconsistent-return-statements
        self,
        subscription_id: str,
        **kwargs: Any
    ) -> AsyncLROPoller[None]:
    ...
    @distributed_trace_async
    async def begin_trigger_resource_group_evaluation(  # pylint: disable=inconsistent-return-statements
        self,
        subscription_id: str,
        resource_group_name: str,
        **kwargs: Any
