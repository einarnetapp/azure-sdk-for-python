...
from ...operations._policy_tracked_resources_operations import build_list_query_results_for_management_group_request, build_list_query_results_for_resource_group_request, build_list_query_results_for_resource_request, build_list_query_results_for_subscription_request
T = TypeVar('T')
    ...
    def list_query_results_for_management_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PolicyTrackedResourcesQueryResults or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.policyinsights.models.PolicyTrackedResourcesQueryResults]
