...
from ...operations._policy_events_operations import build_list_query_results_for_management_group_request, build_list_query_results_for_policy_definition_request, build_list_query_results_for_policy_set_definition_request, build_list_query_results_for_resource_group_level_policy_assignment_request, build_list_query_results_for_resource_group_request, build_list_query_results_for_resource_request, build_list_query_results_for_subscription_level_policy_assignment_request, build_list_query_results_for_subscription_request, build_next_link_request
T = TypeVar('T')
    ...
    def list_query_results_for_management_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PolicyEventsQueryResults or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.policyinsights.models.PolicyEventsQueryResults]
