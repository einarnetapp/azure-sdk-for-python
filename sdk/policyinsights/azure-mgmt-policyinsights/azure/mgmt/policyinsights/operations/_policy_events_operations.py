...
def build_list_query_results_for_management_group_request(
    ...
    **kwargs: Any
    ...
    policy_events_resource = kwargs.pop('policy_events_resource', "default")  # type: str
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/{managementGroupsNamespace}/managementGroups/{managementGroupName}/providers/Microsoft.PolicyInsights/policyEvents/{policyEventsResource}/queryResults")  # pylint: disable=line-too-long
...
def build_list_query_results_for_subscription_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.PolicyInsights/policyEvents/{policyEventsResource}/queryResults")  # pylint: disable=line-too-long
    path_format_arguments = {
        "policyEventsResource": _SERIALIZER.url("policy_events_resource", policy_events_resource, 'str'),
...
def build_list_query_results_for_resource_group_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.PolicyInsights/policyEvents/{policyEventsResource}/queryResults")  # pylint: disable=line-too-long
    path_format_arguments = {
        "policyEventsResource": _SERIALIZER.url("policy_events_resource", policy_events_resource, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_list_query_results_for_resource_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{resourceId}/providers/Microsoft.PolicyInsights/policyEvents/{policyEventsResource}/queryResults")  # pylint: disable=line-too-long
    path_format_arguments = {
        "policyEventsResource": _SERIALIZER.url("policy_events_resource", policy_events_resource, 'str'),
...
def build_list_query_results_for_policy_set_definition_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/{authorizationNamespace}/policySetDefinitions/{policySetDefinitionName}/providers/Microsoft.PolicyInsights/policyEvents/{policyEventsResource}/queryResults")  # pylint: disable=line-too-long
    path_format_arguments = {
        "policyEventsResource": _SERIALIZER.url("policy_events_resource", policy_events_resource, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_list_query_results_for_policy_definition_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/{authorizationNamespace}/policyDefinitions/{policyDefinitionName}/providers/Microsoft.PolicyInsights/policyEvents/{policyEventsResource}/queryResults")  # pylint: disable=line-too-long
    path_format_arguments = {
        "policyEventsResource": _SERIALIZER.url("policy_events_resource", policy_events_resource, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "authorizationNamespace": _SERIALIZER.url("authorization_namespace", authorization_namespace, 'str'),
...
def build_list_query_results_for_subscription_level_policy_assignment_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/{authorizationNamespace}/policyAssignments/{policyAssignmentName}/providers/Microsoft.PolicyInsights/policyEvents/{policyEventsResource}/queryResults")  # pylint: disable=line-too-long
    path_format_arguments = {
        "policyEventsResource": _SERIALIZER.url("policy_events_resource", policy_events_resource, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "authorizationNamespace": _SERIALIZER.url("authorization_namespace", authorization_namespace, 'str'),
...
def build_list_query_results_for_resource_group_level_policy_assignment_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/{authorizationNamespace}/policyAssignments/{policyAssignmentName}/providers/Microsoft.PolicyInsights/policyEvents/{policyEventsResource}/queryResults")  # pylint: disable=line-too-long
    path_format_arguments = {
        "policyEventsResource": _SERIALIZER.url("policy_events_resource", policy_events_resource, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
...
class PolicyEventsOperations:
    ...
    def list_query_results_for_management_group(
        ...
        **kwargs: Any
    ) -> Iterable[_models.PolicyEventsQueryResults]:
        ...
        :keyword policy_events_resource: The name of the virtual resource under PolicyEvents resource
         type; only "default" is allowed. Default value is "default". Note that overriding this default
         value may result in unsupported behavior.
        :paramtype policy_events_resource: str
        ...
        :return: An iterator like instance of either PolicyEventsQueryResults or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.policyinsights.models.PolicyEventsQueryResults]
