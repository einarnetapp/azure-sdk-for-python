...
def build_list_query_results_for_management_group_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/{managementGroupsNamespace}/managementGroups/{managementGroupName}/providers/Microsoft.PolicyInsights/policyTrackedResources/{policyTrackedResourcesResource}/queryResults")  # pylint: disable=line-too-long
    path_format_arguments = {
        ...
        "policyTrackedResourcesResource": _SERIALIZER.url("policy_tracked_resources_resource", policy_tracked_resources_resource, 'str'),
    }
...
def build_list_query_results_for_subscription_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.PolicyInsights/policyTrackedResources/{policyTrackedResourcesResource}/queryResults")  # pylint: disable=line-too-long
    path_format_arguments = {
        "policyTrackedResourcesResource": _SERIALIZER.url("policy_tracked_resources_resource", policy_tracked_resources_resource, 'str'),
...
def build_list_query_results_for_resource_group_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.PolicyInsights/policyTrackedResources/{policyTrackedResourcesResource}/queryResults")  # pylint: disable=line-too-long
    path_format_arguments = {
...
def build_list_query_results_for_resource_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{resourceId}/providers/Microsoft.PolicyInsights/policyTrackedResources/{policyTrackedResourcesResource}/queryResults")  # pylint: disable=line-too-long
    path_format_arguments = {
...
class PolicyTrackedResourcesOperations:
    ...
    def list_query_results_for_management_group(
        ...
        **kwargs: Any
    ) -> Iterable[_models.PolicyTrackedResourcesQueryResults]:
        ...
        :param policy_tracked_resources_resource: The name of the virtual resource under
         PolicyTrackedResources resource type; only "default" is allowed.
        ...
        :return: An iterator like instance of either PolicyTrackedResourcesQueryResults or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.policyinsights.models.PolicyTrackedResourcesQueryResults]
