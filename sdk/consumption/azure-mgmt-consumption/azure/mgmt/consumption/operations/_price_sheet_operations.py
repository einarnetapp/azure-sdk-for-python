...
class PriceSheetOperations:
    ...
    def get_by_billing_period(
        ...
        top: Optional[int] = None,
        **kwargs: Any
    ) -> Optional[_models.PriceSheetResult]:
        ...
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PriceSheetResult or None or the result of cls(response)
        :rtype: ~azure.mgmt.consumption.models.PriceSheetResult or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))  # type: str
        cls = kwargs.pop("cls", None)  # type: ClsType[Optional[_models.PriceSheetResult]]
