...
class Balance(Resource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar refunded_overage_credits: Refunded Overage Credits.
    :vartype refunded_overage_credits: float
    ...
    _validation = {
        ...
        "refunded_overage_credits": {"readonly": True},
    ...
    _attribute_map = {
        ...
        "refunded_overage_credits": {"key": "properties.refundedOverageCredits", "type": "float"},
    ...
    def __init__(
        ...
        self.refunded_overage_credits = None
