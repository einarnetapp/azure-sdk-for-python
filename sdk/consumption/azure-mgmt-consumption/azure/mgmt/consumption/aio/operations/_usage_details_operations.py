...
class UsageDetailsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        """Note: ***Enterprise Agreement and Microsoft Customer Agreement customers:** Please do not use
        this API. Use the `Cost Details API
        </rest/api/cost-management/generate-cost-details-report/create-operation?tabs=HTTP>`_ instead._
