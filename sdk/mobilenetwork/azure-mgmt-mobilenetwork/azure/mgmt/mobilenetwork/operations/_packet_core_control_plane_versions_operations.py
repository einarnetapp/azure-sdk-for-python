...
def build_list_by_resource_group_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PacketCoreControlPlaneVersionsOperations:
    ...
    @distributed_trace
    def list_by_resource_group(self, **kwargs: Any) -> Iterable["_models.PacketCoreControlPlaneVersion"]:
