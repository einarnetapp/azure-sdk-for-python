...
# USAGE
    python remove_suppressed_email_addresses_by_username.py
...
def main():
    ...
    response = client.domains.remove_suppressed_email_addresses(
        resource_group_name="MyResourceGroup",
        email_service_name="MyEmailServiceResource",
        domain_name="mydomain.com",
        parameters={"addresses": ["abc@xyz.com", "defg@xyz.com"], "validSenderUsername": "test"},
    )
    print(response)
