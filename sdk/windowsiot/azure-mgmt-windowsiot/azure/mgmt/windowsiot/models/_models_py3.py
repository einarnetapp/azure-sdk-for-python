...
class DeviceService(TrackedResource):  # pylint: disable=too-many-instance-attributes
...
class DeviceServiceCheckNameAvailabilityParameters(_serialization.Model):
    """Input values.

    All required parameters must be populated in order to send to Azure.

    :ivar name: The name of the Windows IoT Device Service to check. Required.
    :vartype name: str
    """
    ...
    def __init__(self, *, name: str, **kwargs):
        """
        :keyword name: The name of the Windows IoT Device Service to check. Required.
        :paramtype name: str
        """
        super().__init__(**kwargs)
        self.name = name
...
class DeviceServiceDescriptionListResult(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.DeviceService"]] = None, **kwargs):
        """
...
class DeviceServiceNameAvailabilityInfo(_serialization.Model):
...
class ErrorDetails(_serialization.Model):
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetailsError"] = None, **kwargs):
        """
...
class ErrorDetailsError(_serialization.Model):
    """The error object.
