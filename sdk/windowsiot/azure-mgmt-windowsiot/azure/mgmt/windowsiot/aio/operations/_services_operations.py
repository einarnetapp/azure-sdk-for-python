...
from ...operations._services_operations import (
    build_check_device_service_name_availability_request,
...
class ServicesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.windowsiot.aio.DeviceServices`'s
    ...
    async def get(self, resource_group_name: str, device_name: str, **kwargs: Any) -> _models.DeviceService:
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, device_name: str, **kwargs: Any) -> _models.DeviceService:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.DeviceService"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.windowsiot.models.DeviceService]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.DeviceService"]:
