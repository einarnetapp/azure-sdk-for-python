...
def build_delete_request(
    ...
    api_version: Literal["2022-11-10"] = kwargs.pop("api_version", _params.pop("api-version", "2022-11-10"))
...
class MachinesOperations:
    ...
    def delete(  # pylint: disable=inconsistent-return-statements
        ...
        api_version: Literal["2022-11-10"] = kwargs.pop(
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Machine"]:
