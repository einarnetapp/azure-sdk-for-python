...
class DeploymentLicenseRequest(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super(DeploymentLicenseRequest, self).__init__(**kwargs)
        self.verification_version = verification_version


class DeploymentLicenseResponse(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        temporary_license_chain: Optional[List[str]] = None,
        signature: Optional[str] = None,
        **kwargs
    ):
        """
        ...
        :paramtype signature: str
        """
        super(DeploymentLicenseResponse, self).__init__(**kwargs)
