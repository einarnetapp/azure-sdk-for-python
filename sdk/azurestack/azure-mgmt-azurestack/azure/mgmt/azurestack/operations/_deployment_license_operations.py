...
def build_create_request(
    subscription_id: str,
    *,
    json: Optional[_models.DeploymentLicenseRequest] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.AzureStack/generateDeploymentLicense")  # pylint: disable=line-too-long
...
class DeploymentLicenseOperations:
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :param deployment_license_request: Request body for creating a deployment license.
