...
class VirtualNetworkRule(_serialization.Model):
    ...
    :vartype state: str
    :ivar ignore_missing_vnet_service_endpoint: Ignore missing vnet services endpoint or not.
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype state: str
        :keyword ignore_missing_vnet_service_endpoint: Ignore missing vnet services endpoint or not.
