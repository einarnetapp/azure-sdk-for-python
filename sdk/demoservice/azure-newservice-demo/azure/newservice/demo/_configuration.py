...
class DemoNewServiceClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    """Configuration for DemoNewServiceClient.
    ...
    def __init__(self, endpoint: str, instance_id: str, credential: "TokenCredential", **kwargs: Any) -> None:
        super(DemoNewServiceClientConfiguration, self).__init__(**kwargs)
        ...
        kwargs.setdefault("sdk_moniker", "newservice-demo/{}".format(VERSION))
