...
class DemoNewServiceClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype device_update: azure.newservice.demo.operations.DeviceUpdateOperations
    :ivar device_management: DeviceManagementOperations operations
    :vartype device_management: azure.newservice.demo.operations.DeviceManagementOperations
    ...
    def __init__(self, endpoint: str, instance_id: str, credential: "TokenCredential", **kwargs: Any) -> None:
        ...
        self._config = DemoNewServiceClientConfiguration(
