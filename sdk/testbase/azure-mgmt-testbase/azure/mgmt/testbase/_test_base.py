...
class TestBase:    # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.test_base_accounts = TestBaseAccountsOperations(self._client, self._config, self._serialize, self._deserialize)
        ...
        self.favorite_processes = FavoriteProcessesOperations(self._client, self._config, self._serialize, self._deserialize)
        self.analysis_results = AnalysisResultsOperations(self._client, self._config, self._serialize, self._deserialize)
        ...
        self.billing_hub_service = BillingHubServiceOperations(self._client, self._config, self._serialize, self._deserialize)
