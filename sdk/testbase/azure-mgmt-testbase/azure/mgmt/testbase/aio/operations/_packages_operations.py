...
from ...operations._packages_operations import build_create_request_initial, build_delete_request_initial, build_get_download_url_request, build_get_request, build_hard_delete_request_initial, build_list_by_test_base_account_request, build_run_test_request, build_update_request_initial
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class PackagesOperations:
    """PackagesOperations async operations.
    ...
    def list_by_test_base_account(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.PackageListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.testbase.models.PackageListResult]
    ...
    @distributed_trace_async
    async def begin_hard_delete(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        test_base_account_name: str,
        package_name: str,
