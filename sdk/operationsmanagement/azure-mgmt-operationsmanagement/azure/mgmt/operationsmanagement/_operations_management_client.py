...
from .operations import ManagementAssociationsOperations, ManagementConfigurationsOperations, Operations, SolutionsOperations
...
class OperationsManagementClient:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = OperationsManagementClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
