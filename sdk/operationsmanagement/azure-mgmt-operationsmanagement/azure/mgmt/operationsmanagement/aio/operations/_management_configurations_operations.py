...
from ...operations._management_configurations_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_subscription_request
T = TypeVar('T')
