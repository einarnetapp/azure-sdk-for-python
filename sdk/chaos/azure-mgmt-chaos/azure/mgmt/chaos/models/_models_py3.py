...
class ContinuousAction(Action):
    ...
    def __init__(
        self, *, name: str, duration: str, parameters: List["_models.KeyValuePair"], selector_id: str, **kwargs
    ):
        """
        :keyword name: String that represents a Capability URN. Required.
        :paramtype name: str
...
class DelayAction(Action):
    ...
    def __init__(self, *, name: str, duration: str, **kwargs):
        """
        :keyword name: String that represents a Capability URN. Required.
        :paramtype name: str
        :keyword duration: ISO8601 formatted string that represents a duration. Required.
...
class Filters(_serialization.Model):
    ...
    :ivar zones: List of zones. Required.
    ...
    def __init__(self, *, zones: List[str], **kwargs):
        """
        :keyword zones: List of zones. Required.
...
class Selector(_serialization.Model):
    ...
    :ivar filters: Model that represents available filters that can be applied to a targets list.
     Required.
    :vartype filters: ~azure.mgmt.chaos.models.Filters
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword filters: Model that represents available filters that can be applied to a targets
         list. Required.
        :paramtype filters: ~azure.mgmt.chaos.models.Filters
        """
        super().__init__(**kwargs)
        self.type = type
        self.id = id
