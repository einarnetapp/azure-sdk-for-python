...
def build_list_all_request(**kwargs: Any) -> HttpRequest:
    ...
    api_version: Literal["2023-01-31-preview"] = kwargs.pop(
        "api_version", _params.pop("api-version", "2023-01-31-preview")
    )
    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Chaos/operations")
