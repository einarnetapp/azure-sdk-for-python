...
class ManagedHsmsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ManagedHsm or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.keyvault.v2020_04_01_preview.models.ManagedHsm]
    ...
    async def begin_create_or_update(
        ...
        :param name: Name of the managed HSM Pool. Required.
        :type name: str
        :param parameters: Parameters to create or update the managed HSM Pool. Is either a model type
    ...
    async def begin_update(
        ...
        :param name: Name of the managed HSM Pool. Required.
        :type name: str
        :param parameters: Parameters to patch the managed HSM Pool. Is either a model type or a IO
         type. Required.
        :type parameters: ~azure.mgmt.keyvault.v2020_04_01_preview.models.ManagedHsm or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2020_04_01_preview.models.ManagedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
