...
def build_list_request(
    subscription_id: str,
    *,
    filter: Union[str, _models.Enum10],
    api_version: Union[str, _models.Enum11],
...
class VaultsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param vault_name: Name of the vault. Required.
        :type vault_name: str
        :param parameters: Parameters to create or update the vault. Is either a model type or a IO
         type. Required.
        :type parameters: ~azure.mgmt.keyvault.v2019_09_01.models.VaultCreateOrUpdateParameters or IO
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param vault_name: Name of the vault. Required.
        :type vault_name: str
        :param parameters: Parameters to patch the vault. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.keyvault.v2019_09_01.models.VaultPatchParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update_access_policy(
        ...
        **kwargs: Any
        ...
        :param operation_kind: Name of the operation. Known values are: "add", "replace", and "remove".
         Required.
        :type operation_kind: str or ~azure.mgmt.keyvault.v2019_09_01.models.AccessPolicyUpdateKind
        :param parameters: Access policy to merge into the vault. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.keyvault.v2019_09_01.models.VaultAccessPolicyParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_resource_group(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2019_09_01.models.Vault]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_deleted(self, **kwargs: Any) -> Iterable["_models.DeletedVault"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2019_09_01.models.DeletedVault]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :type filter: str or ~azure.mgmt.keyvault.v2019_09_01.models.Enum10
        :param api_version: Azure Resource Manager Api Version. "2015-11-01" Required.
        :type api_version: str or ~azure.mgmt.keyvault.v2019_09_01.models.Enum11
        :param top: Maximum number of results to return. Default value is None.
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def check_name_availability(
        ...
        :param vault_name: The name of the vault. Is either a model type or a IO type. Required.
        :type vault_name: ~azure.mgmt.keyvault.v2019_09_01.models.VaultCheckNameAvailabilityParameters
         or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
