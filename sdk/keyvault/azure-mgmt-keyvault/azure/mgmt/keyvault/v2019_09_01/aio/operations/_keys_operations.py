...
class KeysOperations:
    ...
    async def create_if_not_exist(
        ...
        **kwargs: Any
        ...
        :param key_name: The name of the key to be created. Required.
        :type key_name: str
        :param parameters: The parameters used to create the specified key. Is either a model type or a
         IO type. Required.
        :type parameters: ~azure.mgmt.keyvault.v2019_09_01.models.KeyCreateParameters or IO
    ...
    def list(self, resource_group_name: str, vault_name: str, **kwargs: Any) -> AsyncIterable["_models.Key"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2019_09_01.models.Key]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
