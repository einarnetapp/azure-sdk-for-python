...
class SecretsOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param secret_name: Name of the secret. The value you provide may be copied globally for the
         ...
         or sensitive information. Required.
        :type secret_name: str
        :param parameters: Parameters to create or update the secret. Is either a model type or a IO
         type. Required.
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param secret_name: Name of the secret. Required.
        :type secret_name: str
        :param parameters: Parameters to patch the secret. Is either a model type or a IO type.
         Required.
    ...
    def list(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2022_07_01.models.Secret]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
