...
class MarketplaceOrderingAgreements:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype marketplace_agreements:
     azure.mgmt.marketplaceordering.aio.operations.MarketplaceAgreementsOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.marketplaceordering.aio.operations.Operations
