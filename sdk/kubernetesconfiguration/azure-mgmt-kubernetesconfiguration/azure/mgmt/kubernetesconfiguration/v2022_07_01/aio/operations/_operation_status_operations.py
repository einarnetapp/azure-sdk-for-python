...
class OperationStatusOperations:
    ...
    :type models: ~azure.mgmt.kubernetesconfiguration.v2022_07_01.models
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.kubernetesconfiguration.v2022_07_01.models.OperationStatusList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-07-01")  # type: str
