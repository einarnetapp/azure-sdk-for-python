...
from .operations import ConfidentialLedgerOperationsMixin, LedgerOperations, MccfOperations, Operations
...
class ConfidentialLedger(ConfidentialLedgerOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :ivar mccf: MccfOperations operations
    :vartype mccf: azure.mgmt.confidentialledger.aio.operations.MccfOperations
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2022-09-08-preview". Note that overriding
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.mccf = MccfOperations(self._client, self._config, self._serialize, self._deserialize)
