...
def build_check_name_availability_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version: Literal["2023-18-01"] = kwargs.pop("api_version", _params.pop("api-version", "2023-18-01"))
...
class ConfidentialLedgerOperationsMixin(ConfidentialLedgerMixinABC):
    ...
    def check_name_availability(
        ...
        :param name_availability_request: Name availability request payload. Is either a model type or
         a IO type. Required.
        :type name_availability_request:
        ...
        api_version: Literal["2023-18-01"] = kwargs.pop(
