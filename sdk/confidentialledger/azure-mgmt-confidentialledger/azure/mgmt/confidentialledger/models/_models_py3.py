...
class LedgerProperties(msrest.serialization.Model):
    ...
    :ivar certificate_client_endpoint: Endpoint for accessing network identity.
    :vartype certificate_client_endpoint: str
    ...
    _validation = {
        ...
        'certificate_client_endpoint': {'readonly': True},
    ...
    _attribute_map = {
        ...
        'certificate_client_endpoint': {'key': 'certificateClientEndpoint', 'type': 'str'},
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.certificate_client_endpoint = None
