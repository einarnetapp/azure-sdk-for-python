...
class LedgerProperties(_serialization.Model):
    ...
    :ivar running_state: Running state of Ledger Resource. Known values are: "Active", "Paused",
     "Unknown", "Pausing", and "Resuming".
    :vartype running_state: str or ~azure.mgmt.confidentialledger.models.LedgerRunningState
