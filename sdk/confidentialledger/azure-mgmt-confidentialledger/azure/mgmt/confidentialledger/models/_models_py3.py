...
class ManagedCCF(Resource, ResourceLocation, Tags):
...
class ManagedCCFList(_serialization.Model):
    ...
    def __init__(
        self, *, value: Optional[List["_models.ManagedCCF"]] = None, next_link: Optional[str] = None, **kwargs
    ):
        """
...
class ManagedCCFProperties(_serialization.Model):
    ...
    :ivar identity_service_uri: Endpoint for accessing network identity.
    :vartype identity_service_uri: str
    :ivar app_source_uri: Source Uri containing mccf code.
    ...
    def __init__(self, *, app_source_uri: Optional[str] = None, **kwargs):
        """
        :keyword app_source_uri: Source Uri containing mccf code.
