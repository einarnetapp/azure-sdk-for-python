...
def build_list_by_subscription_request(
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.LabServices/labs")
...
def build_get_request(resource_group_name: str, lab_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_create_or_update_request(
    resource_group_name: str, lab_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(resource_group_name: str, lab_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_request(resource_group_name: str, lab_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_publish_request(resource_group_name: str, lab_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class LabsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, filter: Optional[str] = None, **kwargs: Any) -> Iterable["_models.Lab"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.labservices.models.Lab]
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Lab"]:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, lab_name: str, **kwargs: Any) -> _models.Lab:
        """Get a lab resource.
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, lab_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def begin_publish(self, resource_group_name: str, lab_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    def _sync_group_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, lab_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    @distributed_trace
    def begin_sync_group(self, resource_group_name: str, lab_name: str, **kwargs: Any) -> LROPoller[None]:
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._sync_group_initial(  # type: ignore
                resource_group_name=resource_group_name,
                lab_name=lab_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
