...
class EventHandler(_serialization.Model):
    ...
    :ivar system_events: Gets ot sets the list of system events.
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword system_events: Gets ot sets the list of system events.
...
class ResourceSku(_serialization.Model):
    ...
    :ivar name: The name of the SKU. Required.
     ...
     Allowed values: Standard_S1, Free_F1. Required.
    :vartype name: str
