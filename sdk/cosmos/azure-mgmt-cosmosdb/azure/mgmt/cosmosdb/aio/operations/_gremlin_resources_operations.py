...
class GremlinResourcesOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_gremlin_databases(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either GremlinDatabaseListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdb.models.GremlinDatabaseListResult]
    ...
    @distributed_trace_async
    async def begin_delete_gremlin_database(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        database_name: str,
    ...
    def list_gremlin_graphs(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either GremlinGraphListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdb.models.GremlinGraphListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace_async
    async def begin_delete_gremlin_graph(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        database_name: str,
