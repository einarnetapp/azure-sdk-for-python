...
def main():
    ...
    response = client.migrations.delete(
...
# x-ms-original-file: specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/preview/2022-03-08-preview/examples/Migrations_Delete.json
