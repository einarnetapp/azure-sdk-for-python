...
from ...operations._maria_db_management_client_operations import build_create_recommended_action_session_request_initial, build_reset_query_performance_insight_data_request
...
class MariaDBManagementClientOperationsMixin(MixinABC):
    ...
    @distributed_trace_async
    async def begin_create_recommended_action_session(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        server_name: str,
        advisor_name: str,
