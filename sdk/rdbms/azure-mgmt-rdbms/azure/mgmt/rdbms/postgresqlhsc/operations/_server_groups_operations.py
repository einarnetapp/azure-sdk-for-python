...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    )  # type: Literal["2020-10-05-privatepreview"]
...
class ServerGroupsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.ServerGroup"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresqlhsc.models.ServerGroup]
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.ServerGroup"]:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, server_group_name: str, **kwargs: Any) -> _models.ServerGroup:
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, server_group_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def begin_restart(self, resource_group_name: str, server_group_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def begin_start(self, resource_group_name: str, server_group_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def begin_stop(self, resource_group_name: str, server_group_name: str, **kwargs: Any) -> LROPoller[None]:
