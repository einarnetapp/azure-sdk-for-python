...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version: Literal["2022-11-08"] = kwargs.pop("api_version", _params.pop("api-version", "2022-11-08"))
...
class ClustersOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.ClusterResponse"]:
        """List all the clusters in a given subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ClusterResponse or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresqlhsc.models.ClusterResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

        api_version: Literal["2022-11-08"] = kwargs.pop(
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.ClusterResponse"]:
    ...
    def _create_or_update_initial(
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.ClusterResponse] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("ClusterResponse", pipeline_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.ClusterResponse]:
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlhsc.models.Cluster
        ...
        :return: An instance of LROPoller that returns either ClusterResponse or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresqlhsc.models.ClusterResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlhsc.models.Cluster or IO
    ...
    @distributed_trace
    def get(self, resource_group_name: str, cluster_name: str, **kwargs: Any) -> _models.ClusterResponse:
        ...
        :type cluster_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ClusterResponse or the result of cls(response)
        :rtype: ~azure.mgmt.rdbms.postgresqlhsc.models.ClusterResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        """Updates an existing cluster. The request body can contain one to many of the properties present
        in the normal cluster definition.
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlhsc.models.ClusterForUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param cluster_name: The name of the cluster. Required.
        :type cluster_name: str
        :param parameters: The parameters for updating a cluster. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.rdbms.postgresqlhsc.models.ClusterForUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
