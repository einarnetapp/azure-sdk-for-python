...
class ServersOperations:
    ...
    @distributed_trace
    def list_by_cluster(self, resource_group_name: str, cluster_name: str, **kwargs: Any) -> Iterable["_models.Server"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresqlhsc.models.Server]
    ...
    list_by_cluster.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/serverGroupsv2/{clusterName}/servers"
    }

    @distributed_trace
    def get(self, resource_group_name: str, cluster_name: str, server_name: str, **kwargs: Any) -> _models.Server:
        ...
        :rtype: ~azure.mgmt.rdbms.postgresqlhsc.models.Server
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/serverGroupsv2/{clusterName}/servers/{serverName}"
    }
