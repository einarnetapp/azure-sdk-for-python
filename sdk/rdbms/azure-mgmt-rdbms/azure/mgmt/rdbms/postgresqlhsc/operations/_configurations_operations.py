...
def build_create_or_update_coordinator_request(
    resource_group_name: str, cluster_name: str, configuration_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_create_or_update_node_request(
    resource_group_name: str, cluster_name: str, configuration_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ConfigurationsOperations:
    ...
    def _create_or_update_coordinator_initial(
        self,
    ...
    @overload
    def begin_create_or_update_coordinator(
        self,
        resource_group_name: str,
        cluster_name: str,
        configuration_name: str,
    ...
    def begin_create_or_update_coordinator(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._create_or_update_coordinator_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                configuration_name=configuration_name,
    ...
    def _create_or_update_node_initial(
        self,
        resource_group_name: str,
        cluster_name: str,
        configuration_name: str,
    ...
    @overload
    def begin_create_or_update_node(
        self,
        resource_group_name: str,
        cluster_name: str,
        configuration_name: str,
    ...
    def begin_create_or_update_node(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._create_or_update_node_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                configuration_name=configuration_name,
                parameters=parameters,
