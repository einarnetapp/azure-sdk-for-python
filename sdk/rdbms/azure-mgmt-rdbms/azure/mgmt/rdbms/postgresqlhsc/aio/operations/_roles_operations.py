...
from ...operations._roles_operations import build_create_request_initial, build_delete_request_initial, build_list_by_server_group_request
T = TypeVar('T')
...
class RolesOperations:
    ...
    def list_by_server_group(
        ...
        server_group_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.RoleListResult"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresqlhsc.models.RoleListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-10-05-privatepreview")  # type: str
