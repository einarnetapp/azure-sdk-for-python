...
class ClustersOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.Cluster"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresqlhsc.models.Cluster]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Cluster or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.rdbms.postgresqlhsc.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
