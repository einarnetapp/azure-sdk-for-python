...
class ClustersOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ClusterResponse"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresqlhsc.models.ClusterResponse]
    ...
    ) -> AsyncIterable["_models.ClusterResponse"]:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.ClusterResponse]:
        ...
        :return: An instance of AsyncLROPoller that returns either ClusterResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.rdbms.postgresqlhsc.models.ClusterResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, cluster_name: str, **kwargs: Any) -> _models.ClusterResponse:
