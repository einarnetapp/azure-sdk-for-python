...
class CosmosDBForPostgreSQL:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    Cosmos DB for PostgreSQL resources including clusters, servers, configurations, firewall rules,
    roles, private endpoint connections and private link resources.

    :ivar clusters: ClustersOperations operations
    :vartype clusters: azure.mgmt.rdbms.postgresqlhsc.aio.operations.ClustersOperations
    ...
    :vartype private_endpoint_connections:
     azure.mgmt.rdbms.postgresqlhsc.aio.operations.PrivateEndpointConnectionsOperations
    :ivar private_link_resources: PrivateLinkResourcesOperations operations
    :vartype private_link_resources:
     azure.mgmt.rdbms.postgresqlhsc.aio.operations.PrivateLinkResourcesOperations
    ...
    async def __aenter__(self) -> "CosmosDBForPostgreSQL":
