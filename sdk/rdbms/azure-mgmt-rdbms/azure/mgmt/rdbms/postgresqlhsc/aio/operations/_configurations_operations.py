...
from ...operations._configurations_operations import (
    build_create_or_update_coordinator_request,
    build_create_or_update_node_request,
    build_get_request,
...
class ConfigurationsOperations:
    ...
    async def _create_or_update_coordinator_initial(
        self,
        ...
        **kwargs: Any
        ...
        request = build_create_or_update_coordinator_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            configuration_name=configuration_name,
            subscription_id=self._config.subscription_id,
            ...
            json=_json,
            content=_content,
            template_url=self._create_or_update_coordinator_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _create_or_update_coordinator_initial.metadata = {
    ...
    @overload
    async def begin_create_or_update_coordinator(
        self,
        resource_group_name: str,
        cluster_name: str,
        configuration_name: str,
    ...
    async def begin_create_or_update_coordinator(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._create_or_update_coordinator_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                configuration_name=configuration_name,
    ...
    begin_create_or_update_coordinator.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/serverGroupsv2/{clusterName}/coordinatorConfigurations/{configurationName}"
    }

    async def _create_or_update_node_initial(
        self,
        resource_group_name: str,
        cluster_name: str,
        configuration_name: str,
        ...
        **kwargs: Any
        ...
        request = build_create_or_update_node_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            configuration_name=configuration_name,
            subscription_id=self._config.subscription_id,
            ...
            json=_json,
            content=_content,
            template_url=self._create_or_update_node_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _create_or_update_node_initial.metadata = {
    ...
    @overload
    async def begin_create_or_update_node(
        self,
        resource_group_name: str,
        cluster_name: str,
        configuration_name: str,
    ...
    async def begin_create_or_update_node(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._create_or_update_node_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                configuration_name=configuration_name,
                parameters=parameters,
    ...
    begin_create_or_update_node.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/serverGroupsv2/{clusterName}/nodeConfigurations/{configurationName}"
    }
