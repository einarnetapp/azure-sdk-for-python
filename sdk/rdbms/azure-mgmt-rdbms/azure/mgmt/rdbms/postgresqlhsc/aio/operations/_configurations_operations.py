...
from ...operations._configurations_operations import (
    ...
    build_update_coordinator_request,
    build_update_node_request,
)
...
class ConfigurationsOperations:
    ...
    def list_by_cluster(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresqlhsc.models.Configuration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def _update_coordinator_initial(
        self,
        resource_group_name: str,
        cluster_name: str,
        configuration_name: str,
        parameters: Union[_models.ServerConfigurationRequest, IO],
        **kwargs: Any
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "ServerConfigurationRequest")

        request = build_update_coordinator_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            configuration_name=configuration_name,
            subscription_id=self._config.subscription_id,
            ...
            json=_json,
            content=_content,
            template_url=self._update_coordinator_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _update_coordinator_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/serverGroupsv2/{clusterName}/configurations/{configurationName}/coordinator"
    }

    @overload
    async def begin_update_coordinator(
        self,
        resource_group_name: str,
        cluster_name: str,
        configuration_name: str,
        parameters: _models.ServerConfigurationRequest,
        *,
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlhsc.models.ServerConfigurationRequest
        ...
        :return: An instance of AsyncLROPoller that returns either ServerConfiguration or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.rdbms.postgresqlhsc.models.ServerConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update_coordinator(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlhsc.models.ServerConfigurationRequest or IO
        ...
        if cont_token is None:
            raw_result = await self._update_coordinator_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                configuration_name=configuration_name,
    ...
    begin_update_coordinator.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/serverGroupsv2/{clusterName}/configurations/{configurationName}/coordinator"
    }

    async def _update_node_initial(
        self,
        resource_group_name: str,
        cluster_name: str,
        configuration_name: str,
        ...
        **kwargs: Any
        ...
        request = build_update_node_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            configuration_name=configuration_name,
            subscription_id=self._config.subscription_id,
            ...
            json=_json,
            content=_content,
            template_url=self._update_node_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _update_node_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/serverGroupsv2/{clusterName}/configurations/{configurationName}/node"
    }

    @overload
    async def begin_update_node(
        self,
        resource_group_name: str,
        cluster_name: str,
        configuration_name: str,
    ...
    async def begin_update_node(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._update_node_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                configuration_name=configuration_name,
                parameters=parameters,
