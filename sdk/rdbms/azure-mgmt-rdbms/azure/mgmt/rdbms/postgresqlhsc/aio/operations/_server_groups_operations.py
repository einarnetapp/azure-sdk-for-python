...
from ...operations._server_groups_operations import build_check_name_availability_request, build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_resource_group_request, build_list_request, build_promote_request_initial, build_restart_request_initial, build_start_request_initial, build_stop_request_initial, build_update_request_initial
T = TypeVar('T')
...
class ServerGroupsOperations:
    ...
    def list(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.ServerGroupListResult"]:
        ...
        :return: An iterator like instance of either ServerGroupListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresqlhsc.models.ServerGroupListResult]
    ...
    @distributed_trace_async
    async def begin_promote(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        server_group_name: str,
        **kwargs: Any
