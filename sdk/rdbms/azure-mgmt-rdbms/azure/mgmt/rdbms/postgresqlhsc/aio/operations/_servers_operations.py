...
from ...operations._servers_operations import build_get_request, build_list_by_server_group_request
T = TypeVar('T')
...
class ServersOperations:
    ...
    def list_by_server_group(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.ServerGroupServerListResult"]:
        ...
        :return: An iterator like instance of either ServerGroupServerListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresqlhsc.models.ServerGroupServerListResult]
