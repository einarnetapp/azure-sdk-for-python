...
class Cluster(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar coordinator_v_cores: The vCores count of a server (max: 64). Required for creation.
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :keyword coordinator_v_cores: The vCores count of a server (max: 64). Required for creation.
        ...
        :keyword node_enable_public_ip_access: If public IP is requested or not for a server.
        ...
        :keyword source_location: The location of source cluster for read replica clusters.
...
class ClusterListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.postgresqlhsc.models.Cluster]
    ...
    def __init__(self, *, value: Optional[List["_models.Cluster"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.rdbms.postgresqlhsc.models.Cluster]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class Configuration(ProxyResource):
    ...
    :vartype provisioning_state: str or ~azure.mgmt.rdbms.postgresqlhsc.models.ProvisioningState
    """
...
class Server(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar enable_ha: If high availability is enabled or not for the server.
    :vartype enable_ha: bool
    :ivar enable_public_ip_access: If public IP is requested or not for a server.
    ...
    :vartype citus_version: str
    :ivar is_read_only: If server is set to read-only.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype citus_version: str
        :keyword is_read_only: If server is set to read-only.
...
class ServerListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.postgresqlhsc.models.Server]
    """
    ...
    def __init__(self, *, value: Optional[List["_models.Server"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.rdbms.postgresqlhsc.models.Server]
        """
        super().__init__(**kwargs)
        self.value = value
