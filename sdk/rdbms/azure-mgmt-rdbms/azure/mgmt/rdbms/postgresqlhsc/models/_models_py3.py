...
class Cluster(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar source_resource_id: The source resource id to restore from. It's required to create
     'ReadReplica'.
    :vartype source_resource_id: str
    :ivar source_location: The source cluster location to restore from. It's required for creating
    ...
    :ivar point_in_time_utc: Restore point creation time (ISO8601 format), specifying the time to
     restore from. It's required to create 'PointInTimeRestore'.
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :keyword source_resource_id: The source resource id to restore from. It's required to create
         'ReadReplica'.
...
class ClusterResponse(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    _validation = {
        ...
        "point_in_time_utc": {"readonly": True},
...
class Configuration(ProxyResource):
    ...
    :ivar provisioning_state: Provisioning state of the configuration.
    :vartype provisioning_state: str
    """
...
class FirewallRule(ProxyResource):
    ...
    :ivar provisioning_state: Provisioning state of the firewall rule.
    :vartype provisioning_state: str
    """
...
class Role(ProxyResource):
    ...
    :ivar provisioning_state: Provisioning state of the cluster role.
    :vartype provisioning_state: str
    """
