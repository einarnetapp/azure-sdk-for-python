...
class Cluster(Resource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar enable_ha: If high availability is enabled or not for the cluster.
    ...
    :ivar node_enable_public_ip_access: If public IP is requested or not for a node.
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs
        ...
        :keyword enable_ha: If high availability is enabled or not for the cluster.
        ...
        :keyword node_enable_public_ip_access: If public IP is requested or not for a node.
...
class ClusterListResult(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.ClusterResponse"]] = None, **kwargs):
        """
...
class ClusterResponse(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype coordinator_v_cores: int
    :ivar coordinator_enable_public_ip_access: If public IP is requested or not for a server.
    :vartype coordinator_enable_public_ip_access: bool
    ...
    :vartype node_v_cores: int
    :ivar node_enable_public_ip_access: If public IP is requested or not for a server.
    :vartype node_enable_public_ip_access: bool
    ...
    :vartype private_endpoint_connections:
     list[~azure.mgmt.rdbms.postgresqlhsc.models.PrivateEndpointConnection]
    """
...
class ClusterServerListResult(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.ClusterServer"]] = None, **kwargs):
        """
...
class PrivateEndpointConnection(ProxyResource):
    ...
    :vartype private_link_service_connection_state:
     ~azure.mgmt.rdbms.postgresqlhsc.models.PrivateLinkServiceConnectionStateProperty
    """
...
class PrivateEndpointConnectionListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.postgresqlhsc.models.PrivateEndpointConnectionProperty]
    :ivar next_link: Link to retrieve next page of results.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[PrivateEndpointConnectionProperty]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(self, *, value: Optional[List["_models.PrivateEndpointConnectionProperty"]] = None, **kwargs):
        """
        :keyword value: The list of private endpoint connections.
        :paramtype value:
         list[~azure.mgmt.rdbms.postgresqlhsc.models.PrivateEndpointConnectionProperty]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class PrivateEndpointConnectionProperty(ProxyResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype private_link_service_connection_state:
         ~azure.mgmt.rdbms.postgresqlhsc.models.PrivateLinkServiceConnectionStateProperty
        :keyword provisioning_state: State of the private endpoint connection.
...
class PrivateLinkResource(ProxyResource):
    ...
    :ivar required_zone_names: The private link resource zone names.
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword required_zone_names: The private link resource zone names.
...
class PrivateLinkResourceListResult(_serialization.Model):
    ...
    :ivar value: The list of private link resources.
    :vartype value: list[~azure.mgmt.rdbms.postgresqlhsc.models.PrivateLinkResource]
    :ivar next_link: The link used to get the next page of private link resources.
    :vartype next_link: str
    """
...
class PrivateLinkServiceConnectionState(_serialization.Model):
    ...
    def __init__(self, *, description: Optional[str] = None, status: Optional[str] = None, **kwargs):
        """
...
class PrivateLinkServiceConnectionStateProperty(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword actions_required: The actions required for private link service connection.
...
class RoleListResult(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.Role"]] = None, **kwargs):
        """
...
class ServerConfiguration(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, *, value: Optional[str] = None, requires_restart: Optional[bool] = None, **kwargs):
        """
...
class ServerConfigurationListResult(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.ServerConfiguration"]] = None, **kwargs):
        """
...
class ServerConfigurationRequest(_serialization.Model):
    ...
    :ivar value: Represents the value of a configuration.
    :vartype value: str
    """
    ...
    def __init__(self, *, value: Optional[str] = None, **kwargs):
        """
        :keyword value: Represents the value of a configuration.
        :paramtype value: str
        """
        super().__init__(**kwargs)
        self.value = value
...
class ServerRoleGroupConfiguration(_serialization.Model):
    ...
    def __init__(self, *, role: Union[str, "_models.ServerRole"], value: str, **kwargs):
        """
