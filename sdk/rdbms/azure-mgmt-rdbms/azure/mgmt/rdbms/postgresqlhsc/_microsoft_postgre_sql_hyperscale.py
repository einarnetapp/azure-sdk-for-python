...
class MicrosoftPostgreSQLHyperscale:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.server_group = ServerGroupOperations(self._client, self._config, self._serialize, self._deserialize)
