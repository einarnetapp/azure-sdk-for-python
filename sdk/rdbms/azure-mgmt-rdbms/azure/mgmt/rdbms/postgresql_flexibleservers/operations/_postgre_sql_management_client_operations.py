...
class PostgreSQLManagementClientOperationsMixin(PostgreSQLManagementClientMixinABC):
    ...
    def check_migration_name_availability(
        ...
        **kwargs: Any
        ...
        content_type = kwargs.pop("content_type", _headers.pop("Content-Type", None))  # type: Optional[str]
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.MigrationNameAvailabilityResource]
    ...
    check_migration_name_availability.metadata = {"url": "/subscriptions/{targetDBServerSubscriptionId}/resourceGroups/{targetDBServerResourceGroupName}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{targetDBServerName}/checkMigrationNameAvailability"}  # type: ignore
