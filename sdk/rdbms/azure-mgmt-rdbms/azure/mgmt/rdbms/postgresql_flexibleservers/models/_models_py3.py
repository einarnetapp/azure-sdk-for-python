...
class Backup(msrest.serialization.Model):
    ...
    :ivar geo_redundant_backup: A value indicating whether Geo-Redundant backup is enabled on the
     server. Possible values include: "Enabled", "Disabled". Default value: "Disabled".
    ...
    def __init__(
        ...
        *,
        ...
        geo_redundant_backup: Optional[Union[str, "GeoRedundantBackupEnum"]] = "Disabled",
        **kwargs
    ):
        """
        ...
        :keyword geo_redundant_backup: A value indicating whether Geo-Redundant backup is enabled on
         the server. Possible values include: "Enabled", "Disabled". Default value: "Disabled".
...
class HighAvailability(msrest.serialization.Model):
    ...
    :ivar mode: The HA mode for the server. Possible values include: "Disabled", "ZoneRedundant".
    ...
    def __init__(
        self,
        *,
        mode: Optional[Union[str, "HighAvailabilityMode"]] = "Disabled",
        standby_availability_zone: Optional[str] = "",
        **kwargs
    ):
        """
        :keyword mode: The HA mode for the server. Possible values include: "Disabled",
         "ZoneRedundant". Default value: "Disabled".
...
class NameAvailability(msrest.serialization.Model):
    ...
    :vartype type: str
    :ivar reason: The name availability reason. Possible values include: "Invalid",
     "AlreadyExists".
...
class RestartParameter(msrest.serialization.Model):
    ...
    :ivar failover_mode: Failover mode. Possible values include: "PlannedFailover",
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword failover_mode: Failover mode. Possible values include: "PlannedFailover",
         "ForcedFailover", "PlannedSwitchover", "ForcedSwitchover".
...
class Server(TrackedResource):
    ...
    :ivar version: PostgreSQL Server version. Possible values include: "13", "12", "11".
    ...
    :ivar create_mode: The mode to create a new PostgreSQL server. Possible values include:
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword version: PostgreSQL Server version. Possible values include: "13", "12", "11".
        ...
        :keyword create_mode: The mode to create a new PostgreSQL server. Possible values include:
         "Default", "Create", "Update", "PointInTimeRestore".
...
class ServerForUpdate(msrest.serialization.Model):
    ...
    :vartype maintenance_window:
     ~azure.mgmt.rdbms.postgresql_flexibleservers.models.MaintenanceWindow
    :ivar create_mode: The mode to update a new PostgreSQL server. Possible values include:
     "Default", "Update".
    ...
    def __init__(
        ...
        *,
        ...
        high_availability: Optional["HighAvailability"] = None,
        maintenance_window: Optional["MaintenanceWindow"] = None,
        create_mode: Optional[Union[str, "CreateModeForUpdate"]] = None,
        **kwargs
    ):
        """
        ...
        :paramtype maintenance_window:
         ~azure.mgmt.rdbms.postgresql_flexibleservers.models.MaintenanceWindow
        :keyword create_mode: The mode to update a new PostgreSQL server. Possible values include:
         "Default", "Update".
...
class Sku(msrest.serialization.Model):
    ...
    :ivar name: Required. The name of the sku, typically, tier + family + cores, e.g.
     Standard_D4s_v3.
    :vartype name: str
    :ivar tier: Required. The tier of the particular SKU, e.g. Burstable. Possible values include:
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword name: Required. The name of the sku, typically, tier + family + cores, e.g.
         Standard_D4s_v3.
        :paramtype name: str
        :keyword tier: Required. The tier of the particular SKU, e.g. Burstable. Possible values
