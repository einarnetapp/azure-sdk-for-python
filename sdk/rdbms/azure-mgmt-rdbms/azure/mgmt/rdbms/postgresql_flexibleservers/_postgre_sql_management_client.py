...
from .operations import CheckNameAvailabilityOperations, ConfigurationsOperations, DatabasesOperations, FirewallRulesOperations, GetPrivateDnsZoneSuffixOperations, LocationBasedCapabilitiesOperations, Operations, ServersOperations, VirtualNetworkSubnetUsageOperations
...
class PostgreSQLManagementClient:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.virtual_network_subnet_usage = VirtualNetworkSubnetUsageOperations(self._client, self._config, self._serialize, self._deserialize)
