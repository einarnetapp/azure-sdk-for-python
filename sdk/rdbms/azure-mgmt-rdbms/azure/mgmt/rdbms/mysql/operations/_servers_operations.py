...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DBforMySQL/servers")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
    }
...
class ServersOperations:
    ...
    def begin_create(
        ...
        :type parameters: ~azure.mgmt.rdbms.mysql.models.ServerForCreate or IO
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.mysql.models.ServerUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.mysql.models.ServerUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Server"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.mysql.models.Server]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    _restart_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/restart"
    }
    ...
    _start_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/start"
    }
    ...
    _stop_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/stop"
    }
    ...
    def _upgrade_initial(  # pylint: disable=inconsistent-return-statements
        ...
        resource_group_name: str,
        server_name: str,
        parameters: Union[_models.ServerUpgradeParameters, IO],
        **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "ServerUpgradeParameters")
    ...
    _upgrade_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/upgrade"
    }
    ...
    def begin_upgrade(
        ...
        resource_group_name: str,
        server_name: str,
        parameters: _models.ServerUpgradeParameters,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[None]:
        ...
        :type server_name: str
        :param parameters: The required parameters for updating a server. Required.
        :type parameters: ~azure.mgmt.rdbms.mysql.models.ServerUpgradeParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_upgrade(
        ...
        **kwargs: Any
        ...
        :type server_name: str
        :param parameters: The required parameters for updating a server. Is either a
         ServerUpgradeParameters type or a IO type. Required.
        :type parameters: ~azure.mgmt.rdbms.mysql.models.ServerUpgradeParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
