...
class ImpactType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """The impact type
    """
...
class MaintenanceScope(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    ...
    HOST = "Host"
    #: This maintenance scope is default for update by any Resource Providers.
    RESOURCE = "Resource"
...
class RebootOptions(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class TaskScope(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
