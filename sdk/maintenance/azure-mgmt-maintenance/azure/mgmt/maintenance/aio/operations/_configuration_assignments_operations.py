...
from ...operations._configuration_assignments_operations import build_create_or_update_parent_request, build_create_or_update_request, build_delete_parent_request, build_delete_request, build_get_parent_request, build_get_request, build_list_parent_request, build_list_request
T = TypeVar('T')
