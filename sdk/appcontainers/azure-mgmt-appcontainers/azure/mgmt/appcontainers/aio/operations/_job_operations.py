...
class JobOperations:
    ...
    @distributed_trace_async
    async def begin_run(self, resource_group_name: str, job_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
    ...
    async def _terminate_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, job_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    @distributed_trace_async
    async def begin_terminate(self, resource_group_name: str, job_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._terminate_initial(  # type: ignore
                resource_group_name=resource_group_name,
                job_name=job_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
