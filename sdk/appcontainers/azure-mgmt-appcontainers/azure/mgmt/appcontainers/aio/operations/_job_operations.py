...
class JobOperations:
    ...
    @distributed_trace_async
    async def begin_executions(
        self, resource_group_name: str, job_name: str, filter: Optional[str] = None, **kwargs: Any
    ) -> AsyncLROPoller[AsyncIterable["_models.JobExecution"]]:
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appcontainers.models.JobExecution]]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._executions_initial(
                resource_group_name=resource_group_name,
                job_name=job_name,
                filter=filter,
                api_version=api_version,
