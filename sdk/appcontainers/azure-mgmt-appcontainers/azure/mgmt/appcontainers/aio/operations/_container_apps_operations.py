...
class ContainerAppsOperations:
    ...
    async def list_secrets(
        ...
        container_app_name: str,
        **kwargs: Any
    ) -> Optional[_models.SecretsCollection]:
        ...
        :rtype: ~azure.mgmt.appcontainers.models.SecretsCollection or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', "2022-03-01"))  # type: str
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional[_models.SecretsCollection]]
