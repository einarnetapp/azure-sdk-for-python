...
class ContainerAppsAPIClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype connected_environments_dapr_resiliency_circuit_breaker_policies:
     azure.mgmt.appcontainers.aio.operations.ConnectedEnvironmentsDaprResiliencyCircuitBreakerPoliciesOperations
    ...
    :vartype connected_environments_dapr_resiliency_timeout_policies:
     azure.mgmt.appcontainers.aio.operations.ConnectedEnvironmentsDaprResiliencyTimeoutPoliciesOperations
    ...
    :vartype connected_environments_dapr_resiliency_retry_policies:
     azure.mgmt.appcontainers.aio.operations.ConnectedEnvironmentsDaprResiliencyRetryPoliciesOperations
    ...
    :vartype job: azure.mgmt.appcontainers.aio.operations.JobOperations
