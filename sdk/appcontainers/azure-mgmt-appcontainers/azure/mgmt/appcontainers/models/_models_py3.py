...
class ContainerApp(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar workload_profile: Workload profile type to pin for container app execution.
    :vartype workload_profile: str
    ...
    _attribute_map = {
        ...
        "workload_profile": {"key": "properties.workloadProfile", "type": "str"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword workload_profile: Workload profile type to pin for container app execution.
        :paramtype workload_profile: str
