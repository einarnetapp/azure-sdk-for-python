...
class ConnectedEnvironment(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar dapr_resiliency_defaults: Dapr Resiliency Default Policies.
    :vartype dapr_resiliency_defaults: ~azure.mgmt.appcontainers.models.DaprResiliencyDefaults
    """
    ...
    _attribute_map = {
        ...
        "dapr_resiliency_defaults": {"key": "properties.daprResiliencyDefaults", "type": "DaprResiliencyDefaults"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        dapr_resiliency_defaults: Optional["_models.DaprResiliencyDefaults"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword tags: Resource tags.
        ...
        :paramtype custom_domain_configuration:
         ~azure.mgmt.appcontainers.models.CustomDomainConfiguration
        :keyword dapr_resiliency_defaults: Dapr Resiliency Default Policies.
        :paramtype dapr_resiliency_defaults: ~azure.mgmt.appcontainers.models.DaprResiliencyDefaults
        """
        super().__init__(tags=tags, location=location, **kwargs)
        ...
        self.dapr_resiliency_defaults = dapr_resiliency_defaults
...
class Dapr(_serialization.Model):
    ...
    :ivar resiliency_targets: Dapr targets for for applied resiliency policies.
    :vartype resiliency_targets: ~azure.mgmt.appcontainers.models.DaprResiliencyTargets
    """
    ...
    _attribute_map = {
        ...
        "resiliency_targets": {"key": "resiliencyTargets", "type": "DaprResiliencyTargets"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        resiliency_targets: Optional["_models.DaprResiliencyTargets"] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :keyword resiliency_targets: Dapr targets for for applied resiliency policies.
        :paramtype resiliency_targets: ~azure.mgmt.appcontainers.models.DaprResiliencyTargets
        """
        super().__init__(**kwargs)
        self.enabled = enabled
        self.app_id = app_id
        ...
        self.resiliency_targets = resiliency_targets


class DaprActorResiliencyTarget(_serialization.Model):
    """Dapr Actor for applied policies.

    All required parameters must be populated in order to send to Azure.

    :ivar target: Name of the dapr actor type to apply policies to. Required.
    :vartype target: str
    :ivar retry: Name of Retry Policy to apply.
    :vartype retry: str
    :ivar timeout: Name of Timeout Policy to apply.
    :vartype timeout: str
    :ivar circuit_breaker: Name of Circuit Breaker Policy to apply.
    :vartype circuit_breaker: str
    :ivar circuit_breaker_cache_size: Size of policy lru cache.
    :vartype circuit_breaker_cache_size: int
    :ivar circuit_breaker_scope: Circuit breakers for actors are scoped by 'id', 'type' or 'both'.
    :vartype circuit_breaker_scope: str
    """
    ...
    _attribute_map = {
        ...
        "circuit_breaker": {"key": "circuitBreaker", "type": "str"},
        "circuit_breaker_cache_size": {"key": "circuitBreakerCacheSize", "type": "int"},
        "circuit_breaker_scope": {"key": "circuitBreakerScope", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        circuit_breaker_cache_size: Optional[int] = None,
        circuit_breaker_scope: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword target: Name of the dapr actor type to apply policies to. Required.
        :paramtype target: str
        :keyword retry: Name of Retry Policy to apply.
        :paramtype retry: str
        :keyword timeout: Name of Timeout Policy to apply.
        :paramtype timeout: str
        :keyword circuit_breaker: Name of Circuit Breaker Policy to apply.
        :paramtype circuit_breaker: str
        :keyword circuit_breaker_cache_size: Size of policy lru cache.
        :paramtype circuit_breaker_cache_size: int
        :keyword circuit_breaker_scope: Circuit breakers for actors are scoped by 'id', 'type' or
         'both'.
        :paramtype circuit_breaker_scope: str
        """
        super().__init__(**kwargs)
        self.target = target
        self.retry = retry
        ...
        self.circuit_breaker_cache_size = circuit_breaker_cache_size
        self.circuit_breaker_scope = circuit_breaker_scope


class DaprAppResiliencyTarget(_serialization.Model):
    """Dapr Application for applied policies.

    All required parameters must be populated in order to send to Azure.

    :ivar target: Name of the dapr application to apply policies to. Required.
    :vartype target: str
    :ivar retry: Name of Retry Policy to apply.
    :vartype retry: str
    :ivar timeout: Name of Timeout Policy to apply.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword target: Name of the dapr application to apply policies to. Required.
        :paramtype target: str
        :keyword retry: Name of Retry Policy to apply.
        :paramtype retry: str
        :keyword timeout: Name of Timeout Policy to apply.
...
class DaprComponentResiliencyTarget(_serialization.Model):
    """Dapr Component for applied policies.

    All required parameters must be populated in order to send to Azure.

    :ivar target: Name of the dapr component to apply policies to. Required.
    :vartype target: str
    :ivar outbound: Outbound operations are calls from the dapr sidecar to a component.
    :vartype outbound: ~azure.mgmt.appcontainers.models.DaprComponentResiliencyTargetOutbound
    :ivar inbound: Inbound operations are calls from the dapr sidecar to your application.
    :vartype inbound: ~azure.mgmt.appcontainers.models.DaprComponentResiliencyTargetInbound
    """
    ...
    _attribute_map = {
        "target": {"key": "target", "type": "str"},
        "outbound": {"key": "outbound", "type": "DaprComponentResiliencyTargetOutbound"},
        "inbound": {"key": "inbound", "type": "DaprComponentResiliencyTargetInbound"},
    }
    ...
    def __init__(
        ...
        *,
        target: str,
        outbound: Optional["_models.DaprComponentResiliencyTargetOutbound"] = None,
        inbound: Optional["_models.DaprComponentResiliencyTargetInbound"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword target: Name of the dapr component to apply policies to. Required.
        :paramtype target: str
        :keyword outbound: Outbound operations are calls from the dapr sidecar to a component.
        :paramtype outbound: ~azure.mgmt.appcontainers.models.DaprComponentResiliencyTargetOutbound
        :keyword inbound: Inbound operations are calls from the dapr sidecar to your application.
        :paramtype inbound: ~azure.mgmt.appcontainers.models.DaprComponentResiliencyTargetInbound
        """
        super().__init__(**kwargs)
        self.target = target
...
class DaprComponentResiliencyTargetInbound(_serialization.Model):
...
class DaprComponentResiliencyTargetOutbound(_serialization.Model):
...
class DaprResiliencyCircuitBreakerPoliciesCollection(_serialization.Model):
    ...
    :ivar value: Collection of resources. Required.
    :vartype value: list[~azure.mgmt.appcontainers.models.DaprResiliencyCircuitBreakerPolicy]
    :ivar next_link: Link to next page of resources.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[DaprResiliencyCircuitBreakerPolicy]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(self, *, value: List["_models.DaprResiliencyCircuitBreakerPolicy"], **kwargs: Any) -> None:
        """
        :keyword value: Collection of resources. Required.
        :paramtype value: list[~azure.mgmt.appcontainers.models.DaprResiliencyCircuitBreakerPolicy]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class DaprResiliencyCircuitBreakerPolicy(ProxyResource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.appcontainers.models.SystemData
    :ivar max_requests: Maximum number of requests allowed to pass through.
    :vartype max_requests: int
    :ivar interval: Cyclical period of time used by the CB to clear its internal counts. Valid
     values are of the form 200ms, 15s, 2m, 1h30m, etc.
    :vartype interval: str
    :ivar timeout: The period of the open state until the CB switches to half-open. Valid values
     are of the form 200ms, 15s, 2m, 1h30m, etc.
    :vartype timeout: str
    :ivar trip: A Common Expression Language (CEL) statement that is evaluated by the CB When the
     statement evaluates to true, the CB trips and becomes open.
    :vartype trip: str
    :ivar circuit_breaker_scope: Specify whether circuit breaking state should be scoped to an
     individual actor ID, all actors across the actor type, or both. Possible values include id,
     type, or both.
    :vartype circuit_breaker_scope: str
    :ivar circuit_breaker_cache_size: Specify a cache size for the number of CBs to keep in memory.
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "system_data": {"key": "systemData", "type": "SystemData"},
        "max_requests": {"key": "properties.maxRequests", "type": "int"},
        "interval": {"key": "properties.interval", "type": "str"},
        "timeout": {"key": "properties.timeout", "type": "str"},
        "trip": {"key": "properties.trip", "type": "str"},
        "circuit_breaker_scope": {"key": "properties.circuitBreakerScope", "type": "str"},
        "circuit_breaker_cache_size": {"key": "properties.circuitBreakerCacheSize", "type": "int"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword max_requests: Maximum number of requests allowed to pass through.
        :paramtype max_requests: int
        :keyword interval: Cyclical period of time used by the CB to clear its internal counts. Valid
         values are of the form 200ms, 15s, 2m, 1h30m, etc.
        :paramtype interval: str
        :keyword timeout: The period of the open state until the CB switches to half-open. Valid values
         are of the form 200ms, 15s, 2m, 1h30m, etc.
        :paramtype timeout: str
        :keyword trip: A Common Expression Language (CEL) statement that is evaluated by the CB When
         the statement evaluates to true, the CB trips and becomes open.
        :paramtype trip: str
        :keyword circuit_breaker_scope: Specify whether circuit breaking state should be scoped to an
         individual actor ID, all actors across the actor type, or both. Possible values include id,
         type, or both.
        :paramtype circuit_breaker_scope: str
        :keyword circuit_breaker_cache_size: Specify a cache size for the number of CBs to keep in
...
class DaprResiliencyDefaults(_serialization.Model):
    """Default Resiliency Policy.

    :ivar retries: Retry Policies.
    :vartype retries: list[~azure.mgmt.appcontainers.models.DaprResiliencyRetryPolicy]
    :ivar timeouts: Timeout Policy.
    :vartype timeouts: ~azure.mgmt.appcontainers.models.DaprResiliencyTimeoutPolicy
    :ivar circuit_breakers: Circuit Breaker Policy.
    :vartype circuit_breakers:
     list[~azure.mgmt.appcontainers.models.DaprResiliencyCircuitBreakerPolicy]
    """

    _attribute_map = {
        "retries": {"key": "retries", "type": "[DaprResiliencyRetryPolicy]"},
        "timeouts": {"key": "timeouts", "type": "DaprResiliencyTimeoutPolicy"},
        "circuit_breakers": {"key": "circuitBreakers", "type": "[DaprResiliencyCircuitBreakerPolicy]"},
    }

    def __init__(
        self,
        *,
        retries: Optional[List["_models.DaprResiliencyRetryPolicy"]] = None,
        timeouts: Optional["_models.DaprResiliencyTimeoutPolicy"] = None,
        circuit_breakers: Optional[List["_models.DaprResiliencyCircuitBreakerPolicy"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword retries: Retry Policies.
        :paramtype retries: list[~azure.mgmt.appcontainers.models.DaprResiliencyRetryPolicy]
        :keyword timeouts: Timeout Policy.
        :paramtype timeouts: ~azure.mgmt.appcontainers.models.DaprResiliencyTimeoutPolicy
        :keyword circuit_breakers: Circuit Breaker Policy.
        :paramtype circuit_breakers:
         list[~azure.mgmt.appcontainers.models.DaprResiliencyCircuitBreakerPolicy]
        """
        super().__init__(**kwargs)
...
class DaprResiliencyRetryPoliciesCollection(_serialization.Model):
    ...
    :ivar value: Collection of resources. Required.
    :vartype value: list[~azure.mgmt.appcontainers.models.DaprResiliencyRetryPolicy]
    :ivar next_link: Link to next page of resources.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[DaprResiliencyRetryPolicy]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(self, *, value: List["_models.DaprResiliencyRetryPolicy"], **kwargs: Any) -> None:
        """
        :keyword value: Collection of resources. Required.
        :paramtype value: list[~azure.mgmt.appcontainers.models.DaprResiliencyRetryPolicy]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class DaprResiliencyRetryPolicy(ProxyResource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.appcontainers.models.SystemData
    :ivar policy: Back-off and retry interval strategy.
    :vartype policy: str
    :ivar duration: Time interval between retries. Valid values are of the form 200ms, 15s, 2m,
     1h30m, etc.
    :vartype duration: str
    :ivar max_retries: The maximum number of retries to attempt. -1 denotes an indefinite number of
     retries.
    :vartype max_retries: int
    :ivar max_interval: Determines the maximum interval between retries. Valid values are of the
     form 200ms, 15s, 2m, 1h30m, etc.
    :vartype max_interval: str
    """
    ...
    _attribute_map = {
        ...
        "max_retries": {"key": "properties.maxRetries", "type": "int"},
        "max_interval": {"key": "properties.maxInterval", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword policy: Back-off and retry interval strategy.
        :paramtype policy: str
        :keyword duration: Time interval between retries. Valid values are of the form 200ms, 15s, 2m,
         1h30m, etc.
        :paramtype duration: str
        :keyword max_retries: The maximum number of retries to attempt. -1 denotes an indefinite number
         of retries.
        :paramtype max_retries: int
        :keyword max_interval: Determines the maximum interval between retries. Valid values are of the
         form 200ms, 15s, 2m, 1h30m, etc.
        :paramtype max_interval: str
        """
        super().__init__(**kwargs)
        self.policy = policy
...
class DaprResiliencyTargets(_serialization.Model):
    """Dapr targets for for applied resiliency policies.

    :ivar apps: List of application targets their applied policies.
    :vartype apps: list[~azure.mgmt.appcontainers.models.DaprAppResiliencyTarget]
    :ivar components: List of component targets their applied policies.
    :vartype components: list[~azure.mgmt.appcontainers.models.DaprComponentResiliencyTarget]
    :ivar actors: List of actor targets their applied policies.
    :vartype actors: list[~azure.mgmt.appcontainers.models.DaprActorResiliencyTarget]
    """

    _attribute_map = {
        "apps": {"key": "apps", "type": "[DaprAppResiliencyTarget]"},
        "components": {"key": "components", "type": "[DaprComponentResiliencyTarget]"},
        "actors": {"key": "actors", "type": "[DaprActorResiliencyTarget]"},
    }

    def __init__(
        self,
        *,
        apps: Optional[List["_models.DaprAppResiliencyTarget"]] = None,
        components: Optional[List["_models.DaprComponentResiliencyTarget"]] = None,
        actors: Optional[List["_models.DaprActorResiliencyTarget"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword apps: List of application targets their applied policies.
        :paramtype apps: list[~azure.mgmt.appcontainers.models.DaprAppResiliencyTarget]
        :keyword components: List of component targets their applied policies.
        :paramtype components: list[~azure.mgmt.appcontainers.models.DaprComponentResiliencyTarget]
        :keyword actors: List of actor targets their applied policies.
        :paramtype actors: list[~azure.mgmt.appcontainers.models.DaprActorResiliencyTarget]
        """
        super().__init__(**kwargs)
        self.apps = apps
...
class DaprResiliencyTimeoutPoliciesCollection(_serialization.Model):
    ...
    :ivar value: Collection of resources. Required.
    :vartype value: list[~azure.mgmt.appcontainers.models.DaprResiliencyTimeoutPolicy]
    :ivar next_link: Link to next page of resources.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[DaprResiliencyTimeoutPolicy]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(self, *, value: List["_models.DaprResiliencyTimeoutPolicy"], **kwargs: Any) -> None:
        """
        :keyword value: Collection of resources. Required.
        :paramtype value: list[~azure.mgmt.appcontainers.models.DaprResiliencyTimeoutPolicy]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class DaprResiliencyTimeoutPolicy(ProxyResource):
    """Resiliency Policy Retries.
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.appcontainers.models.SystemData
    :ivar timeout: Timeout duration for the operation. Valid values are of the form 200ms, 15s, 2m,
     1h30m, etc.
    :vartype timeout: str
    """
    ...
    def __init__(self, *, timeout: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword timeout: Timeout duration for the operation. Valid values are of the form 200ms, 15s,
         2m, 1h30m, etc.
        :paramtype timeout: str
        """
        super().__init__(**kwargs)
