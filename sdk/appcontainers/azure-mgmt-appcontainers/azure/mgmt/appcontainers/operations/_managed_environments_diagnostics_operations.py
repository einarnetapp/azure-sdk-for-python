...
def build_get_dapr_components_request(
    ...
    path_format_arguments = {
        ...
        "environmentName": _SERIALIZER.url("environment_name", environment_name, "str", pattern=r"^[^*#&+:<>?]+$"),
        "componentName": _SERIALIZER.url("component_name", component_name, "str", pattern=r"^[^*#&+:<>?]+$"),
    }
...
def build_get_certificates_request(
    ...
    path_format_arguments = {
        ...
        "environmentName": _SERIALIZER.url("environment_name", environment_name, "str", pattern=r"^[^*#&+:<>?]+$"),
        "certificateName": _SERIALIZER.url("certificate_name", certificate_name, "str", pattern=r"^[^*#&+:<>?]+$"),
    }
