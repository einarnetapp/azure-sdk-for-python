...
def build_get_auth_configs_request(
    resource_group_name: str, container_app_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "containerAppName": _SERIALIZER.url("container_app_name", container_app_name, "str", pattern=r"^[^*#&+:<>?]+$"),
    }
...
class ContainerAppsDiagnosticsOperations:
    ...
    @distributed_trace
    def get_auth_configs(self, resource_group_name: str, container_app_name: str, **kwargs: Any) -> _models.AuthConfig:
        ...
        request = build_get_auth_configs_request(
            resource_group_name=resource_group_name,
            container_app_name=container_app_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.get_auth_configs.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    get_auth_configs.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/containerApps/{containerAppName}/detectorProperties/authConfigsApi/"}  # type: ignore
