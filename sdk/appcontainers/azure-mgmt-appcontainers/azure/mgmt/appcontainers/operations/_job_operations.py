...
class JobOperations:
    ...
    def begin_create_or_update(
        ...
        :param job_name: Name of the Container Apps Job. Required.
        :type job_name: str
        :param job_envelope: Properties used to create a container apps job. Is either a model type or
         a IO type. Required.
    ...
    @distributed_trace
    def begin_run(self, resource_group_name: str, job_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    def _terminate_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, job_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_terminate_request(
            ...
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self._terminate_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _terminate_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/jobs/{jobName}/stop"
    }

    @distributed_trace
    def begin_terminate(self, resource_group_name: str, job_name: str, **kwargs: Any) -> LROPoller[None]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._terminate_initial(  # type: ignore
                resource_group_name=resource_group_name,
                job_name=job_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
