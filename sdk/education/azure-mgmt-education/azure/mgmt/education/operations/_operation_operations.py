...
def build_status_request(operation_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Education/operationStatus/{operationId}")
...
class OperationOperations:
    ...
    @distributed_trace
    def status(self, operation_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
    ...
    status.metadata = {"url": "/providers/Microsoft.Education/operationStatus/{operationId}"}  # type: ignore
