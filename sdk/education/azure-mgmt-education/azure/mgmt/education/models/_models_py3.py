...
class GrantDetailsV2(Resource):  # pylint: disable=too-many-instance-attributes
    """Grant details.
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.education.models.SystemData
    :ivar display_name: Grant display name.
...
class GrantListResponseV2(_serialization.Model):
    """List of Grants info.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar value: The list of labs.
    :vartype value: list[~azure.mgmt.education.models.GrantDetailsV2]
    :ivar next_link: The link (url) to the next page of results.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[GrantDetailsV2]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }
