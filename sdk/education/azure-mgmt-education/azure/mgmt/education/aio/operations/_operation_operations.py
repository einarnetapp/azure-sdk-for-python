...
from ...operations._operation_operations import build_status_request
...
class OperationOperations:
    ...
    async def status(self, operation_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
