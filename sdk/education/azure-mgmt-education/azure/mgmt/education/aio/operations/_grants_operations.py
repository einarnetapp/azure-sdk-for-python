...
from ...operations._grants_operations import (
    build_get_request,
    build_get_v2_request,
    build_list_all_request,
    build_list_all_v2_request,
    build_list_request,
    build_list_v2_request,
)
...
class GrantsOperations:
    ...
    def list_all_v2(
        self, include_allocated_budget: Optional[bool] = None, **kwargs: Any
    ) -> AsyncIterable["_models.GrantDetailsV2"]:
        """Get a list of grants that Microsoft has provided.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.education.models.GrantDetailsV2]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
