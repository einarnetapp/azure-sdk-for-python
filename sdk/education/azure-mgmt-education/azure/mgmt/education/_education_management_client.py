...
class EducationManagementClient(
    ...
    :vartype operation: azure.mgmt.education.operations.OperationOperations
    :ivar grant: GrantOperations operations
    :vartype grant: azure.mgmt.education.operations.GrantOperations
    ...
    def __enter__(self):
        # type: () -> EducationManagementClient
