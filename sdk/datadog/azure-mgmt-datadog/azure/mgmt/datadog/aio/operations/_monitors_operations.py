    ...
    def list_api_keys(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DatadogApiKeyListResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datadog.models.DatadogApiKeyListResponse]
    ...
    def list_hosts(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DatadogHostListResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datadog.models.DatadogHostListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_linked_resources(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either LinkedResourceListResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datadog.models.LinkedResourceListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_monitored_resources(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either MonitoredResourceListResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datadog.models.MonitoredResourceListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DatadogMonitorResourceListResponse or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datadog.models.DatadogMonitorResourceListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
