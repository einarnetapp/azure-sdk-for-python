...
def build_create_or_update_request(
    subscription_id: str,
    *,
    json: Optional[_models.DatadogAgreementResource] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class MarketplaceAgreementsOperations:
    ...
    def list(
        self,
        **kwargs: Any
    ) -> Iterable[_models.DatadogAgreementResourceListResponse]:
        ...
        :return: An iterator like instance of either DatadogAgreementResourceListResponse or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.datadog.models.DatadogAgreementResourceListResponse]
