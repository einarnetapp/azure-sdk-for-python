...
class DedicatedHsmListResult(_serialization.Model):
    ...
    def __init__(
        self, *, value: Optional[List["_models.DedicatedHsm"]] = None, next_link: Optional[str] = None, **kwargs
    ):
        """
...
class DedicatedHsmOperation(_serialization.Model):
    ...
    def __init__(
        self, *, name: Optional[str] = None, display: Optional["_models.DedicatedHsmOperationDisplay"] = None, **kwargs
    ):
        """
...
class DedicatedHsmOperationListResult(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.DedicatedHsmOperation"]] = None, **kwargs):
        """
...
class NetworkInterface(_serialization.Model):
    ...
    def __init__(self, *, private_ip_address: Optional[str] = None, **kwargs):
        """
