...
class DedicatedHsm(Resource):
    ...
    :ivar provisioning_state: Provisioning state. Known values are: "Succeeded", "Provisioning",
     "Allocating", "Connecting", "Failed", "CheckingQuota", "Deleting".
...
class DedicatedHsmListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.DedicatedHsm"]] = None,
...
class DedicatedHsmOperationListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.DedicatedHsmOperation"]] = None,
        **kwargs
    ):
        """
