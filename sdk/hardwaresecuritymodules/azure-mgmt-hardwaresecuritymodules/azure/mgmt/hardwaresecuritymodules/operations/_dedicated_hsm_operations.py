...
def build_create_or_update_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.DedicatedHsm] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    ...
    api_version = kwargs.pop('api_version', _params.pop('api-version', "2021-11-30"))  # type: str
...
def build_update_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.DedicatedHsmPatchParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
