...
class ScheduledQueryRulesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~$(python-base-namespace).v2022_06_15.aio.MonitorManagementClient`'s
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.ScheduledQueryRuleResource"]:
        ...
        :return: An iterator like instance of either ScheduledQueryRuleResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2022_06_15.models.ScheduledQueryRuleResource]
    ...
    async def get(self, resource_group_name: str, rule_name: str, **kwargs: Any) -> _models.ScheduledQueryRuleResource:
        ...
        :rtype: ~$(python-base-namespace).v2022_06_15.models.ScheduledQueryRuleResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~$(python-base-namespace).v2022_06_15.models.ScheduledQueryRuleResource
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~$(python-base-namespace).v2022_06_15.models.ScheduledQueryRuleResource or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~$(python-base-namespace).v2022_06_15.models.ScheduledQueryRuleResourcePatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
