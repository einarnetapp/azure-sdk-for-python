...
class ScheduledQueryRulesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~$(python-base-namespace).v2022_06_15.MonitorManagementClient`'s
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ScheduledQueryRuleResource"]:
        ...
        :return: An iterator like instance of either ScheduledQueryRuleResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2022_06_15.models.ScheduledQueryRuleResource]
