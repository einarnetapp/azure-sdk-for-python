...
class Condition(_serialization.Model):
    ...
    :vartype time_aggregation: str or ~$(python-base-namespace).v2022_06_15.models.TimeAggregation
    ...
    :vartype dimensions: list[~$(python-base-namespace).v2022_06_15.models.Dimension]
    :ivar operator: The criteria operator. Relevant and required only for rules of the kind
     ...
     "LessThanOrEqual".
    :vartype operator: str or ~$(python-base-namespace).v2022_06_15.models.ConditionOperator
    ...
    :vartype failing_periods: ~$(python-base-namespace).v2022_06_15.models.ConditionFailingPeriods
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype time_aggregation: str or
         ~$(python-base-namespace).v2022_06_15.models.TimeAggregation
        ...
        :paramtype dimensions: list[~$(python-base-namespace).v2022_06_15.models.Dimension]
        :keyword operator: The criteria operator. Relevant and required only for rules of the kind
         LogAlert. Known values are: "Equals", "GreaterThan", "GreaterThanOrEqual", "LessThan", and
         "LessThanOrEqual".
        :paramtype operator: str or ~$(python-base-namespace).v2022_06_15.models.ConditionOperator
        ...
        :paramtype failing_periods:
         ~$(python-base-namespace).v2022_06_15.models.ConditionFailingPeriods
...
class Dimension(_serialization.Model):
    ...
    :ivar operator: Operator for dimension values. Required. Known values are: "Include" and
     "Exclude".
    :vartype operator: str or ~$(python-base-namespace).v2022_06_15.models.DimensionOperator
    ...
    def __init__(
        ...
        :keyword operator: Operator for dimension values. Required. Known values are: "Include" and
         "Exclude".
        :paramtype operator: str or ~$(python-base-namespace).v2022_06_15.models.DimensionOperator
...
class ErrorContract(_serialization.Model):
    ...
    :vartype error: ~$(python-base-namespace).v2022_06_15.models.ErrorResponseDetails
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorResponseDetails"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~$(python-base-namespace).v2022_06_15.models.ErrorResponseDetails
        """
        super().__init__(**kwargs)
        self.error = error
...
class ErrorResponseDetails(_serialization.Model):
    ...
    :vartype details: list[~$(python-base-namespace).v2022_06_15.models.ErrorResponseDetails]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~$(python-base-namespace).v2022_06_15.models.ErrorResponseAdditionalInfo]
    """
...
class ScheduledQueryRuleCriteria(_serialization.Model):
    ...
    :vartype all_of: list[~$(python-base-namespace).v2022_06_15.models.Condition]
    """
    ...
    def __init__(self, *, all_of: Optional[List["_models.Condition"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype all_of: list[~$(python-base-namespace).v2022_06_15.models.Condition]
        """
        super().__init__(**kwargs)
        self.all_of = all_of
...
class ScheduledQueryRuleResource(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype kind: str or ~$(python-base-namespace).v2022_06_15.models.Kind
    ...
    :vartype system_data: ~$(python-base-namespace).v2022_06_15.models.SystemData
    ...
    :ivar severity: Severity of the alert. Should be an integer between [0-4]. Value of 0 is
     ...
     3, and 4.
    :vartype severity: int or ~$(python-base-namespace).v2022_06_15.models.AlertSeverity
    ...
    :vartype criteria: ~$(python-base-namespace).v2022_06_15.models.ScheduledQueryRuleCriteria
    ...
    :vartype actions: ~$(python-base-namespace).v2022_06_15.models.Actions
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :paramtype kind: str or ~$(python-base-namespace).v2022_06_15.models.Kind
        ...
        :keyword severity: Severity of the alert. Should be an integer between [0-4]. Value of 0 is
         severest. Relevant and required only for rules of the kind LogAlert. Known values are: 0, 1, 2,
         3, and 4.
        :paramtype severity: int or ~$(python-base-namespace).v2022_06_15.models.AlertSeverity
        ...
        :paramtype criteria: ~$(python-base-namespace).v2022_06_15.models.ScheduledQueryRuleCriteria
        ...
        :paramtype actions: ~$(python-base-namespace).v2022_06_15.models.Actions
...
class ScheduledQueryRuleResourceCollection(_serialization.Model):
    ...
    :vartype value: list[~$(python-base-namespace).v2022_06_15.models.ScheduledQueryRuleResource]
    ...
    def __init__(self, *, value: Optional[List["_models.ScheduledQueryRuleResource"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~$(python-base-namespace).v2022_06_15.models.ScheduledQueryRuleResource]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or ~$(python-base-namespace).v2022_06_15.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or
     ~$(python-base-namespace).v2022_06_15.models.CreatedByType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~$(python-base-namespace).v2022_06_15.models.CreatedByType
