...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    )  # type: Literal["2020-05-01-preview"]
...
class ScheduledQueryRulesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~$(python-base-namespace).v2020_05_01_preview.MonitorManagementClient`'s
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ScheduledQueryRuleResource"]:
        ...
        :return: An iterator like instance of either ScheduledQueryRuleResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2020_05_01_preview.models.ScheduledQueryRuleResource]
