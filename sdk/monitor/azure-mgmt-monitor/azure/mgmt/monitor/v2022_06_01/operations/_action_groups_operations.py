...
class ActionGroupsOperations:
    ...
    def begin_post_test_notifications(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~$(python-base-namespace).v2022_06_01.models.TestNotificationDetailsResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_subscription_id(self, **kwargs: Any) -> Iterable["_models.ActionGroupResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2022_06_01.models.ActionGroupResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
