...
def build_list_request(resource_uri: str, *, start_time: Optional[str] = None, **kwargs: Any) -> HttpRequest:
    ...
    )  # type: Literal["2017-12-01-preview"]
...
class MetricNamespacesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~$(python-base-namespace).v2017_12_01_preview.MonitorManagementClient`'s
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2017_12_01_preview.models.MetricNamespace]
