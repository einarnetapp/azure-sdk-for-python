...
class MonitorManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def scheduled_query_rules(self):
        """Instance depends on the API version:
           ...
           * 2022-06-15: :class:`ScheduledQueryRulesOperations<azure.mgmt.monitor.v2022_06_15.aio.operations.ScheduledQueryRulesOperations>`
        ...
        if api_version == '2018-04-16':
            ...
            from ..v2022_06_15.aio.operations import ScheduledQueryRulesOperations as OperationClass
        elif api_version == '2022-08-01-preview':
