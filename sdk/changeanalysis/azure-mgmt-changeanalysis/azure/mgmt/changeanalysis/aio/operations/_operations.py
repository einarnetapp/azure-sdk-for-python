...
class Operations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.ResourceProviderOperationDefinition"]:
        ...
        :return: An iterator like instance of either ResourceProviderOperationDefinition or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.changeanalysis.models.ResourceProviderOperationDefinition]
