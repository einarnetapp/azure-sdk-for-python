...
def build_list_request(*, skip_token: Optional[str] = None, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.ChangeAnalysis/operations")
...
class Operations:
    ...
    def list(
    ...
    ) -> Iterable["_models.ResourceProviderOperationDefinition"]:
        ...
        :return: An iterator like instance of either ResourceProviderOperationDefinition or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.changeanalysis.models.ResourceProviderOperationDefinition]
    ...
    list.metadata = {"url": "/providers/Microsoft.ChangeAnalysis/operations"}
