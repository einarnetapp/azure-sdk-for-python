...
class Alert(ProxyResource):
    ...
    :ivar source: Source of alert. Known values are: "Preset", "User".
    ...
    :ivar status: alert status. Known values are: "None", "Active", "Overridden", "Resolved",
     "Dismissed".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword source: Source of alert. Known values are: "Preset", "User".
...
class AlertPropertiesDefinition(msrest.serialization.Model):
    ...
    :ivar category: Alert category. Known values are: "Cost", "Usage", "Billing", "System".
    ...
    :ivar criteria: Criteria that triggered alert. Known values are: "CostThresholdExceeded",
     ...
     "InvoiceDueDateReached", "CrossCloudNewDataAvailable", "CrossCloudCollectionError",
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword category: Alert category. Known values are: "Cost", "Usage", "Billing", "System".
...
class BlobInfo(msrest.serialization.Model):
    ...
    :vartype byte_count: long
    """

    _attribute_map = {
        'blob_link': {'key': 'blobLink', 'type': 'str'},
        'byte_count': {'key': 'byteCount', 'type': 'long'},
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype byte_count: long
        """
        super(BlobInfo, self).__init__(**kwargs)
...
class CostDetailsOperationResults(msrest.serialization.Model):
    ...
    :ivar data_format: The data format of the report. Known values are: "Csv".
    ...
    _attribute_map = {
        ...
        'byte_count': {'key': 'manifest.byteCount', 'type': 'long'},
        ...
        'request_body': {'key': 'manifest.requestContext.requestBody', 'type': 'GenerateCostDetailsReportRequestDefinition'},
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword data_format: The data format of the report. Known values are: "Csv".
        ...
        :paramtype request_body:
         ~azure.mgmt.costmanagement.models.GenerateCostDetailsReportRequestDefinition
        """
        super(CostDetailsOperationResults, self).__init__(**kwargs)
        self.id = id
        self.name = name
        self.type = type
        self.status = status
...
class CostDetailsTimePeriod(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype end: str
        """
        super(CostDetailsTimePeriod, self).__init__(**kwargs)
        self.start = start
        self.end = end
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword granularity: The granularity of rows in the export. Currently only 'Daily' is
         supported. Known values are: "Daily".
...
class ExportDefinition(msrest.serialization.Model):
    ...
    :ivar type: Required. The type of the export. Note that 'Usage' is equivalent to 'ActualCost'
     ...
     service reservations. Known values are: "Usage", "ActualCost", "AmortizedCost".
    ...
    :ivar timeframe: Required. The time frame for pulling data for the export. If custom, then a
     specific time period must be provided. Known values are: "MonthToDate", "BillingMonthToDate",
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword type: Required. The type of the export. Note that 'Usage' is equivalent to
         ...
         amortization for service reservations. Known values are: "Usage", "ActualCost",
         "AmortizedCost".
...
class ExportExecution(ProxyResource):
    ...
    :ivar e_tag: eTag of the resource. To handle concurrent update scenario, this field will be
     used to determine whether the user is updating the latest version or not.
    :vartype e_tag: str
    :ivar execution_type: The type of the export execution. Known values are: "OnDemand",
     "Scheduled".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword e_tag: eTag of the resource. To handle concurrent update scenario, this field will be
         used to determine whether the user is updating the latest version or not.
        :paramtype e_tag: str
        :keyword execution_type: The type of the export execution. Known values are: "OnDemand",
         "Scheduled".
...
class ExportSchedule(msrest.serialization.Model):
    ...
    :ivar status: The status of the export's schedule. If 'Inactive', the export's schedule is
     paused. Known values are: "Active", "Inactive".
    :vartype status: str or ~azure.mgmt.costmanagement.models.StatusType
    :ivar recurrence: The schedule recurrence. Known values are: "Daily", "Weekly", "Monthly",
     "Annually".
...
class ForecastDataset(msrest.serialization.Model):
    ...
    :ivar granularity: The granularity of rows in the forecast. Known values are: "Daily".
    :vartype granularity: str or ~azure.mgmt.costmanagement.models.GranularityType
    ...
    def __init__(
        ...
        *,
        ...
        filter: Optional["_models.QueryFilter"] = None,
        **kwargs
    ):
        """
        :keyword granularity: The granularity of rows in the forecast. Known values are: "Daily".
        :paramtype granularity: str or ~azure.mgmt.costmanagement.models.GranularityType
...
class ForecastDefinition(msrest.serialization.Model):
    ...
    :ivar type: Required. The type of the forecast. Known values are: "Usage", "ActualCost",
     "AmortizedCost".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword type: Required. The type of the forecast. Known values are: "Usage", "ActualCost",
         "AmortizedCost".
        ...
        :keyword timeframe: Required. The time frame for pulling data for the forecast. If custom, then
         a specific time period must be provided. Known values are: "MonthToDate", "BillingMonthToDate",
         "TheLastMonth", "TheLastBillingMonth", "WeekToDate", "Custom".
...
class GenerateCostDetailsReportErrorResponse(msrest.serialization.Model):
    """Error response indicates that the service is not able to process the incoming request. The reason is provided in the error message. 
  ...
  503 ServiceUnavailable - Service is temporarily unavailable. Retry after waiting for the time specified in the "Retry-After" header.
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype error: ~azure.mgmt.costmanagement.models.ErrorDetails
        """
        super(GenerateCostDetailsReportErrorResponse, self).__init__(**kwargs)
        self.error = error


class GenerateCostDetailsReportRequestDefinition(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword metric: The type of the detailed report. By default ActualCost is provided. Known
         values are: "ActualCost", "AmortizedCost".
        ...
        """
        super(GenerateCostDetailsReportRequestDefinition, self).__init__(**kwargs)
        self.metric = metric
        self.time_period = time_period
...
class KpiProperties(msrest.serialization.Model):
    ...
    :ivar type: KPI type (Forecast, Budget). Known values are: "Forecast", "Budget".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword type: KPI type (Forecast, Budget). Known values are: "Forecast", "Budget".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword report_url: The CSV file from the reportUrl blob link consists of reservation usage
         ...
         "ReservationOrderId", "ReservedHours", "SkuName", "TotalReservedQuantity", "UsageDate",
         "UsedHours".
...
class PivotProperties(msrest.serialization.Model):
    ...
    :ivar type: Data type to show in view. Known values are: "Dimension", "TagKey".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword type: Data type to show in view. Known values are: "Dimension", "TagKey".
...
class QueryAggregation(msrest.serialization.Model):
    ...
    :vartype name: str
    :ivar function: Required. The name of the aggregation function to use. Known values are: "Sum".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype name: str
        :keyword function: Required. The name of the aggregation function to use. Known values are:
         "Sum".
...
class QueryDataset(msrest.serialization.Model):
    ...
    :ivar granularity: The granularity of rows in the query. Known values are: "Daily".
    :vartype granularity: str or ~azure.mgmt.costmanagement.models.GranularityType
    :ivar configuration: Has configuration information for the data in the export. The
     configuration will be ignored if aggregation and grouping are provided.
    :vartype configuration: ~azure.mgmt.costmanagement.models.QueryDatasetConfiguration
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword granularity: The granularity of rows in the query. Known values are: "Daily".
        :paramtype granularity: str or ~azure.mgmt.costmanagement.models.GranularityType
        :keyword configuration: Has configuration information for the data in the export. The
         configuration will be ignored if aggregation and grouping are provided.
        :paramtype configuration: ~azure.mgmt.costmanagement.models.QueryDatasetConfiguration
...
class QueryDefinition(msrest.serialization.Model):
    ...
    :ivar type: Required. The type of the query. Known values are: "Usage", "ActualCost",
     "AmortizedCost".
    :vartype type: str or ~azure.mgmt.costmanagement.models.ExportType
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword type: Required. The type of the query. Known values are: "Usage", "ActualCost",
         "AmortizedCost".
        :paramtype type: str or ~azure.mgmt.costmanagement.models.ExportType
...
class QueryGrouping(msrest.serialization.Model):
    ...
    :ivar type: Required. Has type of the column to group. Known values are: "Tag", "Dimension".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword type: Required. Has type of the column to group. Known values are: "Tag", "Dimension".
...
class ReportConfigDataset(msrest.serialization.Model):
    ...
    :ivar granularity: The granularity of rows in the report. Known values are: "Daily", "Monthly".
    ...
    def __init__(
        ...
        *,
        ...
        filter: Optional["_models.ReportConfigFilter"] = None,
        **kwargs
    ):
        """
        :keyword granularity: The granularity of rows in the report. Known values are: "Daily",
         "Monthly".
...
class ReportConfigGrouping(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        type: Union[str, "_models.ReportConfigColumnType"],
        name: str,
        **kwargs
    ):
        """
...
class ReportConfigSorting(msrest.serialization.Model):
    ...
    :ivar direction: Direction of sort. Known values are: "Ascending", "Descending".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword direction: Direction of sort. Known values are: "Ascending", "Descending".
...
class View(ProxyResource):
    ...
    :ivar accumulated: Show costs accumulated over time. Known values are: "true", "false".
    ...
    :ivar type_properties_query_type: The type of the report. Usage represents actual usage,
     ...
     data. Actual usage and forecasted data can be differentiated based on dates. Known values are:
     "Usage".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword accumulated: Show costs accumulated over time. Known values are: "true", "false".
