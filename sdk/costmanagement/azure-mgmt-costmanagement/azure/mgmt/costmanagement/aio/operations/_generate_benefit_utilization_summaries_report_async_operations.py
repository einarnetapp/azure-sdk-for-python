...
from ...operations._generate_benefit_utilization_summaries_report_async_operations import (
    build_billing_account_scope_request,
    build_billing_profile_scope_request,
    build_reservation_order_scope_request,
    build_reservation_scope_request,
    build_savings_plan_order_scope_request,
    build_savings_plan_scope_request,
)
...
class GenerateBenefitUtilizationSummariesReportAsyncOperations:
    ...
    async def _billing_account_scope_initial(  # pylint: disable=inconsistent-return-statements
        self,
    ...
    async def begin_billing_account_scope(
        self,
        billing_account_id: str,
        benefit_kind: str,
        grain: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._billing_account_scope_initial(  # type: ignore
                billing_account_id=billing_account_id,
                benefit_kind=benefit_kind,
                grain=grain,
                filter=filter,
    ...
    async def _billing_profile_scope_initial(  # pylint: disable=inconsistent-return-statements
        self,
        billing_account_id: str,
    ...
    @distributed_trace_async
    async def begin_billing_profile_scope(
        self,
        billing_account_id: str,
        billing_profile_id: str,
        benefit_kind: str,
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._billing_profile_scope_initial(  # type: ignore
                billing_account_id=billing_account_id,
                billing_profile_id=billing_profile_id,
                benefit_kind=benefit_kind,
                grain=grain,
    ...
    async def _reservation_order_scope_initial(  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace_async
    async def begin_reservation_order_scope(
        self, reservation_order_id: str, grain: Optional[str] = None, filter: Optional[str] = None, **kwargs: Any
    ) -> AsyncLROPoller[None]:
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._reservation_order_scope_initial(  # type: ignore
                reservation_order_id=reservation_order_id,
                grain=grain,
                filter=filter,
                api_version=api_version,
    ...
    async def _reservation_scope_initial(  # pylint: disable=inconsistent-return-statements
        self,
    ...
    @distributed_trace_async
    async def begin_reservation_scope(
        self,
        reservation_order_id: str,
        reservation_id: str,
        grain: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._reservation_scope_initial(  # type: ignore
                reservation_order_id=reservation_order_id,
                reservation_id=reservation_id,
                grain=grain,
                filter=filter,
    ...
    async def _savings_plan_order_scope_initial(  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace_async
    async def begin_savings_plan_order_scope(
        self, savings_plan_order_id: str, grain: Optional[str] = None, filter: Optional[str] = None, **kwargs: Any
    ) -> AsyncLROPoller[None]:
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._savings_plan_order_scope_initial(  # type: ignore
                savings_plan_order_id=savings_plan_order_id,
                grain=grain,
                filter=filter,
                api_version=api_version,
    ...
    async def _savings_plan_scope_initial(  # pylint: disable=inconsistent-return-statements
        self,
    ...
    @distributed_trace_async
    async def begin_savings_plan_scope(
        self,
        savings_plan_order_id: str,
        savings_plan_id: str,
        grain: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._savings_plan_scope_initial(  # type: ignore
                savings_plan_order_id=savings_plan_order_id,
                savings_plan_id=savings_plan_id,
                grain=grain,
                filter=filter,
