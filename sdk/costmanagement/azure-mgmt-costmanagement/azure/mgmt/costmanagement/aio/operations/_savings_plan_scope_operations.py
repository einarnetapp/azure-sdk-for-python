...
from ...operations._savings_plan_scope_operations import (
    build_generate_benefit_utilization_summaries_report_async_request,
)
...
class SavingsPlanScopeOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`savings_plan_scope` attribute.
    """
    ...
    async def _generate_benefit_utilization_summaries_report_async_initial(
        self,
        ...
        **kwargs: Any
        ...
        request = build_generate_benefit_utilization_summaries_report_async_request(
            ...
            json=_json,
            content=_content,
            template_url=self._generate_benefit_utilization_summaries_report_async_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
    ...
    _generate_benefit_utilization_summaries_report_async_initial.metadata = {
    ...
    @overload
    async def begin_generate_benefit_utilization_summaries_report_async(
        self,
        savings_plan_order_id: str,
        savings_plan_id: str,
    ...
    async def begin_generate_benefit_utilization_summaries_report_async(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._generate_benefit_utilization_summaries_report_async_initial(
                savings_plan_order_id=savings_plan_order_id,
                savings_plan_id=savings_plan_id,
    ...
    begin_generate_benefit_utilization_summaries_report_async.metadata = {
        "url": "/providers/Microsoft.BillingBenefits/savingsPlanOrders/{savingsPlanOrderId}/savingsPlans/{savingsPlanId}/providers/Microsoft.CostManagement/generateBenefitUtilizationSummariesReport"
    }
