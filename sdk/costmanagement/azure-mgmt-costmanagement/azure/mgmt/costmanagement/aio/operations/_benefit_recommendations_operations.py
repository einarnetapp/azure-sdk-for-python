...
class BenefitRecommendationsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        """List of recommendations for purchasing benefit (reservation or savings plan).
        ...
        :param filter: Can be used to filter benefitRecommendations by: properties/scope with allowed
         ...
         properties/term with allowed values ['P1Y', 'P3Y'] and default value 'P3Y'; kind with default
         value 'SavingsPlan'; properties/armSkuName with allowed values ['Compute', 'SQL'] - if
         mentioned kind SavingsPlan is applied implicitly; properties/subscriptionId;
         properties/resourceGroup. Default value is None.
        :type filter: str
        :param orderby: May be used to order the recommendations by: properties/armSkuName. This
         implicitly filters the results by the corresponding benefit type. Default value is None.
        :type orderby: str
