...
class ScheduledActionsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable[_models.ScheduledActionListResult]:
        ...
        :return: An iterator like instance of either ScheduledActionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.costmanagement.models.ScheduledActionListResult]
    ...
    @distributed_trace_async
    async def execute_by_scope(  # pylint: disable=inconsistent-return-statements
        self,
        scope: str,
        name: str,
        **kwargs: Any
