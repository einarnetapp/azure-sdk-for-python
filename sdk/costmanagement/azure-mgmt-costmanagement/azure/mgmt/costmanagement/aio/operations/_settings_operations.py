...
class SettingsOperations:
    ...
    async def list(self, scope: str, **kwargs: Any) -> _models.SettingsListResult:
        ...
        :param scope: The scope associated with setting. This includes 'subscriptions/{subscriptionId}'
         for subscription scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}' for
    ...
    list.metadata = {"url": "/{scope}/providers/Microsoft.CostManagement/settings"}  # type: ignore
    ...
    async def create_or_update_by_scope(
        ...
        :param type: Setting type. "taginheritance" Required.
        :type type: str or ~azure.mgmt.costmanagement.models.SettingType
        :param setting: Setting to be created or updated. Is either a model type or a IO type.
         Required.
    ...
    create_or_update_by_scope.metadata = {"url": "/{scope}/providers/Microsoft.CostManagement/settings/{type}"}  # type: ignore
    ...
    get_by_scope.metadata = {"url": "/{scope}/providers/Microsoft.CostManagement/settings/{type}"}  # type: ignore
    ...
    delete_by_scope.metadata = {"url": "/{scope}/providers/Microsoft.CostManagement/settings/{type}"}  # type: ignore
