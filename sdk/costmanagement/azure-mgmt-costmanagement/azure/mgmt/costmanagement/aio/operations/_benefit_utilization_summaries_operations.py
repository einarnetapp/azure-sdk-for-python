...
class BenefitUtilizationSummariesOperations:
    ...
    def list_by_billing_account_id(
        ...
        **kwargs: Any
        ...
        """Lists benefit utilization summaries for the provided billingAccount. This API provides benefit
        utilization summaries only for enrollment accounts.

        :param billing_account_id: Billing account ID. Required.
        :type billing_account_id: str
        :param grain_parameter: Daily or monthly grain. Known values are: "Hourly", "Daily", and
         "Monthly". Default value is None.
        :type grain_parameter: str or ~azure.mgmt.costmanagement.models.GrainParameter
        :param filter: Supports filtering by properties/benefitType, properties/benefitId,
         properties/benefitOrderId and properties/usageDate. properties/benefitType is defaulted to
         savingsPlan. Default value is None.
        :type filter: str
