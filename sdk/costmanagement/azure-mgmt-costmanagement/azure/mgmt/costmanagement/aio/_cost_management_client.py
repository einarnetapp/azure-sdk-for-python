...
from .operations import (
    BenefitRecommendationOperations,
...
class CostManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :ivar benefit_recommendation: BenefitRecommendationOperations operations
    :vartype benefit_recommendation:
     azure.mgmt.costmanagement.aio.operations.BenefitRecommendationOperations
    ...
    def __init__(
        ...
        self.benefit_recommendation = BenefitRecommendationOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
