...
def build_usage_request(
    scope: str,
    *,
    json: Optional[_models.ForecastDefinition] = None,
    content: Any = None,
...
def build_external_cloud_provider_usage_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.CostManagement/{externalCloudProviderType}/{externalCloudProviderId}/forecast")  # pylint: disable=line-too-long
    path_format_arguments = {
