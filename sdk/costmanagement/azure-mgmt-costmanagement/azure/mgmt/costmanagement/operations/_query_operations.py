...
def build_usage_request(scope: str, *, skiptoken: Optional[str] = None, **kwargs: Any) -> HttpRequest:
...
class QueryOperations:
    ...
    @distributed_trace
    def usage(
        self, scope: str, parameters: Union[_models.QueryDefinition, IO], skiptoken: Optional[str] = None, **kwargs: Any
    ) -> Optional[_models.QueryResult]:
        """Query the usage data for scope defined.
