...
def build_usage_request(
    scope: str,
    *,
    json: Optional[_models.QueryDefinition] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_usage_by_external_cloud_provider_type_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.CostManagement/{externalCloudProviderType}/{externalCloudProviderId}/query")  # pylint: disable=line-too-long
    path_format_arguments = {
