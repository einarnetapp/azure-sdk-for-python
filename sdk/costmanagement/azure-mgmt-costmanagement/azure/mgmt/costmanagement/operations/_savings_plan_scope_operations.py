...
def build_generate_benefit_utilization_summaries_report_async_request(
...
class SavingsPlanScopeOperations:
    ...
    def _generate_benefit_utilization_summaries_report_async_initial(
        self,
    ...
    @overload
    def begin_generate_benefit_utilization_summaries_report_async(
        self,
        savings_plan_order_id: str,
        savings_plan_id: str,
    ...
    def begin_generate_benefit_utilization_summaries_report_async(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._generate_benefit_utilization_summaries_report_async_initial(
                savings_plan_order_id=savings_plan_order_id,
                savings_plan_id=savings_plan_id,
