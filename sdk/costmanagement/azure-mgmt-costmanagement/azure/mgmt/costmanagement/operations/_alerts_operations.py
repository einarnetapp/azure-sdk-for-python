...
def build_dismiss_request(
    ...
    alert_id: str,
    *,
    json: Optional[_models.DismissAlertPayload] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_list_external_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.CostManagement/{externalCloudProviderType}/{externalCloudProviderId}/alerts")  # pylint: disable=line-too-long
    path_format_arguments = {
