...
def build_create_or_update_request(
    name: str,
    *,
    json: Optional[_models.ScheduledAction] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_execute_by_scope_request(
    scope: str,
    name: str,
    **kwargs: Any
) -> HttpRequest:
...
def build_check_name_availability_by_scope_request(
    scope: str,
    *,
    json: Optional[_models.CheckNameAvailabilityRequest] = None,
    content: Any = None,
...
class ScheduledActionsOperations:
    ...
    def list(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable[_models.ScheduledActionListResult]:
        ...
        :return: An iterator like instance of either ScheduledActionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.costmanagement.models.ScheduledActionListResult]
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type name: str
        :param scheduled_action: Scheduled action to be created or updated.
    ...
    execute.metadata = {'url': "/providers/Microsoft.CostManagement/scheduledActions/{name}/execute"}  # type: ignore


    @distributed_trace
    def execute_by_scope(  # pylint: disable=inconsistent-return-statements
        self,
        scope: str,
        name: str,
        **kwargs: Any
    ) -> None:
        """Execute a shared scheduled action within the given scope.
        ...
        request = build_execute_by_scope_request(
            scope=scope,
            name=name,
            api_version=api_version,
            template_url=self.execute_by_scope.metadata['url'],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    execute_by_scope.metadata = {'url': "/{scope}/providers/Microsoft.CostManagement/scheduledActions/{name}/execute"}  # type: ignore
    ...
    def check_name_availability(
        ...
        **kwargs: Any
        ...
        :param check_name_availability_request: Scheduled action to be created or updated.
