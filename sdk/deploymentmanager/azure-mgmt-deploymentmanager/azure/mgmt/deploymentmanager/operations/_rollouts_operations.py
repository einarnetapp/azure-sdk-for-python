...
def build_create_or_update_request(
    resource_group_name: str, rollout_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class RolloutsOperations:
    ...
    @distributed_trace
    def cancel(self, resource_group_name: str, rollout_name: str, **kwargs: Any) -> _models.Rollout:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> List[_models.Rollout]:
