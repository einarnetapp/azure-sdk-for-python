...
from ...operations._api_issue_attachments_operations import build_list_by_service_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class ApiIssueAttachmentsOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`api_issue_attachments` attribute.
    """
