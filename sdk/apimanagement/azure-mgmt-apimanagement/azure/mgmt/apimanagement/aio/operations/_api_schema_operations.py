...
from ...operations._api_schema_operations import build_create_or_update_request, build_delete_request, build_get_entity_tag_request, build_get_request, build_list_by_api_request
T = TypeVar('T')
...
class ApiSchemaOperations:
    ...
    def list_by_api(
        ...
        api_id: str,
        **kwargs: Any
    ) -> AsyncIterable[_models.SchemaCollection]:
