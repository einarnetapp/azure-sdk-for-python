    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "DocumentationContract", is_xml=True)
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param if_match: ETag of the Entity. ETag should match the current entity state from the header
         response of the GET request or it should be * for unconditional update. Required.
        :type if_match: str
        :param parameters: Documentation Update parameters. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.apimanagement.models.DocumentationContract or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
