...
from ...operations._delegation_settings_operations import build_create_or_update_request, build_get_request, build_head_request, build_update_request
T = TypeVar('T')
...
class DelegationSettingsOperations:
    ...
    head.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/portalsettings/delegation"}  # type: ignore
