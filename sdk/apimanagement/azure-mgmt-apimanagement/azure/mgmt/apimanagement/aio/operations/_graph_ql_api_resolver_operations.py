...
class GraphQLApiResolverOperations:
    ...
    def list_by_api(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.ResolverCollection]
    ...
    list_by_api.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/resolvers"}  # type: ignore
    ...
    get_entity_tag.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/resolvers/{resolverId}"}  # type: ignore
    ...
    async def get(
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.ResolverContract]
    ...
    get.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/resolvers/{resolverId}"}  # type: ignore
    ...
    create_or_update.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/resolvers/{resolverId}"}  # type: ignore
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param if_match: ETag of the Entity. ETag should match the current entity state from the header
         response of the GET request or it should be * for unconditional update. Required.
        :type if_match: str
        :param parameters: GraphQL API Resolver Update parameters. Is either a model type or a IO type.
         Required.
    ...
    update.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/resolvers/{resolverId}"}  # type: ignore
    ...
    delete.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/resolvers/{resolverId}"}  # type: ignore
