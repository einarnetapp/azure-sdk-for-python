...
from ...operations._regions_operations import build_list_by_service_request
T = TypeVar('T')
...
class RegionsOperations:
    ...
    def list_by_service(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.apimanagement.models.RegionListResult]
