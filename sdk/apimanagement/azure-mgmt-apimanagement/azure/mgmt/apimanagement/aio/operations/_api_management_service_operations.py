...
class ApiManagementServiceOperations:
    ...
    async def _update_hostname_initial(
        self,
        resource_group_name: str,
        service_name: str,
    ...
    @distributed_trace_async
    async def begin_update_hostname(
        self,
        resource_group_name: str,
        service_name: str,
        parameters: _models.ApiManagementServiceUpdateHostnameParameters,
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._update_hostname_initial(  # type: ignore
                resource_group_name=resource_group_name,
                service_name=service_name,
                parameters=parameters,
                api_version=api_version,
