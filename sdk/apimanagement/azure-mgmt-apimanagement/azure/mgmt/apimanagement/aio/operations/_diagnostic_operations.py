...
from ...operations._diagnostic_operations import build_create_or_update_request, build_delete_request, build_get_request, build_head_request, build_list_by_service_request, build_update_request
T = TypeVar('T')
...
class DiagnosticOperations:
    ...
    head.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/diagnostics/{diagnosticId}"}  # type: ignore
