...
from ...operations._policy_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_service_request
T = TypeVar('T')
...
class PolicyOperations:
    ...
    async def delete(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param policy_id: The identifier of the Policy.
        :type policy_id: str or ~azure.mgmt.apimanagement.models.PolicyIdName
        :param if_match: The entity state (Etag) version of the policy to be deleted. A value of "*"
