...
from ...operations._open_id_connect_provider_operations import build_create_or_update_request, build_delete_request, build_get_entity_tag_request, build_get_request, build_list_by_service_request, build_update_request
T = TypeVar('T')
...
class OpenIdConnectProviderOperations:
    ...
    async def update(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param opid: Identifier of the OpenID Connect Provider.
        :type opid: str
        :param if_match: The entity state (Etag) version of the OpenID Connect Provider to update. A
    ...
    async def delete(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param opid: Identifier of the OpenID Connect Provider.
        :type opid: str
        :param if_match: The entity state (Etag) version of the OpenID Connect Provider to delete. A
         value of "*" can be used for If-Match to unconditionally apply the operation.
        :type if_match: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
