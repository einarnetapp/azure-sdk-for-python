...
from ...operations._api_diagnostic_operations import build_create_or_update_request, build_delete_request, build_get_request, build_head_request, build_list_by_service_request, build_update_request
T = TypeVar('T')
...
class ApiDiagnosticOperations:
    ...
    head.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/diagnostics/{diagnosticId}"}  # type: ignore
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param if_match: ETag of the Diagnostic Entity. ETag should match the current entity state from
         the header response of the GET request or it should be * for unconditional update. Default
         value is None.
        :type if_match: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DiagnosticContract, or the result of cls(response)
