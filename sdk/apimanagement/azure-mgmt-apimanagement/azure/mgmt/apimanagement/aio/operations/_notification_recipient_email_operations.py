...
from ...operations._notification_recipient_email_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_notification_request
T = TypeVar('T')
...
class NotificationRecipientEmailOperations:
    ...
    get.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/notifications/{notificationName}/recipientEmails/{email}"}  # type: ignore
