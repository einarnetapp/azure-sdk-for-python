...
from ...operations._api_diagnostic_logger_operations import build_check_entity_exists_request, build_create_or_update_request, build_delete_request, build_list_by_service_request
T = TypeVar('T')
...
class ApiDiagnosticLoggerOperations:
    ...
    def list_by_service(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.apimanagement.models.LoggerCollection]
