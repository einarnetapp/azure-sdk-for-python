...
def build_create_or_update_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.OperationContract] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_update_request(
    ...
    *,
    if_match: str,
    json: Optional[_models.OperationUpdateContract] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    def update(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param operation_id: Operation identifier within an API. Must be unique in the current API
         Management service instance.
        :type operation_id: str
        :param if_match: ETag of the API Operation Entity. ETag should match the current entity state
