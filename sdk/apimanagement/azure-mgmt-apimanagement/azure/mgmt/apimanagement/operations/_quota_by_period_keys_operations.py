...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/quotas/{quotaCounterKey}/{quotaPeriodKey}")  # pylint: disable=line-too-long
...
def build_update_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.QuotaCounterValueContractProperties] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class QuotaByPeriodKeysOperations:
    ...
    get.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/quotas/{quotaCounterKey}/{quotaPeriodKey}"}  # type: ignore
    ...
    def update(  # pylint: disable=inconsistent-return-statements
        ...
        quota_counter_key: str,
        quota_period_key: str,
        parameters: _models.QuotaCounterValueContractProperties,
        **kwargs: Any
    ) -> None:
        ...
        :type parameters: ~azure.mgmt.apimanagement.models.QuotaCounterValueContractProperties
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        _json = self._serialize.body(parameters, 'QuotaCounterValueContractProperties')
    ...
    update.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/quotas/{quotaCounterKey}/{quotaPeriodKey}"}  # type: ignore
