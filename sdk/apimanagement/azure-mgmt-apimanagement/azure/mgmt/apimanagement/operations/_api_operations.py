...
def build_list_by_service_request(
    ...
    **kwargs: Any
    ...
    if expand_api_version_set is not None:
        _query_parameters['expandApiVersionSet'] = _SERIALIZER.query("expand_api_version_set", expand_api_version_set, 'bool')
...
def build_delete_request(
    ...
    **kwargs: Any
    ...
    if delete_revisions is not None:
        _query_parameters['deleteRevisions'] = _SERIALIZER.query("delete_revisions", delete_revisions, 'bool')
    _query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
...
def build_list_by_tags_request(
    ...
    **kwargs: Any
    ...
    if include_not_tagged_apis is not None:
        _query_parameters['includeNotTaggedApis'] = _SERIALIZER.query("include_not_tagged_apis", include_not_tagged_apis, 'bool')
    _query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
