...
def build_perform_connectivity_check_async_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ConnectivityCheckRequest] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
...
class ApiManagementClientOperationsMixin(MixinABC):
    ...
    def begin_perform_connectivity_check_async(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._perform_connectivity_check_async_initial(  # type: ignore
                resource_group_name=resource_group_name,
                service_name=service_name,
