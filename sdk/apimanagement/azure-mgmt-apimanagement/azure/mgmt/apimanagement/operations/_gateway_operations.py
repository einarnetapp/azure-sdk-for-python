...
def build_create_or_update_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.GatewayContract] = None,
    content: Any = None,
...
def build_regenerate_key_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.GatewayKeyRegenerationRequestContract] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_generate_token_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.GatewayTokenRequestContract] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
