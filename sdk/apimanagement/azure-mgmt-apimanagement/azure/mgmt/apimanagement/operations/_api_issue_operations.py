...
def build_head_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/issues/{issueId}")  # pylint: disable=line-too-long
...
def build_create_or_update_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.IssueContract] = None,
    content: Any = None,
