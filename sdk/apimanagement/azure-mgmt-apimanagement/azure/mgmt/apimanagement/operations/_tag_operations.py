...
def build_create_or_update_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.TagCreateUpdateParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_list_by_operation_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "serviceName": _SERIALIZER.url("service_name", service_name, 'str', max_length=50, min_length=1, pattern=r'^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$'),
        "apiId": _SERIALIZER.url("api_id", api_id, 'str', max_length=256, min_length=1, pattern=r'^[^*#&+:<>?]+$'),
        "operationId": _SERIALIZER.url("operation_id", operation_id, 'str', max_length=256, min_length=1, pattern=r'^[^*#&+:<>?]+$'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
...
class TagOperations:  # pylint: disable=too-many-public-methods
    ...
    def update(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param tag_id: Tag identifier. Must be unique in the current API Management service instance.
        :type tag_id: str
        :param if_match: ETag of the Tag Entity. ETag should match the current entity state from the
