...
def build_restore_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ApiManagementServiceBackupRestoreParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_create_or_update_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ApiManagementServiceResource] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_update_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ApiManagementServiceUpdateParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_check_name_availability_request(
    subscription_id: str,
    *,
    json: Optional[_models.ApiManagementServiceCheckNameAvailabilityParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_apply_network_configuration_updates_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ApiManagementServiceApplyNetworkConfigurationParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_upload_certificate_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ApiManagementServiceUploadCertificateParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/uploadcertificate")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serviceName": _SERIALIZER.url("service_name", service_name, 'str', max_length=50, min_length=1, pattern=r'^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_update_hostname_request_initial(
    resource_group_name: str,
    service_name: str,
    subscription_id: str,
    *,
    json: Optional[_models.ApiManagementServiceUpdateHostnameParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/updatehostname")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serviceName": _SERIALIZER.url("service_name", service_name, 'str', max_length=50, min_length=1, pattern=r'^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
class ApiManagementServiceOperations:
    ...
    delete.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}"}  # type: ignore
    ...
    def upload_certificate(
        ...
        resource_group_name: str,
        service_name: str,
        parameters: _models.ApiManagementServiceUploadCertificateParameters,
        **kwargs: Any
    ) -> _models.CertificateInformation:
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CertificateInformation, or the result of cls(response)
        :rtype: ~azure.mgmt.apimanagement.models.CertificateInformation
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', "2022-01-09"))  # type: str
        content_type = kwargs.pop('content_type', _headers.pop('Content-Type', "application/json"))  # type: Optional[str]
        cls = kwargs.pop('cls', None)  # type: ClsType[_models.CertificateInformation]

        _json = self._serialize.body(parameters, 'ApiManagementServiceUploadCertificateParameters')
        ...
        deserialized = self._deserialize('CertificateInformation', pipeline_response)
    ...
    upload_certificate.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/uploadcertificate"}  # type: ignore
    ...
    def _update_hostname_initial(
        ...
        resource_group_name: str,
        service_name: str,
        parameters: _models.ApiManagementServiceUpdateHostnameParameters,
        **kwargs: Any
    ) -> _models.ApiManagementServiceResource:
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        ...
        _json = self._serialize.body(parameters, 'ApiManagementServiceUpdateHostnameParameters')

        request = build_update_hostname_request_initial(
            resource_group_name=resource_group_name,
            service_name=service_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            content_type=content_type,
            json=_json,
            template_url=self._update_hostname_initial.metadata['url'],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _update_hostname_initial.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/updatehostname"}  # type: ignore


    @distributed_trace
    def begin_update_hostname(
        self,
        resource_group_name: str,
        service_name: str,
        parameters: _models.ApiManagementServiceUpdateHostnameParameters,
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.apimanagement.models.ApiManagementServiceUpdateHostnameParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._update_hostname_initial(  # type: ignore
                resource_group_name=resource_group_name,
                service_name=service_name,
                parameters=parameters,
                api_version=api_version,
    ...
    begin_update_hostname.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/updatehostname"}  # type: ignore
