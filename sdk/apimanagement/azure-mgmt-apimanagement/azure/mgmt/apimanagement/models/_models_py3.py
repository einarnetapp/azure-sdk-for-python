...
class AuthenticationSettingsContract(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'o_auth2_authentication_settings': {'key': 'oAuth2AuthenticationSettings', 'type': '[OAuth2AuthenticationSettingsContract]'},
    }
...
class AuthorizationContract(Resource):
    ...
    :ivar type: The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or
     "Microsoft.Storage/storageAccounts".
    :vartype type: str
    :ivar authorization_type: Authorization type options. Known values are: "OAuth2".
    :vartype authorization_type: str or ~azure.mgmt.apimanagement.models.AuthorizationType
    :ivar o_auth2_grant_type: OAuth2 grant type options. Known values are: "AuthorizationCode",
     "ClientCredentials".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword authorization_type: Authorization type options. Known values are: "OAuth2".
...
class PolicyFragmentContract(Resource):
    ...
    :vartype description: str
    :ivar format: Format of the policy fragment content. Known values are: "xml", "rawxml".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype description: str
        :keyword format: Format of the policy fragment content. Known values are: "xml", "rawxml".
...
class PortalConfigCollection(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.PortalConfigContract"]] = None,
        **kwargs
    ):
        """
...
class PortalConfigCspProperties(msrest.serialization.Model):
    ...
    :ivar mode: The mode of the developer portal Content Security Policy (CSP). Known values are:
     "enabled", "disabled", "reportOnly". Default value: "disabled".
    ...
    def __init__(
        self,
        *,
        mode: Optional[Union[str, "_models.PortalSettingsCspMode"]] = "disabled",
        ...
        **kwargs
        ...
        :keyword mode: The mode of the developer portal Content Security Policy (CSP). Known values
         are: "enabled", "disabled", "reportOnly". Default value: "disabled".
