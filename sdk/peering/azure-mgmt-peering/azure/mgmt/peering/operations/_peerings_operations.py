...
def build_get_request(resource_group_name: str, peering_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Peering/peerings")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class PeeringsOperations:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Peering"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.Peering"]:
