...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Peering/peeringServiceProviders"
    )
...
class PeeringServiceProvidersOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.PeeringServiceProvider"]:
