...
from ...operations._peering_services_operations import (
    ...
    build_get_request,
    build_initialize_connection_monitor_request,
...
class PeeringServicesOperations:
    ...
    ) -> AsyncIterable["_models.PeeringService"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.PeeringService"]:
    ...
    @distributed_trace_async
    async def initialize_connection_monitor(  # pylint: disable=inconsistent-return-statements
        self, **kwargs: Any
    ) -> None:
