...
def build_create_or_update_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automanage/configurationProfiles/{configurationProfileName}/versions/{versionName}")  # pylint: disable=line-too-long
...
def build_list_child_resources_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automanage/configurationProfiles/{configurationProfileName}/versions")  # pylint: disable=line-too-long
    path_format_arguments = {
        "configurationProfileName": _SERIALIZER.url("configuration_profile_name", configuration_profile_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
...
class ConfigurationProfilesVersionsOperations(object):
    ...
    def list_child_resources(
        ...
        resource_group_name: str,
        **kwargs: Any
    ) -> Iterable["_models.ConfigurationProfileList"]:
        ...
        :return: An iterator like instance of either ConfigurationProfileList or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.automanage.models.ConfigurationProfileList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-05-04")  # type: str
