...
from ...operations._configuration_profile_assignments_operations import (
    ...
    build_get_request,
    build_list_by_cluster_name_request,
    build_list_by_machine_name_request,
...
class ConfigurationProfileAssignmentsOperations:
    ...
    def list_by_virtual_machines(
    ...
    ) -> AsyncIterable["_models.ConfigurationProfileAssignment"]:
        ...
        :return: An iterator like instance of either ConfigurationProfileAssignment or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.automanage.models.ConfigurationProfileAssignment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
