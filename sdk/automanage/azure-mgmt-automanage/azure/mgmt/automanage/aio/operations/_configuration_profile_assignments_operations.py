...
from ...operations._configuration_profile_assignments_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_cluster_name_request, build_list_by_machine_name_request, build_list_by_subscription_request, build_list_by_virtual_machines_request, build_list_request
T = TypeVar('T')
...
class ConfigurationProfileAssignmentsOperations:
    ...
    def list_by_virtual_machines(
        ...
        vm_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.ConfigurationProfileAssignmentList"]:
        ...
        :return: An iterator like instance of either ConfigurationProfileAssignmentList or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.automanage.models.ConfigurationProfileAssignmentList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-05-04")  # type: str
