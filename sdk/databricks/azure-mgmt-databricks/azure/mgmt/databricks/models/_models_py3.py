...
class AccessConnector(TrackedResource):
    ...
    :ivar location: The geo-location where the resource lives. Required.
    :vartype location: str
    :ivar identity: Type of managed service identity (system assigned or user assigned identities -
     but not system assigned and user assigned identities).
    :vartype identity: ~azure.mgmt.databricks.models.SystemAssignedOrUserAssignedServiceIdentity
    ...
    _attribute_map = {
        ...
        "tags": {"key": "tags", "type": "{str}"},
        "location": {"key": "location", "type": "str"},
        "identity": {"key": "identity", "type": "SystemAssignedOrUserAssignedServiceIdentity"},
    ...
    def __init__(
        ...
        *,
        ...
        identity: Optional["_models.SystemAssignedOrUserAssignedServiceIdentity"] = None,
        ...
        **kwargs: Any
        ...
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
        :keyword identity: Type of managed service identity (system assigned or user assigned
         identities - but not system assigned and user assigned identities).
        :paramtype identity: ~azure.mgmt.databricks.models.SystemAssignedOrUserAssignedServiceIdentity
...
class SystemAssignedOrUserAssignedServiceIdentity(_serialization.Model):
    """Type of managed service identity (system assigned or user assigned identities - but not system
    assigned and user assigned identities).
    ...
    :vartype type: str or
     ~azure.mgmt.databricks.models.SystemAssignedOrUserAssignedServiceIdentityType
    :ivar user_assigned_identities: The set of user assigned identities associated with the
     resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form:
     '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}.
     The dictionary values can be empty objects ({}) in requests.
    ...
    def __init__(
        self,
        *,
        type: Union[str, "_models.SystemAssignedOrUserAssignedServiceIdentityType"],
        user_assigned_identities: Optional[Dict[str, "_models.UserAssignedIdentity"]] = None,
        **kwargs: Any
    ) -> None:
        """
