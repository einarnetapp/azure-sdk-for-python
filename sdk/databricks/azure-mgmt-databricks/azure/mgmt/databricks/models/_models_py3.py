...
class AccessConnector(TrackedResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super(AccessConnector, self).__init__(tags=tags, location=location, **kwargs)
        self.identity = identity
        self.properties = properties


class AccessConnectorListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.AccessConnector"]] = None,
        ...
        **kwargs
        ...
        """
        super(AccessConnectorListResult, self).__init__(**kwargs)
        self.value = value
        self.next_link = next_link


class AccessConnectorProperties(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(AccessConnectorProperties, self).__init__(**kwargs)
        self.provisioning_state = None


class AccessConnectorUpdate(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype identity: ~azure.mgmt.databricks.models.IdentityData
        """
        super(AccessConnectorUpdate, self).__init__(**kwargs)
        self.tags = tags
        self.identity = identity
...
class Encryption(msrest.serialization.Model):
    ...
    :ivar key_source: The encryption keySource (provider). Possible values (case-insensitive):
     Default, Microsoft.Keyvault. Known values are: "Default", "Microsoft.Keyvault". Default value:
     "Default".
    ...
    def __init__(
        self,
        *,
        key_source: Optional[Union[str, "_models.KeySource"]] = "Default",
...
class EncryptionV2(msrest.serialization.Model):
    ...
    :ivar key_source: Required. The encryption keySource (provider). Possible values
     (case-insensitive):  Microsoft.Keyvault. Known values are: "Microsoft.Keyvault".
...
class IdentityData(msrest.serialization.Model):
    ...
    :vartype user_assigned_identities: dict[str, ~azure.mgmt.databricks.models.UserIdentity]
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword user_assigned_identities: The list of user-assigned identities associated with the
         resource. The user-assigned identity dictionary keys will be ARM resource ids in the form:
         '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
        :paramtype user_assigned_identities: dict[str, ~azure.mgmt.databricks.models.UserIdentity]
        """
...
class PrivateEndpointConnectionProperties(msrest.serialization.Model):
    ...
    :ivar provisioning_state: Provisioning state of the private endpoint connection. Known values
     are: "Succeeded", "Creating", "Updating", "Deleting", "Failed".
...
class VirtualNetworkPeering(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        databricks_virtual_network: Optional["_models.VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetwork"] = None,
...
class Workspace(TrackedResource):
    ...
    :ivar public_network_access: The network access type for accessing workspace. Set value to
     disabled to access workspace only via private link. Known values are: "Enabled", "Disabled".
    ...
    :ivar required_nsg_rules: Gets or sets a value indicating whether data plane (clusters) to
     ...
     are: "AllRules", "NoAzureDatabricksRules", "NoAzureServiceRules".
...
class WorkspaceCustomBooleanParameter(msrest.serialization.Model):
    ...
    :ivar type: The type of variable that this is. Known values are: "Bool", "Object", "String".
