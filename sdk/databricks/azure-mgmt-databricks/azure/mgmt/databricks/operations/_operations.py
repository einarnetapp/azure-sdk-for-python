...
def build_list_request(
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Databricks/operations')
...
class Operations(object):
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.databricks.models.OperationListResult]
