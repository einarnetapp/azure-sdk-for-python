...
class SecurityCenter:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype management_group_governance_rule:
     azure.mgmt.security.v2022_01_01_preview.operations.ManagementGroupGovernanceRuleOperations
    ...
    :vartype management_group_governance_rules:
     azure.mgmt.security.v2022_01_01_preview.operations.ManagementGroupGovernanceRulesOperations
    ...
    :ivar management_group_governance_rules_execute_status:
     ManagementGroupGovernanceRulesExecuteStatusOperations operations
    :vartype management_group_governance_rules_execute_status:
     azure.mgmt.security.v2022_01_01_preview.operations.ManagementGroupGovernanceRulesExecuteStatusOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.management_group_governance_rules_execute_status = ManagementGroupGovernanceRulesExecuteStatusOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
