...
def build_rule_id_execute_single_management_group_request(
    rule_id: str, management_group_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class GovernanceRulesOperations:
    ...
    def get(self, rule_id: str, **kwargs: Any) -> _models.GovernanceRule:
        ...
        :param rule_id: The GovernanceRule key - unique key for the standard GovernanceRule. Required.
        :type rule_id: str
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param rule_id: The GovernanceRule key - unique key for the standard GovernanceRule. Required.
        :type rule_id: str
        :param governance_rule: GovernanceRule over a given scope. Required.
    ...
    def create_or_update(
        ...
        :param rule_id: The GovernanceRule key - unique key for the standard GovernanceRule. Required.
        :type rule_id: str
        :param governance_rule: GovernanceRule over a given scope. Is either a model type or a IO type.
         Required.
    ...
    def begin_rule_id_execute_single_subscription(
        ...
        **kwargs: Any
        ...
        :param rule_id: The GovernanceRule key - unique key for the standard GovernanceRule. Required.
        :type rule_id: str
        :param execute_governance_rule_params: ExecuteGovernanceRule over a given scope. Default value
         is None.
    ...
    def begin_rule_id_execute_single_subscription(
        ...
        **kwargs: Any
        ...
        :param rule_id: The GovernanceRule key - unique key for the standard GovernanceRule. Required.
        :type rule_id: str
        :param execute_governance_rule_params: ExecuteGovernanceRule over a given scope. Is either a
    ...
    def _rule_id_execute_single_management_group_initial(  # pylint: disable=inconsistent-return-statements
        self,
        rule_id: str,
        execute_governance_rule_params: Optional[Union[_models.ExecuteGovernanceRuleParams, IO]] = None,
        **kwargs: Any
        ...
        request = build_rule_id_execute_single_management_group_request(
            rule_id=rule_id,
            ...
            json=_json,
            content=_content,
            template_url=self._rule_id_execute_single_management_group_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _rule_id_execute_single_management_group_initial.metadata = {"url": "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Security/governanceRules/{ruleId}/execute"}  # type: ignore

    @overload
    def begin_rule_id_execute_single_management_group(
        self,
        rule_id: str,
        execute_governance_rule_params: Optional[_models.ExecuteGovernanceRuleParams] = None,
        *,
    ...
    def begin_rule_id_execute_single_management_group(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._rule_id_execute_single_management_group_initial(  # type: ignore
                rule_id=rule_id,
                execute_governance_rule_params=execute_governance_rule_params,
                api_version=api_version,
                content_type=content_type,
    ...
    begin_rule_id_execute_single_management_group.metadata = {"url": "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Security/governanceRules/{ruleId}/execute"}  # type: ignore
