...
from ...operations._management_group_governance_rules_execute_status_operations import build_get_request
...
class ManagementGroupGovernanceRulesExecuteStatusOperations:
    ...
    _get_initial.metadata = {"url": "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Security/governanceRules/{ruleId}/execute/operationResults/{operationId}"}  # type: ignore
    ...
    async def begin_get(
        ...
        :type rule_id: str
        :param operation_id: The GovernanceRule execution key - unique key for the execution of
         GovernanceRule. Required.
    ...
    begin_get.metadata = {"url": "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Security/governanceRules/{ruleId}/execute/operationResults/{operationId}"}  # type: ignore
