...
from ...operations._management_group_governance_rules_operations import (
...
class ManagementGroupGovernanceRulesOperations:
    ...
    get.metadata = {"url": "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Security/governanceRules/{ruleId}"}  # type: ignore
    ...
    create_or_update.metadata = {"url": "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Security/governanceRules/{ruleId}"}  # type: ignore
    ...
    _delete_initial.metadata = {"url": "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Security/governanceRules/{ruleId}"}  # type: ignore

    @distributed_trace_async
    async def begin_delete(self, rule_id: str, **kwargs: Any) -> AsyncLROPoller[None]:
    ...
    begin_delete.metadata = {"url": "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Security/governanceRules/{ruleId}"}  # type: ignore
