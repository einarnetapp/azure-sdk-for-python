...
from ...operations._governance_rules_operations import build_create_or_update_request, build_delete_request, build_get_request, build_rule_id_execute_single_security_connector_request, build_rule_id_execute_single_subscription_request
T = TypeVar('T')
