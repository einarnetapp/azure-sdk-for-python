...
from ...operations._governance_rules_operations import (
    ...
    build_get_request,
    build_rule_id_execute_single_management_group_request,
...
class GovernanceRulesOperations:
    ...
    async def _rule_id_execute_single_management_group_initial(  # pylint: disable=inconsistent-return-statements
        self,
        rule_id: str,
        execute_governance_rule_params: Optional[Union[_models.ExecuteGovernanceRuleParams, IO]] = None,
        **kwargs: Any
    ...
    @overload
    async def begin_rule_id_execute_single_management_group(
        self,
        rule_id: str,
        execute_governance_rule_params: Optional[_models.ExecuteGovernanceRuleParams] = None,
        *,
    ...
    async def begin_rule_id_execute_single_management_group(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._rule_id_execute_single_management_group_initial(  # type: ignore
                rule_id=rule_id,
                execute_governance_rule_params=execute_governance_rule_params,
                api_version=api_version,
                content_type=content_type,
