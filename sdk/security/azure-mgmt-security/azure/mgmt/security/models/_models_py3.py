...
class AdditionalData(msrest.serialization.Model):
    ...
    You probably want to use the sub-classes and not this class directly. Known
    sub-classes are: AmazonElasticContainerRegistryVulnerabilityProperties, ContainerRegistryVulnerabilityProperties, ServerVulnerabilityProperties, SqlServerVulnerabilityProperties.
...
class AmazonElasticContainerRegistryVulnerabilityProperties(AdditionalData):
    ...
    :vartype tags: list[any]
    :ivar metadata: The sub assessment metadata.
    :vartype metadata: any
    :ivar package_name: Name of the package the vulnerabilities relates too.
    :vartype package_name: str
    :ivar installed_version: The version installed.
    :vartype installed_version: str
    :ivar registry_host: Name of the registry which the vulnerable image belongs to.
    :vartype registry_host: str
    ...
    :ivar scanner: The vulnerabilities scanner.
    :vartype scanner: any
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(AmazonElasticContainerRegistryVulnerabilityProperties, self).__init__(**kwargs)
        self.assessed_resource_type = 'AmazonElasticContainerRegistryVulnerability'  # type: str
        self.cve = None
        self.tags = None
        self.metadata = None
