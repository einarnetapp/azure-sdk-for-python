...
class Pricing(Resource):
    ...
    :ivar deprecated: (optional) will return true if the pricing bundle is deprecated.
    :vartype deprecated: bool
    :ivar replaced_by: (optional) List of pricing bundles which replace the deprecated bundle, if
     deprecated is true.
