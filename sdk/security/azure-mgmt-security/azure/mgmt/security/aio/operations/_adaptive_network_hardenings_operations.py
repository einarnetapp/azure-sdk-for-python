...
from ...operations._adaptive_network_hardenings_operations import build_enforce_request_initial, build_get_request, build_list_by_extended_resource_request
T = TypeVar('T')
...
class AdaptiveNetworkHardeningsOperations:
    ...
    def list_by_extended_resource(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either AdaptiveNetworkHardeningsList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.AdaptiveNetworkHardeningsList]
    ...
    @distributed_trace_async
    async def begin_enforce(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        resource_namespace: str,
        resource_type: str,
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._enforce_initial(
                resource_group_name=resource_group_name,
                resource_namespace=resource_namespace,
                resource_type=resource_type,
                resource_name=resource_name,
