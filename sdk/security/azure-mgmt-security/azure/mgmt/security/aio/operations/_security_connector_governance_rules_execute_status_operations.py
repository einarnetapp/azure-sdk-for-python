...
from ...operations._security_connector_governance_rules_execute_status_operations import build_get_request_initial
T = TypeVar('T')
    ...
    async def begin_get(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ExecuteRuleStatus or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.security.models.ExecuteRuleStatus]
