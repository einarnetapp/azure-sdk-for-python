...
from ...operations._security_connector_governance_rule_operations import build_list_request
T = TypeVar('T')
...
class SecurityConnectorGovernanceRuleOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable[_models.GovernanceRuleList]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.GovernanceRuleList]
