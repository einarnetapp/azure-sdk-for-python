...
from ...operations._governance_rules_operations import build_create_or_update_request, build_delete_request, build_get_request, build_rule_id_execute_single_security_connector_request_initial, build_rule_id_execute_single_subscription_request_initial
T = TypeVar('T')
...
class GovernanceRulesOperations:
    ...
    @distributed_trace_async
    async def begin_rule_id_execute_single_subscription(  # pylint: disable=inconsistent-return-statements
        self,
        rule_id: str,
        execute_governance_rule_params: Optional[_models.ExecuteGovernanceRuleParams] = None,
        **kwargs: Any
    ...
    @distributed_trace_async
    async def begin_rule_id_execute_single_security_connector(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        security_connector_name: str,
        rule_id: str,
