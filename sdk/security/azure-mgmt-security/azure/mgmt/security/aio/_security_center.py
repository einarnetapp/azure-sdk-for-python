...
from .operations import AdaptiveApplicationControlsOperations, AdaptiveNetworkHardeningsOperations, AdvancedThreatProtectionOperations, AlertsOperations, AlertsSuppressionRulesOperations, AllowedConnectionsOperations, AssessmentsMetadataOperations, AssessmentsOperations, AutoProvisioningSettingsOperations, AutomationsOperations, ComplianceResultsOperations, CompliancesOperations, ConnectorsOperations, CustomAssessmentAutomationsOperations, CustomEntityStoreAssignmentsOperations, DeviceSecurityGroupsOperations, DiscoveredSecuritySolutionsOperations, ExternalSecuritySolutionsOperations, GovernanceAssignmentsOperations, GovernanceRuleOperations, GovernanceRulesOperations, InformationProtectionPoliciesOperations, IngestionSettingsOperations, IotSecuritySolutionAnalyticsOperations, IotSecuritySolutionOperations, IotSecuritySolutionsAnalyticsAggregatedAlertOperations, IotSecuritySolutionsAnalyticsRecommendationOperations, JitNetworkAccessPoliciesOperations, LocationsOperations, MdeOnboardingsOperations, Operations, PricingsOperations, RegulatoryComplianceAssessmentsOperations, RegulatoryComplianceControlsOperations, RegulatoryComplianceStandardsOperations, SecureScoreControlDefinitionsOperations, SecureScoreControlsOperations, SecureScoresOperations, SecurityConnectorGovernanceRuleOperations, SecurityConnectorGovernanceRulesExecuteStatusOperations, SecurityConnectorGovernanceRulesOperations, SecurityConnectorsOperations, SecurityContactsOperations, SecuritySolutionsOperations, SecuritySolutionsReferenceDataOperations, ServerVulnerabilityAssessmentOperations, SettingsOperations, SoftwareInventoriesOperations, SqlVulnerabilityAssessmentBaselineRulesOperations, SqlVulnerabilityAssessmentScanResultsOperations, SqlVulnerabilityAssessmentScansOperations, SubAssessmentsOperations, SubscriptionGovernanceRulesExecuteStatusOperations, TasksOperations, TopologyOperations, VmScannersOperations, WorkspaceSettingsOperations
...
class SecurityCenter:    # pylint: disable=too-many-instance-attributes
    ...
    :vartype adaptive_application_controls:
     azure.mgmt.security.aio.operations.AdaptiveApplicationControlsOperations
    :ivar adaptive_network_hardenings: AdaptiveNetworkHardeningsOperations operations
    :vartype adaptive_network_hardenings:
     azure.mgmt.security.aio.operations.AdaptiveNetworkHardeningsOperations
    ...
    :ivar vm_scanners: VmScannersOperations operations
    :vartype vm_scanners: azure.mgmt.security.aio.operations.VmScannersOperations
    ...
    :vartype governance_rule: azure.mgmt.security.aio.operations.GovernanceRuleOperations
    ...
    :vartype security_connector_governance_rule:
     azure.mgmt.security.aio.operations.SecurityConnectorGovernanceRuleOperations
    ...
    :vartype security_connector_governance_rules:
     azure.mgmt.security.aio.operations.SecurityConnectorGovernanceRulesOperations
    ...
    :vartype subscription_governance_rules_execute_status:
     azure.mgmt.security.aio.operations.SubscriptionGovernanceRulesExecuteStatusOperations
    ...
    :vartype security_connector_governance_rules_execute_status:
     azure.mgmt.security.aio.operations.SecurityConnectorGovernanceRulesExecuteStatusOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.vm_scanners = VmScannersOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
        self.security_connectors = SecurityConnectorsOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
        self.governance_rule = GovernanceRuleOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
        ...
        self.security_connector_governance_rules_execute_status = SecurityConnectorGovernanceRulesExecuteStatusOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
