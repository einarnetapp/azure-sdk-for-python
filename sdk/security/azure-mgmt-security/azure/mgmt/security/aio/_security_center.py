...
class SecurityCenter(MultiApiClientMixin, _SDKClient):
    ...
    def security_connectors(self):
        """Instance depends on the API version:
           ...
           * 2023-02-01-preview: :class:`SecurityConnectorsOperations<azure.mgmt.security.v2023_02_01_preview.aio.operations.SecurityConnectorsOperations>`
        """
        ...
        if api_version == '2021-07-01-preview':
            ...
            from ..v2023_02_01_preview.aio.operations import SecurityConnectorsOperations as OperationClass
        else:
