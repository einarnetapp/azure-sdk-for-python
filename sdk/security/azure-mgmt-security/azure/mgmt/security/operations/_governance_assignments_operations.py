...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.Security/assessments/{assessmentName}/governanceAssignments")  # pylint: disable=line-too-long
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.Security/assessments/{assessmentName}/governanceAssignments/{assignmentKey}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, 'str', skip_quote=True),
        "assessmentName": _SERIALIZER.url("assessment_name", assessment_name, 'str'),
...
def build_create_or_update_request(
    ...
    assignment_key: str,
    *,
    json: Optional[_models.GovernanceAssignment] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class GovernanceAssignmentsOperations:
    ...
    def list(
        ...
        assessment_name: str,
        **kwargs: Any
    ) -> Iterable[_models.GovernanceAssignmentsList]:
        ...
        :return: An iterator like instance of either GovernanceAssignmentsList or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.GovernanceAssignmentsList]
