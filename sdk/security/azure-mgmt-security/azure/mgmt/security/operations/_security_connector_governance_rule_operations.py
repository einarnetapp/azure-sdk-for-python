...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName}/providers/Microsoft.Security/governanceRules")  # pylint: disable=line-too-long
...
class SecurityConnectorGovernanceRuleOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`security_connector_governance_rule` attribute.
    """
    ...
    def list(
        ...
        security_connector_name: str,
        **kwargs: Any
    ) -> Iterable[_models.GovernanceRuleList]:
        ...
        :return: An iterator like instance of either GovernanceRuleList or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.GovernanceRuleList]
