...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Security/governanceRules/{ruleId}")  # pylint: disable=line-too-long
...
def build_create_or_update_request(
    ...
    rule_id: str,
    *,
    json: Optional[_models.GovernanceRule] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_rule_id_execute_single_subscription_request_initial(
    subscription_id: str,
    rule_id: str,
    *,
    json: Optional[_models.ExecuteGovernanceRuleParams] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Security/governanceRules/{ruleId}/execute")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', pattern=r'^[0-9A-Fa-f]{8}-([0-9A-Fa-f]{4}-){3}[0-9A-Fa-f]{12}$'),
        "ruleId": _SERIALIZER.url("rule_id", rule_id, 'str'),
    }
...
def build_rule_id_execute_single_security_connector_request_initial(
    subscription_id: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName}/providers/Microsoft.Security/governanceRules/{ruleId}/execute")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', pattern=r'^[0-9A-Fa-f]{8}-([0-9A-Fa-f]{4}-){3}[0-9A-Fa-f]{12}$'),
...
class GovernanceRulesOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param rule_id: The security GovernanceRule key - unique key for the standard GovernanceRule.
        :type rule_id: str
        :param governance_rule: GovernanceRule over a subscription scope.
    ...
    def _rule_id_execute_single_subscription_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_rule_id_execute_single_subscription_request_initial(
            subscription_id=self._config.subscription_id,
            rule_id=rule_id,
            api_version=api_version,
            content_type=content_type,
    ...
    @distributed_trace
    def begin_rule_id_execute_single_subscription(  # pylint: disable=inconsistent-return-statements
        self,
        rule_id: str,
        execute_governance_rule_params: Optional[_models.ExecuteGovernanceRuleParams] = None,
        **kwargs: Any
    ...
    def _rule_id_execute_single_security_connector_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_rule_id_execute_single_security_connector_request_initial(
            subscription_id=self._config.subscription_id,
    ...
    @distributed_trace
    def begin_rule_id_execute_single_security_connector(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        security_connector_name: str,
        rule_id: str,
