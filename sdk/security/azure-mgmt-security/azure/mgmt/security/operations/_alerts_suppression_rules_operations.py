...
def build_list_request(
    ...
    **kwargs: Any
    ...
    if alert_type is not None:
        _query_parameters['AlertType'] = _SERIALIZER.query("alert_type", alert_type, 'str')
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either AlertsSuppressionRulesList or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.AlertsSuppressionRulesList]
