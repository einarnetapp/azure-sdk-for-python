...
def build_list_request(
    ...
    **kwargs: Any
    ...
    if include_path_recommendations is not None:
        _query_parameters['includePathRecommendations'] = _SERIALIZER.query("include_path_recommendations", include_path_recommendations, 'bool')
    if summary is not None:
        _query_parameters['summary'] = _SERIALIZER.query("summary", summary, 'bool')
