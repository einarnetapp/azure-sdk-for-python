...
class ElasticSansOperations:
    ...
    def _create_initial(
        ...
        parameters: Union[_models.ElasticSanCreateParameter, IO],
        **kwargs: Any
    ) -> _models.ElasticSan:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "ElasticSanCreateParameter")
    ...
    def begin_create(
        ...
        resource_group_name: str,
        elastic_san_name: str,
        parameters: _models.ElasticSanCreateParameter,
        *,
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.elasticsan.models.ElasticSanCreateParameter
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param elastic_san_name: The name of the ElasticSan. Required.
        :type elastic_san_name: str
        :param parameters: Elastic San object. Is either a ElasticSanCreateParameter type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.elasticsan.models.ElasticSanCreateParameter or IO
