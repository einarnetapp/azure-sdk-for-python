...
def build_list_by_resource_group_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ElasticSan/elasticSans")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
...
def build_create_request_initial(
    ...
    *,
    json: Optional[_models.ElasticSan] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ElasticSan/elasticSans/{elasticSanName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._]*[0-9A-Za-z]$'),
...
def build_update_request_initial(
    ...
    elastic_san_name: str,
    *,
    json: Optional[_models.ElasticSanUpdate] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_delete_request_initial(
    ...
    **kwargs: Any
    ...
    # Construct headers
    if force_delete_volume_groups is not None:
        _headers['x-ms-delete-volumegroups'] = _SERIALIZER.header("force_delete_volume_groups", force_delete_volume_groups, 'bool')
    _headers['Accept'] = _SERIALIZER.header("accept", accept, 'str')
