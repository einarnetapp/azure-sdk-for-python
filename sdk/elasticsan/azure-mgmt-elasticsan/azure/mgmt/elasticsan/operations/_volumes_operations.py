...
def build_create_request_initial(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ElasticSan/elasticSans/{elasticSanName}/volumegroups/{volumeGroupName}/volumes/{volumeName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        ...
        "volumeName": _SERIALIZER.url("volume_name", volume_name, 'str', max_length=63, min_length=3, pattern=r'^[a-z0-9]+(-[a-z0-9A-Z]+)*$'),
    }
...
def build_update_request_initial(
    ...
    volume_name: str,
    *,
    json: Optional[_models.VolumeUpdate] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_delete_request_initial(
    ...
    volume_name: str,
    *,
    force_delete_snapshots: Optional[bool] = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct headers
    if force_delete_snapshots is not None:
        _headers['x-ms-delete-snapshots'] = _SERIALIZER.header("force_delete_snapshots", force_delete_snapshots, 'bool')
    _headers['Accept'] = _SERIALIZER.header("accept", accept, 'str')
...
def build_list_by_volume_group_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ElasticSan/elasticSans/{elasticSanName}/volumegroups/{volumeGroupName}/volumes")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._]*[0-9A-Za-z]$'),
        "elasticSanName": _SERIALIZER.url("elastic_san_name", elastic_san_name, 'str', max_length=24, min_length=3, pattern=r'^[A-Za-z0-9]+((-|_)[a-z0-9A-Z]+)*$'),
...
class VolumesOperations:
    ...
    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_delete_request_initial(
            ...
            volume_name=volume_name,
            api_version=api_version,
            force_delete_snapshots=force_delete_snapshots,
    ...
    def begin_delete(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param volume_name: The name of the Volume.
        :type volume_name: str
        :param force_delete_snapshots: Required if the Volume has associated snapshots. Default value
         is None.
        :type force_delete_snapshots: bool
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
    ...
    def list_by_volume_group(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.elasticsan.models.VolumeList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
