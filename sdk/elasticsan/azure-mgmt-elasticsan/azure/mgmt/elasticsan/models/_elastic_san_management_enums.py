...
class EncryptionType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    #: Volume/Snapshot is encrypted at rest with Platform managed key. It is the default encryption
    #: type. This is not a valid encryption type for disk encryption sets.
