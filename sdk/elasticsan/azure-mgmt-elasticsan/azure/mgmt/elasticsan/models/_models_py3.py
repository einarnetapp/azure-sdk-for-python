...
class ElasticSanCreateParameter(ElasticSan):  # pylint: disable=too-many-instance-attributes
    """Response for ElasticSan request.
...
class SnapshotCreateParameter(Snapshot):
    """Response for Volume Snapshot request.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype creation_data: ~azure.mgmt.elasticsan.models.SnapshotCreationData
        """
        super().__init__(tags=tags, creation_data=creation_data, **kwargs)
...
class VolumeCreateParameter(Volume):
    """Response for Volume request.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype size_gi_b: int
        """
        super().__init__(tags=tags, creation_data=creation_data, size_gi_b=size_gi_b, **kwargs)
