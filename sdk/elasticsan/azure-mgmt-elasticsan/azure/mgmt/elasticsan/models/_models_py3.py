...
class ElasticSan(TrackedResource):
    ...
    :ivar sku: Required. resource sku.
    ...
    :ivar base_size_ti_b: Required. Base size of the Elastic San appliance in TiB.
    :vartype base_size_ti_b: long
    :ivar extended_capacity_size_ti_b: Required. Extended size of the Elastic San appliance in TiB.
    ...
    _attribute_map = {
        ...
        'total_size_ti_b': {'key': 'properties.totalSizeTiB', 'type': 'long'},
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword location: The geo-location where the resource lives.
        :paramtype location: str
        :keyword sku: Required. resource sku.
        ...
        :keyword base_size_ti_b: Required. Base size of the Elastic San appliance in TiB.
        :paramtype base_size_ti_b: long
        :keyword extended_capacity_size_ti_b: Required. Extended size of the Elastic San appliance in
         TiB.
...
class ResourceTypeSku(msrest.serialization.Model):
    ...
    :vartype sku: list[~azure.mgmt.elasticsan.models.Sku]
    ...
    :ivar elastic_san: Scalability targets for the San account for a given tier.
    :vartype elastic_san: ~azure.mgmt.elasticsan.models.SanTierInfo
    ...
    _attribute_map = {
        ...
        'elastic_san': {'key': 'elasticSan', 'type': 'SanTierInfo'},
    ...
    def __init__(
        self,
        *,
        elastic_san: Optional["_models.SanTierInfo"] = None,
        volume_group: Optional["_models.VolumeGroupTierInfo"] = None,
        volume: Optional["_models.VolumeTierInfo"] = None,
        **kwargs
    ):
        """
        :keyword elastic_san: Scalability targets for the San account for a given tier.
        :paramtype elastic_san: ~azure.mgmt.elasticsan.models.SanTierInfo
...
class Sku(msrest.serialization.Model):
    ...
    :ivar name: Required. The sku name. Known values are: "Premium_LRS", "Premium_ZRS".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword name: Required. The sku name. Known values are: "Premium_LRS", "Premium_ZRS".
...
class SourceCreationData(msrest.serialization.Model):
    ...
    :ivar create_source: This enumerates the possible sources of a volume creation. The only
     acceptable values to pass in are None and "None". The default value is None.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword create_source: This enumerates the possible sources of a volume creation. The only
         acceptable values to pass in are None and "None". The default value is None.
...
class VolumeTierInfo(msrest.serialization.Model):
    ...
    :ivar iops_per_base_gi_b: Maximum IOPS per GiB.
    :vartype iops_per_base_gi_b: long
    ...
    _validation = {
        ...
        'iops_per_base_gi_b': {'readonly': True},
    ...
    _attribute_map = {
        ...
        'iops_per_base_gi_b': {'key': 'iopsPerBaseGiB', 'type': 'long'},
