...
from ...operations._volume_groups_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_elastic_san_request, build_update_request_initial
T = TypeVar('T')
...
class VolumeGroupsOperations:
    ...
    def list_by_elastic_san(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.elasticsan.models.VolumeGroupList]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either VolumeGroup or the result of
         cls(response)
    ...
    async def _delete_initial(  # pylint: disable=inconsistent-return-statements
        ...
        elastic_san_name: str,
        volume_group_name: str,
        force_delete_volumes_and_snapshots: Optional[bool] = None,
        **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        ...
        request = build_delete_request_initial(
            ...
            volume_group_name=volume_group_name,
            api_version=api_version,
            force_delete_volumes_and_snapshots=force_delete_volumes_and_snapshots,
    ...
    async def begin_delete(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param volume_group_name: The name of the VolumeGroup.
        :type volume_group_name: str
        :param force_delete_volumes_and_snapshots: Required if the Volume Group has associated volumes
         and snapshots. Default value is None.
        :type force_delete_volumes_and_snapshots: bool
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
