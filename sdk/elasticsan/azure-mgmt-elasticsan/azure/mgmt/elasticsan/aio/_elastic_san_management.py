...
from .operations import ElasticSansOperations, Operations, SkusOperations, SnapshotsOperations, VolumeGroupsOperations, VolumesOperations
...
class ElasticSanManagement:
    ...
    :vartype snapshots: azure.mgmt.elasticsan.aio.operations.SnapshotsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.elastic_sans = ElasticSansOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
