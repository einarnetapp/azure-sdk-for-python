...
def build_list_by_resource_group_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json, text/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Scheduler/jobCollections")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json, text/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Scheduler/jobCollections/{jobCollectionName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
...
def build_enable_request_initial(
    subscription_id: str,
    resource_group_name: str,
    job_collection_name: str,
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Scheduler/jobCollections/{jobCollectionName}/enable")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "jobCollectionName": _SERIALIZER.url("job_collection_name", job_collection_name, 'str'),
...
def build_disable_request_initial(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Scheduler/jobCollections/{jobCollectionName}/disable")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "jobCollectionName": _SERIALIZER.url("job_collection_name", job_collection_name, 'str'),
...
class JobCollectionsOperations(object):
    ...
    def list_by_subscription(
        self,
        **kwargs: Any
    ) -> Iterable["_models.JobCollectionListResult"]:
        """Gets all job collections under specified subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either JobCollectionListResult or the result of
         cls(response)
    ...
    def _enable_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_enable_request_initial(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            job_collection_name=job_collection_name,
            api_version=api_version,
    ...
    @distributed_trace
    def begin_enable(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        job_collection_name: str,
        **kwargs: Any
    ...
    @distributed_trace
    def begin_disable(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        job_collection_name: str,
        **kwargs: Any
