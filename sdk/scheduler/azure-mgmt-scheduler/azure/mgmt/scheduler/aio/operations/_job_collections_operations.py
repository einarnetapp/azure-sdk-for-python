...
from ...operations._job_collections_operations import build_create_or_update_request, build_delete_request_initial, build_disable_request_initial, build_enable_request_initial, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_patch_request
T = TypeVar('T')
...
class JobCollectionsOperations:
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either JobCollectionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.scheduler.models.JobCollectionListResult]
    ...
    @distributed_trace_async
    async def begin_enable(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        job_collection_name: str,
        **kwargs: Any
    ...
    @distributed_trace_async
    async def begin_disable(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        job_collection_name: str,
        **kwargs: Any
