...
class AgentUpdatePatchProperties(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword type: The type of maintenance for session host components. Known values are:
         "Default", "Scheduled".
...
class Application(Resource):
    ...
    :ivar application_type: Resource Type of Application. Known values are: "InBuilt",
     "MsixApplication".
    ...
    :ivar command_line_setting: Required. Specifies whether this published application can be
     ...
     at publish time, or no command line arguments at all. Known values are: "DoNotAllow", "Allow",
     "Require".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword application_type: Resource Type of Application. Known values are: "InBuilt",
         "MsixApplication".
...
class ApplicationGroup(ResourceModelWithAllowedPropertySet):
    ...
    :ivar application_group_type: Required. Resource Type of ApplicationGroup. Known values are:
     "RemoteApp", "Desktop".
    ...
    def __init__(
        ...
        *,
        ...
        description: Optional[str] = None,
        friendly_name: Optional[str] = None,
        migration_request: Optional["_models.MigrationRequestProperties"] = None,
        **kwargs
    ):
        """
        :keyword location: The geo-location where the resource lives.
        ...
        :keyword application_group_type: Required. Resource Type of ApplicationGroup. Known values are:
         "RemoteApp", "Desktop".
...
class ApplicationGroupList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.ApplicationGroup"]] = None,
        **kwargs
    ):
        """
...
class ApplicationPatch(msrest.serialization.Model):
    ...
    :ivar command_line_setting: Specifies whether this published application can be launched with
     ...
     time, or no command line arguments at all. Known values are: "DoNotAllow", "Allow", "Require".
    :vartype command_line_setting: str or
     ~azure.mgmt.desktopvirtualization.models.CommandLineSetting
    :ivar command_line_arguments: Command Line Arguments for Application.
    :vartype command_line_arguments: str
...
class DesktopList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.Desktop"]] = None,
        **kwargs
    ):
        """
...
class ExpandMsixImageList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.ExpandMsixImage"]] = None,
        **kwargs
    ):
        """
...
class HostPool(ResourceModelWithAllowedPropertySet):
    ...
    :vartype description: str
    :ivar host_pool_type: Required. HostPool type for desktop. Known values are: "Personal",
     "Pooled", "BYODesktop".
    ...
    :ivar load_balancer_type: Required. The type of the load balancer. Known values are:
    ...
    :ivar sso_secret_type: The type of single sign on Secret Type. Known values are: "SharedKey",
     "Certificate", "SharedKeyInKeyVault", "CertificateInKeyVault".
    ...
    :ivar preferred_app_group_type: Required. The type of preferred application group type, default
     to Desktop Application Group. Known values are: "None", "Desktop", "RailApplications".
    ...
    :ivar public_network_access: Enabled allows this resource to be accessed from both public and
     ...
     Known values are: "Enabled", "Disabled", "EnabledForSessionHostsOnly", "EnabledForClientsOnly".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype description: str
        :keyword host_pool_type: Required. HostPool type for desktop. Known values are: "Personal",
         "Pooled", "BYODesktop".
        ...
        :keyword load_balancer_type: Required. The type of the load balancer. Known values are:
         "BreadthFirst", "DepthFirst", "Persistent".
        ...
        :keyword preferred_app_group_type: Required. The type of preferred application group type,
         default to Desktop Application Group. Known values are: "None", "Desktop", "RailApplications".
...
class HostPoolList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.HostPool"]] = None,
        **kwargs
    ):
        """
...
class HostPoolPatch(Resource):
    ...
    :ivar preferred_app_group_type: The type of preferred application group type, default to
     Desktop Application Group. Known values are: "None", "Desktop", "RailApplications".
    :vartype preferred_app_group_type: str or
     ~azure.mgmt.desktopvirtualization.models.PreferredAppGroupType
    :ivar start_vm_on_connect: The flag to turn on/off StartVMOnConnect feature.
    :vartype start_vm_on_connect: bool
    :ivar public_network_access: Enabled to allow this resource to be access from the public
     network. Known values are: "Enabled", "Disabled", "EnabledForSessionHostsOnly",
...
class MigrationRequestProperties(msrest.serialization.Model):
    ...
    :ivar operation: The type of operation for migration. Known values are: "Start", "Revoke",
     "Complete", "Hide", "Unhide".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword operation: The type of operation for migration. Known values are: "Start", "Revoke",
         "Complete", "Hide", "Unhide".
...
class MSIXPackageList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.MSIXPackage"]] = None,
        **kwargs
    ):
        """
...
class PrivateEndpointConnectionListResultWithSystemData(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.PrivateEndpointConnectionWithSystemData"]] = None,
        **kwargs
    ):
        """
...
class ScalingPlan(ResourceModelWithAllowedPropertySet):
    ...
    :vartype friendly_name: str
    :ivar time_zone: Required. Timezone of the scaling plan.
    :vartype time_zone: str
    :ivar host_pool_type: HostPool type for desktop. Known values are: "Pooled". Default value:
     "Pooled".
    ...
    def __init__(
        ...
        *,
        ...
        description: Optional[str] = None,
        friendly_name: Optional[str] = None,
        host_pool_type: Optional[Union[str, "_models.ScalingHostPoolType"]] = "Pooled",
        ...
        **kwargs
        ...
        :paramtype friendly_name: str
        :keyword time_zone: Required. Timezone of the scaling plan.
        :paramtype time_zone: str
        :keyword host_pool_type: HostPool type for desktop. Known values are: "Pooled". Default value:
         "Pooled".
...
class ScalingPlanList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.ScalingPlan"]] = None,
        **kwargs
    ):
        """
...
class ScalingPlanPooledSchedule(Resource):
    ...
    :ivar ramp_up_load_balancing_algorithm: Load balancing algorithm for ramp up period. Known
     values are: "BreadthFirst", "DepthFirst".
    ...
    :ivar ramp_down_stop_hosts_when: Specifies when to stop hosts during ramp down period. Known
     values are: "ZeroSessions", "ZeroActiveSessions".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword ramp_down_load_balancing_algorithm: Load balancing algorithm for ramp down period.
         Known values are: "BreadthFirst", "DepthFirst".
        ...
        :paramtype off_peak_load_balancing_algorithm: str or
         ~azure.mgmt.desktopvirtualization.models.SessionHostLoadBalancingAlgorithm
        """
        super(ScalingPlanPooledSchedule, self).__init__(**kwargs)
        self.system_data = None
...
class ScalingPlanPooledScheduleList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.ScalingPlanPooledSchedule"]] = None,
        **kwargs
    ):
        """
        ...
        """
        super(ScalingPlanPooledScheduleList, self).__init__(**kwargs)
        self.value = value
        self.next_link = None
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype off_peak_load_balancing_algorithm: str or
         ~azure.mgmt.desktopvirtualization.models.SessionHostLoadBalancingAlgorithm
        """
        super(ScalingPlanPooledSchedulePatch, self).__init__(**kwargs)
        self.days_of_week = days_of_week
        self.ramp_up_start_time = ramp_up_start_time
        self.ramp_up_load_balancing_algorithm = ramp_up_load_balancing_algorithm
        self.ramp_up_minimum_hosts_pct = ramp_up_minimum_hosts_pct
...
class SessionHostHealthCheckReport(msrest.serialization.Model):
    ...
    :ivar health_check_result: Represents the Health state of the health check we performed. Known
     values are: "Unknown", "HealthCheckSucceeded", "HealthCheckFailed", "SessionHostShutdown".
...
class SessionHostList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.SessionHost"]] = None,
        **kwargs
    ):
        """
...
class StartMenuItemList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.StartMenuItem"]] = None,
        **kwargs
    ):
        """
...
class UserSession(Resource):
    ...
    :ivar application_type: Application type of application. Known values are: "RemoteApp",
     "Desktop".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword application_type: Application type of application. Known values are: "RemoteApp",
         "Desktop".
...
class UserSessionList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.UserSession"]] = None,
        **kwargs
    ):
        """
...
class WorkspacePatch(msrest.serialization.Model):
    ...
    :vartype application_group_references: list[str]
    :ivar public_network_access: Enabled to allow this resource to be access from the public
     network. Known values are: "Enabled", "Disabled".
    :vartype public_network_access: str or
     ~azure.mgmt.desktopvirtualization.models.PublicNetworkAccess
    """
