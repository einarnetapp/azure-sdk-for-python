...
class AgentUpdatePatchProperties(msrest.serialization.Model):
    ...
    :ivar type: The preferred mechanism for updating the agent components. This is either Scheduled
     or Default. Possible values include: "Default", "Scheduled".
    :vartype type: str or ~azure.mgmt.desktopvirtualization.models.SessionHostComponentUpdateType
    :ivar use_session_host_local_time: Boolean indicating whether to update the agent components in
     the local time zone of each session host in the host pool. By default, this is false.
    :vartype use_session_host_local_time: bool
    :ivar maintenance_window_time_zone: The time zone for updating the agent components. Valid time
    ...
    :ivar maintenance_windows: The maintenance windows (day and time) for updating the agent
     components. At least 1 window must be specified. Optionally, a 2nd window can be specified.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword type: The preferred mechanism for updating the agent components. This is either
         Scheduled or Default. Possible values include: "Default", "Scheduled".
        :paramtype type: str or ~azure.mgmt.desktopvirtualization.models.SessionHostComponentUpdateType
        :keyword use_session_host_local_time: Boolean indicating whether to update the agent components
         in the local time zone of each session host in the host pool. By default, this is false.
        :paramtype use_session_host_local_time: bool
        :keyword maintenance_window_time_zone: The time zone for updating the agent components. Valid
         time zones can be found here:
         https://docs.microsoft.com/en-us/dotnet/api/system.timezoneinfo.findsystemtimezonebyid?view=net-5.0.
         A time zone must be specified if useSessionHostLocalTime is false.
        :paramtype maintenance_window_time_zone: str
        :keyword maintenance_windows: The maintenance windows (day and time) for updating the agent
         components. At least 1 window must be specified. Optionally, a 2nd window can be specified.
...
class HostPool(ResourceModelWithAllowedPropertySet):
    ...
    :ivar agent_update: The preferred settings for updating the agent components (RDAgent, Geneva
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype public_network_access: str or
         ~azure.mgmt.desktopvirtualization.models.HostpoolPublicNetworkAccess
        :keyword agent_update: The preferred settings for updating the agent components (RDAgent,
...
class MaintenanceWindowPatchProperties(msrest.serialization.Model):
    ...
    :ivar hour: The starting hour of the maintenance window (0-23). Note that maintenance windows
     are 2 hours long. This means that updates can be applied anytime from the specified start hour
     to 2 hours after.
    :vartype hour: int
    :ivar day_of_week: The day of the week (Monday-Sunday). Possible values include: "Monday",
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword hour: The starting hour of the maintenance window (0-23). Note that maintenance
         windows are 2 hours long. This means that updates can be applied anytime from the specified
         start hour to 2 hours after.
        :paramtype hour: int
        :keyword day_of_week: The day of the week (Monday-Sunday). Possible values include: "Monday",
         "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday".
