...
class SessionHostsOperations:
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param session_host_name: The name of the session host within the specified host pool.
         Required.
        :type session_host_name: str
        :param force: Force flag to update sessionHost. Default value is None.
        :type force: bool
    ...
    @distributed_trace
    def list(self, resource_group_name: str, host_pool_name: str, **kwargs: Any) -> Iterable["_models.SessionHost"]:
        """List sessionHosts.
