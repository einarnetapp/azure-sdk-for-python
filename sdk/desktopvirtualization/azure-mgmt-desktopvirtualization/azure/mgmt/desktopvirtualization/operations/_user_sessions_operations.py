...
def build_list_by_host_pool_request(
    resource_group_name: str, host_pool_name: str, subscription_id: str, *, filter: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
...
class UserSessionsOperations:
    ...
    def list_by_host_pool(
        self, resource_group_name: str, host_pool_name: str, filter: Optional[str] = None, **kwargs: Any
