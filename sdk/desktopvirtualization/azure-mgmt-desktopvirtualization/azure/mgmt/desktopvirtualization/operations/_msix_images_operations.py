...
def build_expand_request(
    ...
    host_pool_name: str,
    *,
    json: Optional[_models.MSIXImageURI] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/expandMsixImage")  # pylint: disable=line-too-long
...
class MsixImagesOperations:
    ...
    def expand(
        ...
        **kwargs: Any
    ) -> Iterable[_models.ExpandMsixImageList]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.desktopvirtualization.models.ExpandMsixImageList]
