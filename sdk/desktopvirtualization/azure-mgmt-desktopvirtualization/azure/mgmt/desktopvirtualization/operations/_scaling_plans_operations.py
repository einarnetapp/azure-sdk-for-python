...
def build_get_request(
    ...
    api_version = kwargs.pop("api_version", _params.pop("api-version", "2022-08-10"))  # type: str
    ...
    path_format_arguments = {
        ...
        "scalingPlanName": _SERIALIZER.url("scaling_plan_name", scaling_plan_name, "str", max_length=24, min_length=3),
    }
...
class ScalingPlansOperations:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.ScalingPlan"]:
        """List scaling plans.
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ScalingPlan"]:
