...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/applicationGroups/{applicationGroupName}/startMenuItems")  # pylint: disable=line-too-long
...
class StartMenuItemsOperations:
    ...
    def list(
        ...
        application_group_name: str,
        **kwargs: Any
    ) -> Iterable[_models.StartMenuItemList]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.desktopvirtualization.models.StartMenuItemList]
