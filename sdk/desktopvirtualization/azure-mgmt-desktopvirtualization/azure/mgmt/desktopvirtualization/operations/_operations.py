...
def build_list_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.DesktopVirtualization/operations")
...
class Operations:
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.ResourceProviderOperation"]:
        ...
        :return: An iterator like instance of either ResourceProviderOperation or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.desktopvirtualization.models.ResourceProviderOperation]
