...
from ...operations._host_pools_operations import (
    build_create_or_update_request,
    build_delete_request,
    build_get_request,
    build_list_by_resource_group_request,
    build_list_request,
    build_retrieve_registration_token_request,
...
class HostPoolsOperations:
    ...
    async def get(self, resource_group_name: str, host_pool_name: str, **kwargs: Any) -> _models.HostPool:
        """Get a host pool.
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.HostPool"]:
        """List hostPools.
