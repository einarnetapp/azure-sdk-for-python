...
from ...operations._private_endpoint_connections_operations import build_delete_by_host_pool_request, build_delete_by_workspace_request, build_get_by_host_pool_request, build_get_by_workspace_request, build_list_by_host_pool_request, build_list_by_workspace_request, build_update_by_host_pool_request, build_update_by_workspace_request
T = TypeVar('T')
...
class PrivateEndpointConnectionsOperations:
    ...
    def list_by_host_pool(
        ...
        host_pool_name: str,
        **kwargs: Any
    ) -> AsyncIterable[_models.PrivateEndpointConnectionListResultWithSystemData]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.desktopvirtualization.models.PrivateEndpointConnectionListResultWithSystemData]
