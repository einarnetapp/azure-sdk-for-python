...
from ...operations._private_link_resources_operations import build_list_by_host_pool_request, build_list_by_workspace_request
T = TypeVar('T')
    ...
    def list_by_host_pool(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PrivateLinkResourceListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.desktopvirtualization.models.PrivateLinkResourceListResult]
