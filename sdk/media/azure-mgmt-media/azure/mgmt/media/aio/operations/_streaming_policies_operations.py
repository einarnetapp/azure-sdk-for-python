...
from ...operations._streaming_policies_operations import build_create_request, build_delete_request, build_get_request, build_list_request
T = TypeVar('T')
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either StreamingPolicyCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.media.models.StreamingPolicyCollection]
