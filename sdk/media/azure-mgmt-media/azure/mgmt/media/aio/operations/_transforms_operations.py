...
from ...operations._transforms_operations import (
...
class TransformsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.Transform"]:
        """List Transforms.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.media.models.Transform]
