...
class PrometheusRule(_serialization.Model):
    ...
    :ivar record: The name of the time series to output to. Must be a valid metric name.
    :vartype record: str
    :ivar alert: The name of the alert. Must be a valid metric name.
    :vartype alert: str
    :ivar enabled: the flag that indicates whether the Prometheus rule is enabled.
    :vartype enabled: bool
    :ivar expression: The PromQL expression to evaluate. Every evaluation cycle this is evaluated
     at the current time, and the result recorded as a new set of time series with the metric name
    ...
    :ivar severity: The severity of the alerts fired by the rule.
    ...
    :ivar annotations: Annotations for rule group.
    ...
    :vartype actions: ~azure.mgmt.alertsmanagement.models.PrometheusRuleGroupActions
    ...
    _attribute_map = {
        ...
        "actions": {"key": "actions", "type": "PrometheusRuleGroupActions"},
    ...
    def __init__(
        ...
        *,
        ...
        actions: Optional["_models.PrometheusRuleGroupActions"] = None,
        resolve_configuration: Optional["_models.PrometheusRuleResolveConfiguration"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword record: The name of the time series to output to. Must be a valid metric name.
        :paramtype record: str
        :keyword alert: The name of the alert. Must be a valid metric name.
        :paramtype alert: str
        :keyword enabled: the flag that indicates whether the Prometheus rule is enabled.
        :paramtype enabled: bool
        :keyword expression: The PromQL expression to evaluate. Every evaluation cycle this is
         evaluated at the current time, and the result recorded as a new set of time series with the
         metric name as given by 'record'. Required.
        :paramtype expression: str
        :keyword labels: Labels to add or overwrite before storing the result.
        :paramtype labels: dict[str, str]
        :keyword severity: The severity of the alerts fired by the rule.
        ...
        :keyword annotations: Annotations for rule group.
        ...
        :paramtype actions: ~azure.mgmt.alertsmanagement.models.PrometheusRuleGroupActions
...
class PrometheusRuleGroupActions(_serialization.Model):
    """An alert action. Only relevant for alerts.

    :ivar action_groups: The resource ids of the action group to use.
    ...
    :ivar custom_properties: The custom properties of an action group object.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword action_groups: The resource ids of the action group to use.
        ...
        :keyword custom_properties: The custom properties of an action group object.
...
class PrometheusRuleGroupResource(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar scopes: The list of azure resource id's that this rule group is scoped to. Required.
    :vartype scopes: list[str]
    ...
    _validation = {
        ...
        "location": {"required": True},
        "scopes": {"required": True},
        "rules": {"required": True, "max_items": 20, "min_items": 1},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword scopes: The list of azure resource id's that this rule group is scoped to. Required.
        :paramtype scopes: list[str]
...
class PrometheusRuleGroupResourcePatchParameters(_serialization.Model):
    ...
    :ivar properties:
    :vartype properties:
     ~azure.mgmt.alertsmanagement.models.PrometheusRuleGroupResourcePatchParametersProperties
    """

    _attribute_map = {
        "tags": {"key": "tags", "type": "{str}"},
        "properties": {"key": "properties", "type": "PrometheusRuleGroupResourcePatchParametersProperties"},
    }
...
class PrometheusRuleGroupResourcePatchParametersProperties(_serialization.Model):
