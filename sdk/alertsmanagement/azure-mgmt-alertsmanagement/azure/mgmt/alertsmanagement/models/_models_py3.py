...
class Action(msrest.serialization.Model):
    ...
    :ivar action_type: Required. Action that should be applied.Constant filled by server. Known
     values are: "AddActionGroups", "RemoveAllActionGroups".
...
class AlertsMetaDataProperties(msrest.serialization.Model):
    ...
    :ivar metadata_identifier: Required. Identification of the information to be retrieved by API
     call.Constant filled by server. Known values are: "MonitorServiceList".
...
class Recurrence(msrest.serialization.Model):
    ...
    :ivar recurrence_type: Required. Specifies when the recurrence should be applied.Constant
     filled by server. Known values are: "Daily", "Weekly", "Monthly".
...
class ErrorResponseAutoGenerated(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        error: Optional["_models.ErrorResponseBodyAutoGenerated"] = None,
        **kwargs
    ):
        """
        :keyword error: Details of error response.
...
class ErrorResponseAutoGenerated2(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        error: Optional["_models.ErrorResponseBodyAutoGenerated2"] = None,
        **kwargs
    ):
        """
        :keyword error: Details of error response.
...
class Essentials(msrest.serialization.Model):
    ...
    :ivar signal_type: The type of signal the alert is based on, which could be metrics, logs or
     activity logs. Known values are: "Metric", "Log", "Unknown".
    ...
    :ivar monitor_service: Monitor service on which the rule(monitor) is set. Known values are:
     ...
     "Platform", "SCOM", "ServiceHealth", "SmartDetector", "VM Insights", "Zabbix".
...
class SmartGroup(Resource):
    ...
    :ivar smart_group_state: Smart group state. Known values are: "New", "Acknowledged", "Closed".
    ...
    :ivar severity: Severity of smart group is the highest(Sev0 >... > Sev4) severity of all the
     alerts in the group. Known values are: "Sev0", "Sev1", "Sev2", "Sev3", "Sev4".
    :vartype severity: str or ~azure.mgmt.alertsmanagement.models.Severity
...
class SmartGroupModification(Resource):
    ...
    def __init__(
        self,
        *,
        properties: Optional["_models.SmartGroupModificationProperties"] = None,
        **kwargs
    ):
        """
...
class SmartGroupModificationItem(msrest.serialization.Model):
    ...
    :ivar modification_event: Reason for the modification. Known values are: "SmartGroupCreated",
     "StateChange", "AlertAdded", "AlertRemoved".
...
class SmartGroupsList(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        next_link: Optional[str] = None,
        value: Optional[List["_models.SmartGroup"]] = None,
        **kwargs
    ):
        """
        :keyword next_link: URL to fetch the next set of alerts.
