...
def build_get_all_request(
    ...
    **kwargs: Any
    ...
    if page_count is not None:
        _params['pageCount'] = _SERIALIZER.query("page_count", page_count, 'long')
...
def build_get_by_id_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.AlertsManagement/alerts/{alertId}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
...
def build_change_state_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.AlertsManagement/alerts/{alertId}/changestate")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "alertId": _SERIALIZER.url("alert_id", alert_id, 'str'),
    }
...
def build_get_history_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.AlertsManagement/alerts/{alertId}/history")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "alertId": _SERIALIZER.url("alert_id", alert_id, 'str'),
    }
...
def build_get_summary_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.AlertsManagement/alertsSummary")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
    }
    ...
    if include_smart_groups_count is not None:
        _params['includeSmartGroupsCount'] = _SERIALIZER.query("include_smart_groups_count", include_smart_groups_count, 'bool')
    if target_resource is not None:
        _params['targetResource'] = _SERIALIZER.query("target_resource", target_resource, 'str')
    if target_resource_type is not None:
        _params['targetResourceType'] = _SERIALIZER.query("target_resource_type", target_resource_type, 'str')
...
class AlertsOperations:
    ...
    def get_all(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.alertsmanagement.models.AlertsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
