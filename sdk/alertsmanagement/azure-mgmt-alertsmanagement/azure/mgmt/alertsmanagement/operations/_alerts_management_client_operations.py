...
from .._vendor import AlertsManagementClientMixinABC, _convert_request, _format_url_section
...
def build_prometheus_rule_groups_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
...
class AlertsManagementClientOperationsMixin(AlertsManagementClientMixinABC):
    @distributed_trace
    def prometheus_rule_groups_list_by_subscription(
        self, **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_prometheus_rule_groups_list_by_subscription_request(
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
                    template_url=self.prometheus_rule_groups_list_by_subscription.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
    ...
    prometheus_rule_groups_list_by_subscription.metadata = {
