...
# USAGE
    python create_or_update_a_rule_that_removes_all_action_groups_from_all_alerts_on_any_vm_in_two_resource_groups_during_a_recurring_maintenance_window_(22000400_every_sat_and_sun,_india_standard_time).py
