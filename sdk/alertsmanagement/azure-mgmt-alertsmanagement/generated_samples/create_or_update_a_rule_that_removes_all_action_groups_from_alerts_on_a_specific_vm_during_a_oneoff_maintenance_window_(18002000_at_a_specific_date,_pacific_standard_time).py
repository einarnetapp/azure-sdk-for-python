...
# USAGE
    python create_or_update_a_rule_that_removes_all_action_groups_from_alerts_on_a_specific_vm_during_a_oneoff_maintenance_window_(18002000_at_a_specific_date,_pacific_standard_time).py
