...
from .operations import DashboardsOperations, ListTenantConfigurationViolationsOperations, Operations, TenantConfigurationsOperations
...
class Portal:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.tenant_configurations = TenantConfigurationsOperations(self._client, self._config, self._serialize, self._deserialize)
        self.list_tenant_configuration_violations = ListTenantConfigurationViolationsOperations(self._client, self._config, self._serialize, self._deserialize)
