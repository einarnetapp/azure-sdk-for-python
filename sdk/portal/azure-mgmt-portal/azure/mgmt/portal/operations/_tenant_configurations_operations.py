...
def build_list_request(
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Portal/tenantConfigurations')
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Portal/tenantConfigurations/{configurationName}')
...
class TenantConfigurationsOperations(object):
    ...
    def list(
        self,
        **kwargs: Any
    ) -> Iterable["_models.ConfigurationList"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.portal.models.ConfigurationList]
