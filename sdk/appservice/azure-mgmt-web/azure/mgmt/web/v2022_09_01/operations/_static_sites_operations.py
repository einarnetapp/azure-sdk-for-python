...
def build_list_free_trial_static_web_apps_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Web/freeTrialStaticWebApps")
...
def build_get_free_trial_static_web_app_request(free_trial_static_web_app_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Web/freeTrialStaticWebApps/{freeTrialStaticWebAppName}")
    path_format_arguments = {
        "freeTrialStaticWebAppName": _SERIALIZER.url(
            "free_trial_static_web_app_name", free_trial_static_web_app_name, "str", pattern=r"^[a-zA-Z0-9]+$"
        ),
    }
...
def build_create_free_trial_static_web_app_request(free_trial_static_web_app_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_free_trial_static_web_app_request(free_trial_static_web_app_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_upgrade_free_trial_static_web_app_request(free_trial_static_web_app_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/providers/Microsoft.Web/freeTrialStaticWebApps/{freeTrialStaticWebAppName}/upgrade"
    )
    path_format_arguments = {
        "freeTrialStaticWebAppName": _SERIALIZER.url(
            "free_trial_static_web_app_name", free_trial_static_web_app_name, "str", pattern=r"^[a-zA-Z0-9]+$"
...
class StaticSitesOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def list_free_trial_static_web_apps(self, **kwargs: Any) -> _models.FreeTrialStaticWebAppsProxyEntityCollection:
        """Lists all free trial static web apps.

        Lists all free trial static web apps.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: FreeTrialStaticWebAppsProxyEntityCollection or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2022_09_01.models.FreeTrialStaticWebAppsProxyEntityCollection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        api_version: Literal["2022-09-01"] = kwargs.pop("api_version", _params.pop("api-version", "2022-09-01"))
        cls: ClsType[_models.FreeTrialStaticWebAppsProxyEntityCollection] = kwargs.pop("cls", None)

        request = build_list_free_trial_static_web_apps_request(
            api_version=api_version,
            template_url=self.list_free_trial_static_web_apps.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
        ...
        deserialized = self._deserialize("FreeTrialStaticWebAppsProxyEntityCollection", pipeline_response)
    ...
    list_free_trial_static_web_apps.metadata = {"url": "/providers/Microsoft.Web/freeTrialStaticWebApps"}

    @distributed_trace
    def get_free_trial_static_web_app(
        self, free_trial_static_web_app_name: str, **kwargs: Any
    ) -> _models.FreeTrialStaticWebAppsProxyEntity:
        """Gets a free trial static web app.

        Gets a free trial static web app.

        :param free_trial_static_web_app_name: Name of the free trial static web app. Required.
        :type free_trial_static_web_app_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: FreeTrialStaticWebAppsProxyEntity or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2022_09_01.models.FreeTrialStaticWebAppsProxyEntity
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        api_version: Literal["2022-09-01"] = kwargs.pop("api_version", _params.pop("api-version", "2022-09-01"))
        cls: ClsType[_models.FreeTrialStaticWebAppsProxyEntity] = kwargs.pop("cls", None)

        request = build_get_free_trial_static_web_app_request(
            free_trial_static_web_app_name=free_trial_static_web_app_name,
            api_version=api_version,
            template_url=self.get_free_trial_static_web_app.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
        ...
        deserialized = self._deserialize("FreeTrialStaticWebAppsProxyEntity", pipeline_response)
    ...
    get_free_trial_static_web_app.metadata = {
        "url": "/providers/Microsoft.Web/freeTrialStaticWebApps/{freeTrialStaticWebAppName}"
    }

    @overload
    def create_free_trial_static_web_app(
        self,
        free_trial_static_web_app_name: str,
        free_trial_static_web_app: _models.FreeTrialStaticWebAppsProxyEntity,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.FreeTrialStaticWebAppsProxyEntity:
        ...
        :param free_trial_static_web_app_name: Name of the free trial static web app. Required.
        :type free_trial_static_web_app_name: str
        :param free_trial_static_web_app: Required.
        :type free_trial_static_web_app:
         ~azure.mgmt.web.v2022_09_01.models.FreeTrialStaticWebAppsProxyEntity
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def create_free_trial_static_web_app(
        ...
        **kwargs: Any
        ...
        :type free_trial_static_web_app_name: str
        :param free_trial_static_web_app: Required.
        :type free_trial_static_web_app: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def create_free_trial_static_web_app(
        self,
        free_trial_static_web_app_name: str,
        free_trial_static_web_app: Union[_models.FreeTrialStaticWebAppsProxyEntity, IO],
        **kwargs: Any
    ) -> _models.FreeTrialStaticWebAppsProxyEntity:
        """Creates a free trial static web app.
        ...
        :param free_trial_static_web_app_name: Name of the free trial static web app. Required.
        :type free_trial_static_web_app_name: str
        :param free_trial_static_web_app: Is either a FreeTrialStaticWebAppsProxyEntity type or a IO
         type. Required.
        :type free_trial_static_web_app:
         ~azure.mgmt.web.v2022_09_01.models.FreeTrialStaticWebAppsProxyEntity or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        _json = None
        _content = None
        if isinstance(free_trial_static_web_app, (IO, bytes)):
            _content = free_trial_static_web_app
        else:
            _json = self._serialize.body(free_trial_static_web_app, "FreeTrialStaticWebAppsProxyEntity")

        request = build_create_free_trial_static_web_app_request(
            free_trial_static_web_app_name=free_trial_static_web_app_name,
            api_version=api_version,
            content_type=content_type,
            json=_json,
            content=_content,
            template_url=self.create_free_trial_static_web_app.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    create_free_trial_static_web_app.metadata = {
        "url": "/providers/Microsoft.Web/freeTrialStaticWebApps/{freeTrialStaticWebAppName}"
    }

    @distributed_trace
    def delete_free_trial_static_web_app(  # pylint: disable=inconsistent-return-statements
        self, free_trial_static_web_app_name: str, **kwargs: Any
    ) -> None:
        ...
        request = build_delete_free_trial_static_web_app_request(
            free_trial_static_web_app_name=free_trial_static_web_app_name,
            api_version=api_version,
            template_url=self.delete_free_trial_static_web_app.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    delete_free_trial_static_web_app.metadata = {
        "url": "/providers/Microsoft.Web/freeTrialStaticWebApps/{freeTrialStaticWebAppName}"
    }

    @overload
    def upgrade_free_trial_static_web_app(  # pylint: disable=inconsistent-return-statements
        self,
        free_trial_static_web_app_name: str,
        free_trial_static_web_app: _models.FreeTrialStaticWebAppsProxyEntity,
        *,
    ...
    def upgrade_free_trial_static_web_app(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_upgrade_free_trial_static_web_app_request(
            free_trial_static_web_app_name=free_trial_static_web_app_name,
            api_version=api_version,
            content_type=content_type,
            json=_json,
            content=_content,
            template_url=self.upgrade_free_trial_static_web_app.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    upgrade_free_trial_static_web_app.metadata = {
        "url": "/providers/Microsoft.Web/freeTrialStaticWebApps/{freeTrialStaticWebAppName}/upgrade"
    }
