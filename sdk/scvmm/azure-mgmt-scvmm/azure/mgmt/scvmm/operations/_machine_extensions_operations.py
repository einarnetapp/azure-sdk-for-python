...
def build_create_or_update_request(
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2022-05-21-preview"))
...
class MachineExtensionsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either MachineExtension or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.scvmm.models.MachineExtension]
    ...
    def list(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.scvmm.models.MachineExtension]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
