...
class SCVMM:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype hybrid_identity_metadatas:
     azure.mgmt.scvmm.aio.operations.HybridIdentityMetadatasOperations
    :ivar machine_extensions: MachineExtensionsOperations operations
    :vartype machine_extensions: azure.mgmt.scvmm.aio.operations.MachineExtensionsOperations
