...
from ...operations._sql_migration_services_operations import (
    ...
    build_list_monitoring_data_request,
    build_regenerate_auth_keys_request,
    build_update_request,
    build_validate_ir_request,
)
...
class SqlMigrationServicesOperations:
    ...
    ) -> AsyncIterable["_models.SqlMigrationService"]:
    ...
    def list_migrations(
        self, resource_group_name: str, sql_migration_service_name: str, **kwargs: Any
    ) -> AsyncIterable["_models.DatabaseMigration"]:
    ...
    async def validate_ir(
        ...
        **kwargs: Any
        ...
        :type sql_migration_service_name: str
        :param parameters: Details of SqlMigrationService resource. Required.
        :type parameters: ~azure.mgmt.datamigration.models.ValidateIR
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ValidateIR or the result of cls(response)
        :rtype: ~azure.mgmt.datamigration.models.ValidateIR
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def validate_ir(
        ...
        resource_group_name: str,
        sql_migration_service_name: str,
        parameters: Union[_models.ValidateIR, IO],
        **kwargs: Any
    ) -> _models.ValidateIR:
        """Validate IR connectivity to Linked Services.
        ...
        :param parameters: Details of SqlMigrationService resource. Is either a model type or a IO
         type. Required.
        :type parameters: ~azure.mgmt.datamigration.models.ValidateIR or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.ValidateIR] = kwargs.pop("cls", None)
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "ValidateIR")

        request = build_validate_ir_request(
            resource_group_name=resource_group_name,
            sql_migration_service_name=sql_migration_service_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            ...
            json=_json,
            content=_content,
            template_url=self.validate_ir.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
        ...
        deserialized = self._deserialize("ValidateIR", pipeline_response)
    ...
    validate_ir.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataMigration/sqlMigrationServices/{sqlMigrationServiceName}/validateIR"
    }
