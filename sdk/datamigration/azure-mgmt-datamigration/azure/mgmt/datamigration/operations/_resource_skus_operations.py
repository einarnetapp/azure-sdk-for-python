...
def build_list_skus_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version = kwargs.pop("api_version", _params.pop("api-version", "2022-03-30-preview"))  # type: str
    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DataMigration/skus")
