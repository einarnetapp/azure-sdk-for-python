...
from azure.mgmt.hybridconnectivity import HybridConnectivityManagementAPI
...
# USAGE
    python serviceconfigurations_list.py
...
def main():
    ...
    response = client.serviceconfigurations.list_by_endpoint_resource(
