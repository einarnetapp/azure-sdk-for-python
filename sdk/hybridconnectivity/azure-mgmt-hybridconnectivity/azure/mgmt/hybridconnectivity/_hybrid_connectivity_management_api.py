...
class HybridConnectivityManagementAPI:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :ivar serviceconfigurations: ServiceconfigurationsOperations operations
    :vartype serviceconfigurations:
    ...
    def __init__(
        ...
        self.serviceconfigurations = ServiceconfigurationsOperations(
