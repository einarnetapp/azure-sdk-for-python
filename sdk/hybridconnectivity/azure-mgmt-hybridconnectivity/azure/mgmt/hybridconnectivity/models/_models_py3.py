...
class ServiceConfigurationResource(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar provisioning_state: The resource provisioning state. Known values are: "Succeeded",
     "Failed", and "Canceled".
    :vartype provisioning_state: str or ~azure.mgmt.hybridconnectivity.models.Result
    :ivar created_by: The identity that created the resource.
    :vartype created_by: str
    :ivar created_by_type: The type of identity that created the resource. Known values are:
     "User", "Application", "ManagedIdentity", and "Key".
    ...
    _attribute_map = {
        ...
        "resource_id": {"key": "properties.resourceId", "type": "str"},
        "port": {"key": "properties.port", "type": "str"},
        "provisioning_state": {"key": "properties.provisioningState", "type": "str"},
        "created_by": {"key": "systemData.createdBy", "type": "str"},
        "created_by_type": {"key": "systemData.createdByType", "type": "str"},
        "created_at": {"key": "systemData.createdAt", "type": "iso-8601"},
