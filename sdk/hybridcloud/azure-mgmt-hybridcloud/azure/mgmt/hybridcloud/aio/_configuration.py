...
class HybridcloudConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    """Configuration for Hybridcloud.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super(HybridcloudConfiguration, self).__init__(**kwargs)
