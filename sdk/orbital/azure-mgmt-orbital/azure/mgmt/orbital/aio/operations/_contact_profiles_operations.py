...
from ...operations._contact_profiles_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_subscription_request, build_list_request, build_update_tags_request_initial
T = TypeVar('T')
...
class ContactProfilesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param auto_tracking_configuration: Auto-tracking configuration. Default value is None.
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
    ) -> AsyncIterable[_models.ContactProfileListResult]:
        ...
        :return: An iterator like instance of either ContactProfileListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.orbital.models.ContactProfileListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
