...
class ContainerRegistryManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def cache_rules(self):
        """Instance depends on the API version:
           ...
           * 2022-02-01-preview: :class:`CacheRulesOperations<azure.mgmt.containerregistry.v2022_02_01_preview.operations.CacheRulesOperations>`
        """
        api_version = self._get_api_version('cache_rules')
        if api_version == '2022-02-01-preview':
            from .v2022_02_01_preview.operations import CacheRulesOperations as OperationClass
        else:
    ...
    def credential_sets(self):
        """Instance depends on the API version:
           ...
           * 2022-02-01-preview: :class:`CredentialSetsOperations<azure.mgmt.containerregistry.v2022_02_01_preview.operations.CredentialSetsOperations>`
        """
        api_version = self._get_api_version('credential_sets')
        if api_version == '2022-02-01-preview':
            from .v2022_02_01_preview.operations import CredentialSetsOperations as OperationClass
        else:
