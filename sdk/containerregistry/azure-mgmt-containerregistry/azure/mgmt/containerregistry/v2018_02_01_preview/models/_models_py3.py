...
class BuildArgument(_serialization.Model):
    ...
    def __init__(
        self, *, type: Union[str, "_models.BuildArgumentType"], name: str, value: str, is_secret: bool = False, **kwargs
    ):
        """
...
class BuildArgumentList(_serialization.Model):
    ...
    def __init__(
        self, *, value: Optional[List["_models.BuildArgument"]] = None, next_link: Optional[str] = None, **kwargs
    ):
        """
...
class BuildTaskBuildRequest(QueueBuildRequest):
    ...
    def __init__(self, *, build_task_name: str, **kwargs):
        """
