...
class ContainerRegistryManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype cache_rules:
     azure.mgmt.containerregistry.v2022_02_01_preview.aio.operations.CacheRulesOperations
    ...
    :vartype credential_sets:
     azure.mgmt.containerregistry.v2022_02_01_preview.aio.operations.CredentialSetsOperations
