...
class ReplicationsOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.Replication"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2022_02_01_preview.models.Replication]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either Replication or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2022_02_01_preview.models.Replication]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
