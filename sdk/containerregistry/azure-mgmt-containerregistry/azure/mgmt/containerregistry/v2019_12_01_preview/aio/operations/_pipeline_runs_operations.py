...
class PipelineRunsOperations:
    ...
    async def get(
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", "2019-12-01-preview"))  # type: str
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either PipelineRun or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2019_12_01_preview.models.PipelineRun]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> AsyncIterable["_models.PipelineRun"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2019_12_01_preview.models.PipelineRun]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
