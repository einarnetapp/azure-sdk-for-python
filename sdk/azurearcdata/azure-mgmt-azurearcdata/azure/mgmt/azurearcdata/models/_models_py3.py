...
class AGReplicas(_serialization.Model):
    ...
    :vartype role: str
    :ivar connected_state: The connected state of the replica.
    :vartype connected_state: str
    :ivar synchronization_state: The synchronization state of the availability group replicas.
    :vartype synchronization_state: str
    :ivar availability_mode: The availability mode of the replica.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype role: str
        :keyword connected_state: The connected state of the replica.
        :paramtype connected_state: str
        :keyword synchronization_state: The synchronization state of the availability group replicas.
        :paramtype synchronization_state: str
        :keyword availability_mode: The availability mode of the replica.
...
class FailoverGroupProperties(_serialization.Model):
    ...
    :vartype status: ~azure.mgmt.azurearcdata.models.FailoverGroupStatus
    """
    ...
    def __init__(
        ...
        *,
        ...
        status: Optional["_models.FailoverGroupStatus"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword additional_properties: Unmatched properties from the message are deserialized to this
        ...
        :paramtype status: ~azure.mgmt.azurearcdata.models.FailoverGroupStatus
        """
        super().__init__(**kwargs)
        self.additional_properties = additional_properties
        self.provisioning_state = None
...
class FailoverGroupSpec(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword role: The role of the SQL managed instance in this failover group. Required. Known
         values are: "primary", "secondary", "force-primary-allow-data-loss", and "force-secondary".
...
class FailoverGroupStatus(_serialization.Model):
    """The status of the Kubernetes custom resource.
    ...
    :ivar observed_generation: The version of the replicaSet associated with the failover group
     custom resource.
    :vartype observed_generation: int
    :ivar state: The state of the failover group custom resource. Known values are: "Waiting",
    ...
    :vartype results: str
    :ivar role: The role of the managed instance in the failover group. Known values are:
     "primary", "secondary", "force-primary-allow-data-loss", and "force-secondary".
    :vartype role: str or ~azure.mgmt.azurearcdata.models.InstanceFailoverGroupRole
    :ivar replicas: A list of failover group replicas.
    :vartype replicas: list[~azure.mgmt.azurearcdata.models.AGReplicas]
    """
    ...
    def __init__(
        ...
        *,
        ...
        role: Optional[Union[str, "_models.InstanceFailoverGroupRole"]] = None,
        replicas: Optional[List["_models.AGReplicas"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword additional_properties: Unmatched properties from the message are deserialized to this
        ...
        :keyword observed_generation: The version of the replicaSet associated with the failover group
         custom resource.
        :paramtype observed_generation: int
        :keyword state: The state of the failover group custom resource. Known values are: "Waiting",
         "Succeeded", and "Failed".
        ...
        :keyword role: The role of the managed instance in the failover group. Known values are:
         "primary", "secondary", "force-primary-allow-data-loss", and "force-secondary".
        :paramtype role: str or ~azure.mgmt.azurearcdata.models.InstanceFailoverGroupRole
        :keyword replicas: A list of failover group replicas.
        :paramtype replicas: list[~azure.mgmt.azurearcdata.models.AGReplicas]
        """
        super().__init__(**kwargs)
        self.additional_properties = additional_properties
        self.last_update_time = last_update_time
