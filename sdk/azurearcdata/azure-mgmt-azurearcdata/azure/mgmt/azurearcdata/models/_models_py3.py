...
class SqlServerInstanceProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar license_type: SQL Server license type. Known values are: "Payg", "Paid", "Free", "HADR",
     and "Undefined".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword license_type: SQL Server license type. Known values are: "Payg", "Paid", "Free",
         "HADR", and "Undefined".
