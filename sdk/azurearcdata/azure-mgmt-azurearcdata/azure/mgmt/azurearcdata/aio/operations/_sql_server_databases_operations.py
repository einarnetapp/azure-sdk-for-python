...
class SqlServerDatabasesOperations:
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :param database_name: Name of the database. Required.
        :type database_name: str
        :param sql_server_database_resource: The request body for database resource. Is either a model
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param database_name: Name of the database. Required.
        :type database_name: str
        :param sql_server_database_update: The requested database resource state. Is either a model
         type or a IO type. Required.
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.SqlServerDatabaseResource"]:
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.ArcSqlServerDatabaseListResult]
