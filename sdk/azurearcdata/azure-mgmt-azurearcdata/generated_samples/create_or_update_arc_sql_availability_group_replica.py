...
# USAGE
    python create_or_update_arc_sql_availability_group_replica.py
...
def main():
    ...
    response = client.sql_availability_group_replicas.create(
        resource_group_name="testrg",
        sql_server_instance_name="testSqlServerInstance",
        sql_availability_group_name="testAG",
        sql_availability_group_replica_resource={
