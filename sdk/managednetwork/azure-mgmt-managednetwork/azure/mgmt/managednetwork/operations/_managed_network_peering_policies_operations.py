...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "managedNetworkPeeringPolicyName": _SERIALIZER.url(
            "managed_network_peering_policy_name", managed_network_peering_policy_name, "str"
        ),
    }
...
class ManagedNetworkPeeringPoliciesOperations:
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(managed_network_policy, (IO, bytes)):
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.ManagedNetworkPeeringPolicy]:
        ...
        :return: An instance of LROPoller that returns either ManagedNetworkPeeringPolicy or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetwork.models.ManagedNetworkPeeringPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type managed_network_peering_policy_name: str
        :param managed_network_policy: Parameters supplied to create/update a Managed Network Peering
         Policy. Is either a model type or a IO type. Required.
    ...
    def list_by_managed_network(
        ...
        skiptoken: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.ManagedNetworkPeeringPolicy"]:
        ...
        :return: An iterator like instance of either ManagedNetworkPeeringPolicy or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.managednetwork.models.ManagedNetworkPeeringPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
