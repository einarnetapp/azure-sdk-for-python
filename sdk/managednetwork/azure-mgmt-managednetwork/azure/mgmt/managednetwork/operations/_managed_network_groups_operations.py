...
class ManagedNetworkGroupsOperations:
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(managed_network_group, (IO, bytes)):
    ...
    def list_by_managed_network(
        ...
        skiptoken: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.ManagedNetworkGroup"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.managednetwork.models.ManagedNetworkGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
