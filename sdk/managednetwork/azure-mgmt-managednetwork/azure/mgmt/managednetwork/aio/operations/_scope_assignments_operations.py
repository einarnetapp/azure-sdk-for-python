...
from ...operations._scope_assignments_operations import (
...
class ScopeAssignmentsOperations:
    ...
    async def get(self, scope: str, scope_assignment_name: str, **kwargs: Any) -> _models.ScopeAssignment:
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> AsyncIterable["_models.ScopeAssignment"]:
        """Get the specified scope assignment.
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.managednetwork.models.ScopeAssignment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
