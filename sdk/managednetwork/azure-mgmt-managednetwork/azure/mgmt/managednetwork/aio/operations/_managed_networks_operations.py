...
from ...operations._managed_networks_operations import (
...
class ManagedNetworksOperations:
    ...
    async def get(self, resource_group_name: str, managed_network_name: str, **kwargs: Any) -> _models.ManagedNetwork:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(managed_network, (IO, bytes)):
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no
         Retry-After header is present.
        :return: An instance of AsyncLROPoller that returns either ManagedNetwork or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetwork.models.ManagedNetwork]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_resource_group(
    ...
    ) -> AsyncIterable["_models.ManagedNetwork"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.managednetwork.models.ManagedNetwork]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
