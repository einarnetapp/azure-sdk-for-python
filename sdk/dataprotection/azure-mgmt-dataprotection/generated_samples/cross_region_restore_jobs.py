...
# USAGE
    python cross_region_restore_jobs.py
...
def main():
    ...
    response = client.list_cross_region_restore_jobs(
...
# x-ms-original-file: specification/dataprotection/resource-manager/Microsoft.DataProtection/preview/2023-04-01-preview/examples/CrossRegionRestore/CrossRegionRestoreJobs.json
