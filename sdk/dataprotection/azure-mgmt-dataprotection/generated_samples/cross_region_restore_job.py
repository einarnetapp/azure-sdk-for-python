...
# USAGE
    python cross_region_restore_job.py
...
def main():
    ...
    response = client.get_cross_region_restore_job(
...
# x-ms-original-file: specification/dataprotection/resource-manager/Microsoft.DataProtection/preview/2023-04-01-preview/examples/CrossRegionRestore/CrossRegionRestoreJob.json
