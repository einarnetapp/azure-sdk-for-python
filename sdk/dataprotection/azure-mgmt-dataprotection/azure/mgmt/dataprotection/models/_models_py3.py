...
class AzureBackupFindRestorableTimeRangesRequest(msrest.serialization.Model):
    ...
    :ivar source_data_store_type: Required. Gets or sets the type of the source data store. Known
     values are: "OperationalStore", "VaultStore", "ArchiveStore".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword source_data_store_type: Required. Gets or sets the type of the source data store.
         Known values are: "OperationalStore", "VaultStore", "ArchiveStore".
...
class AzureBackupRestoreRequest(msrest.serialization.Model):
    ...
    :ivar source_data_store_type: Required. Gets or sets the type of the source data store. Known
     values are: "ArchiveStore", "SnapshotStore", "VaultStore".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword source_data_store_type: Required. Gets or sets the type of the source data store.
         Known values are: "ArchiveStore", "SnapshotStore", "VaultStore".
...
class AzureBackupRehydrationRequest(msrest.serialization.Model):
    ...
    :ivar rehydration_priority: Priority to be used for rehydration. Values High or Standard. Known
     values are: "Invalid", "High", "Standard".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword rehydration_priority: Priority to be used for rehydration. Values High or Standard.
         Known values are: "Invalid", "High", "Standard".
...
class AzureBackupRestoreWithRehydrationRequest(AzureBackupRecoveryPointBasedRestoreRequest):
    ...
    :ivar rehydration_priority: Required. Priority to be used for rehydration. Values High or
     Standard. Known values are: "Invalid", "High", "Standard".
    :vartype rehydration_priority: str or ~azure.mgmt.dataprotection.models.RehydrationPriority
    :ivar rehydration_retention_duration: Required. Retention duration in ISO 8601 format i.e P10D
     .
    :vartype rehydration_retention_duration: str
...
class AzureMonitorAlertSettings(msrest.serialization.Model):
    ...
    :ivar alerts_for_all_job_failures: Known values are: "Enabled", "Disabled".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword alerts_for_all_job_failures: Known values are: "Enabled", "Disabled".
...
class DataStoreParameters(msrest.serialization.Model):
    ...
    :ivar object_type: Required. Type of the specific object - used for deserializing.Constant
     filled by server.
    :vartype object_type: str
    :ivar data_store_type: Required. type of datastore; Operational/Vault/Archive. Known values
     are: "OperationalStore", "VaultStore", "ArchiveStore".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword data_store_type: Required. type of datastore; Operational/Vault/Archive. Known values
         are: "OperationalStore", "VaultStore", "ArchiveStore".
...
class DppProxyResource(msrest.serialization.Model):
    ...
    :ivar type: Proxy Resource type represents the complete path of the form
     Namespace/ResourceType/ResourceType/...
    :vartype type: str
    :ivar tags: A set of tags. Proxy Resource tags.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword tags: A set of tags. Proxy Resource tags.
...
class BackupInstanceResource(DppProxyResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super(BackupInstanceResource, self).__init__(tags=tags, **kwargs)
        self.properties = properties
...
class BackupVault(msrest.serialization.Model):
    ...
    :ivar resource_move_state: Resource move state for backup vault. Known values are: "Unknown",
     ...
     "CriticalFailure", "PartialSuccess", "MoveSucceeded".
...
class DppBaseResourceList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.DppBaseResource"]] = None,
        next_link: Optional[str] = None,
        **kwargs
    ):
        """
...
class FeatureValidationRequest(FeatureValidationRequestBase):
    ...
    :ivar object_type: Required. Type of the specific object - used for deserializing.Constant
     filled by server.
    :vartype object_type: str
    :ivar feature_type: backup support feature type. Known values are: "Invalid", "DataSourceType".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword feature_type: backup support feature type. Known values are: "Invalid",
         "DataSourceType".
...
class RestoreTargetInfoBase(msrest.serialization.Model):
    ...
    :vartype object_type: str
    :ivar recovery_option: Required. Recovery Option. Known values are: "FailIfExists".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword recovery_option: Required. Recovery Option. Known values are: "FailIfExists".
...
class SecretStoreResource(msrest.serialization.Model):
    ...
    :vartype uri: str
    :ivar secret_store_type: Required. Gets or sets the type of secret store. Known values are:
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype uri: str
        :keyword secret_store_type: Required. Gets or sets the type of secret store. Known values are:
         "Invalid", "AzureKeyVault".
...
class StorageSetting(msrest.serialization.Model):
    ...
    :ivar type: Gets or sets the type. Known values are: "GeoRedundant", "LocallyRedundant",
     "ZoneRedundant".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword type: Gets or sets the type. Known values are: "GeoRedundant", "LocallyRedundant",
         "ZoneRedundant".
...
class SupportedFeature(msrest.serialization.Model):
    ...
    :ivar support_status: feature support status. Known values are: "Invalid", "NotSupported",
     "AlphaPreview", "PrivatePreview", "PublicPreview", "GenerallyAvailable".
...
class SyncBackupInstanceRequest(msrest.serialization.Model):
    ...
    :ivar sync_type: Field indicating sync type e.g. to sync only in case of failure or in all
     cases. Known values are: "Default", "ForceResync".
...
class TargetDetails(msrest.serialization.Model):
    ...
    :ivar restore_target_location_type: Required. Denotes the target location where the data will
     ...
     Known values are: "Invalid", "AzureBlobs", "AzureFiles".
