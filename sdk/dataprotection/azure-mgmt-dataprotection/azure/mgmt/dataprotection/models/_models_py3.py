...
class CmkKekIdentity(_serialization.Model):
    ...
    :ivar identity_type: Known values are: "Unknown", "SystemAssigned", "UserAssigned", "None", and
     "SystemAssignedAndUserAssigned".
    :vartype identity_type: str or ~azure.mgmt.dataprotection.models.ManagedIdentityType
    :ivar identity_id:
    ...
    def __init__(
        self,
        *,
        identity_type: Optional[Union[str, "_models.ManagedIdentityType"]] = None,
        identity_id: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword identity_type: Known values are: "Unknown", "SystemAssigned", "UserAssigned", "None",
         and "SystemAssignedAndUserAssigned".
        :paramtype identity_type: str or ~azure.mgmt.dataprotection.models.ManagedIdentityType
        :keyword identity_id:
...
class DppIdentityDetails(_serialization.Model):
    ...
    :ivar type: The identityType which can be either SystemAssigned, UserAssigned or None.
    :vartype type: str
    :ivar user_assigned_identities: Gets or sets the user assigned identities.
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.dataprotection.models.UserAssignedIdentityDetails]
    """
    ...
    _attribute_map = {
        ...
        "type": {"key": "type", "type": "str"},
        "user_assigned_identities": {"key": "userAssignedIdentities", "type": "{UserAssignedIdentityDetails}"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        user_assigned_identities: Optional[Dict[str, "_models.UserAssignedIdentityDetails"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword type: The identityType which can be either SystemAssigned, UserAssigned or None.
        :paramtype type: str
...
class EncryptionSettings(_serialization.Model):
    ...
    :ivar state: State of encryption. Known values are: "Disabled", "Enabled", and "Inconsistent".
    :vartype state: str or ~azure.mgmt.dataprotection.models.EncryptionState
    :ivar key_vault_properties: Key Vault Details.
    :vartype key_vault_properties: ~azure.mgmt.dataprotection.models.CmkKeyVaultProperties
    :ivar kek_identity: Identity Details.
    :vartype kek_identity: ~azure.mgmt.dataprotection.models.CmkKekIdentity
    :ivar infrastructure_encryption: State of Infrastructure encryption. Known values are:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword state: State of encryption. Known values are: "Disabled", "Enabled", and
         "Inconsistent".
        :paramtype state: str or ~azure.mgmt.dataprotection.models.EncryptionState
        :keyword key_vault_properties: Key Vault Details.
        :paramtype key_vault_properties: ~azure.mgmt.dataprotection.models.CmkKeyVaultProperties
        :keyword kek_identity: Identity Details.
        :paramtype kek_identity: ~azure.mgmt.dataprotection.models.CmkKekIdentity
        :keyword infrastructure_encryption: State of Infrastructure encryption. Known values are:
         "Disabled" and "Enabled".
...
class SecuritySettings(_serialization.Model):
    ...
    :ivar encryption_settings: Class containing encryption settings of vault.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword encryption_settings: Class containing encryption settings of vault.
...
class UserAssignedIdentityDetails(_serialization.Model):
    ...
    :ivar client_id: The Client Id of the UAMI.
    :vartype client_id: str
    :ivar principal_id: The Object Id of the UAMI.
    :vartype principal_id: str
    """
