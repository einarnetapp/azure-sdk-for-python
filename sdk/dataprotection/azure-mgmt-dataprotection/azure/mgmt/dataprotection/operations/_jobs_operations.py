...
def build_trigger_cancel_request(
    resource_group_name: str, vault_name: str, job_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class JobsOperations:
    ...
    def _trigger_cancel_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, vault_name: str, job_id: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_trigger_cancel(
        ...
        if cont_token is None:
            raw_result = self._trigger_cancel_initial(  # type: ignore
                resource_group_name=resource_group_name,
                vault_name=vault_name,
                job_id=job_id,
                api_version=api_version,
