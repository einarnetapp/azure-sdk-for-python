...
from ...operations._data_protection_mgmt_client_operations import (
    build_fetch_secondary_r_ps_request,
    build_get_cross_region_restore_job_request,
    build_list_cross_region_restore_jobs_request,
)
from .._vendor import DataProtectionMgmtClientMixinABC
...
class DataProtectionMgmtClientOperationsMixin(DataProtectionMgmtClientMixinABC):
    ...
    @overload
    async def get_cross_region_restore_job(
        self,
        resource_group_name: str,
        location: str,
