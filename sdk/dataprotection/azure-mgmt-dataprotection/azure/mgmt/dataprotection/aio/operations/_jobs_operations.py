...
from ...operations._jobs_operations import build_get_request, build_list_request, build_trigger_cancel_request
...
class JobsOperations:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupJobs/{jobId}"
    }

    async def _trigger_cancel_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, vault_name: str, job_id: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_trigger_cancel_request(
            resource_group_name=resource_group_name,
            vault_name=vault_name,
            job_id=job_id,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self._trigger_cancel_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _trigger_cancel_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupJobs/{jobId}/triggerCancel"
    }

    @distributed_trace_async
    async def begin_trigger_cancel(
        self, resource_group_name: str, vault_name: str, job_id: str, **kwargs: Any
    ) -> AsyncLROPoller[None]:
        ...
        if cont_token is None:
            raw_result = await self._trigger_cancel_initial(  # type: ignore
                resource_group_name=resource_group_name,
                vault_name=vault_name,
                job_id=job_id,
                api_version=api_version,
