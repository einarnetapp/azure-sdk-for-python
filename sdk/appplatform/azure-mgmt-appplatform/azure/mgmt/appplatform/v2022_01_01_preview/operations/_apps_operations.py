...
def build_create_or_update_request_initial(
    ...
    app_name: str,
    *,
    json: Optional[_models.AppResource] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_set_active_deployments_request_initial(
    ...
    app_name: str,
    *,
    json: Optional[_models.ActiveDeploymentCollection] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_validate_domain_request(
    ...
    app_name: str,
    *,
    json: Optional[_models.CustomDomainValidatePayload] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either AppResourceCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2022_01_01_preview.models.AppResourceCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
