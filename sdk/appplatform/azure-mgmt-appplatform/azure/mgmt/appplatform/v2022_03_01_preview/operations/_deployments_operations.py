...
def build_create_or_update_request_initial(
    ...
    deployment_name: str,
    *,
    json: Optional[_models.DeploymentResource] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_generate_heap_dump_request_initial(
    ...
    deployment_name: str,
    *,
    json: Optional[_models.DiagnosticParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DeploymentResourceCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2022_03_01_preview.models.DeploymentResourceCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
