...
class ProactiveDetectionConfigurationsOperations:
    ...
    def list(
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[List[_models.ApplicationInsightsComponentProactiveDetectionConfiguration]]
    ...
    def get(
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[_models.ApplicationInsightsComponentProactiveDetectionConfiguration]
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type configuration_id: str
        :param proactive_detection_properties: Properties that need to be specified to update the
         ProactiveDetection configuration. Is either a model type or a IO type. Required.
        :type proactive_detection_properties:
         ~azure.mgmt.applicationinsights.v2018_05_01_preview.models.ApplicationInsightsComponentProactiveDetectionConfiguration
         or IO
