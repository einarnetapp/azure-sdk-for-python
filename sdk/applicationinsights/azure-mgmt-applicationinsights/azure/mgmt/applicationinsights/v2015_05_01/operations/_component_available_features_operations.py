...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/components/{resourceName}/getavailablebillingfeatures")  # pylint: disable=line-too-long
...
class ComponentAvailableFeaturesOperations:
    ...
    def get(
        ...
        **kwargs: Any
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', "2015-05-01"))  # type: str
        cls = kwargs.pop('cls', None)  # type: ClsType[_models.ApplicationInsightsComponentAvailableFeatures]
    ...
    get.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/components/{resourceName}/getavailablebillingfeatures"}  # type: ignore
