...
class ApplicationInsightsComponentAPIKeyListResult(_serialization.Model):
    ...
    def __init__(self, *, value: List["_models.ApplicationInsightsComponentAPIKey"], **kwargs):
        """
...
class ApplicationInsightsComponentExportConfiguration(
    ...
    def __init__(
        self, *, record_types: Optional[str] = None, notification_queue_enabled: Optional[str] = None, **kwargs
    ):
        """
...
class ApplicationInsightsWebTestLocationsListResult(_serialization.Model):
    ...
    def __init__(self, *, value: List["_models.ApplicationInsightsComponentWebTestLocation"], **kwargs):
        """
...
class ComponentPurgeBody(_serialization.Model):
    ...
    def __init__(self, *, table: str, filters: List["_models.ComponentPurgeBodyFilters"], **kwargs):
        """
...
class InnerError(_serialization.Model):
    ...
    def __init__(self, *, diagnosticcontext: Optional[str] = None, time: Optional[datetime.datetime] = None, **kwargs):
        """
...
class WebTestPropertiesConfiguration(_serialization.Model):
    ...
    def __init__(self, *, web_test: Optional[str] = None, **kwargs):
        """
